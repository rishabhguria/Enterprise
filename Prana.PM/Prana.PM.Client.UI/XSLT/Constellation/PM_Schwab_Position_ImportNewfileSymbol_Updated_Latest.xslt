  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and $varFlag='1'">


          <!--<xsl:if test="number($Position) and ($varSymbol = 'QQQ' or $varSymbol ='ARTGX' 
		or $varSymbol ='SWVXX' or $varSymbol ='DFUS' or $varSymbol ='SPY'
									  or $varSymbol ='IVV' or $varSymbol ='VUG' or $varSymbol ='VOO' or $varSymbol ='VTI' or $varSymbol ='SHSSX' 
								     or $varSymbol ='SEQUX' or $varSymbol ='VTV' or $varSymbol ='IJR' or $varSymbol ='VFIAX' or $varSymbol ='WCMIX'
									  or $varSymbol ='SHY' or $varSymbol ='IWN' or $varSymbol ='IWO' or $varSymbol ='IEMG' or $varSymbol ='XLV' or 
									  $varSymbol ='MMAT' or $varSymbol ='ONGAX'  or $varSymbol ='SHY' or $varSymbol ='SNSXX' 
									  or $varSymbol ='VTV'
									  )">--> 

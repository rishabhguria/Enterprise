	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($Quantity) and COL1='T'">
					...
					<PositionMaster>
						...
						<xsl:variable name="PRANA_UNDERLYNE_NAME">
							<xsl:value-of select="document('../ReconMappingXML/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@UnderlyingCode=$PB_Root_NAME]/@PBCode"/>
						</xsl:variable>

						<xsl:variable name="MonthsCodee">
						...
						<xsl:variable name="Future">
							<xsl:value-of select="concat($MonthsCodee,$Yeer)"/>
						</xsl:variable>
						...
						<xsl:variable name="OtherFees">
							<xsl:choose>
								<xsl:when test="COL9='1'">
									<xsl:value-of select="COL37 + COL39 + COL41 + COL47"/>
								</xsl:when>
								<xsl:when test="COL9='2'">
									<xsl:value-of select="COL37 - COL39 - COL41 - COL47"/>
								</xsl:when>
							</xsl:choose>
						</xsl:variable>
						...
						<xsl:variable name="OtherBrokerFees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$OtherFees"/>
							</xsl:call-template>
						</xsl:variable>
						<OtherBrokerFees>
							<xsl:choose>

...
namespace Prana.PostTrade
{
    class HCST : AlgoBase
    {
        ...
        private List<TaxLot> SortSellList(List<TaxLot> taxlots, PostTradeEnums.ClosingField closingField)
        {
            ...
            // Jira : http://jira.nirvanasolutions.com:8080/browse/PRANA-9064
            TaxLot[] TaxlotsClone = new TaxLot[taxlots.Count];
            taxlots.CopyTo(TaxlotsClone, 0);

            // Here we are adding those taxlots which satisfy the short Term citerion in a new list
            ...
            if (taxlots.Count > 0) // sorting by HIFO
            {
                ...
                //Now merging both the lists (short Term as well as normal taxlots) to get the final sorted list

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(substring(substring-after(substring-after(substring-after(COL7,'/'),'/'),' '),1,1),'P') or contains(substring(substring-after(substring-after(substring-after(COL7,'/'),'/'),' '),1,1),'C')">
      ...
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-after(substring-after(substring-after(normalize-space(COL7),'/'),'/'),' '),2),'#.00')"/>
      </xsl:variable>

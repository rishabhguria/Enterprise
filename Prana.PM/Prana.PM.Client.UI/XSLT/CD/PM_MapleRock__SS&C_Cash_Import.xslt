	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:variable name="varCashValueLocal" select="number(translate(translate(translate(translate(COL41,'$',''),',',''),'(',''),')',''))"/>

				<xsl:if test ="$varCashValueLocal ">
					...
					<PositionMaster>
						...
						<xsl:variable name="varCashValueBase" select="number(translate(translate(translate(translate(COL42,'$',''),',',''),'(',''),')',''))"/>

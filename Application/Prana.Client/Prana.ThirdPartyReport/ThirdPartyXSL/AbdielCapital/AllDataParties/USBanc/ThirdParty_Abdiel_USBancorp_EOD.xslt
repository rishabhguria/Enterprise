      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail[Symbol!='PISXX' and Symbol!='DREUSTB']">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <TradeID>
            ...
            <xsl:value-of select="concat($Year,'_',$Month,'_',$Day,'_',Symbol,'_',$FundCode,'_',EntityID)"/>
          </TradeID>
          ...
          <ClearingBroker_Custodian_FCM>
			  <xsl:choose>
				  <xsl:when test="contains($PRANA_FUND_NAME,'ACLP-SS-ADM')">
					  <xsl:value-of select="'SSBS.BOS.CUST.FUT'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'QMF-SS-ADM')">
					  <xsl:value-of select="'SSBS.BOS.CUST.FUT'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'ACLP-State Street')">
					  <xsl:value-of select="'SSBS.BOS.CUST'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'QMF-State Street')">
					  <xsl:value-of select="'SSBS.BOS.CUST'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'ACLP-Wells')">
					  <xsl:value-of select="'WELL.NYC.PB'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'QMF-Wells')">
					  <xsl:value-of select="'WELL.NYC.PB'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'ACLP-ADM')">
					  <xsl:value-of select="'WELL.NYC.FUTURE'"/>
				  </xsl:when>
				  <xsl:when test="contains($PRANA_FUND_NAME,'QMF-ADM')">
					  <xsl:value-of select="'WELL.NYC.FUTURE'"/>
				  </xsl:when>
				  <xsl:otherwise>
					  <xsl:value-of select="''"/>

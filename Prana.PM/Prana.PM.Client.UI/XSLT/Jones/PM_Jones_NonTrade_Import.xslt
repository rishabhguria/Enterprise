	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number($varCash)  and  ($varDescription='DR / CR INTEREST' or $varDescription='MMF INTEREST PMNT' 
          or $varDescription='OTHER EXPENSES' or $varDescription='SL FEES' or $varDescription='SMV REBATE' )" >
					...
					<PositionMaster>
						...
						<xsl:variable name = "PRANA_PRE_ACRONYM_NAME" >
							<xsl:choose>
                <xsl:when test="($varDescription='DR / CR INTEREST' or $varDescription='MMF INTEREST PMNT' or $varDescription='SMV REBATE') 
                  and $varCash &lt; 0">
                ...
                <xsl:when test="($varDescription='DR / CR INTEREST') or ($varDescription='MMF INTEREST PMNT') or ($varDescription='SMV REBATE') 
                  and $varCash &gt; 0">
								...
								<xsl:when test="($varDescription='SL FEES' or $varDescription='OTHER EXPENSES' ) and $varCash &lt; 0">
                ...
                <xsl:when test="($varDescription='DR / CR INTEREST') or ($varDescription='MMF INTEREST PMNT') or ($varDescription='SMV REBATE') 
                  and $varCash &gt; 0">
								...
								<xsl:when test="($varDescription='DR / CR INTEREST' or $varDescription='MMF INTEREST PMNT' or 
                 $varDescription='SMV REBATE' or $varDescription='OTHER EXPENSES' or $varDescription='SL FEES') and $varCash &lt; 0">
									<xsl:value-of select="'Cash'"/>
								</xsl:when>

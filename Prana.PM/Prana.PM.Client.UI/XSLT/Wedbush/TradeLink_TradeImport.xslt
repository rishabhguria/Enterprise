    ...
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
        ...
        <!--<xsl:if test="number(COL4) and COL23='0' and (COL2='88522033')">
			...
			<xsl:if test="number(COL4) and COL23='0' and (COL2='1PT00054' or COL2='1PT00058' or COL2='1PT00071' or COL2='1PT00078' or COL2='1PT00077')">
				
          <PositionMaster>
			  <xsl:variable name = "PB_NAME">
				  <xsl:value-of select="'LIME'"/>
			  </xsl:variable>
			  <xsl:variable name = "PB_COMPANY" >
				  <xsl:value-of select="COL18"/>
			  </xsl:variable>
			  <xsl:variable name="PRANA_SYMBOL">
				  <xsl:value-of select="document('../ReconMappingXml/SymbolMapping.xml')/SymbolMapping/PB[@Name='LIME']/SymbolData[@PBCompanyName=$PB_COMPANY]/@PranaSymbol"/>
			  </xsl:variable>
			  ...
			  <xsl:variable name="PRANA_FUND_NAME">
				  <xsl:value-of select="document('../ReconMappingXml/AccountMapping.xml')/FundMapping/PB[@Name='LIME']/FundData[@PBFundCode=$PB_FUND_NAME]/@PranaFund"/>
			  </xsl:variable>
            ...
            <SideTagValue>
              <xsl:choose>
                <xsl:when test="COL3 = 'P' and COL34 = '2' and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
				  ...
				  <xsl:when test="COL3 = 'P' and COL34 = '3'  and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'B'"/>
				  </xsl:when>
				  <xsl:when test="COL3 = 'S' and COL34 = '2'  and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'2'"/>
				  </xsl:when>
				  <xsl:when test="COL3 = 'S' and COL34 = '3'   and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'5'"/>
				  </xsl:when>
			  ...
			  <xsl:variable name="varFees" select="number(COL22)"/>
			  ...
			  <!--<CounterPartyID>
				  ...
				  <xsl:choose>
					  <xsl:when test ="(COL2 = '1PT00054' or COL2 = '1PT00058') and COL7='11' ">

		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<CASHACCOUNT>
						<xsl:value-of select="concat (FundMappedName, '0')"/>
					</CASHACCOUNT>
					...
					<!--<xsl:choose>
						...
						<xsl:when test="FundAccountNo = 'JMP001813' and (Side='Buy to Close' or Side='Buy to Cover' or Side='Sell short' or Side='Sell to Open')">
							<SECACCOUNT>
								<xsl:value-of select="concat(FundAccountNo,'3')"/>
							</SECACCOUNT>
						</xsl:when>

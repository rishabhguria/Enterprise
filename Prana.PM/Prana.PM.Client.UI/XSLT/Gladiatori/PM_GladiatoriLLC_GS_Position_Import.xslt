...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="StrikePrice">
      <xsl:value-of select="format-number(substring(substring-after(normalize-space(COL7),' '),8) div 1000,'##.00')"/>
    </xsl:variable>
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
                        ...
                        <xsl:variable name="varAsset">
                          <xsl:choose>
                            <xsl:when test="COL33='Equity Options'">
                        ...
                        <SideTagValue>
                          <xsl:choose>
                            <xsl:when test="$Position &gt; 0">
                              <xsl:choose>
                                <xsl:when test="normalize-space(COL33)='Equity Options'">
                                  <xsl:value-of select="'A'"/>
                                </xsl:when>
                                <xsl:when test="normalize-space(COL33)='Corporate Bonds' or normalize-space(COL33)='Convertible Bonds'">
                                  <xsl:value-of select="'1'"/>
                                </xsl:when>  
							    <xsl:when test="normalize-space(COL33)='Common Stock' or normalize-space(COL33)='Equity Stock Indices'">
                                  <xsl:value-of select="'1'"/>
                                </xsl:when>  
                              </xsl:choose>
                            </xsl:when>
							<xsl:when test="$Position &lt; 0">
                              <xsl:choose>
                                ...
                                <xsl:when test="normalize-space(COL33)='Corporate Bonds' or $varAsset='Convertible Bonds'">

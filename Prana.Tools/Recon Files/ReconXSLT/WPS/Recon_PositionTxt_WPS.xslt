      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:variable name="Position">
          <xsl:call-template name="Translate">
            <xsl:with-param name="Number" select="normalize-space(substring(COL1,51,12))"/>
          </xsl:call-template>
        </xsl:variable>


        <xsl:if test="number($Position) and normalize-space(substring(COL1,10,2))!='dp'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="normalize-space(substring(COL1,20,2))='cl' or normalize-space(substring(COL1,20,2))='pt'">
            ...
            <xsl:variable name="varCusip">
              <xsl:value-of select="normalize-space(substring(COL1,65,9))"/>
            </xsl:variable>
            ...
            <Symbol>
              <xsl:choose>
                ...
                <xsl:when test="$varAsset='Options'">
                  <xsl:call-template name="Option">
                    <xsl:with-param name="Symbol" select="normalize-space(substring(COL1,89,30))"/>
                  </xsl:call-template>
                </xsl:when>
            ...
            <xsl:variable name="MarketValue">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="normalize-space(substring(COL1,31,12))"/>
              </xsl:call-template>
            </xsl:variable>
            <MarketValue>
              <xsl:choose>
                ...
                <xsl:when test=" $varAsset='Options'">
                  <xsl:choose>
                    ...
                    <xsl:when test="normalize-space(substring(COL1,10,2))='ss'">
                      <xsl:value-of select="'Shell short'"/>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of select="''"/>
                    </xsl:otherwise>

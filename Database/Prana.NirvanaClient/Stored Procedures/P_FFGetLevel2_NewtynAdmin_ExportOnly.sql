...
/*
exec P_FFGetLevel2_NewtynAdmin_ExportOnly
 @thirdPartyID=12,
 @companyFundIDs=N'1199,1211,1268,1269,1214,1215,1270,1271,1274,1276,1275,1277,1212,1213,1272,1273',
 @inputDate='2021-10-05 00:45:52',
 @companyID=8,
 @auecIDs=N'44,34,43,31,57,59,21,82,18,1,15,62,73,12,80,16',
 @TypeID=0,
 @dateType=0,
 @fileFormatID=32
*/   
    
CREATE PROCEDURE [dbo].[P_FFGetLevel2_NewtynAdmin_ExportOnly]                                                                                                                                                   
(                                                                                                                                                                  
 @thirdPartyID int,                                                                                                                                                                  
...
--Set @inputDate='2021-10-05 00:45:52'
--Set @companyID=8
--Set @auecIDs=N'44,34,43,31,57,59,21,82,18,1,15,62,73,12,80,16'
--Set @TypeID=0
--Set @dateType=0
--Set @fileFormatID=32   
...
WHERE Datediff(DAY, (
	...
	AND (
		(
			VT.TransactionType IN ('Buy','BuytoClose','BuytoOpen','Sell','Sellshort','SelltoClose','SelltoOpen','LongAddition'
				,'LongWithdrawal','ShortAddition','ShortWithdrawal','')
			AND (VT.TransactionSource IN (0,1,2,3,4,14))
			)
		OR (@IncludeExpiredSettledTransaction = 1
		...
		OR (
			...
			AND (
				VT.TransactionSource IN (6,7,8,9,10,11)
				)
			)

...
Create PROCEDURE [dbo].[PM_SaveCompanyFundCashCurrencyValue]      
(                                                                        
...
OPENXML(@handle, '//CashCurrencyValue', 2)                                                                           
 ...
 Group By BaseCurrencyID,LocalCurrencyID,Date,FundID,DataAdjustReq         
...
WHILE @@fetch_status = 0                                        
 ...
 If(@dataAdjustReq is not null And upper(@dataAdjustReq)='YES')      
  Begin      
   Set @count =(Select Count(*)       
    From PM_CompanyFundCashCurrencyValue where FundId=@fundID and BaseCurrencyID=@baseCurrencyId and LocalCurrencyId=@localCurrencyID and DateDiff(d,@date,Date)=0)      
            If(@count > 0 )      
    Begin      
     ...
     Set @varCashValueBase=(Select CashValueBase     
      ...
      Where FundId=@fundID and BaseCurrencyID=@baseCurrencyId and LocalCurrencyId=@localCurrencyID and DateDiff(d,@date,Date)=0      
    End      
 ...
 Else      
  Begin      
    ...
    and FundID =@fundID and BaseCurrencyID = @baseCurrencyID and LocalCurrencyID =@localCurrencyID        

			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:variable name="varAmount">
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="COL35 * (-1)"/>
					</xsl:call-template>
				</xsl:variable>
				...
				<xsl:if test="number($varAmount)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_SYMBOL_NAME" select="normalize-space(COL9)"/>
						...
						<xsl:variable name="varSEDOL" select="normalize-space(COL23)"/>

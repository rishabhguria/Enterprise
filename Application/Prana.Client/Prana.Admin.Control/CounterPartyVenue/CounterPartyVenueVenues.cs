...
namespace Nirvana.Admin.Controls
{
	...
	public class CounterPartyVenueVenues : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox3.Size = new System.Drawing.Size(332, 94);
			...
			// txtFullNameRoute
			// 
			this.txtFullNameRoute.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
...
//			}
		...
		{			
			...
			errorProvider1.SetError(txtFullNameRoute, "");
			...
			{
				errorProvider1.SetError(txtFullNameRoute, "Please enter Route Name!");
			...
			else
			{
				...
				if(venueID == -1)
				{
					...
					Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Venue already exists.");
				}	
				else
				{
					Nirvana.Admin.Utility.Common.ResetStatusPanel(_statusBar);

...
CREATE proc [dbo].[PMGetActivitySummaryReport_Proc]                                                                                              
(                                                                                            
-- @companyID int,                                                                                            
 @startDate datetime,                                                                                            
 @enddate datetime,          
...
isnull(VTL.OtherBrokerFees,0)+isnull(VTL.ClearingBrokerFee,0) as OtherBrokerFees,                                                                            
...
From V_SubAccountCashValue SubAccount 
...
IsNull(CashDiv.Amount,0) as DividendLocal,                   
Case                                                                                                                        
  When SM.CurrencyID =  @BaseCurrencyID                                                                                                                                           
  Then CashDiv.Amount                                          
  Else IsNull(FXDayRatesForDiviDate.ConversionFactor,0) * CashDiv.Amount                                          
End as DividendBase,                  
0 as CashValueBase,  
 ISNULL(SM.BloombergSymbol,'Undefined')as BloombergSymbol,                                
 ISNULL(SM.SedolSymbol,'Undefined') as SedolSymbol,                                

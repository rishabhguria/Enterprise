	...
	<xsl:template match="/NewDataSet">
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
				...
				<LongShortIndicator>
					<xsl:value-of select="'LongShortIndicator'"/>
				</LongShortIndicator>
				...
				<ClientTradeRefNo>
					<xsl:value-of select="'ClientTradeRefNo'"/>
				</ClientTradeRefNo>				
				...
				<PrimeBrokerCustodianAccountID>
					<xsl:value-of select="'PrimeBrokerCustodianAccountID'"/>
				</PrimeBrokerCustodianAccountID>

				<BrokerCounterparty>
					<xsl:value-of select="'BrokerCounterparty'"/>
				</BrokerCounterparty>

				<BrokerDescription>
					<xsl:value-of select="'BrokerDescription'"/>
				</BrokerDescription>
				...
				<ClearingBrokerdescription>
					<xsl:value-of select="'ClearingBrokerdescription'"/>
				</ClearingBrokerdescription>
				...
				<UnderlyingSecurityIdentifierType>
					<xsl:value-of select="'UnderlyingSecurityIdentifierType'"/>
				</UnderlyingSecurityIdentifierType>

				<UnderlyingSecurityIdentifier>
					<xsl:value-of select="'UnderlyingSecurityIdentifier'"/>
				</UnderlyingSecurityIdentifier>
				...
				<QuantityOriginalFace>
					<xsl:value-of select="'QuantityOriginalFace'"/>
				</QuantityOriginalFace>
				...
				<NegativeInterest>
					<xsl:value-of select="'NegativeInterest'"/>
				</NegativeInterest>

				<ConsiderationConstant>
					<xsl:value-of select="'ConsiderationConstant'"/>
				</ConsiderationConstant>
				...
				<NetAmountSettled>
					<xsl:value-of select="'NetAmountSettled'"/>
				</NetAmountSettled>

				<FXdealingrate>
					<xsl:value-of select="'FXdealingrate'"/>
				</FXdealingrate>

				<FXcurrencyReceived>
					<xsl:value-of select="'FXcurrencyReceived'"/>
				</FXcurrencyReceived>

				<FXcurrencyDelivered>
					<xsl:value-of select="'FXcurrencyDelivered'"/>
				</FXcurrencyDelivered>

				<ClassSpecificHedge>
					<xsl:value-of select="'ClassSpecificHedge'"/>
				</ClassSpecificHedge>

				<NotionalAmountReceived>
					<xsl:value-of select="'NotionalAmountReceived'"/>
				</NotionalAmountReceived>

				<NotionalAmountdelivered>
					<xsl:value-of select="'NotionalAmountdelivered'"/>
				</NotionalAmountdelivered>

				<StrategyCodes>
					<xsl:value-of select="'StrategyCodes'"/>
				</StrategyCodes>
				...
				<CountryofQuotation>
					<xsl:value-of select="'CountryofQuotation'"/>
				</CountryofQuotation>
				...
				<Null1>
					<xsl:value-of select="'Null1'"/>
				</Null1>

				<Null2>
					<xsl:value-of select="'Null2'"/>
				</Null2>

				<Null3>
					<xsl:value-of select="'Null3'"/>
				</Null3>
				...
				<AdditionalInfo1>
					<xsl:value-of select="'AdditionalInfo1'"/>
				</AdditionalInfo1>
				...
				<AdditionalInfo3>
					<xsl:value-of select="'AdditionalInfo3'"/>
				</AdditionalInfo3>

				<AdditionalInfo4>
					<xsl:value-of select="'AdditionalInfo4'"/>
				</AdditionalInfo4>

				<AdditionalInfo5>
					<xsl:value-of select="'AdditionaInfo5'"/>
				</AdditionalInfo5>

				<AdditionaInfo6>
					<xsl:value-of select="'AdditionaInfo6'"/>
				</AdditionaInfo6>		
				...
				<xsl:choose>
					<xsl:when test ="TaxLotState!='Amemded'">
						<ThirdPartyFlatFileDetail>
							...
							<PrimeBrokerCustodianAccountID>
								<xsl:choose>
									<xsl:when test="AccountName='ENE - PERS - PFJ004002'">
										<xsl:value-of select="'6075998'"/>
									</xsl:when>
									<xsl:when test="AccountName='ENE - IB - U1550748'">
										<xsl:value-of select="'6004976'"/>
									</xsl:when>
									<xsl:when test="AccountName='KU - PERS - PFJ002006'">
										<xsl:value-of select="'6066508'"/>
									</xsl:when>
									<xsl:when test="AccountName='KU - IB - U751087'">
										<xsl:value-of select="'6066503'"/>
									</xsl:when>
									<xsl:when test="AccountName='KU - GS - 00205584'">
										<xsl:value-of select="'6066501'"/>
									</xsl:when>
									<xsl:when test="AccountName='EQ - PERS - PFJ001008-2'">
										<xsl:value-of select="'6066499'"/>
									</xsl:when>
									<xsl:when test="AccountName='EQ - IB - U571112'">
										<xsl:value-of select="'6066493'"/>
									</xsl:when>
									<xsl:when test="AccountName='ILL - BARCA'">
										<xsl:value-of select="'6066509'"/>
									</xsl:when>
									<xsl:when test="AccountName='ILL - FRONTAURA'">
										<xsl:value-of select="'6066515'"/>
									</xsl:when>
								

									<xsl:otherwise>
										<xsl:value-of select="substring-after(substring-after(AccountName,'-'),'- ')"/>
									</xsl:otherwise>
								</xsl:choose>

...
{
    public class EditTradesAllocated : AllocationUIMap, ITestStep
    {
        /// <summary>
        /// Runs the test.
        /// </summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                DataTable dtAllocatedTrades = ExportAllocatedTrades();
                SelectAndEditTrades(testData, dtAllocatedTrades, sheetIndexToName);
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "EditTradesAllocated");
                _res.IsPassed = false;
        ...
        private void EditCommission(DataRow dataRow)
        {
            try
            {
                ...
                SoftCommission.Click(MouseButtons.Left);
                ExtentionMethods.CheckCellValueConditions(dataRow[TestDataConstants.COL_SOFT_COMMISSION].ToString(), string.Empty, true);
        ...
        /// </summary>
        /// <param name="testData">The test data.</param>
        /// <param name="dtAllocatedTrades">The dt allocated trades.</param>
        private void SelectAndEditTrades(DataSet testData, DataTable dtAllocatedTrades, Dictionary<int, string> sheetIndexToName)
        {
            try
            {
                EditTrade.Click(MouseButtons.Left);
                ...
                foreach (DataRow testRow in testData.Tables[sheetIndexToName[1]].Rows)
                {
                    ...
                    if (dtrow.Length > 0)
                    {
                        ...
                        KeyboardUtilities.PressDownKeyWithWait(dtAllocatedTrades.Rows.IndexOf(dtrow[0]));
        ...
        /// </summary>
        /// <returns></returns>
        private DataTable ExportAllocatedTrades()
        {
            try
            {
                Records = AllocationUIMap.GetLatestGridObject(this.GridAllocated);

	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				<xsl:if test ="number(COL21) and COL2!='10250054' and COL2!='10250055' and COL2!='10250057' and COL2!='10250063' and COL2!='10247028'and contains(COL4, 'OTHER') = false">
										...
										<xsl:when test="$PRANA_Symbol_NAME = ''">
											<xsl:choose>
												...
												<!--<xsl:when test ="normalize-space(COL4)='FIXED INCOME' and COL15=''">
													<xsl:value-of select ="translate(normalize-space(COL17),$varLower,$varUpper)"/>
												</xsl:when>-->

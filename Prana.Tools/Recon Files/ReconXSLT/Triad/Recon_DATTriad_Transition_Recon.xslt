			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:variable name="Quantity">
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="substring(COL1,219,17)"/>
					</xsl:call-template>
				</xsl:variable>
				...
				<xsl:if test="number($Quantity)">
					<PositionMaster>
						...
						<xsl:variable name = "PB_COMPANY_NAME" >
							<xsl:value-of select="substring(COL1,319,20)"/>
						</xsl:variable>
						...
						<xsl:variable name = "PB_FUND_NAME" >
							<xsl:value-of select="substring(COL1,31,6)"/>
						</xsl:variable>
						...
						<xsl:variable name="Symbol" select="normalize-space(substring(COL1,100,16))"/>



						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="contains(substring(COL1,892,1),'C') or contains(substring(COL1,892,1),'P')">
							...
							<xsl:choose>
								...
								<xsl:when test="$Asset='EquityOption'">
									<xsl:call-template name="Option">
										<xsl:with-param name="Symbol" select="substring(COL1,883,16)"/>
						...
						<xsl:variable name="Quantitye">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,219,17) div 100000"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AvgPrice">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,236,18) div 1000000000"/>
							</xsl:call-template>
						</xsl:variable>
						<AvgPX>
							<xsl:choose>
						...
						<xsl:variable name="SecFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,337,8)  div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<SecFee>
							<xsl:choose>
						...
						<xsl:variable name="ClearingFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,345,8) div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<OrfFee>
							<xsl:choose>
						...
						<xsl:variable name="AdditionalFee1">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,721,12) div 100"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee2">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,735,12) div 100"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Side">
							<xsl:value-of select="substring(COL1,6,1)"/>
						</xsl:variable>
						...
						<Side>
							...
							<xsl:choose>
								<xsl:when test="$Asset='EquityOption'">
									<xsl:choose>
										<xsl:when test="$Side='B'and substring(COL1,37,1)='2'">
											<xsl:value-of select="'Buy to Open'"/>
										</xsl:when>
										<xsl:when test="$Side='B'and substring(COL1,37,1)='1'">
											<xsl:value-of select="'Buy to Open'"/>
										</xsl:when>

										<xsl:when test="$Side='S'and substring(COL1,37,1)='2'">
											<xsl:value-of select="'Sell to Close'"/>
										</xsl:when>
										<xsl:when test="$Side='S'and substring(COL1,37,1)='1'">
											<xsl:value-of select="'Sell to Close'"/>
										</xsl:when>

										<xsl:when test="$Side='B'and substring(COL1,37,1)='3'">
											<xsl:value-of select="'Buy to Close'"/>
										</xsl:when>

										<xsl:when test="$Side='S'and substring(COL1,37,1)='3'">
						...
						<xsl:variable name="NetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,363,15) div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<NetNotionalValue>
							<xsl:choose>

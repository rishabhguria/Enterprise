...
namespace Nirvana.Admin.Controls
{
	...
	public class GridStrategy : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.grdStrategy.FlatMode = true;
			...
			this.grdStrategy.Location = new System.Drawing.Point(6, 14);
			this.grdStrategy.Name = "grdStrategy";
			this.grdStrategy.ReadOnly = true;
			this.grdStrategy.Size = new System.Drawing.Size(558, 76);
			this.grdStrategy.TabIndex = 19;
			this.grdStrategy.TableStyles.AddRange(new System.Windows.Forms.DataGridTableStyle[] {
																									this.dataGridTableStyle1});
			// 
			// dataGridTableStyle1
			// 
			this.dataGridTableStyle1.DataGrid = this.grdStrategy;
			...
			this.dataGridTableStyle1.MappingName = "strategies";
			// 
			// dataGridTextBoxColumn1
			// 
			this.dataGridTextBoxColumn1.Format = "";
			this.dataGridTextBoxColumn1.FormatInfo = null;
			this.dataGridTextBoxColumn1.HeaderText = "Strategy ID ";
			this.dataGridTextBoxColumn1.MappingName = "StrategyID";
			...
			this.dataGridTextBoxColumn2.MappingName = "StrategyName";
			...
			this.dataGridTextBoxColumn3.MappingName = "StrategyShortName";
			...
			this.btnDelete.Location = new System.Drawing.Point(490, 88);
			...
			this.btnEdit.Location = new System.Drawing.Point(408, 88);
			...
			this.btnCreate.Location = new System.Drawing.Point(326, 88);
			...
			this.Size = new System.Drawing.Size(572, 112);
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			if (grdStrategy.VisibleRowCount >0)
			{
				if(MessageBox.Show(this, "Do you want to delete this Strategy?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
				{
					...
					{
						CompanyManager.DeleteStrategy(strategyID);	
					}				
					grdStrategy.DataSource = null;
					grdStrategy.DataSource = strategies;
					grdStrategy.Refresh();

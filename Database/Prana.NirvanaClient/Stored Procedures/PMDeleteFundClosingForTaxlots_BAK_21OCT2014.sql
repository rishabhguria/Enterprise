...
-- '85aaf25a-8c2e-4e99-a5bc-a7f431d67651'                  
...
--Modified Date: 2013 17 May           
--Modified Date: Narendra Kumar jangir            
--Desc: Unwind all the future date closing for given symbol and fund                                        
                                                              
CREATE Procedure [dbo].[PMDeleteFundClosingForTaxlots_BAK_21OCT2014]                                                             
(                                                                  
...
if EXISTS(select TaxlotClosingID from #PM_TaxlotClosing PMC where (PMC.Closingmode <>0 and PMC.Closingmode<>7) )      
BEGIN      
...
WHERE PMC.Closingmode <>0 and PMC.Closingmode<>7                

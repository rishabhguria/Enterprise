  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
		  ...
		  <xsl:if test="number(COL8) and contains(COL5,'BNY MELLON USD') and (contains(COL1,'Clover Street') or contains(COL4,'VENBIO SELECT'))">
			  <PositionMaster>
				  ...
				  <xsl:variable name="PRANA_ACRONYM_NAME">
					  <xsl:choose>
						  ...
						  <xsl:when test="(normalize-space(COL3) = 'ULFAZ') and (COL13 &lt; 0)">

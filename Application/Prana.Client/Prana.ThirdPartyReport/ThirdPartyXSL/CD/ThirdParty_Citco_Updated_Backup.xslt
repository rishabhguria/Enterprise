      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:variable name="PB_COUNTERPARTY">
            <xsl:value-of select="document('../ReconMappingXml/ThirdParty_ExecBrokerMapping.xml')/BrokerMapping/PB[@Name = 'CITCO']/BrokerData[@PranaBroker = $PRANA_COUNTERPARTY]/@MLPBroker"/>
          </xsl:variable>

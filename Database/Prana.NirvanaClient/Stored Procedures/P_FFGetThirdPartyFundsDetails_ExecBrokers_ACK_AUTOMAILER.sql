...
/*       
EXEC [P_FFGetThirdPartyFundsDetails_ExecBrokers_ACK_AUTOMAILER]  '10-05-2023'
Modified By: Prabhat
...
CREATE PROCEDURE [dbo].[P_FFGetThirdPartyFundsDetails_ExecBrokers_ACK_AUTOMAILER]                                                                                       
(                                                                                                      
 @inputDate datetime                                                                                                  
)                                                                                                         
AS          

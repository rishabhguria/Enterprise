  ...
  <xsl:template match="/NewDataSet">
    <ThirdPartyFlatFileDetailCollection>
      <xsl:attribute name="xsi:noNamespaceSchemaLocation">C:/UpdatedTP/Prana_Final.xsd</xsl:attribute>
	        ...
	        <xsl:for-each select="ThirdPartyFlatFileDetail[ Asset!='FX' and Asset!='FXForward' and contains(AccountName,'Karst') and 
	  (CurrencySymbol='AUD' or CurrencySymbol='HKD' or CurrencySymbol='IDR' or CurrencySymbol='JPY' or CurrencySymbol='KRW' or CurrencySymbol='MYR' or CurrencySymbol='NZD' or CurrencySymbol='PHP' or CurrencySymbol='SGD' or CurrencySymbol='TWD' or CurrencySymbol='BDT')]">

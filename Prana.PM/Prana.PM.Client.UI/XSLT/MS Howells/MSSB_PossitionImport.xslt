		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:variable name="varPosition">
					<xsl:value-of select="substring(COL1,64,15)"/>
				</xsl:variable>
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								...
								<xsl:when test="contains(substring(COL1,28,5),'CALL') or contains(substring(COL1,28,5),'PUT')">
						...
						<xsl:variable name="Symbol">
							<xsl:value-of select="substring(COL1,33,7)"/>
						</xsl:variable>
							...
							<xsl:choose>
								...
								<xsl:when test="$Asset='Option'">
									<xsl:call-template name ="Option">
										<xsl:with-param name="Symbol" select="substring(COL1,33,6)"/>
						...
						<xsl:variable name="PB_FUND_NAME" select="substring(COL1,7,29)"/>
						...
						<xsl:variable name="Side" select="substring(COL1,64,15)"/>
						...
						<xsl:variable name ="Date" select="substring(COL1,378,11)"/>


						<xsl:variable name="Year1" select="substring(substring-before($Date,'-'),1,2)"/>
						<xsl:variable name="Months" select="substring(substring-after($Date,'-'),1,2)"/>

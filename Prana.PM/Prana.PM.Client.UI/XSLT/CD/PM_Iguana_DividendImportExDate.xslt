        ...
        <xsl:if test="number(COL11)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name = "PB_FUND_NAME" >
              <xsl:value-of select="substring(COL1,1,8)"/>
            </xsl:variable>
            ...
            <xsl:variable name="PB_Symbol" select="COL14"/>
            ...
            <xsl:variable name="PRANA_FUND_ID">
              <xsl:value-of select="document('../ReconMappingXml/FundMapping.xml')/FundMapping/PB[@Name = $varPBName]/FundData[@PBFundCode=$PB_FUND_NAME]/@PranaFundID"/>
            </xsl:variable>

	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="$Position and normalize-space(COL8)!='Deposit' and contains(normalize-space(COL11),'Cancel')!='true' ">
					...
					<PositionMaster>
						...
						<xsl:variable name="Side" select="substring-before(COL8,' ')"/>

...
namespace Nirvana.Admin
{
	...
	public class Holiday : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Holiday));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Description", 2, null, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Descending, false);
			...
			this.btnReset.Location = new System.Drawing.Point(135, 228);
			...
			this.btnEdit.Location = new System.Drawing.Point(96, 130);
			...
			this.btnDelete.Location = new System.Drawing.Point(174, 130);
			...
			this.btnSave.Location = new System.Drawing.Point(55, 228);
			...
			this.updateHoliday.Location = new System.Drawing.Point(37, 154);
			...
			this.dttHolidayDate.TabIndex = 28;
			this.dttHolidayDate.Value = new System.DateTime(2005, 12, 13, 23, 20, 0, 0);
			...
			this.txtHolidayDesc.TabIndex = 9;
			this.txtHolidayDesc.Text = "";
			...
			this.grdHoliday.Size = new System.Drawing.Size(336, 128);
		...
		{	
			...
			Nirvana.Admin.BLL.Holiday holiday = new Nirvana.Admin.BLL.Holiday();
			...
			else
			{
				...
				bool flag = false;
				foreach(Nirvana.Admin.BLL.Holiday checkHoliday in holidays)
				{
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(grdHoliday.Rows.Count > 0)
				{
					...
					if(MessageBox.Show(this, "Do you want to delete this Holiday?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
					{

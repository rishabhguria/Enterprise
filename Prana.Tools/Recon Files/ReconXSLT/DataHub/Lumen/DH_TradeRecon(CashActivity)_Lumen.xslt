          ...
          <xsl:when test="number($Quantity)">
            <PositionMaster>
              ...
              <xsl:variable name="Asset">
                <xsl:choose>
                  <xsl:when test="contains(COL2,'78200295')">
                    <xsl:value-of select="'Equity'"/>
                  </xsl:when>

                  <xsl:when test="contains(COL2,'40301411')">
                    <xsl:value-of select="'Eqity Option'"/>
                  </xsl:when>
              ...
              <Symbol>
                <xsl:choose>
                  ...
                  <xsl:when test="string-length(COL11) &gt; 20">
                    <xsl:value-of select="''"/>
                  </xsl:when>
              ...
              <IDCOOptionSymbol>
                <xsl:choose>
                  <xsl:when test="string-length(COL11) &gt; 20">
                    <xsl:value-of select="concat(COL11, 'U')"/>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select ="''"/>
                  </xsl:otherwise>

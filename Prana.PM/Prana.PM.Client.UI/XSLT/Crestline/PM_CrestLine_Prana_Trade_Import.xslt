          ...
          <PositionMaster>
            ...
            <Symbol>
              <xsl:choose>
                ...
                <xsl:when test="$varSyombol!=''">
                  <xsl:value-of select="$varSyombol"/>
                </xsl:when>
            ...
            <xsl:variable name="SecFee1">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL6 *  COL9 * 0.0000221"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="varCommission">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL16 - $SecFee"/>
              </xsl:call-template>
            </xsl:variable>
            <Commission>
              <xsl:choose>

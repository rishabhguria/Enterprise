...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
    ...
    <Groups>
      ...
      <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[TaxLotState!='Sent'][IsSwapped='false']">
    ...
    <xsl:variable name="varSymbol">
      ...
      <xsl:choose>
        ...
        <xsl:when test="Asset='FixedIncome'">
		 ...
		 <xsl:when test="IsSwapped='true' and TradeAttribute1='BASKET'">

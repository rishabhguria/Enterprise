...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(substring(substring-after(normalize-space(COL5),' '),7,1),'C') or contains(substring(substring-after(normalize-space(COL5),' '),7,1),'P')">
        ...
        <xsl:if test="number($Quantity) ">
          <PositionMaster>
            ...
            <xsl:variable name="Asset">
              <xsl:choose>
                <xsl:when test="contains(substring(substring-after(normalize-space(COL5),' '),7,1),'C') or contains(substring(substring-after(normalize-space(COL5),' '),7,1),'P')">

    ...
    <!--<xsl:variable name="PB_NAME" select="'G2'"/>-->
		...
		<Group
					...
					TransactionType = "FX002" TransactionStatus="{$varTransactionStatus}" TransactionLevel="B" Product_Intrumenttype="{$varIntrumenttype}" ClientTraqdeRefNo="{PBUniqueID}"
						AssociatedTrade_RequestId="{PBUniqueID}" ExecutionAccount="038211165" AccountId_Fund="038211165" ExecutingBroker="{$CPVar}" TradeDate="{TradeDate}"
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and CounterParty != 'Undefined' and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset']">
				...
				<ThirdPartyFlatFileDetail
						...
						AssociatedTrade_RequestId="{PBUniqueID}" ExecutionAccount="038211165" AccountId_Fund="{'038QAH5I7'}" ExecutingBroker="{$CPVar}" TradeDate="{TradeDate}"

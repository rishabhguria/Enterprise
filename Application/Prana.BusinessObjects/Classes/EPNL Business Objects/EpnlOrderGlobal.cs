...
namespace Prana.BusinessObjects
{
    ...
    public class EpnlOrderGlobal
    {
        ...
        /// Also Cloumns like Position Side Global and Long Short Exposure Global which are dependent on Symbol level Summary are kept in EpnlOrderGlobal
        /// All the calculations are performed on EpnlOrderGlobal and then on the basis of compression applied we get ExposurePnlCacheItemGlobal out of it
        /// </summary>
        public EpnlOrderGlobal()
        {
            _id = string.Empty;
            ...
            _positionSideExposureInPortfolio = PositionType.None;
            _positionSideMVInPortfolio = PositionType.None;
            ...
            _potentialRisk = 0.0;
            _trueExposure = 0.0;
            _positionSideExposureUnderlyingInPortfolio = PositionType.None;
        ...
        private PositionType _positionSideMVInPortfolio;
        public PositionType PositionSideMVInPortfolio
        {
            get { return _positionSideMVInPortfolio; }
            set { _positionSideMVInPortfolio = value; }
        }

        private PositionType _positionSideExposureInPortfolio;
        public PositionType PositionSideExposureInPortfolio
        {
            get { return _positionSideExposureInPortfolio; }
            set { _positionSideExposureInPortfolio = value; }
        }

        private double _liquidationCostInPortfolio;
        public double LiquidationCostInPortfolio
        {
        ...
        private PositionType _positionSideExposureUnderlyingInPortfolio;
        public PositionType PositionSideExposureUnderlyingInPortfolio
        {

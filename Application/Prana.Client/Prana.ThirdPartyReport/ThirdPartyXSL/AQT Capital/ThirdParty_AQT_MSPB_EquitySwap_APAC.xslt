...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
    ...
    <Groups>
      ...
      <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[Asset='Equity' and IsSwapped='true'][TaxLotState!='Sent'][CounterParty!='Transfer' and CounterParty!='CorpAction']

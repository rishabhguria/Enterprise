...
namespace Prana.Admin.Controls
{
    ...
    public class ColumnPreferenceControl : System.Windows.Forms.UserControl
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ColumnPreferenceControl));
            ...
            // btnMoveRight
            // 
            this.btnMoveRight.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
            ...
            this.label2.Text = "Client Accounts";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Third Party Accounts";
            // 
            // lstAvailableCol
            // 
            ...
            this.lstAvailableCol.TabIndex = 1;
            // 
            // lstDisplayedCol
            // 
            ...
            this.lstDisplayedCol.TabIndex = 4;
            // 
            // btnMoveAllRight
            // 
            this.btnMoveAllRight.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
            ...
            // btnMoveLeft
            // 
            this.btnMoveLeft.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
            ...
            // btnMoveAllLeft
            // 
            this.btnMoveAllLeft.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
        ...
        //public event EventHandler AvailableColumnsChanged;
        //public event EventHandler DisplayColumnsChanged;
        ...
        private void btnUp_Click(object sender, System.EventArgs e)
        {
            try
            {
                MoveUpDown(lstDisplayedCol, true, "DisplayColumn");
            }
            catch (Exception ex)
            {
                // Invoke our policy that is responsible for making sure no secure information
        ...
        private void btnDown_Click(object sender, System.EventArgs e)
        {
            try
            {
                MoveUpDown(lstDisplayedCol, false, "AvailableColumn");
            }
            catch (Exception ex)
            {
                // Invoke our policy that is responsible for making sure no secure information
        ...
        private void MoveItem(ListBox source, ListBox destination)
        {
            try
            {
                ...
                if (ColumnPreferencesChanged != null)
                    ColumnPreferencesChanged(this, null);
            }
            catch (Exception ex)
            {
                #region Catch
        ...
        private void MoveUpDown(ListBox listBox, bool moveUp, string name)
        {
            try
            {

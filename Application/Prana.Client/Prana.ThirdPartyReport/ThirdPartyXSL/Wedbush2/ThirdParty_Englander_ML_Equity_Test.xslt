      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <!--<MISC05>
			...
			<xsl:choose>
				<xsl:when test ="FundName = 'Stadium Capital LLC' and Asset='Equity' and CounterParty='RODM'">
					<MISC05>
						<xsl:value-of select ="'0.005'"/>
					</MISC05>
				</xsl:when>
				<xsl:when test ="FundName = 'Stadium Capital LLC' and Asset='Equity' and CounterParty ='ATLE'">
					<MISC05>
						<xsl:value-of select ="'0.03'"/>
					</MISC05>
				</xsl:when>
				<xsl:when test ="FundName = 'Stadium Capital LLC' and Asset='Equity' and CounterParty ='BTIG'">
					<MISC05>
						<xsl:value-of select ="'0.02'"/>
					</MISC05>
				</xsl:when>
				<xsl:when test ="FundName = 'Stadium Capital LLC' and Asset='Equity' and CounterParty='LTCO'">
					<MISC05>
						<xsl:value-of select ="'0.02'"/>
					</MISC05>
				</xsl:when>

			...
			<xsl:for-each select ="//PositionMaster">
              ...
              <xsl:value-of select="document('../ReconMappingXML/SymbolMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCompanyName=$PB_SYMBOL_NAME]/@PranaSymbol"/>
						...
						<!--<xsl:variable name="PB_EXCHANGE_NAME">
							...
							<xsl:value-of select="document('../ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode=$PB_EXCHANGE_NAME]/@ExchangeCode"/>
						</xsl:variable>-->
						...
						<xsl:variable name="PB_Contract" select="concat(COL18,COL17)"/>
						...
						<xsl:variable name="Multiplier" select="COL16"/>

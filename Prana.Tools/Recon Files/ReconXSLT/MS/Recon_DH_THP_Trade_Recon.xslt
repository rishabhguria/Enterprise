						...
						<PositionMaster>
							...
							<xsl:variable name="Asset">
								<xsl:choose>
									...
									<xsl:when test="COL7='Equity Swap'">
							...
							<xsl:variable name="varBStrikeAndPutCal">
								<xsl:value-of select="substring-after(substring-after(substring-after(COL6,' '),' '),' ')"/>
							</xsl:variable>

							<xsl:variable name="Symbol">
								<xsl:choose>
									<xsl:when test="COL4='USD'and COL7='Equity'">
										<xsl:value-of select="concat(COL8,' ','US')"/>
									</xsl:when>
									
									<xsl:when test="COL4='USD' and contains(COL8,'$$')">
										<xsl:value-of select="concat(substring(COL8,3,3),'Fwd',' ',COL10)"/>
									</xsl:when>
									<xsl:when test="COL4='USD' and contains(COL6,'SPOT')">
										<xsl:value-of select="concat(COL20,'Fwd',' ',COL10)"/>
									</xsl:when>									

									<xsl:when test="COL4='USD' and COL7='Equity Option'">
							...
							<xsl:variable name="varSecandFees">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="COL14"/>
								</xsl:call-template>
							</xsl:variable>
							
							<xsl:variable name="varTotalCommissionAnd">
								<xsl:choose>
									<xsl:when test="COL14 ='*' or COL14 =''">
										<xsl:value-of select="$Commission"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="$Commission + $varSecandFees"/>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:variable>
							...
							<xsl:variable name="TotalCommissionandFees">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="$varTotalCommissionAnd "/>
								</xsl:call-template>
							</xsl:variable>
							...
							<xsl:variable name ="Date1" select="COL9"/>
							<TradeDate>

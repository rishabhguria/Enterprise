          ...
          <xsl:when test="number($Quantity) or number($Quantity2)">
            ...
            <PositionMaster>
              <xsl:variable name="PB_NAME">
                <xsl:value-of select="'Waterfield'"/>
              </xsl:variable>
              ...
              <MasterFund>
                <xsl:value-of select="'Sanjay Kedia'"/>
              </MasterFund>


              <xsl:variable name="PB_FUND_NAME" select="'Sanjay Kedia'"/>
              <xsl:variable name="PRANA_FUND_NAME">
                <<xsl:value-of select ="document('../../ReconMappingXML/FundMapping.xml')/FundMapping/PB[@Name='Valuefy']/FundData[@SourceFund=$PB_FUND_NAME]/@TargetFund"/>
              </xsl:variable>
              <FundName>
                <xsl:choose>

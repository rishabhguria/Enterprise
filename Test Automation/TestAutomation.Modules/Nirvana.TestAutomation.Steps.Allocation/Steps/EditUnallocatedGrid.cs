...
{
    internal class EditUnallocatedGrid : AllocationUIMap, ITestStep
    {
        /// <summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "EditUnallocatedGrid");
                _res.IsPassed = false;
            ...
            try
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    foreach (DataColumn col in row.Table.Columns)
                    {
                        ...
                        //&& dtExportedTrades.Columns.Contains(columnNameMap[col.ColumnName]))
                        {

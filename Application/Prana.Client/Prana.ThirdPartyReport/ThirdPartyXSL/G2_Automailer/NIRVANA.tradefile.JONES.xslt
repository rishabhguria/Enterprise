...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection xmlns:xsi="http://www.w3.org/2001/XMLschema-instance" xsi:noNamespaceSchemaLocation="alan.xsd">
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty='JONES']">
				
				<ThirdPartyFlatFileDetail emailto="umesh.chopra@nirvanasolutions.com">
					<xsl:choose>
					...
					<OtherFees>
						<xsl:value-of select="TaxOnCommissions + TransactionLevy + ClearingFee + MiscFees"/>
					</OtherFees>

          ...
          <PositionMaster>
            ...
            <!--<xsl:variable name="varBBCode">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="substring(substring-before(normalize-space(COL1),' '),1,string-length(substring-before(normalize-space(COL1),' '))-2)"/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:variable>-->
            ...
            <!--<xsl:variable name ="varBBKey">
              <xsl:choose>
                <xsl:when test="$varAssetType='FUT'">
                  <xsl:choose>
                    <xsl:when test="string-length(substring-before(normalize-space(COL1),' '))=1">
                      <xsl:value-of select="translate(substring-after(substring-after(normalize-space(COL1),' '),' '),$varSmall,$varCapital)"/>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of select="translate(substring-after(normalize-space(COL1),' '),$varSmall,$varCapital)"/>
                    </xsl:otherwise>
                  </xsl:choose>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:choose>
                    <xsl:when test="string-length(substring-before(normalize-space(COL1),' '))=1">
                      <xsl:value-of select="translate(substring-after(substring-after(substring-after(normalize-space(COL1),' '),' '),' '),$varSmall,$varCapital)"/>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of select="translate(substring-after(substring-after(normalize-space(COL1),' '),' '),$varSmall,$varCapital)"/>
                    </xsl:otherwise>
			  ...
			  <xsl:variable name="PRANA_Multiplier">
				  <xsl:value-of select="document('../ReconMappingXml/PriceMulMapping.xml')/PriceMulMapping/PB[@Name='Client Imports']/MultiplierData[@PranaRoot=$varBBCode]/@Multiplier"/>
			  </xsl:variable>
            ...
            <Bloomberg>
			  ...
			  <LastPrice>
				  <xsl:choose>
					  <xsl:when test ="contains($varPrice,'E-') !=  false">
						  <xsl:variable name ="varAfterE">
							  <xsl:value-of select ="substring-after($varPrice,'E-')"/>
						  </xsl:variable>
						  <xsl:choose>

							  <xsl:when test ="$varAfterE = 05">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00001"/>
							  </xsl:when>
							  
							  <xsl:when test ="$varAfterE = 06">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 07">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 08">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 09">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 10">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 11">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000001"/>
							  </xsl:when>
							  <xsl:when test ="$varAfterE = 12">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 13">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 14">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000001"/>
							  </xsl:when>
							  
							  <xsl:when test ="$varAfterE = 15">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 16">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000000001"/>
							  </xsl:when>
							  
							  
							   <xsl:when test ="$varAfterE = 17">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000001"/>
							  </xsl:when>
							  
							   <xsl:when test ="$varAfterE = 18">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 19">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 20">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 21">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 22">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 23">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 24">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 25">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 26">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 27">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 28">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.0000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 29">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 30">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 31">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>


							  <xsl:when test ="$varAfterE = 32">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 33">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>
							  
							  <xsl:when test ="$varAfterE = 34">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 35">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

							  <xsl:when test ="$varAfterE = 44">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000000000000000000001"/>
							  </xsl:when>



							  <xsl:when test ="$varAfterE = 46">
								  <xsl:value-of select ="substring-before($varPrice,'E-') * 0.00000000000000000000000000001"/>
							  </xsl:when>

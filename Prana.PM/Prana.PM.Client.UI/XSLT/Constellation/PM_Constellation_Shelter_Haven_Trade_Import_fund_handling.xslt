			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number($NetPosition)and COL4='NEW'">
					<PositionMaster>
						...
						<xsl:variable name="SecFee" select="COL12"/>
						<SecFee>
							<xsl:choose>
						...
						<xsl:variable name="OrfFee" select="COL13"/>
						<OrfFee>
							<xsl:choose>
						...
						<xsl:if test="$Asset='EquitySwap'">
							...
							<xsl:choose>
									<xsl:when test="contains(COL5,'/')">
								<xsl:choose>
									<xsl:when test="string-length(number(substring-before(substring-after(COL5,'/'),'/'))) = 1">
							...
							<xsl:choose>
									<xsl:when test="contains(COL5,'/')">
								<xsl:choose>
									<xsl:when test="string-length(number(substring-before(COL5,'/'))) = 1">

...
namespace Prana.CommissionRules
{
    ...
    /// Singleton class
    /// </summary>
    internal class CommissionRuleCache
    {
        #region Singleton Instance
        private CommissionRuleCache()
        {
        }

        static CommissionRuleCache _commissionRuleCache = null;
        public static CommissionRuleCache GetInstance()
        {
            if (_commissionRuleCache == null)
            {
                _commissionRuleCache = new CommissionRuleCache();
            }
            return _commissionRuleCache;
        }
        #endregion

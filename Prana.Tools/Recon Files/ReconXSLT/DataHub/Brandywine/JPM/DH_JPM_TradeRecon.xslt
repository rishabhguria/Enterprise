  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity) and (contains(COL20,'PURCH') or contains(COL20,'SOLD'))">
            <PositionMaster>
              ...
              <xsl:variable name="AvgPrice">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="normalize-space(COL45)"/>
                </xsl:call-template>
              </xsl:variable>
              <AvgPX>
                <xsl:choose>
              ...
              <xsl:variable name="varSide" select="normalize-space(COL20)"/>
              <Side>
                <xsl:choose>
                  <xsl:when test="contains($varSide,'PURCH')">

...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(COL17,'CALL') or contains(COL17,'PUT')">
  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($NetPosition) and contains(COL26,'Trade')='true'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="AssetType">
              <xsl:choose>
                ...
                <xsl:when test="contains(COL17,'CALL') or contains(COL17,'PUT')">
            ...
            <xsl:variable name="CostBasis" select="COL71"/>
            ...
            <xsl:variable name="SecFee">
			  ...
			  <xsl:variable name="PB_COUNTER_PARTY" select="normalize-space(COL40)"/>

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/">
		<Groups>
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[TaxLotState!='Sent' and Asset='Future' and Asset='FutureOption']">
				...
				<xsl:if test="(1=position()) or(preceding-sibling::*[1]/PBUniqueID != PBUniqueID)">
					<xsl:if test="CounterParty != 'Corp Action' and CounterParty != 'Transfer'">
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<Group 
				TransactionType = "D01" TransactionStatus="{$varTaxlotStateGrp}" BuySellIndicator="" LongShortIndicator="" PositionType="{$Sidevar}"
				...
				Tax2="0"
				TaxOrFeesIndicator="F" interest="{$varInterest}" Interestindicator="" NetAmount="{format-number($NetAmountSum,'###.00')}" HearsayInd="N" Custodian="MSCO" MoneyManager="" Bookid=""
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and TaxLotState!='Sent']">			
				...
				<ThirdPartyFlatFileDetail		
							...
							Group_Id="" TransactionType = "D01" TransactionStatus="{$varTaxlotStateTx}" BuySellIndicator="" 
							...
							Tax2="0"
							TaxOrFeesIndicator="F" interest="{$varInterest}" Interestindicator="" NetAmount="{format-number(NetAmount,'###.00')}" HearsayInd="N" Custodian="MSCO" 

  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(COL16,'Options')">
      ...
      <xsl:variable name="ExpiryDay">
        <xsl:value-of select="substring(substring-after($Symbol,'1'),4,2)"/>
      </xsl:variable>
      <xsl:variable name="ExpiryMonth">
        <xsl:value-of select="substring(substring-after($Symbol,'1'),2,2)"/>
      </xsl:variable>
      <xsl:variable name="ExpiryYear">
        <xsl:value-of select="concat(1,substring(substring-after($Symbol,'1'),1,1))"/>
      </xsl:variable>

      <xsl:variable name="PutORCall">
        <xsl:value-of select="substring(substring-after($Symbol,'1'),6,1)"/>
      </xsl:variable>
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-after($Symbol,'1'),7) div 1000,'#.00')"/>
      </xsl:variable>
  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($MarkPrice) and contains(COL16,'Cash')!='true'">

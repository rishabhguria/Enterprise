			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="varcommissionRate">
						<xsl:value-of select="document('../ReconMappingXml/CommissionRate.xml')/CommissionRateMapping/PB[@Name='CITCO']/SymbolData[@Asset = $varAssetCategory and @Underlying = $varUnderlying and @Exchange = $varExchange]/@CommRate"/>
					</xsl:variable>
					...
					<!--<Commission>
						<xsl:value-of select='format-number(CommissionCharged, "###.00000000")'/>
						-->
					<!--<xsl:value-of select="CommissionCharged"/>-->
					<!--
					</Commission>-->

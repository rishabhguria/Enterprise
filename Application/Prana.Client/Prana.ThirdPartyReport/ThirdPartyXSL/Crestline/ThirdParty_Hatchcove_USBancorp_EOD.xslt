		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset']">
				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="PB_NAME" select="'USB_Hatchcove'"/>
					<xsl:variable name = "PRANA_FUND_NAME">
						<xsl:value-of select="AccountName"/>
					</xsl:variable>

					<xsl:variable name ="THIRDPARTY_FUND_CODE">
						<xsl:value-of select ="document('../ReconMappingXml/AccountMapping.xml')/FundMapping/PB[@Name='USB_Hatchcove']/FundData[@PranaFund=$PRANA_FUND_NAME]/@PBFundCode"/>
					</xsl:variable>
					...
					<xsl:variable name="varCurrencySymbol" select="CurrencySymbol"/>
					...
					<xsl:variable name ="varEXECUTINGBROKER">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_SettlementInstructionMapping.xml')/InstructionMapping/PB[@Name= $PB_NAME]/InstructionData[@Currency=$varCurrencySymbol and @Broker = $PRANA_BROKER_NAME]/@EXECUTINGBROKER"/>
					</xsl:variable>
					<EXECUTINGBROKER>
						<xsl:choose>
							<xsl:when test="$varEXECUTINGBROKER!=''">
								<xsl:value-of select="$varEXECUTINGBROKER"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="''"/>
							</xsl:otherwise>
					...
					<xsl:variable name ="varEXECUTINGBROKERAC">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_SettlementInstructionMapping.xml')/InstructionMapping/PB[@Name= $PB_NAME]/InstructionData[@Currency=$varCurrencySymbol and @Broker = $PRANA_BROKER_NAME]/@EXECUTINGBROKERAC"/>
					</xsl:variable>
					<EXECUTINGBROKERAC>
						<xsl:choose>
							<xsl:when test="$varEXECUTINGBROKERAC!=''">
								<xsl:value-of select="$varEXECUTINGBROKERAC"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="''"/>
							</xsl:otherwise>
					...
					<xsl:variable name ="varCLEARINGBROKER">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_SettlementInstructionMapping.xml')/InstructionMapping/PB[@Name= $PB_NAME]/InstructionData[@Currency=$varCurrencySymbol and @Broker = $PRANA_BROKER_NAME]/@ClearerID"/>
					</xsl:variable>
					<CLEARINGBROKER>
					<xsl:choose>
							<xsl:when test="$varCLEARINGBROKER!=''">
					...
					<xsl:variable name ="varCLEARINGBROKERAC">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_SettlementInstructionMapping.xml')/InstructionMapping/PB[@Name= $PB_NAME]/InstructionData[@Currency=$varCurrencySymbol and @Broker = $PRANA_BROKER_NAME]/@CLEARINGBROKERAC"/>
					</xsl:variable>
					<CLEARINGBROKERAC>
						<xsl:choose>
							<xsl:when test="$varCLEARINGBROKERAC!=''">
								<xsl:value-of select="$varCLEARINGBROKERAC"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="''"/>
							</xsl:otherwise>
					...
					<xsl:variable name ="varPlaceofSettlementBIC">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_SettlementInstructionMapping.xml')/InstructionMapping/PB[@Name= $PB_NAME]/InstructionData[@Currency=$varCurrencySymbol and @Broker = $PRANA_BROKER_NAME]/@PlaceofSettlementBIC"/>
					</xsl:variable>
					
					<PLACEOFSETTLEMENT>
						<xsl:choose>
                    <xsl:when test="$varPlaceofSettlementBIC!=''">
                      <xsl:value-of select="$varPlaceofSettlementBIC"/>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of select="''"/>
                    </xsl:otherwise>
					...
					<FXBUYCCYISO>
						<xsl:choose>
							<xsl:when test="CurrencySymbol  != 'USD' and Side = 'Buy'">
								<xsl:value-of select="CurrencySymbol"/>
							</xsl:when>
							<xsl:when test="CurrencySymbol  != 'USD' and Side = 'Sell'">

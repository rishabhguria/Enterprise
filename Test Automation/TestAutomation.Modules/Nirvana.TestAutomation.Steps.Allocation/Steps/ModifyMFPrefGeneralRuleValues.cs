...
{
    class ModifyMFPrefGeneralRuleValues: MasterFundPreferencesUIMap, ITestStep 
    {
        /// <summary>
        /// Runs the test.
        /// </summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "ModifyMFPrefGeneralRuleValues");
                _res.IsPassed = false;
        ...
        private void UpdateAccountValues(DataSet testData, Dictionary<int, string> sheetIndexToName, int j)
        {
            ...
            {
                throw new Exception("Account values of general rule of master fund preference has not been updated! (" + ex.Message + ")");
            }
        }
        /// <summary>
        ...
        private void UpdateStrategyValues(DataSet testData, Dictionary<int, string> sheetIndexToName, int j)
        {
            ...
            {
                throw new Exception("Strategy values of general rule of master fund preference has not been updated! (" + ex.Message + ")");
            }
        }
        /// <summary>
        ...
        private void UpdateDefaultRule(DataSet testData, Dictionary<int, string> sheetIndexToName, int j)
        {
            try
            {
                ...
                {
                    ClickdropdownbuttonLongbox(CmbboxTargetPercentage2);
                    Wait(2000);
                ...
                if (!AllocationMethod.Equals(String.Empty) && !TargetPercentage.Equals(TestDataConstants.COL_PRORATA) && !TargetPercentage.Equals(TestDataConstants.COL_LEVELING))
                {
                    ...
                    ClickdropdownbuttonLongbox(CmbboxAllocationMethod1);
                    Wait(2000);
                ...
                {
                    ClickdropdownbuttonLongbox(CmbboxRemainderAllocation2);
                    Wait(2000);
            ...
            {
                throw new Exception("Default rule of general rule of master fund preference has not been updated! (" + ex.Message + ")");
            }
        }
        ...
        private void ClosePopups()
        {
            try
            {
                while (NirvanaPreferences1.IsVisible && UpdatePreferenceUI.IsVisible)
                {

  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
               <xsl:if test="number(COL4) and (COL23='0' or COL23='1') and (COL2='38511651')">
          ...
          <PositionMaster>
			  ...
			  <xsl:variable name="PRANA_SYMBOL">
				  <xsl:value-of select="document('../ReconMappingXml/SymbolMapping.xml')/SymbolMapping/PB[@Name='WedbushGR']/SymbolData[@PBCompanyName=$PB_COMPANY]/@PranaSymbol"/>
			  </xsl:variable>
			  ...
			  <xsl:variable name="After_Apos">
				  <xsl:value-of select="substring-after(COL5,$Apos)"/>
			  </xsl:variable>

			  <xsl:variable name="Prana_Symbol_Apos">
				  <xsl:value-of select="document('../ReconMappingXml/AposSymbolMapping.xml')/SymbolMapping/PB[@Name='WedbushGR']/SymbolData[@AfterApos=$After_Apos]/@PostSymbol"/>
			  </xsl:variable>
			  ...
			  <xsl:variable name="Symbol">
				  <xsl:choose>
					  ...
					  <xsl:when test="contains(COL5,$Apos)">
						  <xsl:choose>
							  <xsl:when test="substring-after(COL5,$Apos)=''">
								  <xsl:value-of select="concat(substring-before(COL5,$Apos),'/P')"/>
							  </xsl:when>
							  <xsl:otherwise>
								  <xsl:value-of select="concat(substring-before(COL5,$Apos),'/',$Prana_Symbol_Apos)"/>
							  </xsl:otherwise>
						  </xsl:choose>
            ...
            <SideTagValue>
              <xsl:choose>
                ...
                <xsl:when test="COL3 != '' and COL3 = 'S'">
				  ...
				  <xsl:when test=" COL3 = 'SS' and (COL23='1' or COL23='0') and COL4 &gt; 0">
					  <xsl:value-of select="'1'"/>
				  </xsl:when>

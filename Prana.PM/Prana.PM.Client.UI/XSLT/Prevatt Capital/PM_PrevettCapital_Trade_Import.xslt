...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:my="put-your-namespace-uri-here" version="1.0">
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="StrikePrice">
      <xsl:value-of select="format-number(COL9,'#.00')"/>
    </xsl:variable>
  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varNetPosition) and $Side!='Cash'">
          <PositionMaster>
              ...
              <xsl:choose>
                ...
                <xsl:when test="$varAsset='EquityOption'">
                  <xsl:call-template name="Option">
                    <xsl:with-param name="varSymbol" select="normalize-space(COL11)" />
                  </xsl:call-template>
                </xsl:when>
            ...
            <xsl:variable name="varPositionSettleDate">

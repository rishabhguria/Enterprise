...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="substring(substring-before(substring-after(substring-after(substring-after(COL10,'/'),'/'),' '),' '),1,1) ='P' or substring(substring-before(substring-after(substring-after(substring-after(COL10,'/'),'/'),' '),' '),1,1) ='C'">
      ...
      <xsl:variable name="ExpiryYear">
        <xsl:value-of select="substring(substring-before(substring-after(substring-after(normalize-space(COL10),'/'),'/'),' '),3,2)"/>
      </xsl:variable>
      ...
      <xsl:variable name="StrikePrice">        
        <xsl:value-of select="format-number(substring-after(substring-after(substring-after(substring-after(COL10,'/'),'/'),' '),' '),'#.00')"/>   
      </xsl:variable>
	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($Quantity) and COL4 !='CASH'">
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="substring(substring-before(substring-after(substring-after(substring-after(COL10,'/'),'/'),' '),' '),1,1) ='P' or substring(substring-before(substring-after(substring-after(substring-after(COL10,'/'),'/'),' '),' '),1,1) ='C'">

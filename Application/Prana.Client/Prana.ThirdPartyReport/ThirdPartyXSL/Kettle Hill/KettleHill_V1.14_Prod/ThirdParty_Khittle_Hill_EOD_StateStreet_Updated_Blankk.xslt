	...
	<xsl:template match="/NewDataSet">
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
				...
				<LateDeliveryDate>
					<xsl:value-of select="'LateDeliveryDate'"/>
				</LateDeliveryDate>
				...
				<UnderlyingSecurityDesc>
					<xsl:value-of select="'UnderlyingSecurityDesc'"/>
				</UnderlyingSecurityDesc>
				...
				<DealPriceCode>
					<xsl:value-of select="'DealPriceCode'"/>
				</DealPriceCode>
				...
				<ChargesFeesAmount>
					<xsl:value-of select="'ChargesFeesAmount'"/>
				</ChargesFeesAmount>
				...
				<StampDutyExemptionAmount>
					<xsl:value-of select="'StampDutyExemptionAmount'"/>
				</StampDutyExemptionAmount>
				...
				<SettlementTransactionConditionIndicator2>
					<xsl:value-of select="'SettlementTransactionConditionIndicator2'"/>
				</SettlementTransactionConditionIndicator2>
				...
				<TrackingIndicator>
					<xsl:value-of select="'TrackingIndicator'"/>
				</TrackingIndicator>
				...
				<FXContraCurrency>
					<xsl:value-of select="'FXContraCurrency'"/>
				</FXContraCurrency>

				<FXOrderCXLIndicator>
					<xsl:value-of select="'FXOrderCXLIndicator'"/>
				</FXOrderCXLIndicator>


				<ExecutingBrokerIDType>
					<xsl:value-of select="'ExecutingBrokerIDType'"/>
				</ExecutingBrokerIDType>

				<ExecutingBrokerID>
					<xsl:value-of select="'ExecutingBrokerID'"/>
				</ExecutingBrokerID>

				<ExecutingBrokerAcct>
					<xsl:value-of select="'ExecutingBrokerAcct'"/>
				</ExecutingBrokerAcct>

				<ClearingBrokerAgentIDType>
					<xsl:value-of select="'ClearingBrokerAgentIDType'"/>
				...
				<ClearingBrokerAgentID>
					<xsl:value-of select="'ClearingBrokerAgentID'"/>

				</ClearingBrokerAgentID>

				<ExposureTypeIndicator>
					<xsl:value-of select="'ExposureTypeIndicator'"/>
				</ExposureTypeIndicator>

				<NetMovementIndicator>
					<xsl:value-of select="'NetMovementIndicator'"/>
				</NetMovementIndicator>
				...
				<AcctWithInstitutionIDType>
					<xsl:value-of select="'AcctWithInstitutionIDType'"/>
				</AcctWithInstitutionIDType>

				<AcctWithInstitutionID>
					<xsl:value-of select="'AcctWithInstitutionID'"/>
				</AcctWithInstitutionID>

				<PayingInstitution>
					<xsl:value-of select="'PayingInstitution'"/>
				</PayingInstitution>

				<BeneficiaryOfMoney>
					<xsl:value-of select="'BeneficiaryOfMoney'"/>
				</BeneficiaryOfMoney>

				<CashAcct>
					<xsl:value-of select="'CashAcct'"/>
				</CashAcct>
				...
				<StampCode>
					<xsl:value-of select="'StampCode'"/>
				</StampCode>

				<TRADDETNarrative>
					<xsl:value-of select="'TRADDETNarrative'"/>
				</TRADDETNarrative>

				<FIANarrative>
					<xsl:value-of select="'FIANarrative'"/>
				</FIANarrative>
				...
				<RepoTermOpenInd>
					<xsl:value-of select="'RepoTermOpenInd'"/>
				</RepoTermOpenInd>

				<RepoTermDate>
					<xsl:value-of select="'RepoTermDate'"/>
				</RepoTermDate>

				<RepoRateType>
					<xsl:value-of select="'RepoRateType'"/>
				</RepoRateType>
				...
				<RepoReference>
					<xsl:value-of select="'RepoReference'"/>
				</RepoReference>

				<RepoTotalTermAmt>
					<xsl:value-of select="'RepoTotalTermAmt'"/>
				</RepoTotalTermAmt>

				<RepoAccrueAmt>
					<xsl:value-of select="'RepoAccrueAmt'"/>
				</RepoAccrueAmt>

				<RepoTotalCollCnt>
					<xsl:value-of select="'RepoTotalCollCnt'"/>
				</RepoTotalCollCnt>

				<RepoCollNumb>
					<xsl:value-of select="'RepoCollNumb'"/>
				</RepoCollNumb>

				<RepoTypeInd>
					<xsl:value-of select="'RepoTypeInd'"/>
				</RepoTypeInd>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[AccountName='PACE - Longs - State Street' or AccountName='PACE - Shorts - Morgan Stanley']">
					...
					<xsl:otherwise>
						<xsl:if test ="number(OldExecutedQuantity)">
							<ThirdPartyFlatFileDetail>
								...
								<PrincipalAmount>
									<xsl:choose>
										<xsl:when test="number($Principal2)">
											<xsl:value-of select="format-number($Principal2,'0.##')"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="0"/>
										</xsl:otherwise>
								...
								<CommissionsAmount>
									<xsl:choose>
										<xsl:when test="number($varCommission2)">
											<xsl:value-of select="format-number($varCommission2,'0.##')"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="0"/>
										</xsl:otherwise>
								...
								<ChargesFeesAmount>
									<xsl:choose>
										<xsl:when test="number($OldOtherFees)">
											<xsl:value-of select="format-number($OldOtherFees,'0.##')"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="0"/>
										</xsl:otherwise>
								...
								<xsl:variable name="varOldFXRate">
									<xsl:choose>
										<xsl:when test="OldSettlCurrency != OldCurrencySymbol">
											<xsl:choose>
												<xsl:when test="OldFXConversionMethodOperator != 'D'">
													<xsl:value-of select="OldFXRate"/>
												</xsl:when>
												<xsl:otherwise>
													<xsl:value-of select="1 div OldFXRate"/>
												</xsl:otherwise>
											</xsl:choose>
										</xsl:when>
										<xsl:otherwise>
								...
								<xsl:variable name = "varNETAMNT">
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:value-of select="$varNetAmmount * $varOldFXRate"/>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:variable>
								<SettlementAmount>
				...
				<ThirdPartyFlatFileDetail>
					...
					<PrincipalAmount>
						<xsl:choose>
							<xsl:when test="number($Principal4)">
								<xsl:value-of select="format-number($Principal4,'0.##')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>
					...
					<CommissionsAmount>
						<xsl:choose>
							<xsl:when test="number($varCommission4)">
								<xsl:value-of select="format-number($varCommission4,'0.##')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>
					...
					<ChargesFeesAmount>
						<xsl:choose>
							<xsl:when test="number($OtherFees4)">
								<xsl:value-of select="format-number($OtherFees4,'0.##')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<Group
				TransactionType = "SW002" TransactionStatus="{$varTaxlotStateTx}" BuySelIndicator="" LongShortIndicator="" PositionType="{$Sidevar}"
				translevel="B" ClientTradeRefNo="{concat(substring(EntityID,3),'C')}" AssociatedTradeId="{concat(substring(EntityID,3),'C')}" ExecutionAccount="038305140" AccountID="038305140"
		...
		SettlementCCY ="{SettlCurrency}"	ExchangeCode="" Quantity="{$QtySum}" 	Price="{format-number($Price_Gp,'0.#######')}"	PriceIndicator="G" Principal="{format-number($Principal_Gp,'0.##')}"
		ExecutingBrokerCommission="{format-number($Comm_Gp,'0.##')}" ExecutingBrokerCommissionIndicator="F" OtherCharges="{format-number($MsFee_Gp,'0.##')}" NotRequired="Blank" MSfeesindicator="F"
		DividendEntitlementPercent=""	Spread="" NetAmount="{format-number($Netamount_Gp,'0.##')}" HearsayInd="N" Custodian="" MoneyManager=""  Bookid=""
		...
		SwapReferenceNo="" BasketId=""   PriceCurrency=""  ResetIndicator="" SNSreference="" ResearchFee="" ResearchFeeIndicator="" LEI=""
		...
		<!-- ...selecting all the records for this Group... -->
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID]">
				...
				<ThirdPartyFlatFileDetail
							TaxLotState="{TaxLotState}" TransactionType = "SW002" TransactionStatus="{$varTaxlotState}" BuySelIndicator=""
							LongShortIndicator="" PositionType="{$Sidevar}" TransactionLevel="A" ClientTradeRefNo="{concat(substring(EntityID,3),'C')}"
							AssociatedTradeId="{PBUniqueID}" ExecutionAccount="" AccountID="{$AccountId_T}"
							...
							Quantity="{AllocatedQty}" Price="{format-number($Price_Al,'0.#######')}" PriceIndicator="G"
							Principal="{format-number($Principal_Al,'0.#####')}" ExecutingBrokerCommission="{format-number($Comm_Al,'0.##')}"
							ExecutingBrokerCommissionIndicator="F" OtherCharges="{format-number($MsFee_Al,'0.##')}" NotRequired="Blank" MSfeesindicator="F"
							DividendEntitlementPercent=""	Spread="" NetAmount="{format-number($Netamount_Al,'0.#####')}" HearsayInd="N" Custodian="MSCO"
							...
							AcquisitionDate="" Comments="" SwapReferenceNo="" BasketId=""   PriceCurrency=""  ResetIndicator="" SNSreference="" ResearchFee="" ResearchFeeIndicator="" LEI=""

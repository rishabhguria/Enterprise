...
using Prana.ATDLLibrary.Model.Types;
...
namespace Prana.ATDLLibrary.Xml
{
    ...
    public static class SchemaDefinitions
    {
        ...
        private static readonly ElementDefinition SecurityType_t = new ElementDefinition(
            AtdlNamespaces.core + "SecurityType", typeof(Prana.ATDLLibrary.Model.Elements.SecurityType_t), SecurityTypeAttributes);
        ...
        private static readonly ElementDefinition Market_t = new ElementDefinition(
            AtdlNamespaces.core + "Market", typeof(Prana.ATDLLibrary.Model.Elements.Market_t), MarketAttributes);
        ...
        private static readonly ElementDefinition Country_t = new ElementDefinition(
            AtdlNamespaces.core + "Country", typeof(Prana.ATDLLibrary.Model.Elements.Country_t), CountryAttributes);
        ...
        private static readonly ElementDefinition Region_t = new ElementDefinition(
            AtdlNamespaces.core + "Region", typeof(Prana.ATDLLibrary.Model.Elements.Region_t), RegionAttributes,
            new ChildElementDefinition(SchemaDefinitions.Country_t, "Countries",
                    typeof(Prana.ATDLLibrary.Model.Collections.CountryCollection), StandardContainerMethod.Add));
        ...
        private static readonly ElementAttribute[] ParameterCommonAttributes = new ElementAttribute[]
        {
            ...
            //New property added
            new ElementAttribute("defaultRegionKey", "DefaultRegionKey", typeof(string), Required.Optional),
            new ElementAttribute("defaultRegionValue", "DefaultRegionValue", typeof(string), Required.Optional),
            new ElementAttribute("requiredInRegions", "RequiredInRegions", typeof(string), Required.Optional),
            new ElementAttribute("enableInRegions", "EnableInRegions", typeof(string), Required.Optional),
            new ElementAttribute("availableInRegions", "AvailableInRegions", typeof(string), Required.Optional),

            new ElementAttribute("replaceVisible", "ReplaceVisible",typeof(string), Required.Optional),
            new ElementAttribute("sendOnReplace", "SendOnReplace", typeof(bool), Required.Optional),

            new ElementAttribute("isReuiredGroupName", "IsReuiredGroupName", typeof(string), Required.Optional),
            new ElementAttribute("validationWith", "ValidationWith", typeof(string), Required.Optional),
            new ElementAttribute("validateWithOrderProperty", "ValidateWithOrderProperty", typeof(string), Required.Optional),
            new ElementAttribute("precision", "Precision", typeof(string), Required.Optional)
        };
        ...
        private static readonly ChildElementDefinition EnumPairs = new ChildElementDefinition(
            new ElementDefinition(AtdlNamespaces.core + "EnumPair", typeof(Prana.ATDLLibrary.Model.Elements.EnumPair_t),
                ...
                "EnumPairs", typeof(Prana.ATDLLibrary.Model.Collections.EnumPairCollection), StandardContainerMethod.Add);
        ...
        public static readonly GenericTypeElementDefinition Parameter_t = new GenericTypeElementDefinition(
            AtdlNamespaces.core + "Parameter", typeof(Prana.ATDLLibrary.Model.Elements.Parameter_t<>), AtdlNamespaces.xsi + "type", "Prana.ATDLLibrary.Model.Types",
        ...
        public static readonly ElementDefinition EditRef_t_Control_t = new ElementDefinition(
            AtdlNamespaces.val + "EditRef", typeof(Prana.ATDLLibrary.Model.Elements.EditRef_t<Prana.ATDLLibrary.Model.Elements.Control_t>), EditRefAttributes);
        ...
        public static readonly ElementDefinition EditRef_t_IParameter_t = new ElementDefinition(
            AtdlNamespaces.val + "EditRef", typeof(Prana.ATDLLibrary.Model.Elements.EditRef_t<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), EditRefAttributes);
        ...
        public static readonly ElementDefinition Edit_t = new ElementDefinition(
            AtdlNamespaces.val + "Edit", typeof(Prana.ATDLLibrary.Model.Elements.Edit_t), EditAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(new RecursiveTypeElementDefinition(), "Edits",
                    typeof(Prana.ATDLLibrary.Model.Collections.EditCollection), StandardContainerMethod.Add)
            });

        private static readonly ElementDefinition Edit_t_Control_t = new ElementDefinition(
            AtdlNamespaces.val + "Edit", typeof(Prana.ATDLLibrary.Model.Elements.Edit_t<Prana.ATDLLibrary.Model.Elements.Control_t>), EditAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(new RecursiveTypeElementDefinition(), "Edits",
                    typeof(Prana.ATDLLibrary.Model.Collections.EditEvaluatingCollection<Prana.ATDLLibrary.Model.Elements.Control_t>), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.EditRef_t_Control_t, "EditRefs",
                    typeof(Prana.ATDLLibrary.Model.Collections.EditRefCollection<Prana.ATDLLibrary.Model.Elements.Control_t>), StandardContainerMethod.Add)
            });

        private static readonly ElementDefinition Edit_t_IParameter_t = new ElementDefinition(
            AtdlNamespaces.val + "Edit", typeof(Prana.ATDLLibrary.Model.Elements.Edit_t<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), EditAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(new RecursiveTypeElementDefinition(), "Edits",
                    typeof(Prana.ATDLLibrary.Model.Collections.EditEvaluatingCollection<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.EditRef_t_IParameter_t, "EditRefs",
                    typeof(Prana.ATDLLibrary.Model.Collections.EditRefCollection<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), StandardContainerMethod.Add)
            });
        ...
        private static readonly ElementAttribute[] StateRuleAttibutes = new ElementAttribute[]
        {
            ...
            new ElementAttribute("value", "Value", typeof(string), Required.Optional),
            new ElementAttribute("reuiredGroupName", "ReuiredGroupName", typeof(string), Required.Optional),
            new ElementAttribute("minValue", "MinValue", typeof(string), Required.Optional),
            new ElementAttribute("maxValue", "MaxValue", typeof(string), Required.Optional),
            new ElementAttribute("validateWithOrderProperty", "ValidateWithOrderProperty", typeof(string), Required.Optional),
            new ElementAttribute("required", "Required", typeof(bool), Required.Optional)
        };
        ...
        public static readonly ElementDefinition StateRule_t = new ElementDefinition(
            AtdlNamespaces.flow + "StateRule", typeof(Prana.ATDLLibrary.Model.Elements.StateRule_t), StateRuleAttibutes,
                new ChildElementDefinition[]
                {
                    new ChildElementDefinition(SchemaDefinitions.Edit_t_Control_t, "Edit", typeof(Prana.ATDLLibrary.Model.Elements.Edit_t<Prana.ATDLLibrary.Model.Elements.Control_t>), StandardContainerMethod.Assign),
                    new ChildElementDefinition(SchemaDefinitions.EditRef_t_Control_t, "EditRef", typeof(Prana.ATDLLibrary.Model.Elements.EditRef_t<Prana.ATDLLibrary.Model.Elements.Control_t>), StandardContainerMethod.Assign)
                });
        ...
        public static readonly ElementDefinition ListItem_t = new ElementDefinition(
            AtdlNamespaces.lay + "ListItem", typeof(Prana.ATDLLibrary.Model.Elements.ListItem_t), ListItemAttibutes);
      ...
      {
            new ElementAttribute("initValue", "InitValue", typeof(string), Required.Optional),
              new ElementAttribute("regionWiseValueAvailable", "RegionWiseValueAvailable", typeof(string), Required.Optional),
            new ElementAttribute("innerControlNames", "InnerControlNames", typeof(string), Required.Optional),
            new ElementAttribute("innerControlValues", "InnerControlValues", typeof(string), Required.Optional)
      };
        ...
        private static readonly ElementAttribute[] SingleSpinnerAttributes = new ElementAttribute[]
        {
            ...
            new ElementAttribute("innerControlNames", "InnerControlNames", typeof(string), Required.Optional),
            new ElementAttribute("innerControlValues", "InnerControlValues", typeof(string), Required.Optional),
            new ElementAttribute("isBlankAllowed", "IsBlankAllowed", typeof(bool), Required.Optional),
        };
        ...
        public static readonly MultiTypeElementDefinition Control_t = new MultiTypeElementDefinition(
            AtdlNamespaces.lay + "Control", AtdlNamespaces.xsi + "type", "Prana.ATDLLibrary.Model.Controls",
            new ConstructorParameter[] { new ConstructorParameter(typeof(string), SourceType.ElementAttribute, "ID") },
            ControlCommonAttributes,
            new Dictionary<Type, ElementAttribute[]>()
            {
                { typeof(Prana.ATDLLibrary.Model.Controls.CheckBox_t), CheckBoxAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.CheckBoxList_t), CheckBoxListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.Clock_t), ClockAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.DoubleSpinner_t), DoubleSpinnerAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.DropDownList_t), DropDownListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.EditableDropDownList_t), EditableDropDownListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.HiddenField_t), HiddenFieldAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.Label_t), LabelAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.MultiSelectList_t), MultiSelectListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.RadioButton_t), RadioButtonAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.RadioButtonList_t), RadioButtonListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.SingleSelectList_t), SingleSelectListAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.SingleSpinner_t), SingleSpinnerAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.Slider_t), SliderAttributes },
                { typeof(Prana.ATDLLibrary.Model.Controls.TextField_t), TextFieldAttributes }
            },
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(SchemaDefinitions.ListItem_t, "ListItems", typeof(Prana.ATDLLibrary.Model.Collections.ListItemCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.StateRule_t, "StateRules", typeof(Prana.ATDLLibrary.Model.Collections.StateRuleCollection), StandardContainerMethod.Add)
            });
        ...
        public static readonly ElementDefinition StrategyPanel_t = new ElementDefinition(
            ...
            typeof(Prana.ATDLLibrary.Model.Elements.StrategyPanel_t),
            StrategyPanelAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(new RecursiveTypeElementDefinition(), "StrategyPanels",
                    typeof(Prana.ATDLLibrary.Model.Collections.StrategyPanelCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.Control_t, "Controls",
                    typeof(Prana.ATDLLibrary.Model.Collections.ControlCollection), StandardContainerMethod.Add)
            });
        ...
        public static readonly ElementDefinition StrategyLayout_t = new ElementDefinition(
            AtdlNamespaces.lay + "StrategyLayout", typeof(Prana.ATDLLibrary.Model.Elements.StrategyLayout_t),
            new ElementAttribute[] { }, new ChildElementDefinition(
                SchemaDefinitions.StrategyPanel_t, "StrategyPanel", typeof(Prana.ATDLLibrary.Model.Elements.StrategyPanel_t), StandardContainerMethod.Assign));
        ...
        public static readonly ElementDefinition StrategyEdit_t = new ElementDefinition(
            AtdlNamespaces.val + "StrategyEdit", typeof(Prana.ATDLLibrary.Model.Elements.StrategyEdit_t),
            StrategyEditAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(SchemaDefinitions.Edit_t_IParameter_t, "Edit",
                    typeof(Prana.ATDLLibrary.Model.Elements.Edit_t<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), StandardContainerMethod.Assign),
                new ChildElementDefinition(SchemaDefinitions.EditRef_t_IParameter_t, "EditRef",
                    typeof(Prana.ATDLLibrary.Model.Elements.EditRef_t<Prana.ATDLLibrary.Model.Elements.Support.IParameter>), StandardContainerMethod.Assign)
            });
        ...
        public static readonly ElementDefinition Strategy_t = new ElementDefinition(
            AtdlNamespaces.core + "Strategy", typeof(Prana.ATDLLibrary.Model.Elements.Strategy_t), StrategyAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(SchemaDefinitions.Parameter_t, "Parameters", typeof(Prana.ATDLLibrary.Model.Collections.ParameterCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.Edit_t, "Edits", typeof(Prana.ATDLLibrary.Model.Collections.EditCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.StrategyLayout_t, "StrategyLayout", typeof(Prana.ATDLLibrary.Model.Elements.StrategyLayout_t), StandardContainerMethod.Assign),
                new ChildElementDefinition(SchemaDefinitions.StrategyEdit_t, "StrategyEdits", typeof(Prana.ATDLLibrary.Model.Collections.StrategyEditCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.Regions, "Regions", typeof(Prana.ATDLLibrary.Model.Collections.RegionCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.Markets, "Markets", typeof(Prana.ATDLLibrary.Model.Collections.MarketCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.SecurityTypes, "SecurityTypes", typeof(Prana.ATDLLibrary.Model.Collections.SecurityTypeCollection), StandardContainerMethod.Add)
            });
        ...
        public static readonly ElementDefinition Strategies_t = new ElementDefinition(
            AtdlNamespaces.core + "Strategies", typeof(Prana.ATDLLibrary.Model.Elements.Strategies_t), StrategiesAttributes,
            new ChildElementDefinition[]
            {
                new ChildElementDefinition(SchemaDefinitions.Strategy_t, "Strategies", typeof(Prana.ATDLLibrary.Model.Collections.StrategyCollection), StandardContainerMethod.Add),
                new ChildElementDefinition(SchemaDefinitions.Edit_t, "Edits", typeof(Prana.ATDLLibrary.Model.Collections.EditCollection), StandardContainerMethod.Add)
            });

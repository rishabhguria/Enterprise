...
{
    class VerifyFatFingerTR : IUIAutomationTestStep
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        DataTable uiData = ds.Tables[ApplicationArguments.mapdictionary["ultraGridFatFingerRuleViolated"].AutomationUniqueValue];

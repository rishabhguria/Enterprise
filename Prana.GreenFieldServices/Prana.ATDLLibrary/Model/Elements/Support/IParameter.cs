...
namespace Prana.ATDLLibrary.Model.Elements.Support
{
    ...
    public interface IParameter
    {
        ...
        /// </summary>
        Use_t Use { get; set; }
        string DefaultRegionKey { get; set; }
        string DefaultRegionValue { get; set; }
        string RequiredInRegions { get; set; }
        string EnableInRegions { get; set; }
        string AvailableInRegions { get; set; }
        string ReplaceVisible { get; set; }
        //Added nullable SendOnReplace
        bool? SendOnReplace { get; set; }
        string IsReuiredGroupName { get; set; }
        string ValidationWith { get; set; }
        string ValidateWithOrderProperty { get; set; }

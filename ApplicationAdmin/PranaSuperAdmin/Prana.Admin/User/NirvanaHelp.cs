...
{
	/// <summary>
	/// Summary description for NirvanaHelp.
	/// </summary>
	public class NirvanaHelp : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(NirvanaHelp));
			...
			this.label1.Text = "Copyright © 2006 Nirvana Financial Solutions. All rights Reserved";
			// 
			// label2
			// 
			...
			this.Name = "NirvanaHelp";
			this.Text = "Nirvana Help";
			this.Load += new System.EventHandler(this.NirvanaHelp_Load);
			this.ResumeLayout(false);

		}
		#endregion

		private void NirvanaHelp_Load(object sender, System.EventArgs e)
		{

...
*/          
CREATE PROCEDURE [dbo].[P_Recon_Const2_Orchad_POS_Swap] (          
...
--,IsNull((#PositionTable.Quantity * (IsNull(coalesce(MP.FinalMarkPrice, MP1.FinalMarkPrice), 0) - (UnitCost.Val)) * #PositionTable.Multiplier * dbo.GetSideMultiplier(#PositionTable.SideID)), 0) AS MarketValue          
...
,UnitCost.Val * FXRate.Val as UnitCostBase       
 ...
 CROSS APPLY (          
  SELECT CASE           
    WHEN ((#PositionTable.IsSwapped = 1))          
     THEN IsNull((#PositionTable.Quantity * (IsNull(coalesce(MP.FinalMarkPrice, MP1.FinalMarkPrice), 0) - IsNull(UnitCost.Val, 0)) * #PositionTable.Multiplier * dbo.GetSideMultiplier(#PositionTable.SideID)), 0)          

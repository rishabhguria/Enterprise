...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:variable name="subTotals"> 
				<xsl:for-each  select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'S2DB_CASH' or AccountName = 'SAPGS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'S2GS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'S2CS_CASH' or AccountName = 'SP29MS_ALL')]">
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'S2DB_CASH' or AccountName = 'SAPGS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'S2GS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'S2CS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'SP29MS_ALL')
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<xsl:variable name="QtySum">
			...
			<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(UnderlyingSymbol=$I_UnderlyingSymbol) and (Side=$I_Side) and (CounterParty=$I_CounterParty)][TaxLotState != 'Deleted']/AllocatedQty)"/>
		</xsl:variable>
		...
		<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[((UnderlyingSymbol=$I_UnderlyingSymbol) and (Side=$I_Side) and (CounterParty=$I_CounterParty)) and (AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'S2DB_CASH' or AccountName = 'SAPGS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'S2GS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'S2CS_CASH' or AccountName = 'SP29MS_ALL')
		and (CurrencySymbol = 'HKD' or CurrencySymbol = 'JPY' or CurrencySymbol = 'SGD' or CurrencySymbol = 'IDR' or CurrencySymbol = 'NZD' or CurrencySymbol = 'MYR' or CurrencySymbol = 'PHP' or CurrencySymbol = 'THB')]">
			...
			<ThirdPartyFlatFileDetail>
				...
				<IdentificationOfASecurity>
					<xsl:choose>
						<xsl:when test ="Asset='Equity' and (AccountName != 'SAPDB_CASH' and AccountName != 'S1DB_CASH' and AccountName != 'SP29DB_CASH' and AccountName = 'S2DB_CASH' and AccountName != 'SAPGS_CASH' and AccountName != 'S1GS_CASH' and AccountName != 'SP29GS_CASH' and AccountName != 'S2GS_CASH' and AccountName != 'SAPCS_CASH' and AccountName != 'S1CS_CASH' and AccountName != 'SP29CS_CASH' and AccountName = 'S2CS_CASH' and AccountName != 'SP29MS_ALL')">
				...
				<xsl:variable name="varTotalOtherChanges">
					<xsl:value-of select="(ClearingFee + TransactionLevy + StampDuty + TaxOnCommissions + MiscFees + OtherBrokerFee)"/>
				</xsl:variable>
				...
				<xsl:variable name="T_NetCashAmount">

					<xsl:choose>
						<xsl:when test ="$varPosType = 'B'">
							<xsl:value-of select='$TradeAmount + $varTotalOtherChanges + $Commission'/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="$TradeAmount - $varTotalOtherChanges - $Commission"/>
						</xsl:otherwise>
				...
				<NetCashAmount>
					<xsl:choose>
						<xsl:when test ="NetAmount != 0">
							<xsl:choose>
								<xsl:when test ="CurrencySymbol = 'JPY'">
									<xsl:value-of select='format-number($T_NetCashAmount, "###")'/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select='format-number($T_NetCashAmount, "###.00")'/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>

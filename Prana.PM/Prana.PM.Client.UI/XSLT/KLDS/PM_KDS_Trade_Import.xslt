	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number($Position) and contains(COL1,'T')='true' and COL4!='48603' and COL4!='48604'">
					...
					<PositionMaster>
						...
						<!--<xsl:variable name="PB_YELLOW_NAME">
							<xsl:value-of select="normalize-space(COL90)"/>
						</xsl:variable>-->
						...
						<!--<xsl:variable name="PRANA_ECHANGE_NAME">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode = $PB_ROOT_NAME]/@ExchangeName"/>
						</xsl:variable>-->

						<xsl:variable name ="PRANA_ROOT_NAME">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode = $PB_ROOT_NAME and @ExchangeName = $PB_EXCHANGE_NAME]/@UnderlyingCode"/>
						</xsl:variable>
						<xsl:variable name ="FUTURE_EXCHANGE_CODE_WITH_EXCH">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode=$PB_ROOT_NAME and @ExchangeName = $PB_EXCHANGE_NAME]/@ExchangeCode"/>
						</xsl:variable>


						<xsl:variable name ="FUTURE_EXCHANGE_CODE">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode=$PB_ROOT_NAME]/@ExchangeCode"/>
						</xsl:variable>

						<xsl:variable  name="FUTURE_FLAG">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/UnderlyingCodeMapping.xml')/UnderlyingMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCode=$PB_ROOT_NAME]/@ExpFlag"/>
						</xsl:variable>
						...
						<FundName>
							<xsl:choose>
								<xsl:when test="COL4='48600'">
									<xsl:value-of select="'SG'"/>
								</xsl:when>
								<xsl:when test="COL4='48601'">

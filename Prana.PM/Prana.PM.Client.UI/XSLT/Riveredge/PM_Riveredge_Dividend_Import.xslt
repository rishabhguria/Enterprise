      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varDividend)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="ExDate" select="COL57"/>

            <xsl:variable name="PayOutDate" select="COL59"/>
            ...
            <xsl:variable name="varSymbol" select="COL15"/>
            <Symbol>
              <xsl:choose>
            ...
            <xsl:variable name="varActivity" select="COL32"/>
            <ActivityType>
              <xsl:choose>
                <xsl:when test="$varDividend &lt; 0">

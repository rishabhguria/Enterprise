...
*/            
CREATE PROCEDURE [dbo].[P_GetTransactions_TotalCommission_RPDOpportunities] (            
...
SELECT @FROMDate = CurrentAUECDate            
 ...
 INSERT INTO #V_Taxlots (            
  ...
  ,TradeAttribute3            
  ,TradeAttribute4            
  ,TradeAttribute5            ,TradeAttribute6            
  ,SecFee            
  ,OccFee            
  ,OrfFee            
  ,ClearingBrokerFee            
 ...
 SELECT VT.TaxLotID AS TaxLotID            
  ...
  (VT.Commission + vt.softcommission) AS TotalCommission     
,(VT.Commission + VT.ClearingBrokerFee) AS Commission            

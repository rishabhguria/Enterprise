...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
    <Groups>
      ...
      <xsl:for-each select="/NewDataSet/ThirdPartyFlatFileDetail[(contains(FundName, 'Swap') = false and TaxLotState = 'Allocated') and (UDASecurityTypeName!='cfeu' and UDASecurityTypeName!='cfus')]">
 ...
 <xsl:if test ="ClosingAlgo != 'HIFO'">
    ...
    <Group 
		RowHeader="FALSE"	RecordType ="Trade" TransactionType ="{$varTransactionType}" ClientAccount="{FundAccntNo}" AccountType="{$varACType}"

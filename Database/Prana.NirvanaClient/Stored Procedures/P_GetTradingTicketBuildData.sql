...
CREATE    PROCEDURE dbo.P_GetTradingTicketBuildData
(
	@companyID int	,
	@UserID int
)
...
T_OrderType.OrderTypes, T_OrderType.OrderTypeTagValue,
T_TimeInForce.TimeInForce, T_TimeInForce.TimeInForceTagValue,
T_HandlingInstructions.HandlingInstructionsTagValue, T_HandlingInstructions.HandlingInstructions
...
left join T_CVAUECOrderTypes 	on T_CVAUECOrderTypes.CVAUECID = T_CVAUEC.CVAUECID
left join T_OrderType		on T_CVAUECOrderTypes.OrderTypesID = T_OrderType.OrderTypesID

left join T_CVAUECTimeInForce 	on T_CVAUECTimeInForce.CVAUECID = T_CVAUEC.CVAUECID
left join T_TimeInForce		on T_CVAUECTimeInForce.TimeInForceID = T_TimeInForce.TimeInForceID

left join T_CVAUECHandlingInstructions 	on T_CVAUECHandlingInstructions.CVAUECID = T_CVAUEC.CVAUECID
left join T_HandlingInstructions	on T_CVAUECHandlingInstructions.HandlingInstructionsID = T_HandlingInstructions.HandlingInstructionsID

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/">
		<Groups>
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(AccountName = 'Sheffield Partners LP-MS'  or AccountName='Sheffield Partners LP-MS SWAP')]">

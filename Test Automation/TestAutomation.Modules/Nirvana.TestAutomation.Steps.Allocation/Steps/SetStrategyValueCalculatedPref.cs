...
{
    class SetStrategyValueCalculatedPref : CalculatedPreferencesUIMap, ITestStep
    {
        /// <summary>
        /// Runs the test
        /// </summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "SetStrategyValueCalculatedPref");
                _res.IsPassed = false;
            ...
            try
            {
                ...
                foreach (string prefName in dictionary.Keys)
                {
                    ...
                    foreach (string account in dictionary[prefName].Keys)
                    {
                        ...
                        SendAcountName( AccountStrategyGrid, account);

		  ...
		  <xsl:if test ="COL1 != 'Account Number'">
			  ...
			  <PositionMaster>
				  ...
				  <xsl:variable name="PRANA_FUND_NAME">
					  <xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/FundMapping.xml')/FundMapping/PB[@Name='GOLDMAN SACHS EXECUTION and CLEARING']/FundData[@PBFundName=$PB_FUND_NAME]/@PranaFund"/>
				  </xsl:variable>

				  <xsl:variable name="PRANA_STRATEGY_NAME">
					  <xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/StrategyMapping.xml')/StrategyMapping/PB[@Name='GOLDMAN SACHS EXECUTION and CLEARING']/StrategyData[@PranaFundName=$PRANA_FUND_NAME]/@PranaStrategy"/>
				  </xsl:variable>
              ...
              <Symbol>
                <xsl:value-of select="COL1"/>
				  ...
				  <xsl:variable name="PRANA_SYMBOL_NAME">
					  <xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/SymbolMapping.xml')/SymbolMapping/PB[@Name='GOLDMAN SACHS EXECUTION and CLEARING']/SymbolData[@PBCompanyName=$PB_Symbol]/@PranaSymbol"/>
				  </xsl:variable>

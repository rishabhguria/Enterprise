...
Execution StateMent:                                                                                                                                                                                               
   EXEC [PMGetValuationSummaryReport] 5, '10-19-2012','1182,1183,1184','1,2,3,4,5'    
  
Modified Date: 10-10-2012  
Modified By: Rahul Gupta  
Description : Optimization related tasks and taxlot FX Implementation                                                                           
****************************************************************************/                                                                                                                                                                                  
...
--[RG: 20120808] Since it was bringing 20 years previous date , hence it have changed it to minimum open transaction date                                                                                     
Set @startingDate = 
(
...
DROP TABLE #CompanyNamesAndUDAData,#DayMarkPrices  
DROP TABLE #TEMPGetConversionFactorForGivenDateRange,#TEMPFundPositionsForDate_ValReport          

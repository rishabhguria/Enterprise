	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position) and normalize-space(COL7)!='Deposit' and COL8!='Cancel' and COL8!='Cancelled' and COL7!='Dividend'">
					...
					<PositionMaster>
						...
						<xsl:variable name="ISIN" select="normalize-space(COL9)"/>
						...
						<xsl:variable name="CostBasis">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="number(COL14)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="number(COL15)"/>
							</xsl:call-template>
						</xsl:variable>
              ...
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL16"/>
						...
						<xsl:variable name="SecFee">
							<xsl:value-of select="(($varCOL13 * $varCOL14) - $varCOL15 + $varCOL16)*(-1)"/>
						</xsl:variable>

						<SecFee>
              <xsl:choose>
                <xsl:when test="$Side='SellShort' or $Side='Sell'">

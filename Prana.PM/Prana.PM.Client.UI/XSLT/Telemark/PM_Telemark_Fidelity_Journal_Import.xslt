  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($varCash) and (COL7='Debit Short Sale Rebate' or COL7='Interest Expense')">
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME">
              <xsl:choose>
                <xsl:when test="COL7 ='Interest Expense'">
                  <xsl:value-of select="'Interest_Expense'"/>
                </xsl:when>

                <xsl:when test="COL7 ='TICKET CHARGE'">
                  <xsl:value-of select="'Interest_Expense'"/>
                </xsl:when>
            ...
            <JournalEntries>
              <xsl:choose>
                <xsl:when test="normalize-space(COL7) = 'Debit Short Sale Rebate'">
                  <xsl:value-of select="concat('Short_Rebate', ':', $varAmount , '|', 'Cash:' , $varAmount)"/>
                </xsl:when>

                <xsl:when test="normalize-space(COL7) = 'Securities Lending Income'">
                  <xsl:value-of select="concat('Cash:', $varAmount , '|', 'Security Lending Income', ':' , $varAmount)"/>
                </xsl:when>

      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($NetPosition)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PB_FUND_NAME" select="'SMA-Thomas Edwards'"/>
            ...
            <Commission>
			  ...
			  <xsl:variable name="SecFee" select="''"/>
			  <StampDuty>
				  <xsl:choose>
            ...
            <xsl:variable name="PB_COUNTER_PARTY" select="'CON'"/>

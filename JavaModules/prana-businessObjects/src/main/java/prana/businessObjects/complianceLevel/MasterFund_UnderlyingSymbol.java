...
public class MasterFund_UnderlyingSymbol {
	...
	private double equityHaircut;
	private double indexHaircut;
	private double deltaAdjPosition;
	private double liquidationPNLPortfolio;
	private double costBasisUnrealizedPnL;
	...
	/**
	 * @return the equityHaircut
	 */
	public double getEquityHaircut() {
		return equityHaircut;
	}

	/**
	 * @param equityHaircut
	 *            the equityHaircut to set
	 */
	public void setEquityHaircut(double equityHaircut) {
		this.equityHaircut = equityHaircut;
	}

	/**
	 * @return the indexHaircut
	 */
	public double getIndexHaircut() {
		return indexHaircut;
	}

	/**
	 * @param indexHaircut
	 *            the indexHaircut to set
	 */
	public void setIndexHaircut(double indexHaircut) {
		this.indexHaircut = indexHaircut;
	}
	...
	/**
	 * @return the liquidationPNLPortfolio
	 */
	public double getLiquidationPNLPortfolio() {
		return liquidationPNLPortfolio;
	}

	/**
	 * @param liquidationPNLPortfolio
	 *            the liquidationPNLPortfolio to set
	 */
	public void setLiquidationPNLPortfolio(double liquidationPNLPortfolio) {
		this.liquidationPNLPortfolio = liquidationPNLPortfolio;
	}

	/**
	 * @return the costBasisUnrealizedPnL
	 */
	public double getCostBasisUnrealizedPnL() {
		return costBasisUnrealizedPnL;
	}

	/**
	 * @param costBasisUnrealizedPnL
	 *            the costBasisUnrealizedPnL to set
	 */
	public void setCostBasisUnrealizedPnL(double costBasisUnrealizedPnL) {
		this.costBasisUnrealizedPnL = costBasisUnrealizedPnL;
	}

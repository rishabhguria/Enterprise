...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<Group 
				...
				ExecutingBrokerCommission="{format-number($CommissionSum + $SoftCommissionSum,'###.0000')}" ExecutingBrokerCommissionIndicator="F" 
				MSFees="" 
				NotRequired=""
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and TaxLotState!='Sent']">
				...
				<ThirdPartyFlatFileDetail		
							...
							Principal="{format-number($TaxlotGrsAmt,'###.00')}" ExecutingBrokerCommission="{format-number(CommissionCharged + SoftCommissionCharged,'###.00')}" 

    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <Side>
			  <xsl:choose>
				  <xsl:when test="Asset='EquityOption'">
					  <xsl:choose>
						  <xsl:when test="(Side='Buy to Open' or Side='Buy') and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWBUY'"/>
						  </xsl:when>

						  <xsl:when test="Side='Sell to Open' and TaxLotState='Allocated' ">
							  <xsl:value-of select="'NewSell Short'"/>
						  </xsl:when>


						  <xsl:when test="Side='Sell to Close' or Side='Sell' and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWSELL'"/>
						  </xsl:when>

						  <xsl:when test="Side='Buy to Close' and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWCOVER'"/>
						  </xsl:when>
						  ...
						  <xsl:when test="Side='Sell to Open' and TaxLotState='Deleted' ">
							  <xsl:value-of select="'CANCELSell Short'"/>
						  </xsl:when>
						  ...
						  <xsl:when test="Side='Buy to Close' and TaxLotState='Deleted'">
							  <xsl:value-of select="'CANCELCOVER'"/>
						  </xsl:when>
				  ...
				  <xsl:otherwise>
					  <xsl:choose>
						  <xsl:when test="Side='Buy' and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWBUY'"/>
						  </xsl:when>

						  <xsl:when test="Side='Sell' and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWSELL'"/>
						  </xsl:when>
						  ...
						  <xsl:when test="Side='Sell short' and TaxLotState='Allocated'">
							  <xsl:value-of select="'NEWSell Short'"/>
						  </xsl:when>
          ...
          <OtherFees>
            <xsl:value-of select ="(OtherBrokerFee + TransactionLevy + ClearingFee + MiscFees + OtherBrokerFee + TaxOnCommissions + OrfFee)"/>
          </OtherFees>

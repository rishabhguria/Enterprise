	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:variable name="Position" select="COL12"/>

				<xsl:if test="number($Position) and normalize-space(COL4)!='CASH EQUIVALENTS'">
					...
					<PositionMaster>
						...
						<xsl:variable name="Cost" select="number(COL16)"/>
						...
						<xsl:variable name="MarketValue" select="number(COL15)"/>

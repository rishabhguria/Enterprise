...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:output method="xml" indent="yes" encoding="ISO-8859-1" />
		...
		<xsl:variable name="sorted-docs">
				<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'SAPGS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'SP29MS_ALL')]">
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[((UnderlyingSymbol=$I_UnderlyingSymbol) and (Side=$I_Side) and (CounterParty=$I_CounterParty)) and (AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'SAPGS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'SP29MS_ALL')
		and (CurrencySymbol = 'HKD' or CurrencySymbol = 'JPY' or CurrencySymbol = 'SGD' or CurrencySymbol = 'IDR' or CurrencySymbol = 'NZD' or CurrencySymbol = 'MYR' or CurrencySymbol = 'PHP' or CurrencySymbol = 'THB')]">
			...
			<ThirdPartyFlatFileDetail>
				...
				<xsl:variable name="varCounterParty">
					...
					<ExecutingBroker>
						<xsl:value-of select="'CTMBRKUKXXX'"/>
					</ExecutingBroker>
				...
				<IdentificationOfASecurity>
					<xsl:choose>
						<xsl:when test ="Asset='Equity' and (AccountName != 'SAPDB_CASH' and AccountName != 'S1DB_CASH' and AccountName != 'SP29DB_CASH' and AccountName != 'SAPGS_CASH' and AccountName != 'S1GS_CASH' and AccountName != 'SP29GS_CASH' and AccountName != 'SAPCS_CASH' and AccountName != 'S1CS_CASH' and AccountName != 'SP29CS_CASH' and AccountName != 'SP29MS_ALL')">

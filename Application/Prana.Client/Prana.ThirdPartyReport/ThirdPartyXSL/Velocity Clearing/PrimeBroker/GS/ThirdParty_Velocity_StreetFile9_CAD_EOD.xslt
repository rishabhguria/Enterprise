...
<COMMISSION>
	   ...
	   <xsl:for-each select="ThirdPartyFlatFileDetail[(Asset='Equity') and CurrencySymbol='CAD' and CounterParty='VCGO']">
        <ThirdPartyFlatFileDetail>
          ...
          <!-- <SEDOL> -->
              ...
              <!-- <xsl:choose> -->
              <!-- <xsl:when test="number(SEDOL)"> -->
                <!-- <xsl:value-of select="concat(concat('=&quot;',SEDOL),'.&quot;')"/> -->
              <!-- </xsl:when> -->
              <!-- <xsl:otherwise> -->

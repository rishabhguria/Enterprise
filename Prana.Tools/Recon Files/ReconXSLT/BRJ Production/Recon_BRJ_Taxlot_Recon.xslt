				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<Side>
							...
							<xsl:choose>
								<xsl:when test="$Side='Long Positions' and $AssetType='Equity'">
									<xsl:value-of select="'Buy'"/>
								</xsl:when>

								<xsl:when test="$Side='Short Positions' and $varAsset='Equity'">
									<xsl:value-of select="'Sell short'"/>
								</xsl:when>

								<xsl:when test="$Side='Long Positions' and $varAsset='EquityOption'">
									<xsl:value-of select="'Buy to Open'"/>
								</xsl:when>

								<xsl:when test="$Side='Short Positions' and$varAsset='EquityOption'">
									<xsl:value-of select="'Sell to Open'"/>
								</xsl:when>

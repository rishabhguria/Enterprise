	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position) and COL4='P' or COL4='C'">
            ...
            <xsl:variable name="PRANA_SUFFIX_NAME">
              <xsl:value-of select="document('../ReconMappingXML/SymbolSuffixMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME]/SymbolData[@PBSuffixCode=$PB_SUFFIX_NAME]/@PranaSuffixCode"/>
						...
						<xsl:variable name ="Asset">
							<xsl:choose>
								<xsl:when test="COL4='P' or COL4='C' ">
						...
						<xsl:variable name="varYear">
							<xsl:value-of select ="substring(substring-after($Symbol,' '),8,2)"/>
						</xsl:variable>
						...
						<xsl:variable name="varPutCall">
							<xsl:value-of select ="substring(substring-after($Symbol,' '),22,1)"/>
						</xsl:variable>

						<xsl:variable name ="varStrikePrice">
							<xsl:value-of select ="substring(substring-after(substring-after($Symbol,' '),' '),1,8)"/>
						</xsl:variable>

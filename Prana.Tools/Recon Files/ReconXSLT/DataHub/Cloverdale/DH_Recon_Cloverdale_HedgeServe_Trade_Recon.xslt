        ...
        <xsl:choose>
          <xsl:when test="number($Quantity)">
            <PositionMaster>
              ...
              <xsl:variable name="PB_COUNTER_PARTY" select="normalize-space(COL8)"/>
              ...
              <xsl:variable name="OptCommission">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="COL154"/>
                </xsl:call-template>
              </xsl:variable>

              <Commission>
                <xsl:choose>
                  <xsl:when test="$Commission &gt; 0 and COL30='Equity'">
                  ...
                  <xsl:when test="$OptCommission &gt; 0 and COL30='Option'">
                    <xsl:value-of select="$OptCommission"/>
                  </xsl:when>
                  <xsl:when test="$OptCommission &lt; 0 and COL30='Option'">
                    <xsl:value-of select="$OptCommission * (-1)"/>
                  </xsl:when>

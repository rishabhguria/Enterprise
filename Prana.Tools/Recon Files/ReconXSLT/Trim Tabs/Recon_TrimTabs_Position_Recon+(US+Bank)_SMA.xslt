		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<!--<xsl:if test ="$varQuantity">-->
					...
					<xsl:if test="number($varQuantity) and contains(COL13,'Cash Disbursement')!='true'">
					...
					<PositionMaster>
						...
						<xsl:variable name="varSymbol">
							<xsl:choose>
								<xsl:when test="normalize-space(COL27) = 'USD'">
						...
						<xsl:variable name="varSedol1">
							<xsl:choose>
								...
								<xsl:when test="string-length(normalize-space(COL4)) = '6'">
									<xsl:value-of select="concat(0,COL4)"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL4)) = '5'">
									<xsl:value-of select="concat('00',normalize-space(COL4))"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="''"/>
								</xsl:otherwise>

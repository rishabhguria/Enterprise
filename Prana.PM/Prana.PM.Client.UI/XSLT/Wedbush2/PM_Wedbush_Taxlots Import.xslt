...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs"
	...
	<xsl:template name="ConvertBBCodetoTicker">
		...
		<xsl:variable name="varStrike">
			<xsl:value-of select="format-number(substring-before(substring-after(COL7,'$'),' '), '#.00')"/>
		</xsl:variable>
  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number(normalize-space(COL4))">
			<!--<xsl:if test="number(COL4) and (COL2='69191389' or COL2='10652626'or COL2='59792710'or COL2='71240526' or COL2='71240527' or COL2='71240528'or COL2='71240529' or COL2='71240540' or COL2='51394556' or COL2='31405346')">-->
			<!--<xsl:if test="number(COL4) and (COL2='51394556' or COL2='31405346')">-->
          <PositionMaster>
			  ...
			  <xsl:variable name ="varCallPut">
				  <xsl:choose>
					  <xsl:when test="normalize-space(substring(COL7,1,4))='CALL' or normalize-space(substring(COL7,1,4))='PUT' ">
						  <xsl:value-of select="1"/>
					  </xsl:when>					
					  <xsl:otherwise>
						  <xsl:value-of select="''"/>

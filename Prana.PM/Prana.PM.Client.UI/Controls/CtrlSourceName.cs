...
//            //bindingSourceDataSourceNameIDList.ResetBindings(false);
//            cmbSourceName.ValueMember = "ID";
//            cmbSourceName.DisplayMember = "FullName";
//            Utils.UltraComboFilter(cmbSourceName, "FullName");
//            //this.cmbSourceName.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.bindingSourceDataSourceNameIDList, "ID", true));
...
//            //if (bool.Equals(this.IsAllDataSourceAvailable, true))
//            //{
//            //    cmbSourceName.Value = 2;
//            //}
...
//            Prana.BusinessObjects.PositionManagement.DataSourceNameID selectedDataSourceNameID = cmbSourceName.SelectedRow.ListObject as Prana.BusinessObjects.PositionManagement.DataSourceNameID;

		...
		<DocumentElement>
            ...
            <xsl:value-of select="''"/>
					...
					<xsl:variable name="varMonth">
						<xsl:choose>
							<xsl:when test="string-length(substring-before(COL11,'-'))= '1'">
								<xsl:value-of select="concat('0',substring-before(COL11,'-'))"/>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:variable name="varDay">
						<xsl:choose>
							<xsl:when test="string-length(substring-before(substring-after(COL11,'-'),'-'))= '1'">
								<xsl:value-of select="concat('0',substring-before(substring-after(COL11,'-'),'-'))"/>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:variable name="varFYear">
						<xsl:value-of select="substring-after(substring-after(COL11,'-'),'-')"/>
					</xsl:variable>
					<PositionStartDate>
						<xsl:value-of select="concat($varMonth,'/',$varDay,'/','20',$varFYear)"/>
					</PositionStartDate>

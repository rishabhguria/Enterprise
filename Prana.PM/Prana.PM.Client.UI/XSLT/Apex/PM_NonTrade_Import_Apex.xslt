  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Cash) and normalize-space(COL11)='CASH BALANCE'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_PRE">
              <xsl:choose>
                ...
                <xsl:when test="$varSubAccountDesc ='WFS Credit Interest' or $varSubAccountDesc ='WFS Debit Interest'">
                ...
                <xsl:when test="$varSubAccountDesc ='WFS Ticket Charge'">
                  <xsl:value-of select="'Ticker FeesExpense'"/>
                </xsl:when>

                <xsl:when test="$varSubAccountDesc ='WFS Security Lending Revenue'">
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_POST">
              <xsl:choose>
                ...
                <xsl:when test="$varSubAccountDesc ='WFS Credit Interest' or $varSubAccountDesc ='WFS Debit Interest'
                          ...
                          or $varSubAccountDesc ='WFS Ticket Charge' or $varSubAccountDesc ='WFS Security Lending Revenue' 
                          or $varSubAccountDesc ='Withdrawal'">
                  <xsl:value-of select="'Cash'"/>
                </xsl:when>
            ...
            <Date>
              <xsl:call-template name="FormatDate">
                <xsl:with-param name="DateTime" select="normalize-space(COL26)"/>
              </xsl:call-template>
            </Date>

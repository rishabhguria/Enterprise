			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($varQuantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_FUND_NAME" select="normalize-space(COL14)"/>
						...
						<Side>
							<xsl:choose>
								<xsl:when test="normalize-space(COL1)='Buy'">
									<xsl:value-of select="'Buy'"/>
								</xsl:when>
								<xsl:when test="normalize-space(COL1)='Sell'">
						...
						<!--<xsl:variable name="varPositionStartDate">
							<xsl:value-of select="concat(substring-before(substring-after(normalize-space(COL10),'/'),'/'),substring-after(normalize-space(COL10),'/'),substring-before(substring-after(substring-after(normalize-space(COL10),'/'),'/'),' '))"/>
						</xsl:variable>

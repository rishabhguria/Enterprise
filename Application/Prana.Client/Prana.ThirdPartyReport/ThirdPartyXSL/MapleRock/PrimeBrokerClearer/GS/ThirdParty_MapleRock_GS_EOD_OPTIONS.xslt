...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/">
		<Groups>
			...
			<!--<xsl:for-each select="/NewDataSet/ThirdPartyFlatFileDetail[Asset='EquityOption']">-->
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<Group 
				...
				Broker="{$varCounterParty}" Custodian="GSCO" TransactionType="{$varTransactionType}" CurrencyCode="{CurrencySymbol}"
				...
				TradeTax="" MiscMoney="{MiscFees}" NetAmount="{$varNetAmount}" Principal="{GrossAmount}" Description="{CompanyName}"
				SecurityType="{$varProductCode}" CountrySettlementCode="" ClearingAgent="" SECFee="" RepoOpenSettleDate="" RepoMaturityDate=""
		  RepoRate="" RepoInterest="" OptionUnderlyer="{$varUnderlyingSymbol}" OptionExpiryDate="{$ExpirationDate}" OptionCallPutIndicator="{substring(PutOrCall,1,1)}"

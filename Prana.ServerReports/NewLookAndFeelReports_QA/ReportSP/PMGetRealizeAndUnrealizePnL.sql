PRINT 'Started Executing: ClientDB_1938_PMGetRealizeAndUnrealizePnL.sql'
GO
IF EXISTS (
		SELECT *
		FROM sysobjects
		WHERE id = object_id(N'[dbo].PMGetRealizeAndUnrealizePnL')
			AND OBJECTPROPERTY(id, N'IsProcedure') = 1
		)
BEGIN
	DROP PROCEDURE [dbo].[PMGetRealizeAndUnrealizePnL]
	PRINT 'Deleted existing Stored Procedure PMGetRealizeAndUnrealizePnL'
END
GO
/*
...
exec [PMGetRealizeAndUnrealizePnL] '10/1/2013','4/07/2015' ,'1182,1183,1184','1,2,3,4,5,6,7,8,9','MTM_V0'                                                                                        
...
go
PRINT 'Done executing ClientDB_1938_PMGetRealizeAndUnrealizePnL.sql'
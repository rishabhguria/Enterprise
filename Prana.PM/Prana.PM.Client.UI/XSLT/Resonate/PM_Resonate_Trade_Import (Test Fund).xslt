  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($NetPosition) and contains(COL21,'CASH')!='true'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="Side" select="normalize-space(COL44)"/>

            <SideTagValue>

              <xsl:choose>
                <xsl:when test="contains(COL21,'OPTIONS')">
                  ...
                  <xsl:choose>
                    ...
                    <xsl:when test="$Side ='BUY'">
					 ...
					 <xsl:when test="$Side ='COVERED SHORTS'">
					  <xsl:value-of select="'B'"/>
					 </xsl:when>

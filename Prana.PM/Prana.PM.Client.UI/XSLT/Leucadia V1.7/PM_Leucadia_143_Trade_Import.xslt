        ...
        <xsl:if test="number($Position) ">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="Asset">
              <xsl:choose>
                <xsl:when test="contains(COL13,'option')">
				  ...
				  <xsl:when test="contains(COL13,'Corporate bonds')">
					  <xsl:value-of select="'Fixed Income'"/>
				  </xsl:when>

				  <xsl:when test="contains(COL13,'Common stock')">
					  <xsl:value-of select="'Equity'"/>
				  </xsl:when>
				  <xsl:when test="contains(COL13,'REIT')">
					  <xsl:value-of select="'Equity'"/>
				  </xsl:when>
            ...
            <xsl:variable name="Symbol">
              <xsl:choose>
				  ...
				  <xsl:when test="contains(COL13,Corporate)">
					  <xsl:value-of select="normalize-space(COL14)"/>
				  </xsl:when>


				  <xsl:when test="contains(COL13,Contract)">
		  ...
		  <Symbol>
			  ...
			  <xsl:choose>
				  ...
				  <xsl:when test="COL13='Contract for difference'">
					  <xsl:value-of select="COL17"/>
				  </xsl:when>

				  <xsl:when test="contains(COL7,'cancel')">
					  <xsl:value-of select="''"/>
				  </xsl:when>
            ...
            <xsl:variable name="PB_COUNTER_PARTY" select="COL12"/>

  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Cash) and contains(COL51,'CASH') ='true'">
            <PositionMaster>
              ...
              <xsl:variable name="varOpeningBalanceCR">
                <xsl:call-template name="Translate">
              ...
              <OpeningBalanceCR>
                <xsl:choose>
                  <xsl:when test="number($varOpeningBalanceCR)">
                    <xsl:value-of select="$varOpeningBalanceCR"/>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="0"/>
                  </xsl:otherwise>

			  ...
			  <PositionMaster>
				  ...
				  <xsl:variable name="PRANA_ACRONYM_NAME">
					  <xsl:choose>
						  ...
						  <xsl:when test="(contains(COL3,'CIP') or contains(COL3,'FEE') or contains(COL3,'/17') or normalize-space(COL5) = 'OTHER INC/EXP') and (COL6 &gt; 0)">
							  <xsl:value-of select="'MISC_INC'"/>
						  </xsl:when>
						  <xsl:when test="(contains(COL3,'CIP') or contains(COL3,'FEE')  or contains(COL3,'/17')or contains(COL3,'TAF') or contains(COL3,'CHARGE') or contains(COL3,'NIRVANA') or normalize-space(COL5) = 'OTHER INC/EXP') and (COL6 &lt; 0)">

...
Execution Method:                      
exec P_MW_getExposureAnalysisReport_AllGrouping_New @Date='2014-12-12',@LongShortExposureChoice=2,@GroupBy1=N'PositionSideExposure',@GroupBy2=N'ExpirationMonthYear',@GroupBy3=N'Select',@GroupBy4=N'Select',@Funds=N'Moussearound Fidelity,Moussearound Goldma
n:002432664,Mousseganesh Goldman:002432672,Mousseganesh Kotak,MousseIndia Fidelity,MousseIndia Goldman:002433464',@Assets=N'Equity,EquityOption,Future,FutureOption,FX,Cash,Indices,FixedIncome,PrivateEquity,FXOption,FXForward,Forex,ConvertibleBond,CreditDe
faultSwap',@Sectors=N'#N/A Invalid Security,Basic Materials,Business Trust,Coal,Commodities,Communications,Consumer Cyclical,Consumer Discretionary,Consumer Non-cyclical,Consumer Staples,Currency Hedge,Diversified,Double Short,Energy,Financial,Fixed Incom
e,Funds,Health Care,Index,Industrial,Information Technology,Material,Pipes/Transport/Midstream,Power/Hydro,Private Investments,Reits,Services,Technology,Timber,Unclassified,Undefined,Utilities',@GroupByUnderlyingExpiration=1,@paramNAVbyMWorPM=1  
...
BeginningMarketValueBase float      
)                 
...
select 'if'           Insert Into #TempPNL            
 ...
 Case         
  when BeginningMarketValueBase > 0        
 ...
 ShortMarketValue,                          
  ...
  NAV as NAV,   
  DeltaExposureBase as  PositionSideExposure,         
  OpenTradeAttribute1 ,        
  OpenTradeAttribute2 ,        
  OpenTradeAttribute3 ,        
  OpenTradeAttribute4 ,        
...
BEGIN   
  ...
  insert into #TempPNL                 
   ...
   Case        
   When  Sum(BeginningQuantity*SideMultiplier) >0        
   ...
   Case                         
    ...
    Then                         
    SUm(Cast(DeltaExposureBase as float))                        
    Else 0                        
   End as  ShortExposure,                    
   abs(Sum(DeltaExposureBase)) as GrossExposureBase,                      
   MAX(NAV) as NAV,  
 SUM(DeltaExposureBase) as  PositionSideExposure,        
   MAX(OpenTradeAttribute1) as OpenTradeAttribute1 ,        
   MAX(OpenTradeAttribute2) as OpenTradeAttribute2,        
   MAX(OpenTradeAttribute3) as OpenTradeAttribute3,        
   MAX(OpenTradeAttribute4) as OpenTradeAttribute4,        
   MAX(OpenTradeAttribute5) as OpenTradeAttribute5,        
   MAX(OpenTradeAttribute6) as OpenTradeAttribute6,        
   MAX(ClosedTradeAttribute1) as ClosedTradeAttribute1 ,        
   MAX(ClosedTradeAttribute2) as ClosedTradeAttribute2,        
   MAX(ClosedTradeAttribute3) as ClosedTradeAttribute3,        
   MAX(ClosedTradeAttribute4) as ClosedTradeAttribute4,        
   MAX(ClosedTradeAttribute5) as ClosedTradeAttribute5,        
   MAX(ClosedTradeAttribute6) as ClosedTradeAttribute6   
 ...
 /***************************/                  
  ...
  WHEN (@GroupBy1 = 'Fund')                    
  Then Fund       
  WHEN (@GroupBy1 = 'PositionSideExposure')                     
  Then Cast(DeltaExposureBase as nvarchar)  
  WHEN  (@GroupBy1 = 'Sector')                                  
  Then UDASector                
  WHEN (@GroupBy1 = 'ExpirationMonthYear')                   
  Then datename(Year,ExpirationDate)                
  WHEN (@GroupBy1 = 'Subsector')                   
  Then UDASubSector                
  WHEN (@GroupBy1 = 'Symbol')                            
  Then Symbol                
  WHEN (@GroupBy1 = 'ExpirationDate')                              
  Then Convert(varchar, ExpirationDate ,111)                
  WHEN (@GroupBy1 = 'Bloomberg')                
 ...
 End             
    ,               
    CASE                
  WHEN (@GroupBy2 = 'Sector')                   
  Then UDASector                
  WHEN (@GroupBy2 = 'ExpirationMonthYear')                   
  Then datename(Year,ExpirationDate)                
  WHEN (@GroupBy2 = 'Subsector')                   
  Then UDASubSector                
  WHEN (@GroupBy2 = 'ExpirationDate')                   
  Then Convert(varchar, ExpirationDate ,111)               
  WHEN (@GroupBy2 = 'Bloomberg')                   
  Then BloombergSymbol      
  WHEN ( @GroupBy2 = 'PositionSideExposure')                     
  Then Cast(DeltaExposureBase as nvarchar)  
  WHEN (@GroupBy2 = 'Asset')                   
  Then Asset               
  WHEN  (@GroupBy2 = 'Symbol')                   
  Then Symbol              
    End                  
    ,            
 Case            
 ...
 END             
    ,              
    CASE                
  WHEN (@GroupBy3 = 'ExpirationMonthYear')                   
  Then datename(Year,ExpirationDate)                
  WHEN (@GroupBy3 = 'Subsector')                   
  Then UDASubSector                
  WHEN ( @GroupBy3 = 'PositionSideExposure')                     
  Then Cast(DeltaExposureBase as nvarchar)  
  WHEN (@GroupBy3 = 'ExpirationDate')                   
  Then Convert(varchar, ExpirationDate ,111)                
  WHEN (@GroupBy3 = 'Bloomberg')                   
  Then BloombergSymbol              
  WHEN (@GroupBy3 = 'Symbol')                   
  Then Symbol               
    End                  
    ,             
    Case            
   WHEN (@GroupBy3 = 'ExpirationMonthYear') Then datename(Month,ExpirationDate)                
   Else Symbol            
    END                
    ,                
    CASE                
  WHEN (@GroupBy4 = 'Subsector')                   
  Then  UDASubSector                
  WHEN (@GroupBy4 = 'ExpirationDate')                   
  Then Convert(varchar, ExpirationDate ,111)                
  WHEN ( @GroupBy4 = 'PositionSideExposure')                     
  Then Cast(DeltaExposureBase as DECIMAL(18,2))  
  WHEN (@GroupBy4 = 'Bloomberg')                   
  Then BloombergSymbol              
  WHEN (@GroupBy4 = 'Symbol')                   
  Then Symbol               
    End                   

	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<xsl:if test ="FundName != 'HSBC 25394' and FundName != 'HSBC 25393'and FundName != 'HSBC 26240'and FundName != 'HSBC 26241' and FundName != 'HSBC 10413' and FundName != 'HSBC 26206' and FundName != 'HSBC 9776' and FundName != 'HSBC 9950 DRP' and FundName != 'HSBC 10520' and FundName!='HSBC 10409' and FundName!='HSBC 10410' and FundName!='HSBC 11139' and FundName!='HSBC 26215' and FundName!='HSBC 26238'and FundName!='HSBC 26239' ">
					...
					<ThirdPartyFlatFileDetail>
						...
						<xsl:choose>
							<xsl:when test="FundName ='HSBC 10443' or FundName = 'IB Offshore' or FundName = 'PERS Offshore' or FundName = 'JEFF Offshore' or FundName = 'JPM SCO'">
								<Fund>
									<xsl:value-of select ="'SONOMALTD'"/>
								</Fund>
							</xsl:when>

							<!--<xsl:when test="FundName ='HSBC Offshore' or FundName = 'IB Offshore' or FundName = 'PERS Offshore' or FundName = 'JEFF Offshore' or FundName = 'JPM SCO'">
								<Fund>
									<xsl:value-of select ="'SONOMALTD'"/>
								</Fund>
							</xsl:when>-->

							<xsl:when test="FundName ='HSBC 10385' or FundName = 'IB SCLP' or  FundName = 'Pershing SCLP' or FundName = 'PERS SCLP' or FundName = 'JEFF SCLP' or FundName = 'Schwab SCLP' or FundName = 'AMTD SCLP' or FundName = 'JPM SCLP' or FundName = 'JPM SCLP Custody'">
								<Fund>
									<xsl:value-of select ="'SONOMALP'"/>
								</Fund>
							</xsl:when>

							<!--<xsl:when test="FundName ='HSBC SCLP' or FundName = 'IB SCLP' or FundName = 'PERS SCLP' or FundName = 'JEFF SCLP' or FundName = 'Schwab SCLP' or FundName = 'AMTD SCLP' or FundName = 'JPM SCLP' or FundName = 'JPM SCLP Custody'">
								<Fund>
									<xsl:value-of select ="'SONOMALP'"/>
								</Fund>
							</xsl:when>-->
						...
						<xsl:choose>
							...
							<xsl:when test ="FundName = 'HSBC 10443'">
								<CustodianAccount>
									<xsl:value-of select ="'HSBC 10443'"/>
								</CustodianAccount>
							</xsl:when>
							...
							<xsl:when test ="FundName = 'JPM SCLP'">
								<CustodianAccount>
									<xsl:value-of select ="'JP Morgan 611-60271'"/>
								</CustodianAccount>
							</xsl:when>
							...
							<xsl:when test ="FundName = 'JPM SCO'">
								<CustodianAccount>
									<xsl:value-of select ="'JP Morgan 611-60272'"/>
								</CustodianAccount>
							</xsl:when>
							<xsl:otherwise>
								<CustodianAccount>
            ...
            <xsl:value-of select ="StrikePrice"/>
						...
						<MiscCharges>
							<xsl:choose>
								<xsl:when test ="(FundName = 'JPM SCLP' or FundName = 'JPM SCO' or FundName = 'Pershing SCLP' or FundName = 'JEFF Offshore' or FundName = 'JEFF SCLP')  and CounterParty = 'JDMA'">
									<xsl:value-of select ="($varMiscCharges)"/>
								</xsl:when>
								<xsl:when test ="(FundName = 'JEFF SCLP' or FundName = 'JPM SCLP' or FundName = 'JPM SCO'  or FundName = 'Pershing SCLP' or FundName = 'JEFF Offshore')">
									<xsl:value-of select ="($varMiscCharges + 15.000000)"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select ="$varMiscCharges"/>
								</xsl:otherwise>
						...
						<xsl:variable name ="SettAmount">
							<xsl:choose>
								...
								<xsl:when test ="NetAmount != 0 and Asset != 'PrivateEquity' and Asset != 'FixedIncome'">
									<xsl:value-of select = 'format-number(NetAmount, "###.0000000")'/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select ="0"/>
								</xsl:otherwise>
						...
						<SettlementAmount>
							<xsl:choose>
								<xsl:when test="Asset = 'FixedIncome'">
									<xsl:choose>
										<xsl:when test ="(FundName = 'JPM SCLP' or FundName = 'JPM SCO' or FundName = 'Pershing SCLP' or FundName = 'JEFF Offshore' or FundName = 'JEFF SCLP') and CounterParty = 'JEFF'">
											<xsl:value-of select ="$SettAmount div 100"/>
										</xsl:when>
										<xsl:when test ="(FundName = 'JEFF SCLP' or FundName = 'JPM SCLP' or FundName = 'JPM SCO' or FundName = 'Pershing SCLP' or FundName = 'JEFF Offshore') and (contains(Side,'Sell')!=false)">
											<xsl:value-of select ="($SettAmount div 100)+ $AccruedInterest - 15"/>
										</xsl:when>
										<xsl:when test ="(FundName = 'JEFF SCLP' or FundName = 'JPM SCLP' or FundName = 'JPM SCO' or FundName = 'Pershing SCLP' or FundName = 'JEFF Offshore') and (contains(Side,'Buy')!=false)">
											<xsl:value-of select ="($SettAmount div 100)+$AccruedInterest + 15"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select ="$SettAmount div 100"/>

 CREATE PROCEDURE [dbo].[P_FFThirdParty_BallinaGroupBYSymbol] 
 (
	@thirdPartyID INT
...
CASE 
		...
		WHEN CharIndex('Walleye WOF Systematic', AccountName) <> 0
			...
			THEN '3E70205C'
		WHEN (CharIndex('Diamond Growth Fund', AccountName) <> 0 Or CharIndex('Walleye WMO', AccountName) <> 0 
			 Or CharIndex('Walleye WMO Systematic', AccountName) <> 0)
			THEN '3E70205C'

          ...
          <xsl:when test="number($varDividend) or number($varDividendBase)">
            <PositionMaster>
              ...
              <Symbol>
				...
				<xsl:when test="contains(COL2,'.00 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.00 EQUITY'),' EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.10 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.10 EQUITY'),'.1 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.20 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.20 EQUITY'),'.2 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.30 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.30 EQUITY'),'.3 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.40 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.40 EQUITY'),'.4 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.50 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.50 EQUITY'),'.5 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.60 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.60 EQUITY'),'.6 EQUITY')"/>
                  </xsl:when>
					<xsl:when test="contains(COL2,'.70 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.70 EQUITY'),'.7 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.80 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.80 EQUITY'),'.8 EQUITY')"/>
                  </xsl:when>
				  <xsl:when test="contains(COL2,'.90 EQUITY')">
                    <xsl:value-of select="concat(substring-before(COL2,'.90 EQUITY'),'.9 EQUITY')"/>
                  </xsl:when>
                  <xsl:otherwise>

...
Modified by: Gourav Soni            
Date : Sept,25, 2019           
Discription: add one condition in fx rate for fxfoward and fx. for this jira https://jira.nirvanasolutions.com:8443/browse/PRANA-32843
...
*/
CREATE PROCEDURE [dbo].[P_GetTransactions_TotalCommission_ACK] (
...
BEGIN
	...
	SELECT VT.TaxLotID AS TaxLotID
		...
		when VT.venueID = 1
		then VT.Commission 
		else VT.Commission + VT.SoftCommission
		end	AS Commission
		...
		,SM.FactSetSymbol AS FactSetSymbol
		,SM.ActivSymbol AS ActivSymbol
		,VT.Side
		,CASE 
			WHEN VT.IsSwapped = 1
				THEN 'EquitySwap'

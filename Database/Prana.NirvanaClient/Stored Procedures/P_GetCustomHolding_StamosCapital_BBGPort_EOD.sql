...
CREATE Procedure [dbo].[P_GetCustomHolding_StamosCapital_BBGPort_EOD]                          
(                                   
@ThirdPartyID int,                                              
...
WHERE (DateDiff(Day, SubAccountBalances.TransactionDate, @InputDate) = 0)      
...
Drop Table #TempOpenPositionsTable, #TempTable,#Temp_FinalTable, #Fund,#TempEODCashAndAccruals  

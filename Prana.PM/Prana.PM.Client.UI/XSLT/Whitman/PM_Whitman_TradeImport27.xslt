			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($NetPosition)">
					...
					<PositionMaster>
						...
						<xsl:variable name="Symbol" select="COL"/>
						...
						<xsl:variable name="Year" select="substring(COL31,1,4)"/>
						<xsl:variable name="Month" select="substring(COL31,5,2)"/>
						<xsl:variable name="Day" select="substring(COL31,8,2)"/>

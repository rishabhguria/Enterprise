...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="ConvertBBCodetoTicker">
    ...
    <xsl:variable name="varExYear">
      <xsl:value-of select="substring(substring-after(substring-after($varBBCode,' '),' '),22,2)"/>
    </xsl:variable>
    ...
    <xsl:variable name="varStrike">
      <xsl:value-of select="format-number(substring(substring-after(substring-after($varBBCode,' '),' '),5,8),'#.00')"/>
    </xsl:variable>

    <xsl:variable name="varExDay">
      <xsl:value-of select="substring(substring-after(substring-after($varBBCode,' '),' '),17,2)"/>
    </xsl:variable>
    ...
    <xsl:variable name="varExMonth">
      <xsl:value-of select="substring(substring-after(substring-after($varBBCode,' '),' '),14,2)"/>
    </xsl:variable>
          ...
          <PositionMaster>
            ...
            <Symbol>
              <xsl:choose>
                ...
                <xsl:when test="string-length(COL4) &gt; 6">

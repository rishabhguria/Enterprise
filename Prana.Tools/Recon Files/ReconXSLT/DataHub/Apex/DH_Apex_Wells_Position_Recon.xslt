  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity)and contains(COL12,'Cash Balance')!='true' and contains(COL25,'S')= true">
            <PositionMaster>
              ...
              <xsl:variable name="Asset">
                <xsl:choose>
                  <xsl:when test="contains(COL10,'Options')">
              ...
              <xsl:variable name="PB_SUFFIX" select="normalize-space(COL28)"/>
              ...
              <xsl:variable name="MarkPrice">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="number(COL31)"/>
                </xsl:call-template>
              </xsl:variable>
              <MarkPrice>
                <xsl:choose>

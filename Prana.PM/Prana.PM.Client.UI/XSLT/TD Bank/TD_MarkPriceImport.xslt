  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($MarkPrice) and not(normalize-space(COL4)='Cash' or normalize-space(COL4)='Equity' or normalize-space(COL4)='CEFunds' or normalize-space(COL4)='Funds')">

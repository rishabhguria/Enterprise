			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="varForexRate">
						<xsl:choose>
							<xsl:when test="CurrencySymbol != 'USD' or CurrencySymbol!= 'GBP' or CurrencySymbol!= 'EUR' or CurrencySymbol!= 'AUD'">
								<xsl:choose>
									<xsl:when test="ForexRate != 0">

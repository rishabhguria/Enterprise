...
{
    public class RemoveDailyCreditLimit : DailyCreditLimitUIMap, ITestStep
    {
                ...
                foreach (DataRow dataRow in testData.Tables[sheetIndexToName[0]].Rows)
                {
                    ...
                    if (foundRow.Length > 0)
                    {
                        ...
                        if (columToMSAAIndexMapping.Count == 0)
                        {
                            ...
                            RemoveDailyCreditLimtAccount(columToMSAAIndexMapping, dataRow, gridRow);
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Remove the account details from daily credit limit.
        /// </summary>
        /// <param name="columToIndexMapping"></param>
        /// <param name="dataRow"></param>
        /// <param name="gridRow"></param>
        private void RemoveDailyCreditLimtAccount(Dictionary<string, int> columToIndexMapping, DataRow dataRow, MsaaObject gridRow)
        {
            try
            {

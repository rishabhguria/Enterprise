...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/">
		<Groups>
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[TaxLotState!='Sent' and (Asset='Equity' and IsSwapped='true')]">
				...
				<xsl:if test="(1=position()) or(preceding-sibling::*[1]/PBUniqueID != PBUniqueID)">				
					<xsl:if test="(CounterParty != 'Corp Action' or CounterParty != 'Transfer')">
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<xsl:variable name="PB_NAME" select="'MSCO'"/>



		<Group 
				TransactionType = "SW002" TransactionStatus="{$varTaxlotStateGrp}" BuySellIndicator="" LongShortIndicator="" PositionType="{$Sidevar}"
				transactionlevel="B" ClientRefNo="{$varPBUniqueIDAndDatePart}" AssociatedTradeId="{$varPBUniqueIDAndDatePart}" ExecutionAccount="038226270" AccountID="038226270"
				...
				MSFees="" 
				NotRequired=""
				MSFeesIndicator="F" DividendEntitlementPercent="" Spread="" NetAmount="{format-number($varGroupNetAmnt,'###.00')}" HearsayInd="N" Custodian="MSCO" MoneyManager="" Bookid=""
				Dealid="" Taxlotid="" Originaltaxlottransactiondate="" OriginalTaxlottransactionprice="" TaxLotCloseoutMethod="" PriceFXRate="1" AcquitionDate="" Comments="" SwapReferenceNo="" BasketId="" PriceCurrency="{CurrencySymbol}" ResetIndicator=""
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and TaxLotState!='Sent' and AccountName!='Strategy Test']">
				...
				<ThirdPartyFlatFileDetail		
							...
							AssociatedTradeId="{$varPBUniqueIDAndDatePart}" ExecutionAccount="038226270" AccountID="{$FundName_ThirdParty}"
							...
							NotRequired=""
							MSFeesIndicator="F" DividendEntitlementPercent="" Spread="" NetAmount="{format-number($varAllocatinNetAmnt,'###.00')}" HearsayInd="N" Custodian="MSCO" 
							MoneyManager="" Bookid="" Dealid="" Taxlotid="" Originaltaxlottransactiondate="" OriginalTaxlottransactionprice="" TaxLotCloseoutMethod="" PriceFXRate="1"

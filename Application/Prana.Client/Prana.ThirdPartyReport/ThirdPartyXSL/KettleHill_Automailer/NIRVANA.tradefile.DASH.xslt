	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection xmlns:xsi="http://www.w3.org/2001/XMLschema-instance" xsi:noNamespaceSchemaLocation="alan.xsd">
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty='DASH']">
				...
				<!--<ThirdPartyFlatFileDetail emailto="rpd@nirvanasolutions.com , Nick.Kemp@iongroup.com, dash_integration@iongroup.com,  David.Cross@iongroup.com, Charlie@rpdfund.com">-->

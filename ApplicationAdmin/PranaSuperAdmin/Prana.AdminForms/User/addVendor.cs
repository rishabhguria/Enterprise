...
namespace Prana.Admin
{
    ...
    public class AddVendor : System.Windows.Forms.Form
    {
        ...
        {
            Prana.Admin.BLL.Vendor vendor = new Prana.Admin.BLL.Vendor();
            vendor.FirstName = txtVendor.Text.Trim();

            //VendorManager.AddVendor(vendor);
            //Prana.Admin.Utility.Common.ResetStatusPanel(stbVendor);
            //Prana.Admin.Utility.Common.SetStatusPanel(stbVendor, "Vendor Added!");

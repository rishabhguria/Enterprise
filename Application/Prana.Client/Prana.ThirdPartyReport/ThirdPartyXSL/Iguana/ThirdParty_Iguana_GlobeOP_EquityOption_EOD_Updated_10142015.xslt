  ...
  <xsl:template match="/ThirdPartyFlatFileDetailCollection">
    <ThirdPartyFlatFileDetailCollection>
	  ...
	  <xsl:for-each select="ThirdPartyFlatFileDetail">
		  <xsl:if test="Asset = 'EquityOption' and (AccountName = 'Iguana Healthcare-JPM' or AccountName = 'Iguana IPO')">
			  <ThirdPartyFlatFileDetail>
				  ...
				  <DealId>
					  <xsl:value-of select="concat(PBUniqueID,'Iguana-',substring-after(AccountName,'-'))"/>
				  </DealId>
            ...
            <Reserved2>
			  ...
			  <Custodian>
				  <xsl:choose>
					  ...
					  <xsl:when test ="AccountName = 'Iguana Healthcare-Lazard'">
				  ...
				  <CashAccount>
					  <xsl:value-of select ="'JPNIGUACFU'"/>
				  </CashAccount>
            ...
            <GlobeOpSecurityIdentifier>
			  ...
			  <RIC>
				  ...
				  <!-- if non us option, then Bloomberg Code else OCC i.e. OSI-21 code for options -->
			  <!--<OCCCode>

				...
				<xsl:if test="number($varQuantity)">
					...
					<PositionMaster>
                        ...
                        <xsl:variable name="varNetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL9) * normalize-space(COL10)"/>
							</xsl:call-template>
						</xsl:variable>
                        ...
                        <xsl:variable name="varNetNotionalValueBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL11) * normalize-space(COL9)"/>
							</xsl:call-template>
						</xsl:variable>

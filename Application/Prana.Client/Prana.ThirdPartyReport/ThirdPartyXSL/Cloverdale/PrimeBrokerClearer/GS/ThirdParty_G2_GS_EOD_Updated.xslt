...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
    <Groups>
      ...
      <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[IsSwapped!='true' and contains(AccountName,'GS') and contains(CounterParty,'CROSS')!='true']">
    ...
    <xsl:variable name="varFeeValue2">
 	...
 	<xsl:variable name ="varAllocationState">
	  ...
	  <Group 
			  ...
			  Broker="{CounterParty}" Custodian="GSCO" TransactionType="{$varTransactionType}" CurrencyCode="{CurrencySymbol}"

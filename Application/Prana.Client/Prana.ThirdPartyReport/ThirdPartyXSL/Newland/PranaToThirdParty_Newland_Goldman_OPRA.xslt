				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:choose>
						...
						<xsl:when test="Asset = 'EquityOption' ">
							<prod_id>
								<xsl:value-of select="concat('$', OpraOptionSymbol)"/>
							</prod_id>
					...
					<total_sec_fees>
						<xsl:value-of select ='format-number(MiscFees, "####.0000")'/>
					</total_sec_fees>
					<total_taxes>
						<xsl:value-of select ="'0'"/>
					</total_taxes>
					<total_other_charges>
						<xsl:value-of select='format-number(OtherBrokerFee + StampDuty + TransactionLevy + ClearingFee , "###.0000")'/>
					</total_other_charges>
					<total_commission>
						<xsl:value-of select ='format-number(CommissionCharged + TaxOnCommissions, "###.0000")'/>
					</total_commission>

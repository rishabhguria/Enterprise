...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<xsl:variable name="COMM2" select="format-number(CommissionCharged + SoftCommissionCharged + ClearingBrokerFee,'###.0000')"/>
		...
		<Group 
				...
				swafrefno="" basketid=""   pricecur=""  resetind="" SNSreference="" ResearchFee="{format-number($ClearingFeeSum,'#.####')}"   ResearchFeeIndicator="F"  LEI="" 
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and AccountName='Heptagon - Shorts - Morgan Stanley']">
				...
				<xsl:variable name="Cpty">
					<xsl:choose>
						...
						<xsl:when test="CounterParty='MSCOU'">
							<xsl:value-of select="'MSCO'"/>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="COMM1" select="format-number(CommissionCharged + SoftCommissionCharged + ClearingBrokerFee,'###.0000')"/>
				...
				<ThirdPartyFlatFileDetail
							...
							acqdate="" comments="" swafrefno="" basketid=""   pricecur=""  resetind="" SNSreference="" ResearchFee="{format-number($ClearingFee1,'#.####')}"   ResearchFeeIndicator="F"  LEI="" 

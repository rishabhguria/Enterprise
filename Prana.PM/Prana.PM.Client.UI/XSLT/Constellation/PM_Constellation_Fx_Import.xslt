			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:variable name="varFXRate">										
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="normalize-space(COL16) div normalize-space(COL17)"/>
					</xsl:call-template>						
				</xsl:variable>
				
				<!--$PB_CURRENCY_NAME='EUR' or $PB_CURRENCY_NAME='GBP' or $PB_CURRENCY_NAME='AUD' or $PB_CURRENCY_NAME='NZD'-->

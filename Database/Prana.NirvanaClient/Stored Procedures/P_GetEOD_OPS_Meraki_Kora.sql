/*
exec [P_GetEOD_OPS_Meraki_Kora] @thirdPartyID=46,@companyFundIDs=N'25,21,22,20,18,19,31,30,24,27,28,23,26,29',@inputDate='2020-06-16 06:33:30',@companyID=7,
...
CREATE PROCEDURE [dbo].[P_GetEOD_OPS_Meraki_Kora] 
(
	 @thirdPartyID INT
...
Select T1.*,IsNull(T2.RemainingQty,0) As RemainingQty
From #TempEOD T1
Left Outer Join #TempParentDetails T2 On T2.Symbol = T1.Symbol
Order By OrderByCol, AccountName, Symbol

Drop Table #TempEOD, #TempParentDetails
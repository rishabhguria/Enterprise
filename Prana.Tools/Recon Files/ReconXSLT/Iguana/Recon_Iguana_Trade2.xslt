  ...
  <xsl:template name="ConvertBBCodetoTicker">
    ...
    <xsl:variable name="varMonthCode">
      <xsl:call-template name="MonthCode">
        <xsl:with-param name="varMonth" select="substring(substring-after($varBBCode,' '),1,2)"/>
  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select="//Comparision">
        <xsl:if test="number(COL42) and COL86 != 'Cash and Equivalents'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PB_Symbol" select="COL78"/>
            ...
            <Symbol>
              <xsl:choose>
                ...
                <xsl:when test="COL86 = 'Puts' or COL86 = 'Calls'">
                  <xsl:call-template name="ConvertBBCodetoTicker">
                    <xsl:with-param name="varBBCode" select="COL78"/>
                  </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="COL78"/>
                </xsl:otherwise>
              </xsl:choose>
            </Symbol>

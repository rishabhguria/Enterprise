			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number($Position) and normalize-space(COL6) != 'NON-TRADE ACTIVITY' and COL8!='USD'">
				  ...
				  <xsl:value-of select="document('../ReconMappingXml/StrategyMapping.xml')/StrategyMapping/PB[@Name=$varPBName]/StrategyData[@PranaFundName=$PRANA_FUND_NAME]/@PranaStrategy"/>
						...
						<xsl:variable name="varPositionSettlementDate">
							<xsl:call-template name="FormatDate">
								<xsl:with-param name="Date" select="COL10"/>
							</xsl:call-template>
						</xsl:variable>
				  ...
				  <xsl:value-of select ="$PRANA_STRATEGY_NAME"/>
						...
						<xsl:variable name="Currency" select="COL4"/>

						<xsl:variable name="PRANA_CURRENCY_CODE">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXml/CurrencyMapping.xml')/CurrencyMapping/PB[@Name=$varPBName]/CurrencyData[@CurrencyName=$Currency]/@CurrencyCode"/>
						</xsl:variable>
						...
						<xsl:variable name ="Bloomberg">
							<xsl:choose>
								...
								<xsl:when test="string-length(COL8) = 21">
									<xsl:value-of select="concat(substring-before(COL8,' '),' ',substring(substring-after(normalize-space(COL8),' '),3,2),'/',substring(substring-after(normalize-space(COL8),' '),5,2),'/',substring(substring-after(normalize-space(COL8),' '),1,2),' ',substring(substring-after(normalize-space(COL8),' '),7,1),format-number((substring(substring-after(normalize-space(COL8),' '),8) div 1000),'#.##'),' ',$PRANA_CURRENCY_CODE,' ','EQUITY')"/>
								</xsl:when>
						...
						<xsl:variable name="PRANA_SYMBOL_NAME_ISIN">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXML/SedolSymbolMapping.xml')/SymbolMapping/PB[@Name=$varPBName]/SymbolData[@SEDOL=$Sedol]/@ISIN"/>
						</xsl:variable>

						<xsl:variable name="PRANA_SYMBOL_NAME_CUSIP">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXML/SedolSymbolMapping.xml')/SymbolMapping/PB[@Name=$varPBName]/SymbolData[@SEDOL=$Sedol]/@CUSIP"/>
						</xsl:variable>


						<xsl:variable name="PRANA_SYMBOL_NAME_TICKER">
							<xsl:value-of select="document('../../../MappingFiles/ReconMappingXML/SedolSymbolMapping.xml')/SymbolMapping/PB[@Name=$varPBName]/SymbolData[@SEDOL=$Sedol]/@TICKER"/>
						</xsl:variable>
						...
						<Symbol>
							<xsl:choose>
								...
								<xsl:when test="$PRANA_SYMBOL_NAME_ISIN!=''">
									<xsl:value-of select="''"/>
								</xsl:when>
								<xsl:when test="$PRANA_SYMBOL_NAME_CUSIP!=''">
									<xsl:value-of select="''"/>

								</xsl:when>
								<xsl:when test="$PRANA_SYMBOL_NAME_TICKER!=''">
									<xsl:value-of select="''"/>
								</xsl:when>
								...
								<xsl:otherwise>
									<xsl:choose>
										<xsl:when test ="(COL4 = 'SO AFRICAN RAND' or COL4 = 'SINGAPORE DOLLAR' or COL4 = 'EURO' or COL4 = 'CANADIAN DOLLAR' or COL4 = 'SWISS FRANC' or COL4 = 'UK POUND STERLING') and COL4 != 'U S DOLLAR'">
											<xsl:value-of select ="''"/>
										</xsl:when>
						...
						<Bloomberg>
							<xsl:choose>
								...
								<xsl:when test="$PRANA_SYMBOL_NAME_TICKER!=''">
									<xsl:value-of select="$PRANA_SYMBOL_NAME_TICKER"/>
								</xsl:when>
								...
								<xsl:otherwise>
									<xsl:choose>
										<xsl:when test ="COL4 = 'SO AFRICAN RAND' or COL4 = 'EURO'  or COL4 = 'SINGAPORE DOLLAR' or COL4 = 'CANADIAN DOLLAR' or COL4 = 'SWISS FRANC' or COL4 = 'UK POUND STERLING'">
											<xsl:value-of select ="''"/>
										</xsl:when>
										<xsl:when test="COL4 = 'U S DOLLAR'">
											<xsl:value-of select="concat(COL8,' ','US',' ','EQUITY')"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="''"/>
										</xsl:otherwise>
						...
						<SEDOL>
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:choose>
										<xsl:when test ="COL4 = 'SO AFRICAN RAND' or COL4 = 'EURO' or COL4 = 'CANADIAN DOLLAR' or COL4 = 'SWISS FRANC' or COL4 = 'UK POUND STERLING' or COL4 = 'SINGAPORE DOLLAR'">
											<xsl:value-of select ="normalize-space(COL8)"/>
										</xsl:when>
										<xsl:when test="COL4 = 'U S DOLLAR'">
											<xsl:value-of select="''"/>
						...
						<CUSIP>
							<xsl:choose>
								...
								<xsl:when test="$PRANA_SYMBOL_NAME_CUSIP!=''">
									<xsl:value-of select="$PRANA_SYMBOL_NAME_CUSIP"/>
								</xsl:when>
								<xsl:when test="$PRANA_SYMBOL_NAME_TICKER!=''">
									<xsl:value-of select="''"/>
								</xsl:when>
								...
								<xsl:otherwise>
									<xsl:choose>
										<xsl:when test ="COL4 = 'SO AFRICAN RAND'  or COL4 = 'SINGAPORE DOLLAR' or COL4 = 'EURO' or COL4 = 'CANADIAN DOLLAR' or COL4 = 'SWISS FRANC' or COL4 = 'UK POUND STERLING'">
											<xsl:value-of select ="''"/>
										</xsl:when>
										<xsl:when test="COL4 = 'U S DOLLAR'">
											<xsl:value-of select="''"/>
						...
						<ISIN>
							<xsl:choose>
								...
								<xsl:when test="$PRANA_SYMBOL_NAME_ISIN!=''">
									<xsl:value-of select="$PRANA_SYMBOL_NAME_ISIN"/>
								</xsl:when>
								<xsl:when test="$PRANA_SYMBOL_NAME_CUSIP!=''">
									<xsl:value-of select="''"/>
						...
						<ExchangeCode>
							<xsl:choose>
								<xsl:when test="contains(COL4,'CANADIAN')">

  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and (contains(COL27,'Equities')='true' or contains(COL27,'Fixed')='true')">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="Costbasis">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="$COL10 div $Position"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:call-template name="Translate">
              <xsl:with-param name="Number" select="$COL14 div $COL10"/>
            </xsl:call-template>
            </xsl:variable>

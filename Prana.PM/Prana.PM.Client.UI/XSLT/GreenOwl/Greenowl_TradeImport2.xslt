	...
	<xsl:template name="Option">
		...
		<xsl:if test="contains(substring-after(substring-after(substring-after(substring-after(normalize-space(COL14),' '),' '),' '),' '),CALL) or contains(substring-after(substring-after(substring-after(substring-after(normalize-space(COL14),' '),' '),' '),' '),PUT) ">
			...
			<xsl:variable name="ExpiryDay">
				<xsl:value-of select="substring(substring-after(substring-after(normalize-space(COL14),' '),' '),1,2)"/>
			</xsl:variable>
			...
			<xsl:variable name="StrikePrice">
				...
				<!--<xsl:value-of select="format-number(substring-before(substring-after(substring-after(substring-after(normalize-space(COL14),' '),' '),' '),' '),'#.0')"/>-->
			</xsl:variable>

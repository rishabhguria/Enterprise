...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="substring(substring-after(normalize-space(COL2),' '),7,1)='P' or substring(substring-after(normalize-space(COL2),' '),7,1)='C'">
      ...
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-after(normalize-space(COL2),' '),8) div 1000,'#.00')"/>
      </xsl:variable>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="substring(substring-after(normalize-space(COL2),' '),7,1)='P' or substring(substring-after(normalize-space(COL2),' '),7,1)='C'">
          <PositionMaster>
            ...
            <PutOrCall>
              <xsl:choose>
                <xsl:when test="substring(substring-after(normalize-space(COL2),' '),7,1)='P'">
                  <xsl:value-of select="'0'"/>
                </xsl:when>
                <xsl:when test="substring(substring-after(normalize-space(COL2),' '),7,1)='C'">
            ...
            <IDCOOptionSymbol>
              <xsl:value-of select="concat($varOSI,'U')"/>
            </IDCOOptionSymbol>
            <AUECID>

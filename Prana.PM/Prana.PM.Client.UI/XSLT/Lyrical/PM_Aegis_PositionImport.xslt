        ...
        <xsl:if test="number(COL12) and COL9!='FCASH' and COL9!='FDUXX' and COL9!='FZFXX' and COL9!='FDRXX'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_SYMBOL_NAME">
              <xsl:value-of select="document('../ReconMappingXml/SymbolMapping.xml')/SymbolMapping/PB[@Name='Fidelity']/SymbolData[normalize-space(@PBCompanyName)=$PB_Symbol]/@PranaSymbol"/>
            </xsl:variable>

            <xsl:variable name="PB_CountnerParty" select="COL5"/>
            <xsl:variable name="PRANA_CounterPartyID">
              <xsl:value-of select="document('../ReconMappingXml/ExecBrokerMapping.xml')/BrokerMapping/PB[@Name= 'Fidelity']/BrokerData[@PranaBroker=$PB_CountnerParty]/@PranaBrokerCode"/>
            </xsl:variable>

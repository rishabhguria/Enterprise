        ...
        <xsl:if test="number($varNetPosition) and COL7 !='Cash'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varSymbol">
             <xsl:choose> 
               <xsl:when test="normalize-space(COL10)!=''"> 
            ...
            <xsl:variable name="varAssetType">
              <xsl:choose>
                ...
                <xsl:when test="normalize-space(COL7)='Bond'">
            ...
            <Symbol>
              <xsl:choose>
                ...
                <xsl:when test="$varCUSIP !='' and $varAssetType = 'FixedIncome'">
                  <xsl:value-of select="''"/>
                </xsl:when>
			...
			<xsl:variable name="varSide">
			 ...
			 <Side>
              <xsl:choose>
                ...
                <xsl:otherwise>
                   <xsl:choose>
                    <xsl:when test="$varSide = 'Buy' or $varSide = 'CoverShort'">
                      <xsl:value-of select="'Buy'"/>
                    </xsl:when>
                     <xsl:when test="$varSide = 'Sell' or $varSide = 'SellShort'">

...
[P_MW_GetNAVForEachFund_StartDate] '2014/07/11'   
'Growth and Income Fund:43001028,Income and Principal Preservation:43001030',1,'MTM_V0',1,1     
     
******************************************************************************/      
      
alter Proc [dbo].[P_MW_GetNAVForEachFund_StartDate]                        
(           
 @StartDate datetime,                                         
 @fund varchar(max),     
 @NAVFromPMorMW int,                      

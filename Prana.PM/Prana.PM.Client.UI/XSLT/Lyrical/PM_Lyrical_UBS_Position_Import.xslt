	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test ="$PRANA_FUND_NAME!='' and number($varQuantity) and (substring(COL1,8,6)!='919136' and substring(COL1,8,6)!='919446'and substring(COL1,8,6)!='919195'and substring(COL1,8,6)!='919101' and  substring(COL1,8,4)!='CASH') and substring(COL1,32,9) !='90265M102'  and substring(COL1,32,9) !='751990441'  and substring(COL1,32,9) !='90265L104'and substring(COL1,32,9) !='90262Y737'">

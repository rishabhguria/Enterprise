...
namespace Prana.Utilities.UI
{
    ...
    public class ToggleSwitch : Control
    {
        ...
        private bool _allowCheckChangedDuringLoad = false;
        ...
        [DefaultValue(true)]
        [Category("Behavior")]
        [Description("Gets or sets whether we need check changed event to be called during load")]
        public bool AllowCheckChangedDuringLoad
        {
            get { return _allowCheckChangedDuringLoad; }
            set { _allowCheckChangedDuringLoad = value; }
        }
        ...
        private void BeginAnimation(bool checkedValue)
        {
            ...
            if (_allowCheckChangedDuringLoad)
            {
        ...
        private void AnimationComplete()
        {
            ...
            if (AllowCheckChangedDuringLoad)
            {
        ...
        public void ClickOnToggleSwitch(bool isBloombergSymbology)
        {
            this.Checked = isBloombergSymbology;
        }
        #endregion
    }
}

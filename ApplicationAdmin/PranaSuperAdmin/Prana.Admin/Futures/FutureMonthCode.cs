...
namespace Nirvana.Admin
{
	...
	public class FutureMonthCode : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.grdFutureMonth.FlatMode = true;
		...
		{	
			...
			Nirvana.Admin.BLL.FutureMonthCode futureMonthCode = new Nirvana.Admin.BLL.FutureMonthCode();
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(grdFutureMonth.Rows.Count > 0)
				{
					...
					if(MessageBox.Show(this, "Do you want to delete this FutureMonth?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
					{

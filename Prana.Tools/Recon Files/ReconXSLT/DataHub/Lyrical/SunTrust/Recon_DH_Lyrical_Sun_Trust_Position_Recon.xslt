  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:variable name="Position" select="COL25"/>

        <xsl:choose>
          <xsl:when test="number($Position) and not(normalize-space(COL4)='CASH')">
            <PositionMaster>
              ...
              <Symbol>
                <xsl:choose>
                  ...
                  <xsl:when test="normalize-space(COL4)!='CASH'">
                    <xsl:value-of select="''"/>
                  </xsl:when>
              ...
              <xsl:variable name="Cusip" select="COL4"/>

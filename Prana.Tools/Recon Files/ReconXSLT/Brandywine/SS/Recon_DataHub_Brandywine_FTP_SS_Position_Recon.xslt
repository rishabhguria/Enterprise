				...
				<xsl:if test="number($Quantity)">
					<PositionMaster>
						...
						<xsl:variable name="PB_SYMBOL_NAME">
							<xsl:value-of select="substring(COL1,24,5)"/>
						</xsl:variable>
						...
						<xsl:variable name="PB_FUND_NAME" select="substring(COL1,9,9)"/>
						...
						<xsl:variable name="NetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,244,16)"/>
							</xsl:call-template>
						</xsl:variable>
						<NetNotionalValue>
							<xsl:choose>
						...
						<xsl:variable name="NetNotionalValueBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,608,16)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="varMarketValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,107,22)"/>
							</xsl:call-template>
						</xsl:variable>
						<MarketValue>
							<xsl:choose>

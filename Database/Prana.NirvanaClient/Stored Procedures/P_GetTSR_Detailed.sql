...
[P_GetTSR_Detailed] '2014-1-1','2014-4-30','TradeDate','1254,1270,1238,1267,1272','1,2,3,4,5,6,7,8'
***************************************************************/

                                                   
CREATE proc [dbo].[P_GetTSR_Detailed]                                                                                            
(
 @startDate datetime,                                                                                          
 @enddate datetime,                  
 @FetchDataOnBasisOf varchar(20),--ProcessData/TradeDate         
 @Fund varchar(max),                    
 @Asset varchar(max)                                                                                        
)                                                                                          
as                                                                                        
...
----------Fee && commission changes----------------------------------------------------------------------------        

isnull(VTL.Commission,0) as Commission,                                                      
isnull(VTL.OtherBrokerFees,0) as OtherBrokerFees,                  
isnull(VTL.StampDuty,0)+isnull(VTL.TransactionLevy,0)+isnull(VTL.ClearingFee,0)+isnull(VTL.TaxOnCommissions,0)+isnull(VTL.MiscFees,0) as OtherFees,      
    
-----------------------------------    
isnull(VTL.SoftCommission,0) as SoftCommission,                                                                                         
isnull(VTL.SECFee,0) as SECFee,    
isnull(VTL.ORFFee,0) as ORFFee,    
isnull(VTL.OCCFee,0) as OCCFee,    
...
LEFT OUTER JOIN V_SecMasterData as SM on VTL.Symbol=SM.TickerSymbol                                                          

  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select="//PositionMaster">
        <xsl:if test ="COL2 = 'PRINCIPAL CASH'">
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_FUND_NAME">
              <xsl:value-of select="document('../ReconMappingXml/FundMapping.xml')/AccountMapping/PB[@Name='MarkStone']/AccountData[@PBAccountName=$PB_FUND_NAME]/@PranaAccount"/>
            </xsl:variable>

...
>
	...
	<xsl:template name="Option">
		...
		<xsl:if test="COL3='Equity Option'">
			<!--<xsl:if test="contains(substring-before(substring-after(substring-after(COL9,' '),' '),' '),'P') or contains(substring-before(substring-after(substring-after(COL9,' '),' '),' '),'C')">-->
			...
			<xsl:variable name="ExpiryYear">
				<xsl:value-of select="substring(substring-before(substring-after(COL9,' '),'-'),3,2)"/>
			</xsl:variable>

			<xsl:variable name="PutORCall">
				<xsl:value-of select="substring(substring-before(substring-after(substring-after(substring-after(COL9,' '),' '),' '),' '),1)"/>
			</xsl:variable>
			<xsl:variable name="StrikePrice">
				<xsl:value-of select="format-number(substring-before(substring-after(substring-after(normalize-space(COL9),' '),' '),' '),'#.00')"/>
			</xsl:variable>
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="contains(COL153,'C') or contains(COL153,'P')">

  ...
  <xsl:template match="/">
    <Groups>
      ...
      <!-- looping trough all the records...                         -->
		<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[AccountName !='F1446160 – AirT' and AccountName !='MHX000217 – AirT' and AccountName !='AXT000082 – AirT' and AccountName !='T6A017165 – AirT' and AccountName !='U1459812 – SAIC' and AccountName !='U1460034 – SAIC' and AccountName !='T6A016076 – SAIC' and AccountName!='Rebal Risk Analysis']">
    ...
    <xsl:variable name="varFeeValue2">
 	...
 	<xsl:variable name ="varAllocationState">
	  ...
	  <Group 
			  ...
			  Broker="{$varCounterParty}" Custodian="GSCO" TransactionType="{$varTransactionType}" CurrencyCode="{SettlCurrency}"

...
namespace FinnhubAdapter
{
    public class FinnhubProvider : ILiveFeedProvider
    {
        /// <summary>
        /// The URL
        /// </summary>
        private const string URLSTART = "https://finnhub.io/api/v1/quote?symbol=";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FinnhubProvider"/> class.
        /// </summary>
        private void Initialize()
        {
            #region Configs
            //Read Finnhub specific config file
            ...
            pricingSourceCol.DefaultValue = "Finnhub";
        ...
        private DataTable GetLiveFeedData(Dictionary<string, string> openSymbols)
        {
            ...
            foreach (KeyValuePair<string, string> kvp in openSymbols)
            {
                try
                {
                    string json = new WebClient().DownloadString(URLSTART + kvp.Value + URLEND);

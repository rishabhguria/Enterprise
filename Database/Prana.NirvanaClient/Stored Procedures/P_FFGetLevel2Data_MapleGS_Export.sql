CREATE PROCEDURE [dbo].[P_FFGetLevel2Data_MapleGS_Export]                                                                                                                                                   
(                                                                                                                                                                  
 @thirdPartyID int,                                                                                                                                                                  
...
T_PBWiseTaxlotState.TaxlotState  as  TaxlotStateID,         
 ...
 T_PBWiseTaxlotState.TaxlotFIXState,         
           
 T_PBWiseTaxlotState.TaxlotFIXAckState,                                                   
...
VT.IsSwapped                                  
  ...
  from                                                             
    V_TaxLots VT                                                                                       
    Left Outer Join T_PBWiseTaxlotState on T_PBWiseTaxlotState.TaxlotID=VT.TaxlotID  and (@fileFormatID = FileFormatID or FileFormatID = 0)                                                

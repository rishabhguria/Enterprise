...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:variable name="varMonth" select="substring-before(substring-after(substring-after(//PositionMaster[contains(COL1,'As of Date')]/COL1, ':'),' '),' ')"/>
			<xsl:variable name="varDay" select="substring-before(substring-after(substring-after(substring-after(//PositionMaster[contains(COL1,'As of Date')]/COL1, ':'),' '),' '),' ')"/>
			<xsl:variable name="varYear" select="substring-after(substring-after(substring-after(substring-after(//PositionMaster[contains(COL1,'As of Date')]/COL1, ':'),' '),' '),' ')"/>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test ="number($Position)">
					<PositionMaster>
						...
						<xsl:variable name="varMonthTemplate">
							<xsl:call-template name="MonthName">
								<xsl:with-param name="Month" select="$varMonth"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="varDate">
							<xsl:value-of select="concat($varMonthTemplate,'/',$varDay,'/',$varYear)"/>							
						</xsl:variable>

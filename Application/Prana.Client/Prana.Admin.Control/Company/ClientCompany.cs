...
namespace Nirvana.Admin.Controls
{
	...
	public class ClientCompany : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.gpbDetails.Size = new System.Drawing.Size(336, 168);
			...
			this.label9.Location = new System.Drawing.Point(118, 90);
			...
			this.gpbSecondaryContact.Location = new System.Drawing.Point(342, 2);
			this.gpbSecondaryContact.Name = "gpbSecondaryContact";
			this.gpbSecondaryContact.Size = new System.Drawing.Size(336, 168);
			...
			this.label30.Location = new System.Drawing.Point(8, 93);
			...
			this.label31.Location = new System.Drawing.Point(8, 117);
			...
			this.label34.Location = new System.Drawing.Point(8, 45);
			...
			this.gpbPrimaryContact.Location = new System.Drawing.Point(2, 170);
			this.gpbPrimaryContact.Name = "gpbPrimaryContact";
			this.gpbPrimaryContact.Size = new System.Drawing.Size(336, 168);
			...
			this.txtPC1FirstName.TabIndex = 12;
			...
			this.label11.Location = new System.Drawing.Point(118, 260);
		...
		private CompanyClient GetCompanyClient()
		{
			...
			errorProvider1.SetError(txtPC1LastName, "");
			errorProvider1.SetError(txtPC1Email, "");
			if (txtCompanyName.Text == "")
			{
				errorProvider1.SetError(txtCompanyName, "Please enter Client Company name!");
			...
			{
				errorProvider1.SetError(txtPC1LastName, "Please enter Primary Contact Last name!");
				txtPC1LastName.Focus();
				companyClient = null;
			}
			else if (txtPC1Email.Text == "")
			{
				errorProvider1.SetError(txtPC1Email, "Please enter Primary contact Email in details!");
				txtPC1Email.Focus();
				companyClient = null;
			}
			else
		...
		public int CompanyClientSave(CompanyClient companyClient)
		{
			...
			if (txtCompanyName.Text == "")
			{
				...
				Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Please enter Client Company name!");
				txtCompanyName.Focus();
			}
			else if (txtAddress1.Text == "")
			{
				Nirvana.Admin.Utility.Common.ResetStatusPanel(_statusBar);
				Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Please enter Address 1 in details!");
			...
			{
				Nirvana.Admin.Utility.Common.ResetStatusPanel(_statusBar);
				Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Please select Company Type!");
				cmbCompanyTYpe.Focus();
			}
			else if (txtPC1LastName.Text == "")
			{
				Nirvana.Admin.Utility.Common.ResetStatusPanel(_statusBar);
				Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Please enter Primary contact First name in details!");
				txtAddress1.Focus();
			}
			else if (txtPC1Email.Text == "")
			{
				Nirvana.Admin.Utility.Common.ResetStatusPanel(_statusBar);
				Nirvana.Admin.Utility.Common.SetStatusPanel(_statusBar, "Please enter Primary contact Email in details!");
				txtPC1Email.Focus();
			}
			else
			{

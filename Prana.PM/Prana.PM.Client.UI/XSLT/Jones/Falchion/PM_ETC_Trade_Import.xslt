				...
				<xsl:if test="number($NetPosition)">
					...
					<PositionMaster>
						...
						<xsl:variable name="varSecFees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$CostBasis * $NetPosition *.0000231"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="varOrfFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$CostBasis * $NetPosition *.378"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="($NetPosition *$CostBasis )+ $varSecFees + $varOrfFee + COL22"/>
							</xsl:call-template>
						</xsl:variable>

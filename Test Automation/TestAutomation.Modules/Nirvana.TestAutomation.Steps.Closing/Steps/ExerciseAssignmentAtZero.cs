...
{
    class ExerciseAssignmentAtZero : ExerciseTradesTab, ITestStep
    {
        ...
        /// </summary>
        private void ExerciseAssignmentMenuClick()
        {
            try
            {
                GrdAccountUnexpired.Click(MouseButtons.Right);
                ExerciseDivideAssignmentatZero.Click(MouseButtons.Left);
            }
            catch (Exception ex)
            {

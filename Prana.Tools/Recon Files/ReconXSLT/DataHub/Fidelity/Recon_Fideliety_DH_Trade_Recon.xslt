          ...
          <xsl:when test="number($Quantity)">
            <PositionMaster>
              ...
              <xsl:variable name="varSEDOL">
                <xsl:value-of select="normalize-space(substring(COL1,1262,7))"/>
              </xsl:variable>
              ...
              <xsl:variable name="AvgPrice">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="substring(COL1,261,6)"/>
                </xsl:call-template>
              </xsl:variable>
              <AvgPX>
                <xsl:choose>
              ...
              <xsl:variable name="Commission">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="substring(COL1,1303,18) div 10000"/>
                </xsl:call-template>
              </xsl:variable>
				<xsl:variable name="varCommission">
					<xsl:choose>
						<xsl:when test="substring(COL1,1280,3) !='USD'">
              ...
              <AUECFee2>
				...
				<xsl:variable name="varStampDuty">
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="substring(COL1,1284,18) div 10000"/>
					</xsl:call-template>
				</xsl:variable>
              ...
              <xsl:variable name="TotalCommissionandFees">
				...
				<xsl:variable name="varTotalCommissionandFees">
					<xsl:choose>
						<xsl:when test="substring(COL1,1280,3) !='USD'">
							<xsl:value-of select="($varCommission + $StampDuty)"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="''"/>
						</xsl:otherwise>

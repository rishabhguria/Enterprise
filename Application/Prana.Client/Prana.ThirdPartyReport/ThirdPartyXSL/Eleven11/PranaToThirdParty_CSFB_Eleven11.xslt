				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:if test="Asset='EquityOption'">
						<xsl:choose>
							...
							<xsl:when test="Side='SellShort' or Side='Sell to Open' ">
								<Buy_Sell_Sht_Cvr>
					...
					<xsl:if test ="Asset !='EquityOption'">
						<xsl:choose>
							...
							<xsl:when test="Asset != 'EquityOption' and Side='Sell short' or  Side='Sell to Open' ">
								<Buy_Sell_Sht_Cvr>
					...
					<AccountNumber>
						<xsl:value-of select="'700000'"/>
					</AccountNumber>

					
					<xsl:if test ="Asset = 'Equity'">
						<xsl:choose>
							<xsl:when test=" Side='Buy to Cover' or Side='Buy to Close' or Side='Sell short' or Side='Sell to Open'">
								<AccountType>
					...
					<!--put strike price for future otpions.-->
					<xsl:choose>
						<xsl:when test ="Asset = 'FutureOption'">
							<Rate>

...
namespace Nirvana.Admin
{
	...
	public class HandlingInstruction : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(HandlingInstruction));
			...
			this.txtHandlingInstructionTagValue.Text = "";
			...
			this.txtHandlingInstruction.Text = "";
			...
			this.grdHandlingInstructions.FlatMode = true;
		...
		{	
			...
			Nirvana.Admin.BLL.HandlingInstruction handlingInstruction = new Nirvana.Admin.BLL.HandlingInstruction();
			...
			{
				errorProvider1.SetError(btnSave, "HandlingInstruction Already Exists");
			}
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(grdHandlingInstructions.Rows.Count > 0)
				{
					...
					if(MessageBox.Show(this, "Do you want to delete this HandlingInstruction?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
					{
						...
						bool chkVarraible = OrderManager.DeleteHandlingInstruction(handlingInstructionID, false);
						if(!(chkVarraible))
						{

				...
				<xsl:if test="number($Position)">
					<PositionMaster>
						...
						<xsl:variable name="PB_NAME">
							<xsl:value-of select="'19 Capital'"/>
						</xsl:variable>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$Position * 0.005"/>
							</xsl:call-template>
						</xsl:variable>
						<Commission>
							<xsl:choose>
						...
						<xsl:variable name="PB_BROKER_NAME">
							<xsl:value-of select="translate(COL6,$vLowercaseChars_CONST,$vUppercaseChars_CONST)"/>
						</xsl:variable>

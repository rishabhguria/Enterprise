      ...
      <xsl:for-each select="//Comparision">
        <xsl:variable name="varDividend">
          <xsl:call-template name="Translate">
            <xsl:with-param name="Number" select="CO17"/>
          </xsl:call-template>
        </xsl:variable>
        <xsl:choose>
          <xsl:when test="number($varDividend)">
            <PositionMaster>
              ...
              <xsl:variable name="PB_Symbol" select="normalize-space(COL15)"/>
              ...
              <xsl:variable name="varDividendLocal">
                <xsl:call-template name="Translate">
                  <xsl:with-param name="Number" select="COL28 + COL42"/>
                </xsl:call-template>
              </xsl:variable>
              <DividendLocal>
                <xsl:choose>
              ...
              <xsl:variable name="Gross_Dividend">
                <xsl:choose>
                  <xsl:when test="COL18='DividendExpense' or COL18='DividendIncome'">

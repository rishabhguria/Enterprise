  ...
  <xsl:template match="/DocumentElement">
    <DocumentElement>
      <xsl:for-each select="//Comparision">
        ...
        <xsl:if test ="$varInstrument='0' or $varInstrument='1' or $varInstrument='B' or $varInstrument='BL' or $varInstrument='J'">
          ...
          <PositionMaster>
            ...
            <xsl:choose>
              ...
              <xsl:when test ="$varInstrument='1' or $varInstrument = '0'">
                <Symbol>

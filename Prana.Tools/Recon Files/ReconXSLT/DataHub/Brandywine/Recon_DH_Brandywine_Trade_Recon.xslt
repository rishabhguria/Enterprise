  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity) and COL6='PURCHASE' or COL6='SALE'">
            <PositionMaster>
              ...
              <xsl:variable name="PRANA_SUFFIX_NAME">
                <xsl:value-of select="document('../../ReconMappingXML/SymbolSuffixMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME]/SymbolData[@PBSuffixCode=$PB_SYMBOL_NAME]/@PranaSuffixCode"/>
              </xsl:variable>
              ...
              <xsl:variable name="SettleDate" select="COL11"/>

				...
				<xsl:if test="number($Quantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="COL4='Option - Index'">
									<xsl:value-of select="'EquityOption'"/>
								</xsl:when>
								<xsl:when test="COL4='Option - Commodity Future'">
						...
						<xsl:variable name="VarFutureUnder">
							<xsl:value-of select="substring(substring-before(COL5,' '),1,2)"/>
						</xsl:variable>

						<xsl:variable name="VarFutureMonthCode">
							<xsl:value-of select="substring(substring-before(COL5,' '),3)"/>
						</xsl:variable>

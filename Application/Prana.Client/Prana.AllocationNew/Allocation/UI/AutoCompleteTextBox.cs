...
namespace Prana.AllocationNew
{
    public class AutoCompleteTextBox : TextBox
    {
        ...
        /// <summary>
        /// Initializes new instance of Class and assign _listBox to Containing Form
        /// </summary>
        /// <param name="frm">Container that contains parent form</param>
        public AutoCompleteTextBox(Form frm)
        {
        ...
        /// <summary>
        /// intializes the components and adds the event handlers
        /// </summary>
        /// <param name="frm"></param>
        private void InitializeComponent(Form frm)
        {
            try
            {
        ...
        private void ShowListBox()
        {
            try
            {
                ...
                {
                    _listBox.Location = new Point(this.Location.X + this.Parent.Location.X + this.Parent.Parent.Location.X + 4, this.Location.Y + this.Parent.Location.Y + this.Parent.Parent.Location.Y + this.Height + this.Height + 5);
                }
                else
                {
                    _listBox.Location = new Point(this.Location.X + this.Parent.Location.X + this.Parent.Parent.Location.X, this.Location.Y + this.Parent.Location.Y + this.Parent.Parent.Location.Y + this.Height);
                }
                //_isAdded = true;

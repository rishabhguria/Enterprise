...
namespace Nirvana.Admin
{
	...
	{
		private const string FORM_NAME = "CounterPartyType : ";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CounterPartyType));
			...
			this.groupBox1.Location = new System.Drawing.Point(58, 182);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(228, 46);
			this.groupBox1.TabIndex = 72;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Add/Update CounterPartyType";
			...
			this.btnEdit.Location = new System.Drawing.Point(97, 156);
			...
			this.btnClose.Location = new System.Drawing.Point(211, 230);
			...
			this.grdCounterPartyType.FlatMode = true;
			...
			this.grdCounterPartyType.Size = new System.Drawing.Size(327, 154);
		...
		{	
			...
			Nirvana.Admin.BLL.CounterPartyType counterPartyType = new Nirvana.Admin.BLL.CounterPartyType();
			...
			{
				errorProvider1.SetError(btnSave, "CounterPartyType Already Exists");
			}
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(grdCounterPartyType.Rows.Count > 0)
				{
					...
					if(MessageBox.Show(this, "Do you want to delete this CounterParty Type?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
					{
						...
						bool chkVarraible = CounterPartyManager.DeleteCounterPartyType(counterPartyTypeID, false);
						if(!(chkVarraible))
						{
							MessageBox.Show(this, "CounterParty Type is referenced in CounterParty.\n Please remove references first to delete it.", "Nirvana Alert");
						}
						else
						{
							BindCounterPartyTypeGrid();

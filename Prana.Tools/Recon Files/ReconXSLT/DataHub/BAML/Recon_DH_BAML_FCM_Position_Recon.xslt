					...
					<xsl:when test="number($Quantity)">
						<PositionMaster>
							...
							<xsl:variable name="Asset">
								<xsl:choose>
									<xsl:when test="COL64 ='Option' and string-length(COL66) &gt; 20">
									...
									<xsl:when test="COL64 ='Swap'">
										<xsl:value-of select="'EquitySwap'"/>
									</xsl:when>
									<xsl:when test="COL64 ='ForwardFX'">
							...
							<xsl:variable name="Symbol" select="normalize-space(COL37)"/>
							<Symbol>
								<xsl:choose>
							...
							<!--<SEDOL>
								<xsl:value-of select="COL88"/>
							</SEDOL>

							<ISIN>
								<xsl:value-of select="COL89"/>
							</ISIN>-->
							...
							<MarketValue>
								<xsl:choose>
									...
									<xsl:when test="number($MarketValue) and COL5='2'">
										<xsl:value-of select="$MarketValue "/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="0"/>

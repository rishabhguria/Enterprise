...
namespace Prana.BusinessObjects
{
    ...
    public class VolatilityImport : BusinessBase<VolatilityImport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VolatilityImport"/> class.
        /// </summary>
        public VolatilityImport()
        {
        }
        ...
        /// <summary>
        /// The _volatility price
        /// </summary>
        private double _volatilityPrice = 0;
        ...
        {
            get { return _volatilityPrice; }
            set { _volatilityPrice = value; }
        }
        ...
        public class CustomRules : RuleArgs
        {
            ...
            public static void CheckValidationOnAllFileds(VolatilityImport finalTarget)
            {
            ...
            {
                VolatilityImport finalTarget = target as VolatilityImport;
                if (finalTarget != null)
                {

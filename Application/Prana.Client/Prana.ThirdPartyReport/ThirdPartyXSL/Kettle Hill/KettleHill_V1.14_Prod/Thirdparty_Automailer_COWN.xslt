...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/NewDataSet">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty='COWN']">
				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="PB_NAME" select="'COWN'"/>
					...
					<xsl:variable name="VarComm">
						<xsl:choose>
							...
							<xsl:when test="$varFXRate!=0 and FXConversionMethodOperator='M'">
								<xsl:value-of select="format-number($varCommissions * $varFXRate,'##.00')"/>
							</xsl:when>

							<xsl:when test="$varFXRate!=0 and FXConversionMethodOperator='D'">
								<xsl:value-of select="format-number($varCommissions div $varFXRate,'##.00')"/>
							</xsl:when>

...
*/              
CREATE PROCEDURE [dbo].[P_GetTransactions_KLDS_MS_Trade] (              
...
BEGIN              
 ...
 CREATE TABLE #SecMasterDataTempTable (              
  ...
  ,LeadCurrencyID INT              
  ,VsCurrencyID INT              
  ,CurrencyID INT            ,UnderlyingSymbol VARCHAR(100)              
 ...
 INNER JOIN T_currency CUR ON CUR.CurrencyID = VT.CurrencyID -- Left outer join  T_SwapParameters SW on VT.GroupID=SW.GroupID                                                                                                                              

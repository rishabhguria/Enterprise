...
{
    internal class EquityActivityGenerator : TradingActivityGenerator
    {
        /// <summary>
                ...
                switch (CashTransactionSource)
                {
                    ...
                    case CashTransactionType.TradeImport:
                        ...
                        if (t.LongOrShort.Equals(PositionTag.Long))
                        {
                            ...
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapLongAddition.ToString() : Activities.EquityLongAddition.ToString());
                            }
                            else if (t.TransactionType == Convert.ToString(TradingTransactionType.LongWithdrawal))
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapLongWithdrawal.ToString() : Activities.EquityLongWithdrawal.ToString());
                            }
                            else
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapL.ToString() : Activities.EquityL.ToString());
                            }
                        }
                        else
                        {
                            ...
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapShortAddition.ToString() : Activities.EquityShortAddition.ToString());
                            }
                            else if (t.TransactionType == Convert.ToString(TradingTransactionType.ShortWithdrawal))
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapShortWithdrawal.ToString() : Activities.EquityShortWithdrawal.ToString());
                            }
                            else
                            {
                                cashActivity.ActivityType = CachedDataManager.GetActivityTypeWithAcronym(t.ISSwap ? Activities.EquitySwapS.ToString() : Activities.EquityS.ToString());
                            }
                        }

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="Option">
		...
		<xsl:if test="normalize-space(COL9)='501' or normalize-space(COL9)='601'">
			...
			<xsl:variable name="ExpiryDay">
				<xsl:value-of select="substring(substring-after($Symbol,' '),7,2)"/>
			</xsl:variable>
			...
			<xsl:variable name="PutORCall">
				<xsl:value-of select="substring(substring-after($Symbol,' '),9,1)"/>
			</xsl:variable>
			<xsl:variable name="StrikePrice">
				<xsl:value-of select="format-number(substring-after(substring-after($Symbol,' '),' '),'#.00')"/>
			</xsl:variable>
			...
			<xsl:choose>
				<xsl:when test="$ExpiryMonth='01' and $ExpiryYear='15'">
					<xsl:choose>
					...
					<PositionMaster>
						...
						<xsl:variable name="AssetType">
							<xsl:choose>
								...
								<xsl:when test="normalize-space(COL9)='501' or normalize-space(COL9)='601'">

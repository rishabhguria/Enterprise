<?xml version="1.0" encoding="UTF-8"?>
								<!--Description - Jef EOD file 
								 Date Created - 02-10-2012(mm-DD-YYYY) -->
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
				...
				<Unitscurr1>
					<xsl:value-of select="'Unitscurr1'" />
				</Unitscurr1>
				
				<Unitscurr2>
					<xsl:value-of select ="'Unitscurr2'"/>
				</Unitscurr2>
				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:choose>
						<xsl:when test ="Asset='FXForward'">
							<xsl:choose>
								<xsl:when test="Side='Buy' or Side='Buy to Open' or Side='Buy to Close'">
									<!-- Currency1 - the currency being bought or sold.-->
									<Currency1>
										<xsl:value-of select ="LeadCurrencyName"/>
									</Currency1>
									<!-- Currency2 – the currency on the other side of the trade.-->
									<Currency2>
										<xsl:value-of select ="VsCurrencyName"/>
									</Currency2>
									<!-- Unitscurr1 – how much of Currency1 is being bought or sold.-->
									<Unitscurr1>
										<xsl:value-of select ="AllocatedQty"/>
									</Unitscurr1>
									<!-- Unitscurr2 – how much of Currency2 will be exchanged for Currency1.-->
									<Unitscurr2>
										<xsl:value-of select='format-number(AllocatedQty * AveragePrice, "#.00")' />
									</Unitscurr2>
									<!-- ValueDate – the date the contract will expire (separate from Expiry Date field).-->
									<ValueDate>
										<xsl:value-of select="$varExpiry" />
									</ValueDate>
								</xsl:when>

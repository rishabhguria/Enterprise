  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and contains(COL4,'O:')">

          <PositionMaster>


            <xsl:variable name="PB_NAME">
              <xsl:value-of select="'Resonate'"/>
            </xsl:variable>
            ...
            <xsl:variable name="ExpiryMonth">
              <xsl:value-of select="substring-after(substring-before(COL3,'/'),' ')"/>
            </xsl:variable>
            ...
            <xsl:variable name="PutORCall">
              <xsl:value-of select="substring(substring-after(substring-after(substring-after(COL3,'/'),'/'),' '),1,1)"/>
            </xsl:variable>
            <xsl:variable name="StrikePrice">
              <xsl:value-of select="format-number((substring(substring-after(substring-after(substring-after(COL3,'/'),'/'),' '),2,4) ),'#.00')"/>
            </xsl:variable>

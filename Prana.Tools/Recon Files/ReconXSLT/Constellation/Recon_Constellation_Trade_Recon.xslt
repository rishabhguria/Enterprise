        ...
        <xsl:if test="number($Quantity) ">
          <PositionMaster>
            ...
            <xsl:variable name="varAvgPrice">
              <xsl:choose>
                <xsl:when test="COL2='OPEN'">
                  <xsl:value-of select="COL12"/>
                </xsl:when>
                <xsl:when test="COL2='UNWIND'">
            ...
            <xsl:variable name="AvgPrice">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="$varAvgPrice"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="NetNotionalValue">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="$varNetNotional"/>
              </xsl:call-template>
            </xsl:variable>
            <NetNotionalValue>
              <xsl:choose>
            ...
            <xsl:variable name ="varSide1" select="COL2"/>
            <xsl:variable name ="varSide2" select="COL3"/>
            <Side>
              <xsl:choose>
                <xsl:when test="$varSide1='OPEN' and $varSide2='SHORT'">
                  <xsl:value-of select="'Sell short'"/>
                </xsl:when>
                <xsl:when test="$varSide1='OPEN' and $varSide2='LONG'">
                  <xsl:value-of select="'Buy'"/>
                </xsl:when>
                <xsl:when test="$varSide1='UNWIND' and $varSide2='SHORT'">
                  <xsl:value-of select="'Buy to Close'"/>
                </xsl:when>
                <xsl:when test="$varSide1='UNWIND' and $varSide2='LONG'">

...
<!--BA 07072023 C 212.5-->
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="StrikePrice1">
      <xsl:value-of select="format-number(substring-after(substring-after(substring-after(normalize-space(COL3),' '),' '),' '),'##.00')"/>
    </xsl:variable>
    ...
    <xsl:value-of select="concat('O:',$UnderlyingSymbol,' ',$ExpiryYear,$MonthCodeVar,$StrikePrice1,'D',$Day)"/>
  </xsl:template>
          ...
          <PositionMaster>
           ...
           <xsl:variable name="PutORCall">
            ...
            <xsl:variable name="varAssetType">
              <xsl:choose>
                <xsl:when test="$PutORCall = 'P' or $PutORCall = 'C'">
            ...
            <xsl:variable name="varActivtyType">
            ...
            <SideTagValue>
              <xsl:choose>
                <xsl:when test="$varAssetType='EquityOption'">
                  <xsl:choose>
                    <xsl:when test="$varSide='SELL'and $varActivtyType='SHORT'">
                      <xsl:value-of select="'C'"/>
                    </xsl:when>
                    <xsl:when test="$varSide='BUY' and $varActivtyType='SHORT'">
                      <xsl:value-of select="'B'"/>
                    </xsl:when>

                    <xsl:when test="$varSide='BUY' and $varActivtyType='MARGIN'">
                      <xsl:value-of select="'A'"/>
                    </xsl:when>

                    <xsl:when test="$varSide='SELL' and $varActivtyType='MARGIN'">
                      <xsl:value-of select="'D'"/>
                    </xsl:when>
            ...
            <TransactionType>
              <xsl:choose>
                <xsl:when test="contains(COL5,'OPT ASSIGNED')">
            ...
            <!-- <CostBasis> -->
              <!-- <xsl:choose> -->
                <!-- <xsl:when test="$varAssetType='EquityOption'"> -->
                  <!-- <xsl:choose> -->
                    <!-- <xsl:when test="$varPrice &gt; 0"> -->
                      <!-- <xsl:value-of select="($varPrice div $varNetPosition) div 100"/> -->
                    <!-- </xsl:when> -->
                    <!-- <xsl:when test="$varNetPosition &lt; 0"> -->
                      <!-- <xsl:value-of select="(($varPrice div $varNetPosition) div 100) * (-1)"/> -->
                    <!-- </xsl:when> -->
                    <!-- <xsl:otherwise> -->
                      <!-- <xsl:value-of select="0"/> -->
                    <!-- </xsl:otherwise> -->
                ...
                <!-- <xsl:otherwise> -->
                  <!-- <xsl:choose> -->
                    <!-- <xsl:when test="$varPrice &gt; 0"> -->
                      <!-- <xsl:value-of select="($varPrice div $varNetPosition)"/> -->
                    <!-- </xsl:when> -->
                    <!-- <xsl:when test="$varPrice &lt; 0"> -->
                      <!-- <xsl:value-of select="($varPrice div $varNetPosition) * (-1)"/> -->
                    <!-- </xsl:when> -->
                    <!-- <xsl:otherwise> -->
                      <!-- <xsl:value-of select="0"/> -->
                    <!-- </xsl:otherwise> -->

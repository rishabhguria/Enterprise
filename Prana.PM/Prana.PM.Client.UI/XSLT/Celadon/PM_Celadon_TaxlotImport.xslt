...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="ExpiryYear">
      <xsl:value-of select="substring(normalize-space(translate($Symbol,translate($Symbol, '0123456789.', ''), '')),1,2)"/>
    </xsl:variable>
    <xsl:variable name="PutORCall">
      <xsl:value-of select="substring(translate($Symbol,'0123456789.',''),$var,1)"/>
    </xsl:variable>
	
	<xsl:variable name ="varStrikePriceInt">
				<xsl:value-of select ="format-number(substring(translate($Symbol,translate($Symbol, '0123456789.', ''), ''),7,5),'##')"/>
	</xsl:variable>

	<xsl:variable name ="varStrikePriceDec">
				<xsl:value-of select ="format-number(substring(translate($Symbol,translate($Symbol, '0123456789.', ''), ''),12,5),'##')"/>
	</xsl:variable>
	...
	<xsl:template match="/">
		...
		<DocumentElement>
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of select ="$PB_FUND_NAME"/>
						...
						<xsl:variable name="Side" select="COL20"/>
						...
						<!--<DayCount>
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="'COL64'"/>
							</xsl:call-template>
						</DayCount>-->
            ...
            <xsl:variable name="varMonth">
              <xsl:value-of select="substring(COL6,4,2)"/>
            </xsl:variable>

            <xsl:variable name="varYear">
              <xsl:value-of select="substring(COL6,7,4)"/>
            </xsl:variable>
            ...
            <OriginalPurchaseDate>
			  ...
			  <PositionStartDate>
             <xsl:value-of select="'05-21-2021'"/>
            </PositionStartDate>

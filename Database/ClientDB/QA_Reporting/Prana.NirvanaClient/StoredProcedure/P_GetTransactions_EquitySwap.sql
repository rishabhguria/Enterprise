...
*/      
CREATE PROCEDURE [dbo].[P_GetTransactions_EquitySwap] (      
...
T_Asset.AssetName END AS Asset    
 ...
 ,VT.TradeAttribute5      
  ...
  ,SM.IsCurrencyFuture      
  ,UDA.*      
  ,SettlCurrFxRate1.Val * (VT.Commission+VT.SoftCommission) AS SettlementCurrencyCommission      
 ...
 LEFT OUTER JOIN PM_DataSourceCompanyFund DSF        
  ON DSF.CompanyFundID = VT.FundID        

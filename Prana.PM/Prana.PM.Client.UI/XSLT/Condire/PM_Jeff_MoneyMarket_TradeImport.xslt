  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and normalize-space(COL22)='CASH' and normalize-space(COL21)='*' and normalize-space(COL24)=1">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varTDate">
              <xsl:choose>
                <xsl:when test="contains(COL9,'/')">
                  <xsl:choose>
                    <xsl:when test="string-length(substring-before(substring-after(normalize-space(COL9),'/'),'/'))=1">
            ...
            <xsl:variable name="varTMonth">
              <xsl:choose>
                <xsl:when test="contains(COL9,'/')">
                  <xsl:choose>
                    <xsl:when test="string-length(substring-before(normalize-space(COL9),'/'))=1">
            ...
            <PositionStartDate>
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of select="concat(substring-before(substring-after(normalize-space(COL9),'-'),'-'),'/',substring-after(substring-after(normalize-space(COL9),'-'),'-'),'/',substring-before(normalize-space(COL9),'-'))"/>
                </xsl:otherwise>
              </xsl:choose>
            </PositionStartDate>
            ...
            <xsl:variable name="varODate">
              <xsl:choose>
                <xsl:when test="contains(COL10,'/')">
                  <xsl:choose>
                    <xsl:when test="string-length(substring-before(substring-after(normalize-space(COL10),'/'),'/'))=1">
            ...
            <PositionSettlementDate>
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of select="concat(substring-before(substring-after(normalize-space(COL10),'-'),'-'),'/',substring-after(substring-after(normalize-space(COL10),'-'),'-'),'/',substring-before(normalize-space(COL10),'-'))"/>
                </xsl:otherwise>
              </xsl:choose>
            </PositionSettlementDate>

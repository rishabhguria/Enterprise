    ...
    public class ExecutionInstruction : System.Windows.Forms.Form
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (txtExecutionInstruction != null)
                {
                    txtExecutionInstruction.Dispose();
                }
                if (txtExecutionInstructionTagValue != null)
                {
                    txtExecutionInstructionTagValue.Dispose();
                }
                if (lblExecutionInstruction != null)
                {
                    lblExecutionInstruction.Dispose();
                }
                if (lblExecutionInstructionTagValue != null)
                {
                    lblExecutionInstructionTagValue.Dispose();
                }
                if (grdExecutionInstructions != null)
                {
                    grdExecutionInstructions.Dispose();
                }
                if (grpExecutionInstruction != null)
                {
                    grpExecutionInstruction.Dispose();
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ExecutionInstruction));
            ...
            this.grpExecutionInstruction.Controls.Add(this.label1);
            ...
            this.grpExecutionInstruction.Location = new System.Drawing.Point(43, 162);
            this.grpExecutionInstruction.Name = "grpExecutionInstruction";
            this.grpExecutionInstruction.Size = new System.Drawing.Size(264, 67);
            ...
            this.txtExecutionInstructionTagValue.Location = new System.Drawing.Point(79, 42);
            ...
            this.txtExecutionInstruction.Location = new System.Drawing.Point(79, 20);
            ...
            this.lblExecutionInstruction.Size = new System.Drawing.Size(38, 15);
            this.lblExecutionInstruction.TabIndex = 0;
            this.lblExecutionInstruction.Text = "Name";
            // 
            // label3
            // 
            ...
            this.grdExecutionInstructions.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
            ...
            this.grpExecutionInstruction.PerformLayout();
        ...
        private void BindExecutionInstructionsGrid()
        {
            ...
            {
                ExecutionInstructions nullExecutionInstuctions = new ExecutionInstructions();
                nullExecutionInstuctions.Add(new Prana.Admin.BLL.ExecutionInstruction(int.MinValue, "", ""));
                grdExecutionInstructions.DataSource = nullExecutionInstuctions;
            }
        }
        ...
        private int SaveExecutionInstruction()
        {
            ...
            errorProvider1.SetError(txtExecutionInstructionTagValue, "");
            errorProvider1.SetError(btnSave, "");

            int result = int.MinValue;

            Prana.Admin.BLL.ExecutionInstruction executionInstruction = new Prana.Admin.BLL.ExecutionInstruction();
            ...
            else if (txtExecutionInstructionTagValue.Text.Trim().Length == 0)
            {
                errorProvider1.SetError(txtExecutionInstructionTagValue, "Provide Value!");
                return result;
            }
            else
            {
            ...
            {
                MessageBox.Show("Execution Instruction with the same name or tag already exists.", "Prana Alert", MessageBoxButtons.OK);
            }
        ...
        private void btnDelete_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (grdExecutionInstructions.Rows.Count > 0)
                {
                    string eiName = grdExecutionInstructions.ActiveRow.Cells["ExecutionInstructions"].Text.ToString();
                    if (eiName != "")
                    {
                        //Asking the user to be sure about deleting the executionInstruction.
                        if (MessageBox.Show(this, "Do you want to delete this ExecutionInstruction?", "Prana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
                        {
                            ...
                            bool chkVarraible = OrderManager.DeleteExecutionInstruction(executionInstructionID);
                            if (!(chkVarraible))
                            {

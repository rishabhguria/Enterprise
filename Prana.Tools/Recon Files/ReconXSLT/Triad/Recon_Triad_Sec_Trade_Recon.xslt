				...
				<xsl:if test="number($Quantity)">
					<PositionMaster>
						...
						<xsl:variable name="ClearingFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL89 div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<OrfFee>
							<xsl:choose>
						...
						<xsl:variable name="AdditionalFee1">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL123"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AdditionalFee3">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL127"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AdditionalFee4">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL129"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee5">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL131"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee6">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL133"/>
							</xsl:call-template>
						</xsl:variable>

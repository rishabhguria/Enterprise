...
Select @MaxUDASectorID = Max(SectorID) From [Constellation3SM].DBO.T_UDASector       
...
From #TempDataTable       
Where GICS_SECTOR_NAME Not In (Select SectorName From [Constellation3SM].DBO.T_UDASector)      
And GICS_SECTOR_NAME Is Not Null And GICS_SECTOR_NAME <> ''      
      
---- Insert UDA Sector in Master Table      
Insert Into [Constellation3SM].DBO.T_UDASector (SectorID,SectorName)      
Select       
...
From [Constellation3SM].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation3SM].DBO.T_UDASector UDASector On UDASector.SectorName = Temp.GICS_SECTOR_NAME   
...
Select @MaxUDASubSectorID = Max(SubSectorID) From [Constellation3SM].DBO.T_UDASubSector       
...
From #TempDataTable       
Where GICS_SUB_INDUSTRY_NAME Not In (Select SubSectorName From [Constellation3SM].DBO.T_UDASubSector)      
And GICS_SUB_INDUSTRY_NAME Is Not Null And GICS_SUB_INDUSTRY_NAME <> ''      
      
---- Insert UDA Sub Sector in Master Table      
Insert Into [Constellation3SM].DBO.T_UDASubSector (SubSectorID,SubSectorName)      
Select       
...
From [Constellation3SM].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation3SM].DBO.T_UDASubSector UDASubSector On UDASubSector.SubSectorName = Temp.GICS_SUB_INDUSTRY_NAME   
...
Select @MaxUDACountryID = Max(CountryID) From [Constellation3SM].DBO.T_UDACountry       
...
From #TempDataTable     
Where COUNTRY_FULL_NAME Not In (Select CountryName From [Constellation3SM].DBO.T_UDACountry)      
And COUNTRY_FULL_NAME Is Not Null And COUNTRY_FULL_NAME <> ''  
        
------ Insert UDA Country in Master Table      
Insert Into [Constellation3SM].DBO.T_UDACountry (CountryID,CountryName)      
Select       
...
From [Constellation3SM].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation3SM].DBO.T_UDACountry UDACountry On UDACountry.CountryName = Temp.COUNTRY_FULL_NAME   

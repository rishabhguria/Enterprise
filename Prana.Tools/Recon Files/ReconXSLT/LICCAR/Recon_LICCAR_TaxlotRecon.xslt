        ...
        <xsl:if test="number($Quantity)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="normalize-space(COL5)='STK'">
                  <xsl:value-of select="'Equity'"/>
                </xsl:when>

                <xsl:when test="normalize-space(COL5)='OPT'">
                  <xsl:value-of select="'EquityOption'"/>
                </xsl:when>

                <xsl:when test="normalize-space(COL5)='CASH'">
            ...
            <xsl:variable name="PB_FUND_NAME" select="COL33"/>
            ...
            <OriginalPurchaseDate>
              <xsl:value-of select="concat(substring($varTradeDate,5,2),'/',substring($varTradeDate,7,2),'/',substring($varTradeDate,1,4))"/>
            </OriginalPurchaseDate>

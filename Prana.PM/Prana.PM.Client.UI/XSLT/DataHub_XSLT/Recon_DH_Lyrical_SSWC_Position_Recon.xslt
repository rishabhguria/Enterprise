  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($varQuantity) and contains(COL1,'Total')!='true' and not(contains(COL1,'Cash') and not(contains(COL1,'SSGA')))">
            <PositionMaster>
              ...
              <xsl:variable name="varCUSIP" select="normalize-space(COL2)"/>
              ...
              <xsl:variable name="MarketValue" select ="format-number(COL6,'##.####')"/>
              <MarketValue>
                <xsl:choose>
              ...
              <xsl:variable name="MarkPrice" select ="number(COL6) div number(COL5)"/>
              <MarkPrice>
                <xsl:choose>

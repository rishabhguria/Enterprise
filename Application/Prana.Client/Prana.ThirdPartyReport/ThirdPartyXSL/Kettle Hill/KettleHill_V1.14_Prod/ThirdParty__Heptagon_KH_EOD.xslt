...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[AccountName ='Heptagon - Shorts - Morgan Stanley' or AccountName = 'Heptagon - Longs - BBH' ]">
		 <ThirdPartyFlatFileDetail>
					...
					<TaxlotState>
					 ...
					 <xsl:variable name="PB_NAME" select="'Heptagon'"/>
					 <xsl:variable name = "PRANA_FUND_NAME">
						 <xsl:value-of select="'Hept Kettle Hill L/S Equity Fund'"/>
					 </xsl:variable>
			 ...
			 <Ticker>
				 <xsl:choose>
			       ...
			       <Broker>
					...
					<LocalAllOtherFees>
						<xsl:value-of select="format-number($OtherFees,'##.####')"/>
					</LocalAllOtherFees>
					...
					<LongShort>
						<xsl:choose>
							...
							<xsl:when test="Side='Buy to Close' or Side='Sell to Open' or Side='Sell short'">

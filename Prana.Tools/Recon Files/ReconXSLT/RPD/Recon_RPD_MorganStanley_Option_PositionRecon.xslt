  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($varQuantity)  and ($varQuantity!=0) ">
          ...
          <PositionMaster>
            ...
            <MarkPrice>
			 ...
			 <xsl:variable name="FXRate">
			  <xsl:call-template name="Translate">
				  <xsl:with-param name="Number" select="normalize-space(COL46)"/>
			  </xsl:call-template>
			  </xsl:variable>
            ...
            <xsl:variable name ="Bloomberg" select="normalize-space(COL14)"/>
            ...
            <xsl:variable name ="Date" select="normalize-space(COL1)"/>
            ...
            <ISINSymbol>
			  ...
			  <!--<IDCOOptionSymbol>
				  <xsl:choose>
					  ...
					  <xsl:when test="$AssetType='EquityOption'">
						  <xsl:value-of select="concat($varSymbol,'U')"/>
					  </xsl:when>
			  ...
			  <xsl:variable name="PB_COUNTER_PARTY" select="normalize-space(COL60)"/>

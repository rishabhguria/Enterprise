      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number(COL4)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name ="varMonthNo">
              <xsl:call-template name="MonthNo">
                <xsl:with-param name="varMonth" select="COL2"/>
					  ...
					  <TickerSymbol>
              <xsl:value-of select="concat(COL1,' 3',COL2,$varDay,'-LME')"/>
            </TickerSymbol>


            <ExpirationDate>
						  <xsl:value-of select="concat($varMonthNo,'/',$varDay,'/','2013')"/>
					  </ExpirationDate>
            ...
            <LongName>
              <xsl:value-of select="concat('LM', COL1,'P 2013',$varMonthNo,$varDay,' Comdty')"/>
            </LongName>

<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:my="put-your-namespace-uri-here" version="1.0" exclude-result-prefixes="xs">
	...
	<msxsl:script language="C#" implements-prefix="my"> public string Now(int year, int month) { DateTime thirdFriday= new DateTime(year, month, 15); while (thirdFriday.DayOfWeek != DayOfWeek.Friday) { thirdFriday = thirdFriday.AddDays(1); } return thirdFriday.ToString(); } </msxsl:script>
	...
	<xsl:template name="Option">
		...
		<!--<xsl:variable name="varOptionS" select="COL6"/>-->
		...
		<!--CLS US 01/31/25 C115-->
		<xsl:variable name="StrikePrice">
			<xsl:value-of select="format-number(substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL6),' '),' '),'/'),'/'),' '),2),'##.00')"/>
		</xsl:variable>
					...
					<xsl:when test="number($Quantity) ">
						...
						<PositionMaster>
							...
							<xsl:variable name="varSymbol">
								<xsl:value-of select="substring-before(COL6, ' US')"/>
							</xsl:variable>

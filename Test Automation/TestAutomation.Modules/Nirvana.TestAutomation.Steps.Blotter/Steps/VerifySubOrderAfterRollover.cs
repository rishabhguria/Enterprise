...
{
    class VerifySubOrderAfterRollover : BlotterUIMap, ITestStep
    {
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "VerifySubOrderAfterRollover");
                _res.IsPassed = false;
        ...
        /// <summary>
        /// To Obtain and verify data on sub order grid after rollover
        /// </summary>

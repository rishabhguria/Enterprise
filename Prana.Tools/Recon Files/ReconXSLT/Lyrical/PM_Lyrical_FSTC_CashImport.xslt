...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<!--<xsl:variable name="FundName" select="//PositionMaster[contains(COL1,'Northern Institutional Treasury Portfolio')]/COL6"/>-->
				...
				<xsl:if test ="number(COL6)">
					<PositionMaster>
						...
						<FundName>
							...
							<xsl:value-of select="'Northern Institutional Treasury Portfolio'"/>
						</FundName>

...
Description : Increase MasterFund length.        
JIRA  : https://jira.nirvanasolutions.com:8443/browse/ONB-1303     
*/ 
CREATE PROCEDURE [dbo].[PMGetFundPositionsWithMarketValue] (  
 ...
 CROSS APPLY (  
  SELECT CASE   
    WHEN (  
     ...
     THEN IsNull((#PositionTable.Quantity * (IsNull(coalesce(MP.FinalMarkPrice, MP1.FinalMarkPrice), 0) - IsNull(#PositionTable.AvgPX, 0)) * #PositionTable.Multiplier * dbo.GetSideMultiplier(#PositionTable.SideID)), 0)  - IsNull(#PositionTable.TotalCommissionandFees,0)

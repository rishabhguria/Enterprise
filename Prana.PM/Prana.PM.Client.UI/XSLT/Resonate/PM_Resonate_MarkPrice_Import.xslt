...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/">
        ...
        <xsl:variable name ="varValidAcc">
          <xsl:choose>
            <xsl:when test=" COL3='STAR V PARTNERS LLC C/O RESONATE CAPITAL  LLC'">
              <xsl:value-of select="'true'"/>
            </xsl:when>
            <xsl:when test=" COL3='RESONATE CORE LP C/O RESONATE CAPITAL  LLC'">
              <xsl:value-of select="'true'"/>
            </xsl:when>
            <xsl:otherwise>

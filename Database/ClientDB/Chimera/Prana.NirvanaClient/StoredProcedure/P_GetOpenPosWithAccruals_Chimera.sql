/*                      
exec P_GetOpenPosWithAccruals_Chimera @thirdPartyID=93,@companyFundIDs=N'2,1,3,4',@inputDate='2019-02-06 04:30:24:000',  
@companyID=7,@auecIDs=N'1,15,11,12',@TypeID=0,@dateType=0,@fileFormatID=180  
*/                      
                          
CREATE Procedure [dbo].[P_GetOpenPosWithAccruals_Chimera]                    
(                             
@ThirdPartyID int,                                        

  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and (contains(COL5,'DABRA CAPITAL MASTER FUND I') or 
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varFXRate">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="translate(COL89,'+','')"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <Multiplier>
              <xsl:value-of select="translate(COL70,'+','')"/>
            </Multiplier>

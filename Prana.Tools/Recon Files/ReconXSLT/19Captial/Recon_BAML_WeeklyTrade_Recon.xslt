					...
					<PositionMaster>
						...
						<Side>
							<xsl:choose>
								<xsl:when test="$Asset='EquityOption'">
									<xsl:choose>
										<xsl:when test="contains($Side,'B') and COL8='0'">
											<xsl:value-of select="'Buy to Open'"/>
										</xsl:when>
										<xsl:when test="contains($Side,'B') and COL8='1'">
											<xsl:value-of select="'Buy to Close'"/>
										</xsl:when>
										<xsl:when test="contains($Side,'S') and COL8='0'">
											<xsl:value-of select="'Sell to Close'"/>
										</xsl:when>
										<xsl:when test="contains($Side,'S') and COL8='1'">

			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:variable name="Quantity">
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="COL195"/>
					</xsl:call-template>
				</xsl:variable>

				<xsl:if test="number($Quantity)  and contains(COL4,'CASH')!='true'">
					...
					<PositionMaster>
						...
						<xsl:variable name="Symbol" select="COL200"/>

						<xsl:variable name="BBSymbol" select="COL40"/>
            ...
            <xsl:variable name="COL6">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL6"/>
						...
						<xsl:variable name="TradeDate" select="COL169"/>
                ...
                <xsl:otherwise>
                  <xsl:value-of select="0"/>
						...
						<xsl:variable name="MarketValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL125"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<CUSIP>
							<xsl:value-of select="translate(COL57,$Apos,'')"/>
						</CUSIP>

						<Bloomberg>
							<xsl:value-of select="concat(COL40,' ','EQUITY')"/>
						</Bloomberg>
						...
						<SEDOL>
							<xsl:value-of select="translate(COL193,$Apos,'')"/>
						</SEDOL>

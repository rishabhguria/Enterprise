			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<xsl:variable name ="Asset" select="COL10"/>
						<SideTagValue>
							<xsl:choose>
								<xsl:when test ="$Asset='Options' and COL11='Long'">
									<xsl:value-of select ="'A'"/>
								</xsl:when>

								<xsl:when test ="$Asset='Options' and COL11='Short'">
									<xsl:value-of select ="'C'"/>
								</xsl:when>
								<xsl:when test ="$Asset='Equity' and COL11='Long'">
									<xsl:value-of select ="'1'"/>
								</xsl:when>

								<xsl:when test ="$Asset='Equity' and COL11='Short'">
									<xsl:value-of select ="'5'"/>
								</xsl:when>
							</xsl:choose>
						...
						<xsl:variable name="UnitCost">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$COLI div $Position"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="FXrate">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$COLB div $COLL"/>
							</xsl:call-template>
						</xsl:variable>

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),' '),' '),' '),1,1)='C' or substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),' '),' '),' '),1,1)='P'">
        ...
        <xsl:if test="number($Quantity)">
          <PositionMaster>
            ...
            <xsl:variable name = "varAsset" >
              <xsl:choose>
                <xsl:when test="substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),' '),' '),' '),1,1)='C' or substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),' '),' '),' '),1,1)='P'">

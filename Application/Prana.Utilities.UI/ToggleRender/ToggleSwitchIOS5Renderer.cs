...
namespace Prana.Utilities.UI
{
    public class ToggleSwitchIOS5Renderer : ToggleSwitchRendererBase
    {
        ...
        public ToggleSwitchIOS5Renderer()
        {
            ...
            LeftSideUpperColor1 = Color.FromArgb(215, 255, 255, 255);
            LeftSideUpperColor2 = Color.FromArgb(215, 255, 255, 255);
            LeftSideLowerColor1 = Color.FromArgb(215, 255, 255, 255);
            LeftSideLowerColor2 = Color.FromArgb(215, 255, 255, 255);
            LeftSideUpperBorderColor = Color.FromArgb(150, 123, 157, 196);
            LeftSideLowerBorderColor = Color.FromArgb(150, 174, 208, 241);
            RightSideUpperColor1 = Color.FromArgb(215, 255, 255, 255);
            RightSideUpperColor2 = Color.FromArgb(215, 255, 255, 255);
            RightSideLowerColor1 = Color.FromArgb(215, 255, 255, 255);
            RightSideLowerColor2 = Color.FromArgb(215, 255, 255, 255);
            ...
            ButtonNormalOuterBorderColor = Color.FromArgb(104, 156, 46);
            ButtonNormalInnerBorderColor = Color.FromArgb(104, 156, 46);
            ButtonNormalSurfaceColor1 = Color.FromArgb(104, 156, 46);
            ButtonNormalSurfaceColor2 = Color.FromArgb(104, 156, 46);
            ButtonHoverOuterBorderColor = Color.FromArgb(104, 156, 46);
            ButtonHoverInnerBorderColor = Color.FromArgb(104, 156, 46);
            ButtonHoverSurfaceColor1 = Color.FromArgb(104, 156, 46);
            ButtonHoverSurfaceColor2 = Color.FromArgb(104, 156, 46);
            ButtonPressedOuterBorderColor = Color.FromArgb(104, 156, 46);
            ButtonPressedInnerBorderColor = Color.FromArgb(104, 156, 46);
            ButtonPressedSurfaceColor1 = Color.FromArgb(104, 156, 46);
            ButtonPressedSurfaceColor2 = Color.FromArgb(104, 156, 46);
        }
        ...
        public override void RenderButton(Graphics g, Rectangle buttonRectangle)
        {
            ...
            Color buttonShadowColor = (!ToggleSwitch.Enabled && ToggleSwitch.GrayWhenDisabled) ? ButtonShadowColor.ToGrayScale() : ButtonShadowColor.ToGrayScale();
            ...
            if ((!ToggleSwitch.Enabled && ToggleSwitch.GrayWhenDisabled) || !ToggleSwitch.Checked)

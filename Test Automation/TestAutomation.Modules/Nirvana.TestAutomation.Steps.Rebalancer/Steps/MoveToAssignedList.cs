...
{
    class MoveToAssignedList : IUIAutomationTestStep
    {
        public TestResult RunUIAutomationTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                uiAutomationHelper.FindAndClickElement(ApplicationArguments.mapdictionary["CustomGroupsCustomGroupButtonMoveToAssignedList"].AutomationUniqueValue);

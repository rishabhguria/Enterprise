...
{
  public class GetNAV : NAVUIMap, ITestStep
    {
      /// <summary>
      /// Run the test.
      /// </summary>
      ...
      /// <returns></returns>
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                {
                    DailyNAV(inputData, selectDate, copyDate);
                }
                else
                {
                    MonthlyNAV(inputData);
                }
            }
            catch (Exception ex)
            {
      ...
      /// <param name="copyDate">Copy Date.</param>
        private void DailyNAV(DataTable inputData, String selectDate, String copyDate)
        {
            try
            {
      ...
      /// </summary>
      /// <param name="inputData">The test Data.</param>
        private void MonthlyNAV(DataTable inputData)
        {
            try
            {
                String date = string.Empty;

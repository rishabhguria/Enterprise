...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
      ...
      <ThirdPartyFlatFileDetail>
        ...
        <NewCancelAmend>
          <xsl:value-of select="'NewCancelAmend'"/>
        </NewCancelAmend>
        ...
        <EntityID>
          <xsl:value-of select="EntityID"/>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty!='PRVT' and CounterParty!='Transfer' and CounterParty!='CorpAction' and CounterParty!='Washsale' and CounterParty!='BOX Collapse' and CounterParty!='SwapReset' and CounterParty!='Swap Reset' and CounterParty!='RBAL' and CounterParty!='XFER'][AccountName!='CRPR-MS-OTC' and AccountName!='CRPI-MS-OTC' and AccountName!='CRPL-MS-OTC' and AccountName!='CRPA-MS-OTC' and AccountName!='ST-MASTER-CASH' and AccountName!='ST-EDV-MS-PB' and AccountName!='ST-Main-MS-FX' and AccountName!='ST-Main-MS-PB' and AccountName!='ST-Main-MS-SWAP1' and AccountName!='ST-Main-MS-SWAP2' and AccountName!='ST-MONT-MS-PB' and AccountName!='ST-PUFF-MS-PB' and AccountName!='TO-DAWS-MS-PB' and AccountName!='TO-ELKO-MS-PB' and AccountName!='CRPR-KTN-MS-PB']">

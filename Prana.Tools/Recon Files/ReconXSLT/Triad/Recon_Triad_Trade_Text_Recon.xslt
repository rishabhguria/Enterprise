				...
				<xsl:if test="number($Quantity)">
					<PositionMaster>
						...
						<xsl:variable name="PB_SYMBOL_NAME">
							<xsl:value-of select="substring(normalize-space(COL1),399,19)"/>
						</xsl:variable>
						...
						<xsl:variable name="Symbol">
							<xsl:value-of select="substring(COL1,883,29)"/>
						</xsl:variable>
						<Symbol>
							<xsl:choose>
						...
						<xsl:variable name="PB_FUND_NAME" select="substring(COL1,31,5)"/>
						...
						<xsl:variable name="PB_BROKER_NAME">
							<xsl:value-of select="substring(COL1,638,3)"/>
						</xsl:variable>
						...
						<xsl:variable name="Quantitye">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,219,16) div 100000"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AvgPrice">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,236,17) div 1000000000"/>
							</xsl:call-template>
						</xsl:variable>
						<AvgPX>
							<xsl:choose>
						...
						<xsl:variable name="AdditionalFee1">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),721,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee2">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),735,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee3">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),749,11)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AdditionalFee4">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),763,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee5">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),777,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee6">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(normalize-space(COL1),791,11)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Side">
							<xsl:variable name="Side" select="substring(COL1,6,1)"/>
						</xsl:variable>
						<Side>
							<xsl:choose>
								<xsl:when test ="contains(substring(COL1,326,1),'B')">
									<xsl:value-of select="'Buy'"/>
								</xsl:when>
								<xsl:when test ="contains(substring(COL1,326,1),'S')">
						...
						<xsl:variable name="NetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,363,14) div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<NetNotionalValue>
							<xsl:choose>

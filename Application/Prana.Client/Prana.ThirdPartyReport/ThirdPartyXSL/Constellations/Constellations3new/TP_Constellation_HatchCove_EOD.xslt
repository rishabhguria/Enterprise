    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <Othercharges>
            <xsl:value-of select ="OtherBrokerFee+ StampDuty + SecFee + TransactionLevy + ClearingFee"/>
          </Othercharges>
          ...
          <!-- <ClearingBrokerinstructions> -->
            <!-- <xsl:value-of select ="''"/> -->
          <!-- </ClearingBrokerinstructions> -->
		  <xsl:variable name="SellTestCurrency" select="CurrencySymbol"/> 
		  <SellCurrency>
		<xsl:choose>
              <xsl:when test="$SellTestCurrency ='USD' ">
                <xsl:value-of select ="''"/>
              </xsl:when>
              
              <xsl:otherwise>
                <xsl:value-of select="$SellTestCurrency"/>
              </xsl:otherwise>
            </xsl:choose>
		</SellCurrency>

...
namespace Prana.PM.Admin.UI.Controls
{
    public partial class CtrlCompanyApplicationDetails : UserControl
    {
        ...
        public void PopulateCompanyApplicationDetails(Prana.BusinessObjects.PositionManagement.CompanyNameID companyNameID)
       {
           int companyID = companyNameID.ID;
           
           CompanyApplicationDetails = CompanyManager.GetCompanyApplicationDetailsForID(companyID);
           CompanyApplicationDetails.CompanyNameID = companyNameID;
        ...
        private void AddDataBindings()
        {
            ...
            rdbModels.DataBindings.Add(new System.Windows.Forms.Binding("Tag", CompanyApplicationDetails, "PricingModel", true));
            rdbModels.DataBindings.Add(new System.Windows.Forms.Binding("Text", CompanyApplicationDetails, "PricingModel.Name", true));
            //Sugandh - some unclear thing to do as of  now. But I am doing it now as i am in a hurry.
            rdbModels.Checked = true;
       ...
       /// </summary>
        ...
        {
            bindingSourceUploadDataSources.DataSource = Prana.PM.DAL.DataSourceManager.RetrieveDataSourceNames(false, false);
        ...
        {
            int numberOfRowsEffected = CompanyManager.SaveCompanyApplicationDetails(CompanyApplicationDetails);
            MessageBox.Show(this, "Company Application details saved !", "Position Management", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //ToDo--- 
        }

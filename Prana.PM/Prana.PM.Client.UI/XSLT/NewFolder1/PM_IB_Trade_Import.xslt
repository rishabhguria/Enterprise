		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
					...
					<PositionMaster>
						...
						<Symbol>
							<xsl:choose>
								...
								<xsl:when test="$Asset='Futuer'">
									<xsl:value-of select="concat(substring(COL5,1,2),' ',substring(COL5,3,2))"/>
								</xsl:when>
              ...
              <xsl:value-of select="COL9" />
						...
						<TransactionType>
							<xsl:choose>
								<xsl:when test="COL4='Transfer' and COL24='BUY'">
									<xsl:value-of select="'LongAddition'"/>
								</xsl:when>
								<xsl:when test="COL4='Transfer' and COL24='SELL'">

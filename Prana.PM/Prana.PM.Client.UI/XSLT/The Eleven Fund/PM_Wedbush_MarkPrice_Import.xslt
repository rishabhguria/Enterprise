		...
		<DocumentElement>
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:variable name="varMarkPrice">
					<!-- <xsl:choose> -->
						<!-- <xsl:when test="normalize-space(COL1) !=0"> -->
							<!-- <xsl:call-template name="Translate"> -->
					        	<!-- <xsl:with-param name="Number" select="normalize-space(COL6) div normalize-space(COL1)"/> -->
					        <!-- </xsl:call-template> -->
						<!-- </xsl:when>						 -->
						<!-- <xsl:otherwise> -->
							<xsl:value-of select="normalize-space(COL6) div normalize-space(COL1)"/>
						<!-- </xsl:otherwise> -->
					<!-- </xsl:choose>					 -->
				</xsl:variable>
				...
				<xsl:if test="number(COL1)">
					...
					<PositionMaster>
						...
						<!--<xsl:variable name="varSymbol">
							<xsl:choose>
								<xsl:when test="string-length(COL2) = ">

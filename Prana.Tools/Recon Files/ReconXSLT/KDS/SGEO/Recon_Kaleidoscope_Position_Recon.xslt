...
>
	...
	<xsl:template name="Option">
		...
		<xsl:if test="COL6='OPTION'">
			<xsl:variable name="UnderlyingSymbol">
				<xsl:value-of select="substring-before(COL1,' ')"/>
			</xsl:variable>
			<xsl:variable name="ExpiryDay">
				<xsl:value-of select="substring(substring-after(COL1,' '),3,2)"/>
			</xsl:variable>
			<xsl:variable name="ExpiryMonth">
				<xsl:value-of select="substring(substring-after(COL1,' '),1,2)"/>
			</xsl:variable>
			<xsl:variable name="ExpiryYear">
				<xsl:value-of select="substring(substring-after(COL1,' '),7,2)"/>
			</xsl:variable>
			...
			<xsl:variable name="StrikePrice">
				<xsl:value-of select="format-number(substring-after(substring-after(substring-after(COL1,' '),' '),' '),'#.00')"/>
			</xsl:variable>
					...
					<PositionMaster>
						...
						<IDCOOptionSymbol>
							<xsl:choose>
								...
								<xsl:when test="$Asset='EquityOption'">
									<xsl:value-of select="concat(COL28,'U')"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="''"/>
								</xsl:otherwise>
						...
						<xsl:variable name="vraMarketValue">
							<xsl:call-template name="Translate">
						...
						<MarketValueBase>
							<xsl:choose>
								<xsl:when test="number($vraMarketValue)">
									<xsl:value-of select="$vraMarketValue"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="0"/>
								</xsl:otherwise>

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
    ...
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity) and COL13!='Cash Equivalents'">
            <PositionMaster>
              ...
              <Symbol>
                <xsl:choose>
                  ...
                  <xsl:when test="string-length(normalize-space(COL5))">

  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
		  ...
		  <xsl:if test="number(COL58) and COL14='Money Market' and (contains(COL4,'2B LLC') or contains(COL4,'VENBIO SELECT'))">
			  <PositionMaster>
				  ...
				  <xsl:variable name="PRANA_ACRONYM_NAME">
					  <xsl:choose>
						  ...
						  <xsl:when test="(normalize-space(COL14) = 'Money Market') and (COL58 &lt; 0)">

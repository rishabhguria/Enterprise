  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select="//PositionMaster">
		  ...
		  <xsl:if test="number(COL25) and (COL4= 'TRADE' or COL4= 'MISCELLANEOUS')  and COL20!= 'OTHER' and $PRANA_FUND_NAME != '' ">
			  <PositionMaster>
                    ...
                    <xsl:otherwise>
                      <xsl:choose>
                        <xsl:when test="$varAssetType = 'EQUITIES' or $varAssetType = 'INDICES'">
						  ...
						  <xsl:when test="$varAssetType = 'FIXED INCOME'">
							  <xsl:value-of select="''"/>
						  </xsl:when>	
            ...
            <xsl:choose>
			  ...
			  <FXConversionMethodOperator>
				  ...
				  <PositionStartDate>
					  <xsl:value-of select="concat(substring-before(COL14,'/'),'/',substring-before(substring-after(COL14,'/'),'/'),'/',substring-after(substring-after(COL14,'/'),'/'))"/>
				  </PositionStartDate>
				  ...
				  <PositionSettlementDate>
					  <xsl:value-of select="concat(substring-before(COL15,'/'),'/',substring-before(substring-after(COL15,'/'),'/'),'/',substring-after(substring-after(COL15,'/'),'/'))"/>
				  </PositionSettlementDate>
            ...
            <SideTagValue>
				<xsl:choose>
				  ...
				  <Strategy>
					  <xsl:value-of select="concat(COL32,',',COL4)"/>
				  </Strategy>

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<xsl:variable name="CancelCorrect">
			<xsl:choose>
				<xsl:when test="TaxLotState='Allocated'">
		...
		<Group 
				OrderNumber ="{EntityID}" Cancelcorrectindicator ="N" AccountNumber="{$varFund}" SecurityIdentifier="{$varSymbol}"
		  ...
		  EntityID="{EntityID}" TaxLotState="Allocated" TaxLotState1="" FileHeader="FALSE" FileFooter="FALSE">

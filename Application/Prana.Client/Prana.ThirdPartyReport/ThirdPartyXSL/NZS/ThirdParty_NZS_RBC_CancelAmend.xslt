      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty!= 'Transfer' or CounterParty!= 'Corporate action' or CounterParty!= 'Cost Adjustment']">
		...
		<xsl:variable name="varDay">
          ...
          <xsl:variable name="varSettleDay">
            ...
            <SET-DAT>
            <xsl:value-of select="concat($varSettleYear,$varSettleMonth,$varSettleDay)"/>
            </SET-DAT>
          ...
          <OTH-FEE>
            <xsl:value-of select="SecFees + OtherBrokerFee + ClearingBrokerFee + MiscFees + OccFee + OrfFee + StampDuty + TransactionLevy"/>
          </OTH-FEE>

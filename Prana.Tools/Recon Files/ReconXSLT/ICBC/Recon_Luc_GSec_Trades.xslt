          ...
          <PositionMaster>
            ...
            <xsl:variable name="varSMRequest">
			  ...
			  <xsl:variable name="PRANA_STRATEGY_NAME">
				  <xsl:value-of select="document('../ReconMappingXml/StrategyMapping.xml')/StrategyMapping/PB[@Name='GSec']/StrategyData[@PranaFundName=$PRANA_FUND_NAME]/@PranaStrategy"/>
			  </xsl:variable>
            ...
            <Side>
              <xsl:choose>
                <xsl:when test="$varSide = 'BUY TO OPEN' or $varSide = 'BUY TO COVER' or $varSide = 'BUY TO CLOSE'  or $varSide = 'BUY'">
                  <xsl:value-of select="'Buy'"/>
                </xsl:when>
				  <xsl:when test="$varSide = 'SELL' or $varSide = 'SELL TO OPEN' or $varSide = 'SELL' or $varSide = 'SHORT SELL' or $varSide = 'SELL TO CLOSE'">

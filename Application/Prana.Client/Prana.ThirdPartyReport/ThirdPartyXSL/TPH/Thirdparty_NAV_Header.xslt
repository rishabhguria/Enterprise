	...
	<xsl:template match="/ThirdPartyFlatFileHeader">
		<ThirdPartyFlatFileHeader>
			...
			<xsl:variable name="TimeStamp">
				<xsl:value-of select="concat(substring(substring-after(DateAndTime,':'),1,2),':',substring(substring-after(DateAndTime,':'),3,2),':',substring(substring-after(DateAndTime,':'),5,2))"/>
			</xsl:variable>
			...
			<AllValues>
				<xsl:value-of select="concat('F','   ','INAV','037',$TimeStamp,'    ',$DateStamp,'    ','34','     ','3782','     ')"/>
			</AllValues>

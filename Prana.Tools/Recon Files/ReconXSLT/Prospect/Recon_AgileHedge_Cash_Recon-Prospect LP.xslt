	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($CashLocal) and (normalize-space(COL7)='EURO - GSEC' or normalize-space(COL7)='U.S. DOLLAR - GSCO' or normalize-space(COL7)='CANADIAN DOLLAR - GSEC')">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_FUND_NAME" select="'Prospect - LP - BTIG'"/>

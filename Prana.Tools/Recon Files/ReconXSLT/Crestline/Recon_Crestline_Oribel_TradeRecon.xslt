  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($qty) and COL18!='LT' and COL18!='DIV' and contains(COL1,'APEX')">
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="normalize-space(COL7)='Equity Option'">
              ...
              <xsl:choose>
                <xsl:when test="$varAsset='EquityOption'">
                  <xsl:choose>
                    ...
                    <xsl:when test="$varSide='C'">
                      <xsl:value-of select="'Buy to Close'"/>
                    </xsl:when>

                    <xsl:when test="$varSide='H'">

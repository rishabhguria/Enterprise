...
CREATE Procedure [dbo].[P_GetOpenPos_Const_Shelterhaven]                        
(                                 
@ThirdPartyID int,                                            
...
SM.OSISymbol,
Case
When Round((PT.TaxlotOpenQty * PT.AvgPrice * SM.Multiplier * dbo.GetSideMultiplier(PT.OrderSideTagValue)) + (PT.OpenTotalCommissionAndFees),2) <> 0 
Then (PT.TaxlotOpenQty * PT.AvgPrice * SM.Multiplier * dbo.GetSideMultiplier(PT.OrderSideTagValue)) + (PT.OpenTotalCommissionAndFees)
Else 0

				...
				<xsl:if test="number($Quantity) ">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="contains(substring(substring-after(substring-after(substring-after(COL4,'/'),'/'),' '),1,1),'P') or contains(substring(substring-after(substring-after(substring-after(COL4,'/'),'/'),' '),1,1),'C')">
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$COL18 - $COL16"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="TaxOnCommissions">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$COL23 - $COL21"/>
							</xsl:call-template>
						</xsl:variable>
						<CommissionsBase>

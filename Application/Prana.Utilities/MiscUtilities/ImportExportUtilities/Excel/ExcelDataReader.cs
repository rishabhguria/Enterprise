...
namespace Prana.Utilities.ImportExportUtilities.Excel
{

    /// <summary>
    /// Main class implementation
    /// Taken from ExcelDataReader - http://www.codeproject.com/KB/office/Excel_DataReader.aspx
    /// It reads the excel file and returns a dataset consisting of various tables for each 
    ...
    public class ExcelDataReader : IDisposable
    {
        ...
        public ExcelDataReader(Stream file)
        {
            ...
            RemoveEmptyRows(m_workbookData);
        ...
        private void RemoveEmptyRows(DataSet ds)
        {
            foreach (DataTable dataSource in ds.Tables)
            {

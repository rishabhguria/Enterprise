  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and COL2 !='Cash &amp; Equivalents'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varCostBasis">
              <xsl:choose>
                ...
                <xsl:when test="COL1 ='U.S. Dollars'">
            ...
            <xsl:variable name="varCOL7">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL7"/>
              </xsl:call-template>
            </xsl:variable>

            <xsl:variable name="varInTFRtate">
              <xsl:choose>             
                
                <xsl:when test="COL1 !='U.S. Dollars'">
                  <xsl:value-of select="$varMarketValue div ($varFXRate * $varCOL7)"/>
                </xsl:when>
              </xsl:choose>
            </xsl:variable>
            ...
            <FXRate>
              <xsl:choose>
                <xsl:when test="$varInTFRtate &gt; 0">
                  <xsl:value-of select="$varInTFRtate"/>
                </xsl:when>
                <xsl:when test="$varInTFRtate &lt; 0">
                  <xsl:value-of select="$varInTFRtate * (-1)"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="0"/>
                </xsl:otherwise>

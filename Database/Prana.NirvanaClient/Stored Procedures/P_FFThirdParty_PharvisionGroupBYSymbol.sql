 CREATE PROCEDURE [dbo].[P_FFThirdParty_PharvisionGroupBYSymbol] 
 (
	@thirdPartyID INT
...
SET AccountName = 
CASE 
		WHEN CharIndex('Boothbay Absolute Return - 82615315', AccountName) <> 0
			THEN '3E7026UH'
		WHEN CharIndex('Pharvision Capital LP - 83777315', AccountName) <> 0
			THEN '3E7026UH'
			WHEN CharIndex('Scalebuilder - 53279315', AccountName) <> 0
			THEN '3E7026UH'
		WHEN CharIndex('Topwater Stonefly Fund LLC - 65342446', AccountName) <> 0
			THEN '3E7026UG'
		WHEN CharIndex('Scalebuilder - 75303315', AccountName) <> 0
            THEN '3E7026UH'
		ELSE AccountName
		END

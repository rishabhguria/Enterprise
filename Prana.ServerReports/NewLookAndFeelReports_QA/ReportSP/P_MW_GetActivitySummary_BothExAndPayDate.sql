    GO 
  print 'Started Executing: ClientDB_P_MW_GetActivitySummary_BothExAndPayDate_Symbol.sql'
GO 
                      
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[P_MW_GetActivitySummary_BothExAndPayDate]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
DROP PROCEDURE [dbo].[P_MW_GetActivitySummary_BothExAndPayDate]
END
GO              
...
GO 
  print 'Done Executing: ClientDB_P_MW_GetActivitySummary_BothExAndPayDate.sql'
 GO 
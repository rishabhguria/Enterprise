...
{
    /// <summary>
    /// Class FxContractSymbolData
    /// </summary>
    [Serializable]
    public class FxContractSymbolData : FxSymbolData
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FxContractSymbolData"/> class.
        /// </summary>
        public FxContractSymbolData()
        {
        ...
        public FxContractSymbolData(string[] data, ref int i)
            : base(data, ref i)
        {
        ...
        public FxContractSymbolData(SymbolData symbolData, Operator ConversionMethod)
        {
            try
            {

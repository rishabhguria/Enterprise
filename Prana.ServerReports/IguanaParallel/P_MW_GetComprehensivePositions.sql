--exec P_MW_GetComprehensivePositions @Date='2015-09-02 00:00:00:000',@fund=N'Iguana Healthcare-JPM',@IncludeCash=0,@LocalCurrency=0,@NAVSource=0    
...
(SELECT SUM(EndingMarketValueBase) FROM #temp          

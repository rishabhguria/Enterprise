	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Quantity) and contains(COL2,'.')">
					<PositionMaster>
						...
						<xsl:variable name="varExDay">
							<xsl:value-of select="substring(substring-after(normalize-space(COL2),' '),7,2)"/>
						</xsl:variable>
						...
						<xsl:variable name="varPutORCall">
							<xsl:value-of select="substring(substring-after(normalize-space(COL2),' '),9,1)"/>
						</xsl:variable>
						<xsl:variable name="varStrikePrice">
							<xsl:value-of select="format-number(substring(substring-after(normalize-space(COL2),' '),10),'00.00')"/>
						</xsl:variable>
						...
						<PutOrCall>
							<xsl:choose>
								<xsl:when test="contains(substring(substring-after(normalize-space(COL2),' '),9,1),'P')">
									<xsl:value-of select="'0'"/>
								</xsl:when>
								<xsl:when test="contains(substring(substring-after(normalize-space(COL2),' '),9,1),'C')">

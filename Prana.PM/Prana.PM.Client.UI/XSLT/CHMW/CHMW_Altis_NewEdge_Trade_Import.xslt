			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($NetPosition) ">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_Contract" select="COL73"/>
						...
						<xsl:variable name="Price">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$Price1"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Side" select="normalize-space(COL90)"/>
						...
						<xsl:variable name ="Date" select="COL35"/>


						<xsl:variable name="Year1" select="substring(substring-after(substring-after(COL1,'/'),'/'),1,4)"/>
						<xsl:variable name="Month" select="substring(substring-before(substring-after(COL1,'/'),'/'),1,2)"/>
						<xsl:variable name="Day" select="substring(COL1,1,2)"/>
						...
						<xsl:variable name="Year2" select="substring(substring-after(substring-after(COL1,'/'),'/'),1,4)"/>
						<xsl:variable name="Month1" select="substring(substring-before(substring-after(COL1,'/'),'/'),1,2)"/>
						<xsl:variable name="Day1" select="substring(COL1,1,2)"/>

						<xsl:variable name="Year3" select="substring(substring-after(substring-after(COL89,'/'),'/'),1,4)"/>
						<xsl:variable name="Month2" select="substring(substring-before(substring-after(COL89,'/'),'/'),1,2)"/>
						<xsl:variable name="Day2" select="substring(COL89,1,2)"/>
						...
						<PositionSettlementDate>
							<xsl:choose>
								<xsl:when test="contains(COL22,'Spot')">
									<xsl:value-of select="concat($Month2,'/',$Day2,'/',$Year3)"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="concat($Month1,'/',$Day1,'/',$Year2)"/>
								</xsl:otherwise>
							</xsl:choose>
						...
						<xsl:variable name ="Fees">
							<xsl:value-of select ="COL16 + COL17 + COL18"/>
						</xsl:variable>
						...
						<xsl:variable name="Multiplier" select="COL36"/>

...
{
   public class GetDailyTradingVolume : DailyTradingVolumeUIMap, ITestStep
    {
       /// <summary>
       /// Run the test.
       /// </summary>
       ...
       /// <returns></returns>
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                {
                    DailyTradingVolumeData(inputData, selectDate, copyDate);
                }
                else
                {
                    MonthlyTradingVolumeData(inputData);
                }
            }
            catch (Exception ex)
            {
       ...
       /// <param name="copyDate">The copy date.</param>
        private void DailyTradingVolumeData(DataTable inputData, String selectDate, String copyDate)
        {
            try
            {
       ...
       /// <summary>
       /// Monthly trading volume data.
       /// </summary>
       /// <param name="inputData">The test data.</param>
        private void MonthlyTradingVolumeData(DataTable inputData)
        {
            try
            {
                String date = string.Empty;

...
namespace Nirvana.TestAutomation.Steps.PortfolioManagement
{
    ...
    public partial class IncreasePositionFromPM : PortfolioManagementUIMap, ITestStep
    {
            ...
            try
            {
                ...
                foreach (DataRow row in testData.Tables[sheetIndexToName[0]].Rows)
                {
                    ...
                    if (indexLong >= 0)
                    {
                        ...
                        bool flag = DataUtilities.pickFromMenuItem(PopupMenuDropDown, "Increase Position");
                        Wait(2000);
                        break;
                    }
                }

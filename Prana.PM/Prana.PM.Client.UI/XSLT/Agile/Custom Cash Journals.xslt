  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
		  ...
		  <xsl:if test="number(COL6) and normalize-space(normalize-space(COL4)) != 'DIV'and normalize-space(normalize-space(COL4)) != 'PDST' and $PRANA_FUND_NAME!=''">
			  <PositionMaster>
				  ...
				  <xsl:variable name="PRANA_ACRONYM_NAME">
					  <xsl:choose>
						  ...
						  <xsl:when test="(normalize-space(COL5) = 'INTEREST' or normalize-space(COL4)='INTR') and (COL6 &lt; 0)">
						  ...
						  <xsl:when test="(contains(COL3,'CIP') or contains(COL3,'/16')or contains(COL3,'STERLING') or contains(COL3,'NIRVANA') or normalize-space(COL5) = 'OTHER INC/EXP') and (COL6 &lt; 0)">

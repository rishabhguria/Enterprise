GO
/****** Object:  StoredProcedure [dbo].[P_NT_GetAccruals]    Script Date: 05/13/2015 16:36:32 ******/
SET ANSI_NULLS ON
GO
...
@RawOrBatch = 1
Exec [P_NT_GetAccruals] @StartDate,@EndDate,@BeginningOrEnding,@EquivalentBusinessDateOrRecentNonZeroCashDate,@RawOrBatch
*/
-- =============================================
CREATE PROCEDURE [dbo].[P_NT_GetAccruals] 
@StartDate datetime,
@EndDate datetime,
@BeginningOrEnding bit,
@EquivalentBusinessDateOrRecentNonZeroCashDate bit,
...
Begin 
	Insert Into #AcctValues 
	(AcctId,AcctName,RunDate,ValueLocal,BeginningFXRate,EndingFXRate) 
	Select AcctId,AcctName,RunDate,(Case @BeginningOrEnding When 0 Then BeginningMarketValueLocal Else EndingMarketValueLocal End),BeginningFXRate,EndingFXRate From T_NT_CashAccruals Where CashOrAccruals = 1
End 

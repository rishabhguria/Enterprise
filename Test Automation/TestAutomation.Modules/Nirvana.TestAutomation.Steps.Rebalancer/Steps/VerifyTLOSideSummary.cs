...
{
    class VerifyTLOSideSummary : RebalancerUIMap, IUIAutomationTestStep
    {
        public TestResult RunUIAutomationTest(System.Data.DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                try
                {
                    ...
                    DataTable uiData = gridDataProvider.GetWPFGridData(ApplicationArguments.mapdictionary["TradeListOrderSideSummaryModuleWindow"].AutomationUniqueValue,ApplicationArguments.mapdictionary["TradeListOrderSideSummaryGridName"].AutomationUniqueValue);

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template name="Option">
		...
		<!--<xsl:if test="contains(COL42,'C') or contains(COL42,'P')">-->
		<xsl:if test ="contains(COL2,'Option')">
			...
			<xsl:variable name="ExpiryMonth">
				<xsl:value-of select="substring-after(substring-before(normalize-space(COL42),'/'),' ')"/>
			</xsl:variable>
			...
			<xsl:variable name="PutORCall">
				<xsl:value-of select="substring(substring-after(substring-after(COL42,' '),' '),1,1)"/>
			</xsl:variable>
			<xsl:variable name="StrikePrice">
				<xsl:value-of select="substring(substring-after(substring-after(COL42,' '),' '),3 div 1000)"/>
			</xsl:variable>
					...
					<PositionMaster>
							...
							<xsl:choose>
								...
								<xsl:when test="$Asset= Option">
									<xsl:call-template name="Option">
										<xsl:with-param name="Symbol" select="COL42"/>
						...
						<SideTagValue>
							<xsl:choose>
								<xsl:when test ="$Asset='Option'">
									<xsl:choose>
										<xsl:when test ="COL90='Buy'">
											<xsl:value-of select ="'A'"/>
										</xsl:when>
										<xsl:when test ="COL90='Sell'">
											<xsl:value-of select ="'D'"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select ="''"/>

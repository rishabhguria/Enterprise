...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='Fund for the Aged: 1045216' or FundName='JHL Manhattan: 1048172' or FundName='Fountain House Inc: 117816000' or FundName='Jewish Home and Hospital: 1045217']">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='Fund for the Aged: 1045216'">
								<xsl:value-of select="'1045216'"/>
							</xsl:when>

							<xsl:when test="FundName='JHL Manhattan: 1048172'">
								<xsl:value-of select="'1048172'"/>
							</xsl:when>

							<xsl:when test="FundName='Fountain House Inc: 117816000'">
								<xsl:value-of select="'117816000'"/>
							</xsl:when>

							<xsl:when test="FundName='Jewish Home and Hospital: 1045217'">
								<xsl:value-of select="'1045217'"/>
							</xsl:when>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/NewDataSet">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[AccountName='315' or AccountName='316' or AccountName='318' or AccountName='318lcv' or AccountName='319' or AccountName='319lcv']">
				<ThirdPartyFlatFileDetail>
              ...
              <xsl:otherwise>
                <xsl:value-of select="''"/>
					...
					<SecurityDescription>
						<xsl:value-of select="substring(translate(CompanyName,',',''),1,34)"/>
					...
					<xsl:variable name="Principal" select="Quantity * format-number(AvgPrice,'0.####') * Multiplier"/>
					...
					<xsl:variable name="varSideMul">
						<xsl:choose>
							<xsl:when test="SideID = '5' or SideID = '11' or SideID = '2' ">
								<xsl:value-of select="-1"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="1"/>
					...
					<xsl:variable name="varNetAmmount">						
						<xsl:value-of select="$Principal + (($OtherFees + Commission) * $varSideMul)"/>
					</xsl:variable>

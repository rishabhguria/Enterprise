...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
		  ...
		  <Groups>
			  ...
			  <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[AccountName !='AIRT-AGEN 0082' and AccountName !='AIRT-AGEN 0217' and AccountName !='AIRT-IB 6160' and AccountName !='AIRT-PIPR 7165' and AccountName !='SPAG-IB 0034' and AccountName !='SPAG-IB 9812' and AccountName !='SPAG-PIPR 6076' and AccountName !='SPAG-PIPR 9500'
  and AccountName!='MSTR-Rebal Risk Analysis'and AccountName!='AIRT-Risk Analysis'and AccountName!='AIRT-IB 8649'and AccountName!='GNTJMP-IB 1913'
  and AccountName!='SAYANI-STCH GHS' and AccountName!='SAYANI-STCH GBP' and AccountName!='SAYANI-STCH USD' and AccountName!='SAYANI-STCH ZAR' and AccountName!='SAYANI-STCH MAD' and AccountName!='SAYANI-STCH XOF' and AccountName!='SAYANI-STCH EGP' and AccountName!='SAYANI-STCH TZS'and AccountName!='SAYANI-STCH KES' and CounterParty != 'CorpAction']">

				  <!--<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[AccountName !='MHX000217 – AirT']">-->
 	...
 	<xsl:variable name ="varAllocationState">
	  ...
	  <xsl:variable name="varCustodian">
		  <xsl:choose>
			  ...
			  <xsl:when test="AccountName ='PANAFR-AGEN 0097' or AccountName ='AOII-AGEN 0095'">
				  <xsl:value-of select="'AGEN'"/>
			  </xsl:when>

			  <xsl:when test="AccountName ='PANAFR-SBIC NGN' or AccountName ='PANAFR-SBIC GHS' or AccountName ='PANAFR-SBIC KES'">
				  <xsl:value-of select="'SBIC'"/>
			  </xsl:when>

			  <xsl:when test="AccountName ='SAYANI-STCH GHS' or AccountName ='SAYANI-STCH GBP' or AccountName ='SAYANI-STCH ZAR' or AccountName ='SAYANI-STCH MAD'">
				  <xsl:value-of select="'SCBL'"/>
			  </xsl:when>

			  <xsl:when test="AccountName ='PANAFR-SBSA-ZAR'">
				  <xsl:value-of select="'SBSA'"/>
			  </xsl:when>

			  <xsl:when test="AccountName ='PANAFR-IB 3356'">
				  <xsl:value-of select="'IB'"/>
			  </xsl:when>
			  
			  <xsl:when test="AccountName ='PANAFR-INTC ZAR' or AccountName = 'PANAFR-INTC EGP' or AccountName = 'PANAFR-INTC NGN' or AccountName = 'PANAFR-INTC MAD'  or AccountNames = 'PANAFR-INTC GHS'  or AccountName = 'PANAFR-INTC KES'  or AccountName = 'PANAFR-INTC GBP' or AccountName = 'PANAFR-INTC XOF' ">
	  ...
	  <Group 
			  ...
			  Broker="{$varCounterParty}" Custodian="{$varCustodian}" TransactionType="{$varTransactionType}" CurrencyCode="{SettlCurrency}"
			  ...
			  TradeTax="" MiscMoney="{$Fees1}" NetAmount="{$varNetAmount}" Principal="{$varGrossAmount}" Description=""
			  SecurityType="{$varSecurityName}" CountrySettlementCode="" ClearingAgent="" SECFee="{$Fees2}" RepoOpenSettleDate="" RepoMaturityDate=""
        ...
        OptionStrikePrice="{$varStrikePrice}"

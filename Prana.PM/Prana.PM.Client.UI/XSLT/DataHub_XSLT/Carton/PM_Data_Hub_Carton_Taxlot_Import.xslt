			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_FUND_NAME" select="'2001840'"/>
						...
						<!--<xsl:variable name="varCostBasis">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$varCostValue div $Position"/>
							</xsl:call-template>
						</xsl:variable>-->
						...
						<xsl:variable name="varFXRate">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$varNetprice div ($Position * $varCostValue)"/>
							</xsl:call-template>
						</xsl:variable>
						<FXRate>
							<xsl:choose>

  ...
  <xsl:template match="/ThirdPartyFlatFileDetailCollection">
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
		  <xsl:if test ="AccountName = 'Maerisland S-1 BNY' or AccountName = 'Maerisland S-1 GSCO'">
			  ...
			  <ThirdPartyFlatFileDetail>
				  ...
				  <DTC>
					  <xsl:choose>
						  <xsl:when test ="(CounterParty = 'JEFF' or CounterParty = 'JEFFD' or CounterParty = 'BTIG' or CounterParty = 'WELLS' or CounterParty = 'JETS') and CurrencySymbol = 'USD' and Asset = 'Equity'">
				  ...
				  <NetAmount>
					  <xsl:value-of select="NetAmount + CommissionCharged"/>
				  </NetAmount>

...
/*              
P_MW_GetActivitySummary_BothExAndPayDate '06-16-2015','06-16-2015',1,'','Symbol'              
*/                    
...
Case When IsNumeric(FXRate_TradeDate)<>0 THEN     
      CONVERT(decimal (10,5),FXRate_TradeDate)    
   ELSE     
      isnull(FXRate_TradeDate,0)    
...
--MarkFXRate_TradeDate as TradeDateFXRate,    
 ...
 CASE      
  ...
  THEN   
   CASE      
   WHEN FXRate_TradeDate = 0 OR FXRate_TradeDate = 1   
   THEN AvgPrice * MarkFXRate_TradeDate      

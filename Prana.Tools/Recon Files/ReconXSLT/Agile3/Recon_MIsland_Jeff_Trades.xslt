            ...
            <xsl:choose>
			  ...
			  <Side>
				  <xsl:choose>
					  ...
					  <!--<xsl:when test="$varSide = 'Buy' or $varSide = 'Cover Short'">
						  <xsl:value-of select="'Buy'"/>
					  </xsl:when>-->
					  <!--<xsl:when test="$varSide = 'Sell' and $varAssetType = 'OPT'">
					  ...
					  <xsl:when test="$varAssetType = 'OPT' and ($varSide = 'Sell' or $varSide = 'Sell Short')">
						  <xsl:value-of select="'Sell to Close'"/>
					  </xsl:when>

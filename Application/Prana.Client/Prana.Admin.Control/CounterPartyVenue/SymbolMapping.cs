...
namespace Nirvana.Admin.Controls
{
	...
	public class SymbolMapping : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox6.Size = new System.Drawing.Size(446, 232);
			...
			this.btnGrdDelete.Location = new System.Drawing.Point(360, 206);
			...
			this.btnEdit.Location = new System.Drawing.Point(280, 206);
			...
			this.btnCreate.Location = new System.Drawing.Point(200, 206);
			...
			this.dtgrdSymbolMapping.Location = new System.Drawing.Point(8, 20);
			...
			this.dataGridTextBoxColumn6.HeaderText = "AUEC";
			this.dataGridTextBoxColumn6.MappingName = "AUEC";
			...
			this.dataGridTextBoxColumn7.HeaderText = "Symbol";
			this.dataGridTextBoxColumn7.MappingName = "SymbolName";
...
//					symbolMappingEdit.SymbolID = int.Parse(dtgrdSymbolMapping[dtgrdSymbolMapping.CurrentCell.RowNumber, 3].ToString());
					counterPartyVenueSymbolMappingEdit.SymbolMappingEdit = (Nirvana.Admin.BLL.SymbolMapping)((Nirvana.Admin.BLL.SymbolMappings) dtgrdSymbolMapping.DataSource)[dtgrdSymbolMapping.CurrentCell.RowNumber];
		...
		private void btnGrdDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				if (dtgrdSymbolMapping.VisibleRowCount >0)
				{
					...
					{
						int symbolMappingID = int.Parse(dtgrdSymbolMapping[dtgrdSymbolMapping.CurrentCell.RowNumber, 3].ToString());
						...
						else
						{
							...
							symbolMapping.AUEC = dtgrdSymbolMapping[dtgrdSymbolMapping.CurrentCell.RowNumber, 5].ToString();
							...
							symbolMapping.SymbolName = dtgrdSymbolMapping[dtgrdSymbolMapping.CurrentCell.RowNumber, 6].ToString();

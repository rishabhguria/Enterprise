		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position) and (not(contains($SymbolChk,'SD1')) and not(contains($SymbolChk,'SD2')) and not(contains($SymbolChk,'SD3')))">
					<!--and (not(contains($SymbolChk,'SD1')) and not(contains($SymbolChk,'SD2')) and not(contains($SymbolChk,'SD3')))-->
					...
					<PositionMaster>
						...
						<Symbol>
							<xsl:choose>
								...
								<xsl:when test ="substring(COL1,11,9)='290386H40'">
						...
						<!--<CUSIP>
							<xsl:choose>
								...
								<xsl:when test="$Symbol!='*'">
									<xsl:value-of select="substring(COL1,11,9)"/>
								</xsl:when>

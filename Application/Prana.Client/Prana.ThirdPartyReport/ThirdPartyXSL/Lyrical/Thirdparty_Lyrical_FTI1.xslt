...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='Town of Davie Police Pension Plan: 451035770' or FundName='Serena Foundation: 441052670' or FundName='Generation Fund: 441052770' or FundName='William H. Osborn Family Trust: 421079310' or FundName='Article Sixth A Trust UW William H: 421079010' or FundName='The Emily Davie and Joseph Kornfeld: 441037650' or FundName='Article Sixth B Trust UW William H: 421079110' or FundName='Trust U Article 11G George W Merck: 420850497']">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='Town of Davie Police Pension Plan: 451035770'">
								<xsl:value-of select="'451035770'"/>
							</xsl:when>

							<xsl:when test="FundName='Serena Foundation: 441052670'">
								<xsl:value-of select="'441052670'"/>
							</xsl:when>

							<xsl:when test="FundName='Generation Fund: 441052770'">
								<xsl:value-of select="'441052770'"/>
							</xsl:when>

							<xsl:when test="FundName='William H. Osborn Family Trust: 421079310'">
								<xsl:value-of select="'421079310'"/>
							</xsl:when>

							<xsl:when test="FundName='Article Sixth A Trust UW William H: 421079010'">
								<xsl:value-of select="'421079010'"/>
							</xsl:when>

							<xsl:when test="FundName='Article Sixth B Trust UW William H: 421079110'">
								<xsl:value-of select="'421079110'"/>
							</xsl:when>


							<xsl:when test="FundName='The Emily Davie and Joseph Kornfeld: 441037650'">
								<xsl:value-of select="'441037650'"/>
							</xsl:when>

							<xsl:when test="FundName='Trust U Article 11G George W Merck: 420850497'">
								<xsl:value-of select="'420850497'"/>
							</xsl:when>

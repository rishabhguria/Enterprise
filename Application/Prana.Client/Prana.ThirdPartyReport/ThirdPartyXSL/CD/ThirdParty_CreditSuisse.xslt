...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[AccountName = 'S1CS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'S2CS_CASH']">
				...
				<ThirdPartyFlatFileDetail>
					...
					<NetProceedsLocal>
						<xsl:choose>
							<xsl:when test ="CurrencySymbol = 'JPY'">
								<xsl:value-of select='format-number($varNetProceedsLocal, "###")'/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select='format-number($varNetProceedsLocal, "###.00")'/>
							</xsl:otherwise>
						</xsl:choose>
					</NetProceedsLocal>

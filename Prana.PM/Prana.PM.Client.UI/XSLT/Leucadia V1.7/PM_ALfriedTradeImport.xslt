			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<SideTagValue>
							<xsl:choose>
								<xsl:when test ="$Asset='OPTC    ' and COL13='Sell'">
									<xsl:value-of select ="'D'"/>
								</xsl:when>

								<xsl:when test ="$Asset='OPTC ' and COL13='Buy'">
									<xsl:value-of select ="'A'"/>
								</xsl:when>
								<xsl:when test ="$Asset!='OPTC ' and COL13='Buy'">
									<xsl:value-of select ="'1'"/>
								...
								<xsl:when test ="$Asset!='OPTC ' and COL13='Cover Short'">
									<xsl:value-of select ="'B'"/>
								</xsl:when>
								<xsl:when test ="$Asset!='OPTC ' and COL13='Sell'">
									<xsl:value-of select ="'2'"/>
								</xsl:when>
								<xsl:when test ="$Asset!='OPTC ' and COL13='Sell Short'">
									<xsl:value-of select ="'5'"/>
								</xsl:when>
							</xsl:choose>
						...
						<xsl:variable name="UnitCost">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="$COLI"/>
							</xsl:call-template>
						</xsl:variable>

  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and contains (COL6,'Cash')!='true'">
          ...
          <PositionMaster>
            ...
            <Symbol>
			  ...
			  <xsl:variable name="Underlying" select="substring-before(COL4,'1')"/>
			  ...
			  <xsl:variable name="IdcoLast" select="substring(COL4,string-length($Underlying)+1)"/>
            ...
            <xsl:variable name="Date" select="COL7"/>

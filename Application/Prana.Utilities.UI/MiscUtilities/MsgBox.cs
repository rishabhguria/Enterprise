...
namespace Prana.Utilities.UI.MiscUtilities
{
    public class MsgBox : Form
    {
        ...
        private TableLayoutPanel _plFooter = new TableLayoutPanel();
        ...
        private MsgBox()
        {
            ...
            _flpButtons.Anchor = AnchorStyles.Top | AnchorStyles.Bottom;
            ...
            _plFooter.ColumnCount = 1;
            _plFooter.RowCount = 1;
        ...
        public static DialogResult Show(string message, string title, Buttons buttons, Icon icon, AnimateStyle style, string Yes = "Yes", string No = "No", string Cancel = "Cancel")
        {
            _msgBox = new MsgBox();
            _msgBox._lblMessage.Text = message;
            _msgBox._lblTitle.Text = title;
            ...
            MsgBox.InitButtons(buttons, Yes, No, Cancel);
            MsgBox.InitIcon(icon);
        ...
        private static void InitButtons(Buttons buttons, string Yes = "Yes", string No = "No", string Cancel = "Cancel")
        {
            switch (buttons)
            {
                ...
                case MsgBox.Buttons.YesNo:
                    _msgBox.InitYesNoButtons(Yes, No);
                    break;

                case MsgBox.Buttons.YesNoCancel:
                    _msgBox.InitYesNoCancelButtons(Yes, No, Cancel);
                    break;
            }
        ...
        private void InitYesNoButtons(string Yes, string No)
        {
        ...
        private void InitYesNoCancelButtons(string Yes, string No, string Cancel)
        {
            Button btnYes = new Button();
            btnYes.Text = Yes;
            btnYes.Width = 105;

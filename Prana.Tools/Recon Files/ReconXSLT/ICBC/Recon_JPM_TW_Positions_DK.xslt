	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select="//Comparision">
				<xsl:if test ="number(COL21) and normalize-space(COL4)!='OTHER'">
								...
								<Symbol>
									<xsl:choose>
										<xsl:when test="$PRANA_Symbol_NAME = ''">
											<xsl:choose>
												<xsl:when test="string-length(normalize-space(COL16))=4 and (COL3 = 'HKD' or COL3 = 'SGD' or COL3 = 'JPY')">
													<xsl:value-of select="concat(normalize-space(translate(COL16,'/','.')),$varSuffix)"/>
												</xsl:when>
												<xsl:when test="string-length(normalize-space(COL16))=3 and (COL3 = 'HKD' or COL3 = 'SGD' or COL3 = 'JPY')">
													<xsl:value-of select="concat('0',normalize-space(translate(COL16,'/','.')),$varSuffix)"/>
												</xsl:when>
												<xsl:when test="string-length(normalize-space(COL16))=2 and (COL3 = 'HKD' or COL3 = 'SGD' or COL3 = 'JPY')">
													<xsl:value-of select="concat('00',normalize-space(translate(COL16,'/','.')),$varSuffix)"/>
												</xsl:when>
												<xsl:when test ="COL3 = 'CAD' and contains(COL16,'/') != false">
													<xsl:value-of select ="concat(substring-before(COL16,'/'),'.',substring-after(normalize-space(COL16),'/'),$varSuffix)"/>
												</xsl:when>

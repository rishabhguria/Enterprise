...
namespace Prana.SM.OTC.ValueConvertor
{
    ...
    [Serializable]
    sealed public class ObservableDictionary<TKey, TValue> :
        ...
        INotifyPropertyChanged
    {
        ...
        public ObservableDictionary(int p1, string p2)
        {
        ...
        /// 
        /// </summary>
        /// <typeparam name="TVKey">The type of the key.</typeparam>
        private class KeyedDictionaryEntryCollection<TVKey> : KeyedCollection<TVKey, DictionaryEntry>
        {
            #region constructors
            ...
            ///         <cref>KeyedDictionaryEntryCollection`1</cref>
            ///     </see>
            ///     class.
            /// </summary>
            ...
            /// </summary>
            /// <param name="comparer">The comparer.</param>
            public KeyedDictionaryEntryCollection(IEqualityComparer<TVKey> comparer) : base(comparer) { }
            ...
            /// <param name="entry">The entry.</param>
            /// <returns></returns>
            protected override TVKey GetKeyForItem(DictionaryEntry entry)
            {
                return (TVKey)entry.Key;
            }
        ...
        /// 
        /// </summary>
        /// <typeparam name="TUKey">The type of the key.</typeparam>
        /// <typeparam name="TUValue">The type of the value.</typeparam>
        [Serializable, StructLayout(LayoutKind.Sequential)]
        public struct Enumerator<TUKey, TUValue> : IEnumerator<KeyValuePair<TUKey, TUValue>>, IDictionaryEnumerator
        {
            #region constructors

            /// <summary>
            /// Initializes a new instance of the <see>
            ///         <cref>Enumerator`2</cref>
            ///     </see>
            ///     struct.
            /// </summary>
            /// <param name="dictionary">The dictionary.</param>
            /// <param name="isDictionaryEntryEnumerator">if set to <c>true</c> [is dictionary entry enumerator].</param>
            internal Enumerator(ObservableDictionary<TUKey, TUValue> dictionary, bool isDictionaryEntryEnumerator)
            {
                _dictionary = dictionary;
                _version = dictionary._version;
                _index = -1;
                _isDictionaryEntryEnumerator = isDictionaryEntryEnumerator;
                _current = new KeyValuePair<TUKey, TUValue>();
            }
            ...
            /// The current.
            /// </value>
            public KeyValuePair<TUKey, TUValue> Current
            {
                get
                {
                    ValidateCurrent();
            ...
            public bool MoveNext()
            {
                ...
                {
                    _current = new KeyValuePair<TUKey, TUValue>((TUKey)_dictionary._keyedEntryCollection[_index].Key,
                        (TUValue)_dictionary._keyedEntryCollection[_index].Value);
                    return true;
                }
                _index = -2;
                _current = new KeyValuePair<TUKey, TUValue>();
            ...
            object IEnumerator.Current
            {
                get
                {
                    ...
                    return new KeyValuePair<TUKey, TUValue>(_current.Key, _current.Value);
                }
            }
            ...
            /// The _dictionary
            /// </summary>
            private ObservableDictionary<TUKey, TUValue> _dictionary;
            ...
            /// The _current
            /// </summary>
            private KeyValuePair<TUKey, TUValue> _current;

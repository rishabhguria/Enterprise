...
{
    class VerifySymbolDivisorWindow : PopUpUIMap, ITestStep
    {
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                if (File.Exists(DevPath + TestDataConstants.DUMP_PATH + "SymbolDivisorWindow.xml"))
                    File.Delete(DevPath + TestDataConstants.DUMP_PATH + "SymbolDivisorWindow.xml");
                while (!File.Exists(DevPath + TestDataConstants.DUMP_PATH + "SymbolDivisorWindow.xml"))
                { PopUpUIMap.DumpWindow("SymbolDivisorWindow"); }
                StringBuilder errorBuilder = new StringBuilder();
                DataTable xmltoDataTable = CommonMethods.ReadXML(DevPath + TestDataConstants.DUMP_PATH + "SymbolDivisorWindow.xml");

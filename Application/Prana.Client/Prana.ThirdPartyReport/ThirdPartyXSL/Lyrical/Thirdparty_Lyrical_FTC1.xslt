...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='Rx Foundation: 76859200' or FundName='Trust Under Indenture: 58270200' or FundName='Trust Under Art 11: 58269200' or FundName='Trust Under Art 10: 58329200']">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='Rx Foundation: 76859200'">
								<xsl:value-of select="'76859200'"/>
							</xsl:when>
							
							<xsl:when test="FundName='Trust Under Indenture: 58270200'">
								<xsl:value-of select="'58270200'"/>
							</xsl:when>

							<xsl:when test="FundName='Trust Under Art 11: 58269200'">
								<xsl:value-of select="'58269200'"/>
							</xsl:when>

							<xsl:when test="FundName='Trust Under Art 10: 58329200'">
								<xsl:value-of select="'58329200'"/>
							</xsl:when>

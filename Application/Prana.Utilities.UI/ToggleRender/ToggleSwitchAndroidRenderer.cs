...
namespace Prana.Utilities.UI
{
    public class ToggleSwitchAndroidRenderer : ToggleSwitchRendererBase
    {
        ...
        public ToggleSwitchAndroidRenderer()
        {
            ...
            BackColor = Color.FromArgb(255, 166, 166, 166);
            LeftSideColor = Color.FromArgb(255, 166, 166, 166);
            RightSideColor = Color.FromArgb(255, 166, 166, 166);
            OffButtonColor = Color.FromArgb(255, 55, 67, 85);
            OnButtonColor = Color.FromArgb(255, 55, 67, 85);
            OffButtonBorderColor = Color.FromArgb(255, 55, 67, 85);
            OnButtonBorderColor = Color.FromArgb(255, 55, 67, 85);
            SlantAngle = 8;
        }

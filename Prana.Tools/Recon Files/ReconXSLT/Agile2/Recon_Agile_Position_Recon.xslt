	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test ="number($varQuantity) and COL2!='CURRENCY'">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								...
								<xsl:when test="COL2='OPTION' and COL23=''">
						...
						<!--<xsl:variable name="varRoot_Code">
							<xsl:chose>
								<xsl:when>
						...
						<AccountName>
									...
									<xsl:value-of select ="'Long Tail Fut-GS'"/>
						...
						<xsl:variable name="Quantity">
							<xsl:choose>
								<xsl:when test="$Asset='FixedIncome'">
									<xsl:value-of select="$varQuantity * 1000"/>
								</xsl:when>
								<xsl:otherwise>

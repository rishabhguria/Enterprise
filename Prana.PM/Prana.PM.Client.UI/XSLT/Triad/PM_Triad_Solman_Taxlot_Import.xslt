			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position)">
					<PositionMaster>
						...
						<xsl:variable name="varUnitCoast">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL15"/>
							</xsl:call-template>
						</xsl:variable>
						<xsl:variable name="varUnitCoastLocal">
							<xsl:call-template name="Translate">
						...
						<xsl:variable name="Costbasis">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select=" $varUnitCoast div $varUnitCoastLocal"/>
							</xsl:call-template>
						</xsl:variable>
						<CostBasis>
							<xsl:choose>
						...
						<xsl:variable name ="Date" select="substring-before(COL9,' ')"/>
						<PositionStartDate>

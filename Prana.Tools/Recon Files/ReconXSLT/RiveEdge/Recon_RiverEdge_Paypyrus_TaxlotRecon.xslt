  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="string-length($Symbol) &gt; 15">
      ...
      <xsl:variable name="ExpiryDay">
        <xsl:value-of select="normalize-space(substring-before(substring-after(substring-after(substring-after($Symbol,' '),' '),'/'),'/'))"/>
      </xsl:variable>
      <xsl:variable name="ExpiryMonth">
        <xsl:value-of select="normalize-space(substring-before(substring-after(substring-after($Symbol,' '),' '),'/'))"/>
      </xsl:variable>
      <xsl:variable name="ExpiryYear">
        <xsl:value-of select="normalize-space(substring-before(substring-after(substring-after(substring-after(substring-after($Symbol,' '),' '),'/'),'/'),' '))"/>
      </xsl:variable>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($Quantity)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PB_FUND_NAME" select="'Papyrus Capital Fund LP'"/>
            ...
            <xsl:variable name="Year">
              <xsl:value-of select="substring-before(substring-after(substring-after(COL32,'-'),'-'),' ')"/>
            </xsl:variable>

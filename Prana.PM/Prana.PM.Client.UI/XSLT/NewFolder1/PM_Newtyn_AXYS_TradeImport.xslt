  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test ="number(COL9) and number(COL22) and COL2!='newfr' and COL2!='newgs' and COL2!='ntefr' and COL2!='ntegs' ">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_FUND_NAME">
              <xsl:value-of select="document('../ReconMappingXml/FundMapping.xml')/FundMapping/PB[@Name='BNP']/FundData[@PBFundName=$PB_FUND_NAME]/@PranaFund"/>
            </xsl:variable>

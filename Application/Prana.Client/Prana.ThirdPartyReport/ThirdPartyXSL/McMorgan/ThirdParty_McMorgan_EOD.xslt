...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template match="/ThirdPartyFlatFileDetailCollection">
        ...
        <Account>
				...
				<xsl:for-each select="ThirdPartyFlatFileDetail [ CounterParty = 'JOHN' and AccountID = '6746022837' and AccountID ='70133116']">
				<ThirdPartyFlatFileDetail>
          ...
          <!--<Account>
            <xsl:choose>
              <xsl:when test="AccountName = 'Ibew Pacific Coast'">
                <xsl:value-of select="'6746022837'"/>
              </xsl:when>
              <xsl:when test="contains(AccountName, 'Construction Industry')">
                <xsl:value-of select="'70133116'"/>
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="AccountName"/>
              </xsl:otherwise>

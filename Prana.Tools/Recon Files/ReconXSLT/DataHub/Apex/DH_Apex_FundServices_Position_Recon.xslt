...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(substring(substring-after(normalize-space(COL1),' '),7,1),'P') or contains(substring(substring-after(normalize-space(COL1),' '),7,1),'C')">
      <xsl:variable name="UnderlyingSymbol">
        <xsl:value-of select="substring-before(normalize-space(COL1),' ')"/>
      </xsl:variable>
      <xsl:variable name="ExpiryDay">
        <xsl:value-of select="substring(substring-after(normalize-space(COL1),' '),5,2)"/>
      </xsl:variable>
      ...
      <xsl:variable name="PutORCall">
        <xsl:value-of select="substring(substring-after(normalize-space(COL1),' '),7,1)"/>
      </xsl:variable>
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-after(normalize-space(COL1),' '),8) div 1000,'#.00')"/>
      </xsl:variable>
          ...
          <xsl:when test="number($Quantity)">
            <PositionMaster>
              ...
              <xsl:variable name="varAsset">
                <xsl:choose>
                  <xsl:when test="contains(substring(substring-after(normalize-space(COL1),' '),7,1),'P') or contains(substring(substring-after(normalize-space(COL1),' '),7,1),'C')">

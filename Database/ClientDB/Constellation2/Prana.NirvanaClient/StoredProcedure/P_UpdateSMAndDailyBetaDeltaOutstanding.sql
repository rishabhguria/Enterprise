...
--Set @FilePath = 'C:\Users\Administrator\Desktop\ConstellationV1.7.1\UpdateOutstandingShares\ConstellationBBData.csv' 
...
Select @MaxUDASectorID = Max(SectorID) From [Constellation2SMV1.7.1].DBO.T_UDASector       
...
From #TempDataTable       
Where GICS_SECTOR_NAME Not In (Select SectorName From [Constellation2SMV1.7.1].DBO.T_UDASector)      
And GICS_SECTOR_NAME Is Not Null And GICS_SECTOR_NAME <> ''      
      
---- Insert UDA Sector in Master Table      
Insert Into [Constellation2SMV1.7.1].DBO.T_UDASector (SectorID,SectorName)      
Select       
...
From [Constellation2SMV1.7.1].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation2SMV1.7.1].DBO.T_UDASector UDASector On UDASector.SectorName = Temp.GICS_SECTOR_NAME   
...
Select @MaxUDASubSectorID = Max(SubSectorID) From [Constellation2SMV1.7.1].DBO.T_UDASubSector       
...
From #TempDataTable       
Where GICS_SUB_INDUSTRY_NAME Not In (Select SubSectorName From [Constellation2SMV1.7.1].DBO.T_UDASubSector)      
And GICS_SUB_INDUSTRY_NAME Is Not Null And GICS_SUB_INDUSTRY_NAME <> ''      
      
---- Insert UDA Sub Sector in Master Table      
Insert Into [Constellation2SMV1.7.1].DBO.T_UDASubSector (SubSectorID,SubSectorName)      
Select       
...
From [Constellation2SMV1.7.1].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation2SMV1.7.1].DBO.T_UDASubSector UDASubSector On UDASubSector.SubSectorName = Temp.GICS_SUB_INDUSTRY_NAME   
...
Select @MaxUDACountryID = Max(CountryID) From [Constellation2SMV1.7.1].DBO.T_UDACountry       
...
From #TempDataTable     
Where COUNTRY_FULL_NAME Not In (Select CountryName From [Constellation2SMV1.7.1].DBO.T_UDACountry)      
And COUNTRY_FULL_NAME Is Not Null And COUNTRY_FULL_NAME <> ''  
        
------ Insert UDA Country in Master Table      
Insert Into [Constellation2SMV1.7.1].DBO.T_UDACountry (CountryID,CountryName)      
Select       
...
From [Constellation2SMV1.7.1].DBO.T_SMSymbolLookUpTable SM      
Inner Join #TempDataTable Temp On Temp.Security = SM.BloombergSymbol      
Inner Join [Constellation2SMV1.7.1].DBO.T_UDACountry UDACountry On UDACountry.CountryName = Temp.COUNTRY_FULL_NAME   

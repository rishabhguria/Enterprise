		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				...
				<ThirdPartyFlatFileDetail>
					...
					<MarkPriceBase>
						<xsl:choose>
							<xsl:when test="number(MarkPriceBase)">
								<xsl:value-of select="format-number(MarkPriceBase,'0.########')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>
					...
					<MarketValueBase>
						<xsl:choose>
							<xsl:when test="number(MarketValueBase)">
								<xsl:value-of select="format-number(MarketValueBase,'0.########')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>
					...
					<PutORCall>
						<xsl:choose>
							<xsl:when test="number(PutOrCall)">
					...
					<SettmentCurrencyMarkPrice>
						<xsl:choose>
							<xsl:when test="number(SettlementCurrencyMarkPrice)">
								<xsl:value-of select="format-number(SettlementCurrencyMarkPrice,'0.########')"/>
							</xsl:when>
					...
					<SettmentCurrencyCostBasis>
						<xsl:choose>
							<xsl:when test="number(SettlementCurrencyCostBasis)">
								<xsl:value-of select="format-number(SettlementCurrencyCostBasis,'0.########')"/>
							</xsl:when>
					...
					<SettmentCurrencyMarketValue>
						<xsl:choose>
							<xsl:when test="number(SettlementCurrencyMarketValue)">
								<xsl:value-of select="format-number(SettlementCurrencyMarketValue,'0.########')"/>
							</xsl:when>
					...
					<SettmentCurrencyTotalCost>
						<xsl:choose>
							<xsl:when test="number(SettlementCurrencyTotalCost)">
								<xsl:value-of select="format-number(SettlementCurrencyTotalCost,'0.########')"/>
							</xsl:when>

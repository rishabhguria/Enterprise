  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($NetPosition) and COL13='TPP Security Trade'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="CostBasis">
              <xsl:choose>
                <xsl:when test="COL8='B'">
                  <xsl:value-of select="((COL19 - COL29) div $NetPosition)"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="(COL19 * -1 + COL28 + COL33) div $NetPosition"/>
                </xsl:otherwise>
              </xsl:choose>
            </xsl:variable>
            ...
            <SideTagValue>
              ...
              <xsl:choose>
                <xsl:when test="COL9='O' and COL8='B'">
                  <xsl:value-of select="'1'"/>
                </xsl:when>

                <xsl:when test="COL9='C' and COL8='S'">
                  <xsl:value-of select="'2'"/>
                </xsl:when>

                <xsl:when test="COL9='O' and COL8='S'">
                  <xsl:value-of select="'5'"/>
                </xsl:when>

                <xsl:when test="COL9='C' and COL8='B'">
                  <xsl:value-of select="'B'"/>
                </xsl:when>
            ...
            <xsl:variable name="NetNotional" select="$NetPosition * $CostBasis"/>

            <xsl:variable name="Commission" select="COL29"/>
            ...
            <OrfFee>
              ...
              <xsl:choose>
                ...
                <xsl:when test="$OrFee &gt; 0">
                  <xsl:value-of select="$OrFee"/>
                </xsl:when>

                <xsl:when test="$OrFee &lt; 0">
                  <xsl:value-of select="$OrFee * (-1)"/>
                </xsl:when>
            ...
            <xsl:variable name="SecFee" select="COL32"/>
            ...
            <xsl:variable name="FXRate" select="COL20 div COL19"/>

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="varPrice">
      <xsl:value-of select="normalize-space(substring-before(COL2,'Equity'))"/>
    </xsl:variable>
   
    <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-after(substring-after(substring-after($varPrice,'/'),'/'),' '),2),'#.00')"/>
      </xsl:variable>

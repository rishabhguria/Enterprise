				...
				<xsl:if test="number($Position)">
					<PositionMaster>
						...
						<xsl:variable name ="Asset">
							<xsl:choose>
								<xsl:when test="(substring(substring-after(normalize-space(COL4),' '),7,1)='C' or substring(substring-after(normalize-space(COL4),' '),7,1)='P') and string-length(normalize-space(COL4) &gt; 20)">

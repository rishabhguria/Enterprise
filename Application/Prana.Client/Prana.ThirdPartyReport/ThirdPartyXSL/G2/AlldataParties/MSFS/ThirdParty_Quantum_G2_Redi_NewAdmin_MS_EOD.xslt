		...
		<Groups>
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail">
				...
				<xsl:if test="(1=position()) or(preceding-sibling::*[1]/PBUniqueID != PBUniqueID)">
					<xsl:if test="CounterParty != 'Undefined' and CounterParty != 'REBL' or (AccountName ='Quantum Partners LP' or  AccountName ='G2 Long Only Fund QP LP')">
  ...
  <xsl:template  name="TestTaxlotId">
    ...
    <xsl:if test="TaxLotState !='Amended' and TaxLotState !='Deleted'">
			...
			<xsl:variable name="QtySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/AllocatedQty)"/>
			</xsl:variable>
			<xsl:variable name="GroupNetAmt">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/NetAmount)"/>
			</xsl:variable>
			<xsl:variable name="CommissionSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/CommissionCharged)"/>
			</xsl:variable>
			<xsl:variable name="TaxOnCommissionSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/TaxOnCommissions)"/>
			</xsl:variable>
			<xsl:variable name="SecFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/SecFee)"/>
			</xsl:variable>
			<xsl:variable name="StampDutySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/StampDuty)"/>
			</xsl:variable>
			<xsl:variable name="TransactionLevySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/TransactionLevy)"/>
			</xsl:variable>
			...
			<xsl:variable name="MiscFeesSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/MiscFees)"/>
			</xsl:variable>
			<xsl:variable name="OrfFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/OrfFee)"/>
			</xsl:variable>
			<xsl:variable name="OtherBrokerFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/OtherBrokerFee)"/>
			</xsl:variable>
			<xsl:variable name="GrossAmountSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][TaxLotState != 'Deleted'][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/GrossAmount)"/>
			</xsl:variable>
			...
			<xsl:variable name="tempSideVar">
				<xsl:value-of  select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/Side"/>
			</xsl:variable>

			<xsl:variable name="tempCPVar">
				<xsl:value-of  select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/CounterParty"/>
			</xsl:variable>
      ...
      <xsl:variable name="varTaxlotStateTx">
		...
		<xsl:variable name="AccountId_Group">
			...
			<xsl:if test="number($QtySum)">
				...
				<Group 
					...
					<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[(PBUniqueID = $I_GroupID)][CounterParty != 'Undefined'][AccountName= 'Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']">
		...
		<xsl:if test="TaxLotState = 'Deleted'">
			...
			<!-- Building a Group with the EntityID $I_GroupID... -->
			<xsl:variable name="QtySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/AllocatedQty)"/>
			</xsl:variable>
			<xsl:variable name="GroupNetAmt">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/NetAmount)"/>
			</xsl:variable>
			<xsl:variable name="CommissionSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/CommissionCharged)"/>
			</xsl:variable>
			<xsl:variable name="TaxOnCommissionSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/TaxOnCommissions)"/>
			</xsl:variable>
			<xsl:variable name="SecFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/SecFee)"/>
			</xsl:variable>
			<xsl:variable name="StampDutySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/StampDuty)"/>
			</xsl:variable>
			<xsl:variable name="TransactionLevySum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/TransactionLevy)"/>
			</xsl:variable>
			<xsl:variable name="ClearingFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/ClearingFee)"/>
			</xsl:variable>
			<xsl:variable name="MiscFeesSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/MiscFees)"/>
			</xsl:variable>
			<xsl:variable name="OrfFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/OrfFee)"/>
			</xsl:variable>
			<xsl:variable name="OtherBrokerFeeSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/OtherBrokerFee)"/>
			</xsl:variable>
			<xsl:variable name="GrossAmountSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/GrossAmount)"/>
			</xsl:variable>
			<xsl:variable name="NetAmountSum">
				<xsl:value-of  select="sum(/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID=$I_GroupID][AccountName ='Quantum Partners LP' or AccountName ='G2 Long Only Fund QP LP']/NetAmount)"/>
			</xsl:variable>
		...
		<xsl:variable name="AccountId_Group">
			...
			<xsl:if test="number($QtySum)">
				...
				<Group 
					...
					<!-- ...selecting all the records for this Group... -->
					<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and CounterParty != 'Undefined' and (contains(AccountName,'Quantum Partners LP')='true' or AccountName ='G2 Long Only Fund QP LP')]">
						<!-- ...and building a ThirdPartyFlatFileDetail for each -->
            <!--<xsl:if test="TaxLotState='Deleted'">-->

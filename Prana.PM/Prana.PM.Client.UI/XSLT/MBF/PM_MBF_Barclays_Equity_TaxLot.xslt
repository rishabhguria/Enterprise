	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="COL1 !='BCS' and COL1 !='*' and COL1 !='DATE'">
					<PositionMaster>
						<!--fundname section-->
						...
						<xsl:choose>
							<xsl:when test="COL1 ='BCS' or COL1='DATE' or COL1='*'">
								<PositionStartDate>
									<xsl:value-of select="''"/>
								</PositionStartDate>
							</xsl:when>

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template name="ConvertBBCodetoTicker">
    ...
    <xsl:variable name="varStrike">
      <xsl:value-of select="format-number(substring(substring-after($varBBCode,' '),8)div 1000, '#.00')  "/>
    </xsl:variable>

    <xsl:variable name="ExpiryDay">
      <xsl:value-of select="substring(substring-after($varBBCode,' '),5,2)"/>
    </xsl:variable>
    ...
    <xsl:variable name="varPutOrCall">
      <xsl:value-of select="substring(substring-after($varBBCode,' '),7,1)"/>
    </xsl:variable>
    ...
    <xsl:value-of select="concat('O:',$varUnderlying,' ',$ExpiryYear,$MonthCodeVar,$varStrike,'D',$Day)"/>
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varOptionSymbol">
              <xsl:call-template name="ConvertBBCodetoTicker">
                <xsl:with-param name="varBBCode" select="normalize-space(COL1)"/>
              </xsl:call-template>
            </xsl:variable>
            <Symbol>
              <xsl:choose>

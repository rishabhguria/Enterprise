	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($Quantity) and not(contains(COL3,'TOTALS')) and not(contains(COL3,'Total Investments')) and not(contains(COL3,'Northern Institutional Treasury Portfolio '))">

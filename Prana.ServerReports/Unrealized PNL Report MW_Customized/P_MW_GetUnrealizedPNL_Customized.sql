...
Usage:                      
[P_MW_GetUnrealizedPNL_Customized] '2012-07-26','MTM_V0','1195,1212','3'           
*******************************************************************/                        
                      
                     
CREATE Procedure [dbo].[P_MW_GetUnrealizedPNL_Customized]                        
(                        
@Rundate datetime,                    
...
--Derived Fields          
Case when (366-DateDiff(d,TradeDate,Rundate))>0       
Then (366-DateDiff(d,TradeDate,Rundate))      
Else 0      
End      
as DaysLeft,                    
...
--------Long term unrealized PNL-------------              
            
CASE WHEN  (DateDiff(d,DateAdd(year,1,TradeDate),PNL.Rundate) > 0)        
Then          
  Case           
  -- When Unrealize P&L is without Commission and with Single FX Rate          
  When           
...
Else 0                 
End as LongTermUnrealizedPNL,        
        
        
--------Short term unrealized PNL-------------        

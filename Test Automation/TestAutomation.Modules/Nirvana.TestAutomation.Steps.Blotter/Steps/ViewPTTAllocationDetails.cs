...
{
    public class ViewPTTAllocationDetails : BlotterUIMap, ITestStep
    {
        ...
        private void InputEnter(DataRow dr)
        {
            try
            {
                ...
                PTTAllocationDetails.Click(MouseButtons.Left);
            }
            catch (Exception)
            {
                throw;

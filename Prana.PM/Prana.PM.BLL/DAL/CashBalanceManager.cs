...
{
    public class CashBalanceManager
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static CashBalanceManagement GetCashBalanceDataForDataSource(ThirdPartyNameID dataSourceNameID, DateTime date)
        {
            ...
            if ((int.Equals(dataSourceNameID.ID, 35)) || int.Equals(dataSourceNameID.ID, 0))
            {
                ...
                row2.Account.ShortName = "WealthMultiplier";

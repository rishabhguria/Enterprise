...
[PMGetRealizeAndUnrealizePnL_TEST] '5/1/2015','5/18/2015' ,'1238','1','MTM_V0'    
                                                                                        
******************************************************************/      
                       
CREATE PROCEDURE  [dbo].[PMGetRealizeAndUnrealizePnL_TEST]                                                                           
(                                                                                                                                                                                                                                                
...
--Set @StartDate='5/1/2015'                                    
--Set @EndDate='5/18/2015'              
--Set @Fund = '1238'            
--Set @Asset= '1'            
--Set @ReportId = 'MTM_V0'                 
...
ClosedTradeAttribute5=    
CASE    
WHEN (ClosedTradeAttribute5='' OR ClosedTradeAttribute5 = NULL)    THEN 'undefined'    
ELSE ClosedTradeAttribute5    
END,    
ClosedTradeAttribute6=    
CASE    
...
Set OpenQty =   
 Case   
  When (Open_CloseTag = 'O' And Side = 'Short')   
  Then TaxLotOpenQty * -1  
  When (Open_CloseTag = 'O' And Side = 'Long')   
  Then TaxLotOpenQty  
  Else 0  
 End   
...
--print 'Done Executing: ClientDB_812_PMGetRealizeAndUnrealizePnL.sql' 
...
{
    class CloseOrder : AllocationUIMap, ITestStep
    {
        /// <summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                CloseOrder.Click(MouseButtons.Left);
                if (NirvanaAllocation.IsVisible)
                    ButtonOK.Click(MouseButtons.Left);
            }
            catch (Exception ex)
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "CloseOrder");
                _res.IsPassed = false;

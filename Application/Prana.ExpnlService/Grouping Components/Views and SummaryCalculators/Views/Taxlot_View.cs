...
{
    public class Taxlot_View : IGroupingComponent, IDisposable
    {
        private ICompressor _compressor = new Taxlot_View_Compressor();
        ...
        public Taxlot_View()
        {
            try
            {
                GroupingComponentName = CompressionViewFactory.TAXLOT_COMPRESSION;

		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
			   ...
			   <xsl:for-each select="ThirdPartyFlatFileDetail">
				   <xsl:if test ="AccountName != 'MS Swap'">
				...
				<ThirdPartyFlatFileDetail>
					...
					<ClientRef>
						<xsl:value-of select="concat(substring(EntityID,4,15),'A')"/>
					</ClientRef>

					<Associated>
						<xsl:value-of select="concat(substring(EntityID,4,15),'B')"/>
					</Associated>

					<ExecAccount>
						<xsl:value-of select="'38080099'"/>
					</ExecAccount>
					...
					<xsl:variable name="varPB">
							<xsl:value-of select="document('../ReconMappingXml/AccountwisePBMapping.xml')/BrokerMapping/PB[@Name='MS']/BrokerData[@PranaFundName = $varFundName]/@PB"/>
					</xsl:variable>

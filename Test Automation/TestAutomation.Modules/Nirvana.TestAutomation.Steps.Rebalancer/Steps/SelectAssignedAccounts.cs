...
{
    class SelectAssignedAccounts : IUIAutomationTestStep
    {
        public TestResult RunUIAutomationTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                bool selectionSucceeded = uiAutomationHelper.CustomGroupDataSelectItem("RebalancerWindow", "RebalancerWindow", testData.Tables[0], "SelectAssignedAccounts", "ListItems");

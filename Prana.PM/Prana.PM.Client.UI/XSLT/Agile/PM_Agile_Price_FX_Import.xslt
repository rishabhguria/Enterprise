	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number(COL4) and contains(COL1,'CURNCY') and COL13='SPOT'">
					<PositionMaster>
						...
						<FXConversionMethodOperator>
							<xsl:choose>
								<xsl:when test="$BaseCurrency='EUR' or $BaseCurrency='AUD' or $BaseCurrency='GBP' or $BaseCurrency='NZD' ">

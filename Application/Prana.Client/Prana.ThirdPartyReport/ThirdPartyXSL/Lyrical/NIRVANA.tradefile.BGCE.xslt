	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection xmlns:xsi="http://www.w3.org/2001/XMLschema-instance" xsi:noNamespaceSchemaLocation="alan.xsd">
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				...
				<ThirdPartyFlatFileDetail emailto="avinash.kumar@nirvanasolutions.com, lyrical@nirvanasolutions.com, yogesh.sharma@nirvanasolutions.com, joseph.smith@nirvanasolutions.com, michael.rosenblat@nirvanasolutions.com, MPascale@mintpartners.com">
				 <!--<ThirdPartyFlatFileDetail emailto="avinash.kumar@nirvanasolutions.com, anand.pandey@nirvanasolutions.com, yogesh.sharma@nirvanasolutions.com">--> 
					<xsl:choose>

    ...
    public class ContractListingType : System.Windows.Forms.Form
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (txtContractListingType != null)
                {
                    txtContractListingType.Dispose();
                }
                if (grdContractListingType != null)
                {
                    grdContractListingType.Dispose();
                }
                if (grpContractlistingtype != null)
                {
                    grpContractlistingtype.Dispose();
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.grdContractListingType.UseFlatMode = DefaultableBoolean.True;
        ...
        private void BindContractListingTypeGrid()
        {
            ...
            if (contractListingTypes.Count == 0)
            {
                Prana.Admin.BLL.ContractListingType nullContractListingType = new Prana.Admin.BLL.ContractListingType(int.MinValue, "");
                contractListingTypes.Add(nullContractListingType);
            }
        ...
        private int SaveContractListingType()
        {
            ...
            Prana.Admin.BLL.ContractListingType contractListingType = new Prana.Admin.BLL.ContractListingType();
        ...
        private void btnDelete_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (grdContractListingType.Rows.Count > 0)
                {
                    ...
                    if (contractListingTypeID != int.MinValue)
                    {
                        //Asking the user to be sure about deleting the contractListingType.
                        if (MessageBox.Show(this, "Do you want to delete this ContractListingType?", "Prana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
                        {

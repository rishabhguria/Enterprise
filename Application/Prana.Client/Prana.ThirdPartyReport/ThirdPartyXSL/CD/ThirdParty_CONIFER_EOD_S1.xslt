	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<xsl:if test ="AccountNo='32577' or AccountNo='SSAPMF' or AccountNo='013101969' or AccountNo='002200079' or AccountNo='5870004'">
				<ThirdPartyFlatFileDetail>
					<!--for system internal use-->
					<RowHeader>
						<xsl:value-of select ="'true'"/>
					...
					<xsl:variable name="NormalizedFxRate">
						<xsl:choose>
							<xsl:when test="ForexRate_Trade='' or ForexRate_Trade='0' or AccountNo = 'SSAPMF' or AccountNo = '002200079' ">
								<xsl:value-of select="1"/>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:variable name="NormalizedAveragePrice">
						<xsl:choose>
							<xsl:when test="AccountNo = 'SSAPMF' or AccountNo = '002200079'">
				  ...
				  <xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="AccountNo='441885' or AccountNo='32577' or AccountNo='013425764' or AccountNo='013101969' or AccountNo='9530857' or AccountNo='5870004'">
							<Security>
					...
					<xsl:choose>
						<xsl:when test="AccountNo='32577' or AccountNo='SSAPMF'">
							<Cust>
								<xsl:value-of select="'deut'"/>
							</Cust>
						</xsl:when>
						<xsl:when test="AccountNo='013101969' or AccountNo='002200079'">
							<Cust>
								<xsl:value-of select="'gsco'"/>
							</Cust>
						</xsl:when>
						<xsl:when test="AccountNo='5870004'">
							<Cust>
								<xsl:value-of select="'ubsw'"/>
							</Cust>
						</xsl:when>

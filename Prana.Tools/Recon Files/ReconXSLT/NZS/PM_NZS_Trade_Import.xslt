  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varNetPosition) and COL31 ='Common Stock'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_SYMBOL_NAME">
			  ...
			  <xsl:variable name="varSedol">
				   <xsl:value-of select="substring(COL25,2)"/>
			  </xsl:variable>
            ...
            <xsl:variable name="varPositionStartDate">
              <xsl:call-template name="FormatDate">
                <xsl:with-param name="varFullDate" select="COL12"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="varPositionSettlementDate">
              <xsl:call-template name="FormatDate">
                <xsl:with-param name="varFullDate" select="COL11"/>
              </xsl:call-template>
            </xsl:variable>

      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:variable name="Cash">
          <xsl:call-template name="Translate">
            <xsl:with-param name="Number" select="normalize-space(COL58)"/>
          </xsl:call-template>
        </xsl:variable>

        <xsl:if test="number($Cash) and contains(normalize-space(COL9), 'CASH')">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_PRE">
              <xsl:choose>
				  <xsl:when test="contains(normalize-space(COL13), 'Cash') and $Cash &gt; 0 ">
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_POST">
				<xsl:choose>
					 <xsl:when test="$varSubAccountDesc ='Cash Collateral Movement' and $Cash &gt; 0 ">
            ...
            <Description>
				<xsl:value-of select="'Cash Collateral Movement'"/>
            </Description>
			<CurrencyName>

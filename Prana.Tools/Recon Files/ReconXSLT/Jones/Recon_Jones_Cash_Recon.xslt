      ...
      <xsl:for-each select="//Comparision">
        ...
        <xsl:if test="number($varLCash)">
          <PositionMaster>
            ...
            <xsl:variable name="varMonth" select="substring(COL5,5,2)"/>
            <xsl:variable name="varDay" select="substring(COL5,7,2)"/>
            <xsl:variable name="varYear" select="substring(COL5,1,4)"/>
            <Date>

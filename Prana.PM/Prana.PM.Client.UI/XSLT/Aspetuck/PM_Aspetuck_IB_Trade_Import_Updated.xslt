...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<msxsl:script language="C#" implements-prefix="my5">
		...
		ds.ReadXml(@"D:/Nirvana/NirvanaCode/SourceCode/Prod/Prana/Application/Prana.Client/Prana/bin/Release/MappingFiles/ReconMappingXml/HolidayMapping.xml");
		int count = 0;
		...
		{
		if(DateTime.Compare(dt,Convert.ToDateTime(ds.Tables[1].Rows[i][0].ToString())) == 0)
		{
		flag = true;
		}
		}

					...
					<PositionMaster>
						...
						<Symbol>
							...
							<xsl:choose>
								...
								<xsl:when test="COL2='CAU8' and COL3='Index'">
									<xsl:value-of select="'FESB U18-EUX'"/>
								</xsl:when>
								<xsl:when test="COL2='CAU8' and COL3='Comdty'">
									<xsl:value-of select="'EBM U18-ENC'"/>
								</xsl:when>
								<xsl:when test="COL2='HGU8' and COL3='Comdty'">
									<xsl:value-of select="'HG U18'"/>
								</xsl:when>
								<xsl:when test="COL2='HGU8' and COL3='Index'">
									<xsl:value-of select="'FSTH U18-EUX'"/>
								</xsl:when>
								<xsl:when test="COL2='SMH8' and COL3='Index'">
									<xsl:value-of select="'FSMI H18-EUX'"/>
								</xsl:when>
								<xsl:when test="COL2='QCN8' and COL3='Comdty'">
									<xsl:value-of select="'C N18-ICL'"/>
								</xsl:when>
								<xsl:when test="COL2='QCN8' and COL3='Index'">
									<xsl:value-of select="'OMXS30 N18-OMF'"/>
								</xsl:when>
								<xsl:when test="COL2='SMH8' and COL3='Comdty'">
									<xsl:value-of select="'ZM H18'"/>
								</xsl:when>								
						...
						<AccountName>
							<xsl:choose>
								...
								<xsl:when test="COL17='052BAMJF1'">
									<xsl:value-of select="'KFMSFUT'"/>
								</xsl:when>
						...
						<xsl:variable name="STRATEGY_NAME">
							<xsl:choose>
								<xsl:when test ="normalize-space(COL6)='bmark'">									
									<xsl:value-of select ="concat(normalize-space(COL6),'_',normalize-space(substring-before(COL7,',')))"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select ="concat(normalize-space(COL6),'_',normalize-space(COL7))"/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:variable>
						...
						<Strategy>
							<xsl:choose>
								...
								<xsl:when test ="normalize-space(COL6)='bmark' and normalize-space(COL7)='blend (onshore),sp500' and $PRANA_STRATEGY != 'Spectrum'">
									<xsl:value-of select ="$STRATEGY_NAME"/>
								</xsl:when>
								<xsl:when test ="normalize-space(COL6)='bmark' and normalize-space(COL7)='blend (onshore),mscieafe' and $PRANA_STRATEGY != 'Spectrum'">
									<xsl:value-of select ="$STRATEGY_NAME"/>
								</xsl:when>
								...
								<xsl:when test ="normalize-space(COL6)='bmark' and normalize-space(COL7)='msci_emg (offshore),msciemg'">
									<xsl:value-of select ="$STRATEGY_NAME"/>
								</xsl:when>
								<xsl:when test ="normalize-space(COL6)='bmark' and normalize-space(COL7)='msci_eafe (offshore)'">
									<xsl:value-of select ="$STRATEGY_NAME"/>
								</xsl:when>
						...
						<SideTagValue>
							...
							<xsl:choose>
								...
								<xsl:when test="$Side='BC' and COL23='Option'">
									<xsl:value-of select="'B'"/>
								</xsl:when>
						...
						<Fees>
							...
							<xsl:choose>
								<xsl:when test="contains(COL23,'Option') and contains(COL16,'MSET') ">

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template name="Option">
		...
		<xsl:if test="contains(COL,'CALL') or contains(COL,'PUT')"> <!--<Description>-->
				...
				<xsl:if test="number($MarkPrice)">
					...
					<PositionMaster>
						...
						<xsl:variable name ="Month">
							<xsl:value-of select ="substring(COL61,5,2)"/>
						</xsl:variable>
						<xsl:variable name ="Date">
							<xsl:value-of select ="substring(COL61,7,2)"/>
						</xsl:variable>
						<xsl:variable name ="Year">
							<xsl:value-of select ="substring(COL61,1,4)"/>
						</xsl:variable>

	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($Quantity) and contains(COL43,'T')='true'">
					<PositionMaster>
						...
						<xsl:variable name="Quantitye">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL12 div 100000"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AvgPrice">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL64 div 1000000000"/>
							</xsl:call-template>
						</xsl:variable>
						<AvgPX>
							<xsl:choose>
						...
						<xsl:variable name="AdditionalFee6">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL96"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<Side>
							<xsl:choose>
								<xsl:when test ="contains(COL40,'B')">
									<xsl:value-of select="'Buy'"/>
								</xsl:when>
								<xsl:when test ="contains(COL40,'S')">
						...
						<xsl:variable name="Year">
							<xsl:value-of select="substring(COL28,1,4)"/>
						</xsl:variable>
						<xsl:variable name="Month">
							<xsl:value-of select="substring(COL28,5,2)"/>
						</xsl:variable>
						<xsl:variable name="Day">

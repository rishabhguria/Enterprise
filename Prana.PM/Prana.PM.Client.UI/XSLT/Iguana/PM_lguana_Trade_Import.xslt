			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($NetPosition)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_FUND_NAME" select="translate(normalize-space(COL10),$lower_CONST,$upper_CONST)"/>
						...
						<xsl:variable name="PB_BROKER_NAME">
						  <xsl:value-of select="translate(normalize-space(COL6),$lower_CONST,$upper_CONST)"/>
						</xsl:variable>

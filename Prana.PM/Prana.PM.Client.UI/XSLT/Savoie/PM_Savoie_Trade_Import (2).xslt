				...
				<xsl:if test="number($NetPosition)">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="string-length(COL41) &gt; 20">
						...
						<xsl:variable name="Symbol" select="COL41"/>
						...
						<TransactionType>
							<xsl:choose>
								<xsl:when test="COL11='OPTASSIGN'">
									<xsl:value-of select="'Assignment'"/>
								</xsl:when>
								<xsl:when test="COL11='OPTEXERCISE'">
									<xsl:value-of select="'Exercise'"/>
								</xsl:when>
								<xsl:when test="COL11='OPTEXPIRE'">
									<xsl:value-of select="'Expire'"/>
								</xsl:when>
								<!--<xsl:when test="COL11='RDRCUSTRCV'">
									<xsl:value-of select="'ExeriseIn'"/>
								</xsl:when>-->
							</xsl:choose>
						</TransactionType>

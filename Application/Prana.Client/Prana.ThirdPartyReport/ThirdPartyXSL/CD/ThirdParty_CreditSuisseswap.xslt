...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[AccountName = 'S1CS_SWAP' or AccountName = 'SAPCS_SWAP' or AccountName = 'SP29CS_SWAP' or AccountName = 'S2CS_SWAP']">
				...
				<ThirdPartyFlatFileDetail>
					...
					<!--format-number(AveragePrice, "###.0000")-->
					...
					<AccruedInterestSettlement>
						<xsl:value-of select ="$varAccruedInterest * FXRate_Taxlot"/>
					</AccruedInterestSettlement>

					<PrincipalSettlement>
						<xsl:value-of select ="GrossAmount * FXRate_Taxlot"/>
					</PrincipalSettlement>

					<!--<CommissionSettlement>
						<xsl:choose>
							<xsl:when test ="$varcommissionRate != ''">
								<xsl:value-of select="AllocatedQty * $varcommissionRate * FXRate_Taxlot"/>
							</xsl:when>
							<xsl:otherwise>
					...
					<FeesSettlement>
						<xsl:value-of select ="(StampDuty  + ClearingFee + MiscFees + OtherBrokerFee + TaxOnCommissions) * FXRate_Taxlot"/>
					</FeesSettlement>
					...
					<LeviesSettlement>
						<xsl:value-of select ="TransactionLevy * FXRate_Taxlot"/>
					</LeviesSettlement>

					<SECFeesSettlement>
						<xsl:value-of select ="SecFees * FXRate_Taxlot"/>
					</SECFeesSettlement>

					<NetProceedsSettlement>
						<xsl:value-of select ="$varNetProceedsLocal * FXRate_Taxlot"/>
					</NetProceedsSettlement>

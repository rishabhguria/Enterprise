...
/*
EXEC [P_GetMasterFundNAV_EOD_CrestLine] 1,'15','09-08-2020',1,1,1,1,1
*/

CREATE Procedure [dbo].[P_GetMasterFundNAV_EOD_CrestLine]                        
(                                 
	@ThirdPartyID int,                                            
...
Round(Sum( SubBal.CloseDrBalBase  -SubBal.CloseCrBalBase),2) As NAV,

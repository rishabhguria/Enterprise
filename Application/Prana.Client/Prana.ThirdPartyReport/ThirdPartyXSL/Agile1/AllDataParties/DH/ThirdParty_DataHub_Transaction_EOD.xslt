		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				...
				<ThirdPartyFlatFileDetail>
					...
					<TotalCommisionandFees>
						<xsl:choose>
							<xsl:when test="number(TotalCommisionandFees)">
								<xsl:value-of select="TotalCommisionandFees"/>
							</xsl:when>
					...
					<TotalCommisionandFeesBase>
						<xsl:choose>
							<xsl:when test="number(TotalCommisionandFeesBase)">
								<xsl:value-of select="TotalCommisionandFeesBase"/>
							</xsl:when>

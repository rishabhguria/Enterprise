...
{
    /// <summary>
    /// ThirdPartyGenerate Class 
    /// </summary>
    class ThirdPartyGenerate : ThirdPartyUIMap, ITestStep
    {
        /// <summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                Wait(3000);
                //Deselect already selected checkbox Header Row
        ...
        /// <summary>
        /// matchedSelect method compare test case of Datagrid with xls sheet and perform Generate operation.
        /// </summary>
        /// <param name="dr"></param>

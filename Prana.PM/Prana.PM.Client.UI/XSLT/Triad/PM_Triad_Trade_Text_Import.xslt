				...
				<xsl:if test="number($Quantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="ClearingFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,345,7) div 100"/>
							</xsl:call-template>
						</xsl:variable>
						<OrfFee>
							<xsl:choose>
						...
						<xsl:variable name="AdditionalFee1">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,721,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee2">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,735,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee3">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,749,11)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AdditionalFee4">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,763,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee5">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,777,11)"/>
							</xsl:call-template>
						</xsl:variable>

						<xsl:variable name="AdditionalFee6">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,791,11)"/>
							</xsl:call-template>
						</xsl:variable>

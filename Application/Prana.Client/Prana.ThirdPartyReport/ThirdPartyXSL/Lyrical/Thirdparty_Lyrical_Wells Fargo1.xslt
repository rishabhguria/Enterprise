...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='Okabena U.S. Satellite Equity Fund LLC' or FundName='The Purpleville Foundation: 14462208']">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='Okabena U.S. Satellite Equity Fund LLC'">
								--><!--<xsl:value-of select="'12570901'"/>--><!--
								<xsl:value-of select="concat(concat('=&quot;','12570901'),'&quot;')"/>
							</xsl:when>

							<xsl:when test="FundName='The Purpleville Foundation: 14462208'">
								--><!--<xsl:value-of select="'14462208'"/>--><!--
								<xsl:value-of select="concat(concat('=&quot;','14462208'),'&quot;')"/>
							</xsl:when>

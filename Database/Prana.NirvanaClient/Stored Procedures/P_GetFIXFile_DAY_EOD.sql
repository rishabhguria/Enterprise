/*
EXEC P_GetFIXFile_DAY_EOD 1,1,'2020-08-28',1,1,1,1,1,1
*/

Create PROC P_GetFIXFile_DAY_EOD
(
@thirdPartyID INT
...
--select * from #TempParentDay
select  * into #TempParentCurrentDay  from #TempParentDay where datediff(d,ArrivalTime_QuoteTime,@inputDate) =0
select   * into #TempParent from #TempParentDay where OrderRef  in (select OrderRef from #TempParentCurrentDay) --order by DecisionTime  desc
...
Drop Table #TempParentDay,#TempParent,#TempParentCurrentDay,#TempUpdatedParentOrderDetails
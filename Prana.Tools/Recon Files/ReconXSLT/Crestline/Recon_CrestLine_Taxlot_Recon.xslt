  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($Quantity) and not(contains(COL5,'CFD'))">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="COL3='Option'">
                  <xsl:value-of select="'EquityOption'"/>
                </xsl:when>
                <xsl:when test="COL3='Fixed Income'">
                  <xsl:value-of select="'FixedIncome'"/>
                </xsl:when>
                <xsl:when test="COL3='Future'">
            ...
            <xsl:variable name ="varDate" select="COL11"/>
            <TradeDate>

...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:variable name="FundName" select="//Comparision[contains(COL1,'Account Name')]/COL2"/>

      <xsl:variable name="Date" select="//Comparision[contains(COL1,'Processing Date')]/COL2"/>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity) and not(contains(COL3,'TOTALS')) and not(contains(COL3,'Total Investments')) and not(contains(COL3,'Northern Institutional Treasury Portfolio '))">
            <PositionMaster>

    ...
    <xsl:variable name="varFeeValue2">
 	...
 	<xsl:variable name ="varAllocationState">
	  ...
	  <Group 
			  ...
			  Broker="{CounterParty}" Custodian="NT" Exchange="{$varEXCODE}" TransactionType="{$varTransactionType}" CurrencyCode="{SettlCurrency}"
			  ...
			  TradeTax="{$varTradeTax}" OtherBrokerFees="{OtherBrokerFee}" NetAmount="{$varNetAmount}" Principal="{$varGrossAmount}" Description="FX"

				...
				<xsl:if test="number($Position)">
					<PositionMaster>
						...
						<xsl:variable name ="Year">
							<xsl:choose>
								<xsl:when test="string-length(normalize-space(COL14))= 6 and substring(COL14,6,1)='8'">
									<xsl:value-of select="concat('1',substring(COL14,6,1))"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 6">
									<xsl:value-of select="substring(COL14,6,1)"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 5 and substring(COL14,5,1)='8'">
									<xsl:value-of select="concat('1',substring(COL14,5,1))"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 5">
									<xsl:value-of select="substring(COL14,5,1)"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 4 and substring(COL14,4,1)='8'">
									<xsl:value-of select="concat('1',substring(COL14,4,1))"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 4">
									<xsl:value-of select="substring(COL14,4,1)"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 3 and substring(COL14,3,1)='8'">
									<xsl:value-of select="concat('1',substring(COL14,3,1))"/>
								</xsl:when>
								<xsl:when test="string-length(normalize-space(COL14))= 3">
									<xsl:value-of select="substring(COL14,3,1)"/>
								</xsl:when>
								<xsl:when test="contains(COL14,' ') and substring(substring-after(COL14,' '),2,1)='8'">
									<xsl:value-of select="concat('1',substring(substring-after(COL14,' '),2,1))"/>
								</xsl:when>
								<xsl:when test="contains(COL14,' ')">
						...
						<xsl:variable name="Symbol" select="substring-before(COL14,' ')"/>
						<Symbol>
							<xsl:choose>

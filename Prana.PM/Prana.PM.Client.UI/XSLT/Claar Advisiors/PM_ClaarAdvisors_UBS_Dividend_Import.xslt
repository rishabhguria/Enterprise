  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varDividend) and COL5 !='*'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varSedol" select="COL6"/>
            ...
            <ExDate>
              <xsl:value-of select="$varExtDate"/>
            </ExDate>
            <xsl:variable name="varRecordtDate">
              <xsl:call-template name="FormatDate">
            ...
            <RecordDate>
              <xsl:value-of select="$varRecordtDate"/>
            </RecordDate>
            ...
            <xsl:variable name="PB_CURRENCY_NAME" select="COL2"/>

            <xsl:variable name="PRANA_CURRENCY_ID">
              <xsl:value-of select="document('../ReconMappingXml/CurrencyMapping.xml')/CurrencyMapping/PB[@Name=$PB_Name_Curr]/CurrencyData[@PBCurrencyName=$PB_CURRENCY_NAME]/@PranaCurrencyID"/>
            </xsl:variable>
            <CurrencyID>

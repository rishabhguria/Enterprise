...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[CounterParty ='BARC']">			
					<ThirdPartyFlatFileDetail>
						<RowHeader>
							<xsl:value-of select ="'true'"/>
						</RowHeader>
            ...
            <xsl:variable name ="PB_DVP_FUND_CODE">
              <xsl:value-of select ="document('../ReconMappingXml/EOD_Mapping.xml')/FundMapping/PB[@Name='EOD']/FundData[@NirvanaAccountName=$PRANA_FUND_NAME]/@BarclaysDVP"/>
            </xsl:variable>
			...
			<AccountID>
              <xsl:choose>
                <xsl:when test ="$PB_DVP_FUND_CODE!=''">
                  <xsl:value-of select ="$PB_DVP_FUND_CODE"/>
                </xsl:when>
           ...
           <xsl:value-of select="$PRANA_FUND_NAME"/>
			...
			<xsl:variable name="THIRDPARTY_CUSTODIAN">
				<xsl:value-of select="document('../ReconMappingXml/EOD_Mapping.xml')/FundMapping/PB[@Name='EOD']/FundData[@NirvanaAccountName=$PRANA_FUND_NAME]/@Custodian"/>
			</xsl:variable>

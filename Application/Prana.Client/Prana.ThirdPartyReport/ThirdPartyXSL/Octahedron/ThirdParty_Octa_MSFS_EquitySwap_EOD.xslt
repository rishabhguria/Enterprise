...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template name="TaxLotIDBuilder">
    ...
    <xsl:if test="IsSwapped='false' and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset' and TaxLotState != 'Deleted'">
      ...
      <Group
					transType = "{$TransactionType}" TransStatus="{$varTaxlotStateTx}" BuySell="" LongShort="" PosType="{$Sidevar}"
					translevel="B" ClientRef="{PBUniqueID}" Associated="{PBUniqueID}" ExecAccount="038211165" AccountID="038211165"
					ExecBkr="{$CPVar}" SecType="{$varSecType}" SecID="{$varSymbol}" desc="{FullSecurityName}" TDate="{TradeDate}" SDate="{SettlementDate}"
					SCCY="{SettlCurrency}"	ExCode="" qty="{$QtySum}" 	Price="{format-number($varAveragePriceSettl,'###.00000')}"	type="G" prin="{format-number($varGroupGrsAmtSettl,'###.00')}"
					comm="{format-number($varCOMM,'###.00')}" comtype="F"
					Taxfees="{$varTaxFees}"
					Tax2="0"
					feesind="F" interest="{$varAccruedInterest}" interestindicator="{$varInterestindicator}" netamount="{format-number($varNetamountSettl,'###.00')}" hsyind="Y" custbkr="{$varCustodian1}" mmgr="" bookid=""
        ...
        <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset' and AccountName != 'Quantum Partners LP']">
          ...
          <ThirdPartyFlatFileDetail
								TaxLotState="{TaxLotState}" transType = "{$TransactionType}" TransStatus="{$varTaxlotState}" BuySell="" LongShort="" PosType="{$Sidevar}"
								translevel="A" ClientRef="{concat(PBUniqueID,'038Q51978')}" Associated="{PBUniqueID}" ExecAccount="038211165" AccountID="038QAH5I7"
								ExecBkr="{$CPVar}" SecType="{$varSecType}" SecID="{$varSymbol}" desc="{FullSecurityName}" TDate="{TradeDate}" SDate="{SettlementDate}"
								SCCY="{SettlCurrency}"	ExCode="" qty="{AllocatedQty}" Price="{format-number($varAveragePriceSettl,'###.00000')}" type="G" prin="{format-number($varGroupGrsAmtSettl,'###.00')}"
								comm="{format-number($varCOMM,'###.00')}" comtype="F"
								Taxfees="{$varTaxFees}"
								Tax2="0"
								feesind="F" interest="{$varAccruedInterest}" interestindicator="{$varInterestindicator}" netamount="{format-number($varNetamountSettl,'###.00')}" hsyind="Y" custbkr="{$varCustodian1}" mmgr="" bookid=""
    ...
    <xsl:if test="TaxLotState = 'Deleted' and IsSwapped='false' and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset'">
      ...
      <Group
					transType = "{$TransactionType2}" TransStatus="{$varTaxlotStateTx}" BuySell="" LongShort="" PosType="{$Sidevar}"
					translevel="B" ClientRef="{PBUniqueID}" Associated="{PBUniqueID}" ExecAccount="038211165" AccountID="038211165"
					ExecBkr="{$CPVar}" SecType="{$varSecType}" SecID="{$varSymbol}" desc="{FullSecurityName}" TDate="{TradeDate}" SDate="{SettlementDate}"
					SCCY="{SettlCurrency}"	ExCode="" qty="{$QtySum}" 	Price="{format-number($varAveragePriceSettl,'###.00000')}"	type="G" prin="{format-number($varGroupGrsAmtSettl,'###.00')}"
					comm="{format-number($varCOMM,'###.00')}" comtype="F"
					Taxfees="{$varTaxFees}"
					Tax2="0"
					feesind="F" interest="0" interestindicator="" netamount="{format-number($varNetamountSettl,'###.00')}" hsyind="Y" custbkr="{$varCustodian1}" mmgr="" bookid=""
					dealid="" taxlotid="" taxdate="" taxprice="" closeoutmethod="" exrate="" acqdate="" comments="" fxind=""
					EntityID="{EntityID}" TaxLotState="{TaxLotState}">
        ...
        <!-- ...selecting all the records for this Group... -->
        <!--<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and CounterParty != 'Undefined' and contains(AccountName,'Quantum Partners LP')!='true' and contains(AccountName,'MS Investment Partners')!='true']">-->
        <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID and CounterParty != 'Undefined' and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOXcollapse' and CounterParty!='SwapReset' and IsSwapped='false']">
          <!-- ...and building a ThirdPartyFlatFileDetail for each -->
          <!--<xsl:if test="TaxLotState!='Deleted'">-->
          ...
          <ThirdPartyFlatFileDetail
								TaxLotState="{TaxLotState}" transType = "{$TransactionType2}" TransStatus="{$varTaxlotState}" BuySell="" LongShort="" PosType="{$Sidevar}"
								translevel="A" ClientRef="{concat(PBUniqueID,'038Q51978')}" Associated="{PBUniqueID}" ExecAccount="038211165" AccountID="{'038QAH5I7'}"
								ExecBkr="{$CPVar}" SecType="{$varSecType}" SecID="{$varSymbol}" desc="{FullSecurityName}" TDate="{TradeDate}" SDate="{SettlementDate}"
								SCCY="{SettlCurrency}"	ExCode="" qty="{AllocatedQty}" Price="{format-number($varAveragePriceSettl,'###.00000')}" type="G" prin="{format-number($varGroupGrsAmtSettl,'###.00')}"
								comm="{format-number($varCOMM,'###.00')}" comtype="F"

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template name="TaxLotIDBuilder">
		...
		<Group 
				...
				translevel="B" ClientRef="{PBUniqueID}" Associated="{PBUniqueID}" ExecAccount="038305140" AccountID="038305140"
				...
				dealid="" taxlotid="" taxdate="" taxprice="" closeoutmethod="" exrate="" acqdate="" comments=""
			...
			<xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[PBUniqueID = $I_GroupID]">
				...
				<ThirdPartyFlatFileDetail
							...
							translevel="A" ClientRef="{concat(substring(EntityID,3),'C')}" Associated="{PBUniqueID}" ExecAccount="038305140" AccountID="{$AccountId_T}"
							ExecBkr="{$CPVar}" SecType="{$varSecType}" SecID="{$varSymbol}" desc="{translate(FullSecurityName,',','')}" TDate="{TradeDate}" SDate="{SettlementDate}"
							...
							Taxfees="{$TaxFees}" 
							Tax2="0"
							feesind="F" interest="0" interestindicator="" netamount="{format-number(NetAmount,'###.00')}" hsyind="N" custbkr="MSCO" mmgr="" bookid=""
							dealid="" taxlotid="" taxdate="" taxprice="" closeoutmethod="" exrate="" acqdate="" comments=""

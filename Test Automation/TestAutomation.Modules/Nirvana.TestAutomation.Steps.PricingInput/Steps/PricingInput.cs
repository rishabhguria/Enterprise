...
{
    public class PricingInput : PricingInputUIMap, ITestStep
    {
        /// <summary>
        /// Runs the test.
        /// </summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                //if (!CheckBoxLastPrice.IsChecked)
                //    CheckBoxLastPrice.Click(MouseButtons.Left);
                //Wait(8000);
                ...
                foreach (DataRow dataRow in testData.Tables[sheetIndexToName[0]].Rows)
                {
                    ...
                    if (foundRow.Length > 0)
                    {
                        ...
                        if (dataRow.Table.Columns.Contains(TestDataConstants.COL_SM_SHAREOUTSTANDING))
                        {

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[Asset!='FX' and Asset!='FXForward' and (AccountName='NT - IAMG' or AccountName='GS - D9MA' or AccountName='GS SWAP - D9MA') and (CurrencySymbol='AUD' or CurrencySymbol='HKD' or CurrencySymbol='IDR' or CurrencySymbol='JPY' or CurrencySymbol='KRW' or CurrencySymbol='MYR' or CurrencySymbol='NZD' or CurrencySymbol='PHP' or CurrencySymbol='SGD'  or CurrencySymbol='THB') or(Symbol='J37-SES')]">
				...
				<ThirdPartyFlatFileDetail>				
					...
					<xsl:variable name="varCounterPartyAndTradeCurrency">
						<xsl:choose>
							<xsl:when test ="CurrencySymbol='USD' or CurrencySymbol='CAD' or CurrencySymbol='BRL' or CurrencySymbol='CLP'">

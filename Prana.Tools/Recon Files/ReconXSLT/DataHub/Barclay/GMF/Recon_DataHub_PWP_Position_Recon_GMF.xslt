	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select ="//Comparision">
				...
				<xsl:choose>
					<xsl:when test="number($Quantity)and COL2!='Cash and Equivalents' and COL2!='Currency'and contains(COL2,'Future') and COL1='BCI-FUT'">
						...
						<PositionMaster>
							...
							<xsl:variable name="PB_FUND_NAME" select="'GMF_Barclays'"/>

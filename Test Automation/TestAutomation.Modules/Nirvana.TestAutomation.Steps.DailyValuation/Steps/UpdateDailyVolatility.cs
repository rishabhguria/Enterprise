...
{
    public class UpdateDailyVolatility : DailyVolatilityUIMap, ITestStep
    {
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                OpenDailyVolatilityTab();
                UpdateDailyVolatilityData(testData, sheetIndexToName);
        ...
        /// <summary>
        /// Update Daily Volatility data.
        /// </summary>
        /// <param name="testData"></param>
        /// <param name="sheetIndexToName"></param>
        private void UpdateDailyVolatilityData(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            try
            {

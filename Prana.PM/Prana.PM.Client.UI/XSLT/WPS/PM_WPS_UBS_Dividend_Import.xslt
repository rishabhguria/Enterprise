      ...
      <xsl:for-each select="//PositionMaster">
        <xsl:variable name="varDividend">
          <xsl:call-template name="Translate">
            <xsl:with-param name="Number" select="substring(COL1,106,9)"/>
          </xsl:call-template>
        </xsl:variable>
        <xsl:if test="number($varDividend) and substring(COL1,14,2)='dv'">
          <PositionMaster>
            ...
            <xsl:variable name="PB_Symbol" select="substring(COL1,20,4)"/>
            ...
            <xsl:variable name="varDate">
              <xsl:value-of select="substring(COL1,33,8)"/>
            </xsl:variable>

...
namespace Nirvana.Admin.Controls
{
	...
	public class GridCompanyCounterPartiesFundLevelTags : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.grdFundLevelTags.Location = new System.Drawing.Point(10, 182);
			this.grdFundLevelTags.Name = "grdFundLevelTags";
			this.grdFundLevelTags.ReadOnly = true;
			this.grdFundLevelTags.Size = new System.Drawing.Size(640, 78);
			...
			this.colOnBehalfOfCompID.Width = 75;
			// 
			// colOnBehalfOfSubID
			// 
			...
			this.btnDelete.Location = new System.Drawing.Point(576, 264);
			...
			this.btnEdit.Location = new System.Drawing.Point(494, 264);
			...
			this.uctCreateCompanyCounterPartyFundLevelTags.Location = new System.Drawing.Point(136, 6);
			this.uctCreateCompanyCounterPartyFundLevelTags.Name = "uctCreateCompanyCounterPartyFundLevelTags";
			this.uctCreateCompanyCounterPartyFundLevelTags.Size = new System.Drawing.Size(394, 170);
			...
			this.Size = new System.Drawing.Size(662, 292);
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			if(grdFundLevelTags.VisibleRowCount > 0)
			{
				if(MessageBox.Show(this, "Do you want to delete this Fund Level Tag?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
				{
					...
					companyCounterPartyVenueDetail.UserID = int.Parse(grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 6].ToString());
					companyCounterPartyVenueDetail.ClearingFirmPrimeBrokerID = int.Parse(grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 7].ToString());
					companyCounterPartyVenueDetail.DeliverToCompanyID = grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 8].ToString();
					companyCounterPartyVenueDetail.DeiverToSubID = grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 9].ToString();
					companyCounterPartyVenueDetail.SenderCompanyID = grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 10].ToString();
					companyCounterPartyVenueDetail.FundID = int.Parse(grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 11].ToString());
					companyCounterPartyVenueDetail.OnBehalfOfCompID = grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 12].ToString();
					companyCounterPartyVenueDetail.CMTAGiveUp = int.Parse(grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 15].ToString());
					companyCounterPartyVenueDetail.OnBehalfOfSubID = grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 13].ToString();
					companyCounterPartyVenueDetail.CompanyCounterPartyVenueTagID = int.Parse(grdFundLevelTags[grdFundLevelTags.CurrentCell.RowNumber, 14].ToString());

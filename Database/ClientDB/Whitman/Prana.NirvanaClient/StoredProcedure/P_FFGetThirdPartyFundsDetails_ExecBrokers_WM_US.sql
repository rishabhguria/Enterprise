...
*/
CREATE PROCEDURE [dbo].[P_FFGetThirdPartyFundsDetails_ExecBrokers_WM_US] (@inputDate DATETIME)
AS
SELECT
	-- 1 as Tag , --ashish            
...
WHERE DateDiff(d, VT.AUECLocalDate, @inputDate) = 0
	AND (
		...
		OR Currency.CurrencyID = '3'
		) --And T_CompanyFunds.FundName like ('Maerisland%')                      
	--where AUECLocalDate > '2016-01-30 23:59:00.000' and AUECLocalDate < '2016-02-02 00:00:00.000' --And T_CompanyFunds.FundName like ('Maerisland%')                      

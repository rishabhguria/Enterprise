...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template name="Option">
		...
		<xsl:if test="COL12 ='P' or COL12 ='C'">
			...
			<xsl:variable name="ExpiryYear">
				<xsl:value-of select="substring(normalize-space(COL8),3,2)"/>
			</xsl:variable>
			...
			<xsl:variable name="StrikePrice">
				<xsl:value-of select="format-number(normalize-space(COL11),'#.00')"/>
			</xsl:variable>
					...
					<xsl:when test="number($Quantity)">
						<PositionMaster>
							...
							<xsl:variable name="Asset">
								<xsl:choose>
									<xsl:when test="COL12 ='P' or COL12 ='C'">
							...
							<xsl:variable name="TotalCommissionandFees">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="COL19 + COL20 + COL21 + COL22 + COL23 + COL24"/>
								</xsl:call-template>
							</xsl:variable>
							...
							<Side>
								<xsl:choose>
									<xsl:when test="$Asset ='EquityOption'">
										<xsl:choose>
											<xsl:when test="$Side='1' and COL35='O'">
												<xsl:value-of select="'Buy to Open'"/>
											</xsl:when>
											<xsl:when test="$Side='1' and COL35='C'">
												<xsl:value-of select="'Buy to Close'"/>
											</xsl:when>
											<xsl:when test="$Side='2' and COL35 ='C'">
												<xsl:value-of select ="'Sell to Close'"/>
											</xsl:when>
											<xsl:when test="$Side='2' and COL35 ='O'">
									...
									<xsl:otherwise>
										<xsl:choose>
											<xsl:when test="$Side='1' and COL35='L'">
												<xsl:value-of select="'Buy'"/>
											</xsl:when>
											<xsl:when test="$Side='1' and COL35='S'">
												<xsl:value-of select="'Buy to Close'"/>
											</xsl:when>
											<xsl:when test="$Side='2' and COL35 ='L'">
												<xsl:value-of select ="'Sell'"/>
											</xsl:when>
											<xsl:when test="$Side='2' and COL35 ='S'">

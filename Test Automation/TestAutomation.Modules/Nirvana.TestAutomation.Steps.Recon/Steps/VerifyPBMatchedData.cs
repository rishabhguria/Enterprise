...
{
    class VerifyPBMatchedData : ReconUIMap, ITestStep
    {
        /// <summary>
        /// Runs the test.
        /// </summary>
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            try
            {
                ...
                List<String> errors = VerifyPBMatchData(testData, sheetName);
                if (errors.Count > 0)
                {
        ...
        private List<String> VerifyPBMatchData(DataSet testData, String sheetName)
        {
            try
            {
                string uiName = "PBMatchedData";

	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select="//PositionMaster">
				<xsl:if test="COL1 !='Advisor' and COL5 !='FORWARD'">
				<PositionMaster>											
					...
					<xsl:variable name="varMappedCurrency">
						<xsl:value-of select="document('../ReconMappingXml/CurrencyMapping.xml')/CurrencyMapping/PB[@Name='GSEC']/CurrencyData[@CurrencyDesc=$varCurrency]/@CurrencyName"/>	
					</xsl:variable>

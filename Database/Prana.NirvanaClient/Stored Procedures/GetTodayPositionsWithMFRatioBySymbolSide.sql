...
CREATE Procedure [dbo].[GetTodayPositionsWithMFRatioSymbolSide]          
(          
  @date datetime          
)           
As        
...
PT.OrderSideTagValue      
 ...
 and TaxLotOpenQty<>0 Group By Symbol,FundID,PT.OrderSideTagValue
...
RTRIM(FT.OrderSideTagValue) as COL12

/****** Object:  StoredProcedure [dbo].[P_NT_DeleteCashAccruals]    Script Date: 05/13/2015 16:36:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- =============================================
--Exec P_NT_DeleteCashAccruals '1/1/2015','05/01/2015' 
-- =============================================
CREATE PROCEDURE [dbo].[P_NT_DeleteCashAccruals]
...
BEGIN
	...
	Delete A From T_NT_CashAccruals A Join #Fund FS On FS.Fund = A.AcctName Where Datediff(d,@FromDate,RunDate) >= 0 and Datediff(d,RunDate,@ToDate) >= 0  

    ...
    <ThirdPartyFlatFileDetailCollection>
      <xsl:attribute name="xsi:noNamespaceSchemaLocation">C:/UpdatedTP/Prana_Final.xsd</xsl:attribute>
		...
		<ThirdPartyFlatFileDetail>
		   ...
		   <OrderQuantity>
			...
			<BankToExecuteFX>
				<xsl:value-of select ="'BankToExecuteFX'"/>
			</BankToExecuteFX>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
		  <ThirdPartyFlatFileDetail>
			  ...
			  <SECfees>
				  <xsl:value-of select ="SecFees + OtherBrokerFee + StampDuty + TransactionLevy + ClearingFee + TaxOnCommissions"/>
			  </SECfees>
			  ...
			  <xsl:variable name="varClearingBroker">
				  <xsl:value-of select="document('../ReconMappingXml/ClearingBrokerMapping.xml')/ClearingBrokerMapping/PB[@Name='UNIONBANK']/CBData[@CounterParty=$varCounterParty]/@ClearingBroker"/>
			  </xsl:variable>
			  ...
			  <!--<ClearingAgent>
				  <xsl:value-of select ="'Union Bank'"/>
			  </ClearingAgent>-->

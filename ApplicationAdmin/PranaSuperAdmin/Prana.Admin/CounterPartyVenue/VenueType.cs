...
namespace Nirvana.Admin
{
	...
	public class VenueType : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(VenueType));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Type", 1, null, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Descending, false);
			...
			this.btnSave.Location = new System.Drawing.Point(54, 230);
			...
			this.grpVenueType.Location = new System.Drawing.Point(56, 186);
			...
			this.btnEdit.Location = new System.Drawing.Point(96, 160);
			...
			this.btnReset.Location = new System.Drawing.Point(132, 230);
			...
			this.btnDelete.Location = new System.Drawing.Point(174, 160);
			...
			this.btnClose.Location = new System.Drawing.Point(210, 230);
			...
			this.grdVenueType.FlatMode = true;
			...
			this.grdVenueType.Size = new System.Drawing.Size(332, 154);
		...
		{	
			...
			Nirvana.Admin.BLL.VenueType venueType = new Nirvana.Admin.BLL.VenueType();
			...
			if(newVenueTypeID == -1)
			{
				errorProvider1.SetError(btnSave, "VenueType Already Exists");
			}
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(grdVenueType.Rows.Count > 0)
				{
					...
					if(MessageBox.Show(this, "Do you want to delete this VenueType?", "Nirvana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
					{
						...
						bool chkVarraible = VenueManager.DeleteVenueType(venueTypeID, false);
						if(!(chkVarraible))
						{

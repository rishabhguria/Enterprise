...
/*
EXEC P_VeocityClearing_Pershing_EOD 1,'64,69,66,10,8,9,67,70,65,68,108','2022-01-26',1,'1,2',1,0,12,0

*/

CREATE Procedure [dbo].[P_VeocityClearing_Pershing_AllDataPerty_EOD]
(
	@thirdPartyID INT
...
If (@fileFormatID = 139)
Begin
Delete From @Fund Where FundId not in('8','9','10','64','65','66','67','68','69','70','108','186','175')
End
...
Select *
InTo #Temp_Trades_Grouped_S
From #Temp_Trades_Grouped

update G
set G.AccountName = S.AccountName
from #Temp_Trades_Grouped G
inner join #Temp_Trades_Grouped_S S on S.UniqueID=G.UniqueID where S.AccountName = 'SMW Local 12' 

Select * from #Temp_Trades_Grouped
Order By DefKey, CustomOrdering, AccountName, Symbol, Side

Drop Table #Temp_Trades_Grouped,#Temp_Trades_Grouped_S,#Temp_Trades_Grouped_G

      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($Position)">
          <PositionMaster>
            ...
            <xsl:variable name="PB_CountnerParty" select="COL22"/>
            ...
            <CounterPartyID>
              <xsl:choose>
                <xsl:when test="contains(COL22,'WEEDEN')">
                  <xsl:value-of select="'1'"/>
                </xsl:when>
				<xsl:when test="contains(COL22,'GOLDMAN')">
            ...
            <xsl:variable name="varSide">
              <xsl:choose>
                <xsl:when test="$varAsset='EquityOption'">
                  <xsl:value-of select="concat(COL2,' ',COL28)"/>
                </xsl:when>
                <xsl:otherwise>

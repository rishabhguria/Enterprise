	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select ="//Comparision">
				...
				<xsl:choose>
					<xsl:when test="number($Quantity)and COL25 !='FX' and COL1!='DPRXX'">
					<PositionMaster>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL14,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<Commission>
							<xsl:choose>
						...
						<xsl:variable name="OtherBrokerFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL15,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<Fees>
							<xsl:choose>
						...
						<xsl:variable name="ClearingFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL16,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<ClearingFee>
							<xsl:choose>
						...
						<xsl:variable name="AUECFee1">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL18,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<AUECFee1>
							<xsl:choose>
						...
						<xsl:variable name="AUECFee2">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL19,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<AUECFee2>
							<xsl:choose>
						...
						<xsl:variable name="StampDuty">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL20,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<StampDuty>
							<xsl:choose>
						...
						<xsl:variable name="GrossNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL27,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<GrossNotionalValue>
							<xsl:choose>
						...
						<xsl:variable name="GrossNotionalValueBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL28,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="NetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL29,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<NetNotionalValue>
							<xsl:choose>
						...
						<xsl:variable name="NetNotionalValueBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL30,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="TotalCommissionandFees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL31,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="TotalCommissionandFeesBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL32,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="ClearingBrokerFeeBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL39,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="MiscFees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="format-number(COL17,'##.####')"/>
							</xsl:call-template>
						</xsl:variable>
						<MiscFees>
							<xsl:choose>

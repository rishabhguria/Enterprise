...
using Prana.Utilities.SymbolUtilities;
...
namespace Prana.Utilities.UI.UIUtilities
{
    public partial class PranaOptionCtrl : UserControl
    {
        ...
        private int _symbology = (int)ApplicationConstants.SymbologyCodes.TickerSymbol;
        ...
        public void SetUp(int defaultSymbology, int defaultOptionType)
        {
            try
            {
        ...
        public void RefreshControl(int defaultSymbology, int defaultOptionType)
        {
        ...
        private void BindOptionTypeCombo(int defaultOptionType)
        {
            try
            {
                List<EnumerationValue> ds = Prana.Utilities.MiscUtilities.EnumHelper.ConvertEnumForBindingWithAssignedValues(typeof(OptionType));

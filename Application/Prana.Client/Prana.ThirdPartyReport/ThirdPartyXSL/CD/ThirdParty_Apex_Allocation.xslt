      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:variable name="PRANA_MasterFund_Name">
            <xsl:value-of select="document('../ReconMappingXml/MasterFundMapping.xml')/MasterFundMapping/PB[@Name= 'BNY']/MasterFundData[@FundName=$Prana_FundName]/@MasterFundName"/>
          </xsl:variable>

  ...
  <xsl:template match="/">
    <DocumentElement>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Quantity) and (COL5!='' or COL5='*') and contains(COL8,'CASH')!='true' and not (contains(COL9,'Money Market Fund')) ">
            <PositionMaster>
              ...
              <xsl:variable name="PB_FUND_NAME" select="COL81"/>

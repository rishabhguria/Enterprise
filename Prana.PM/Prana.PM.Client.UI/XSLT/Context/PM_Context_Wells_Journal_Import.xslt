        ...
        <xsl:if test="number($varCash)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME">
              <xsl:choose>
                <xsl:when test="COL19='MISC EXPENSE'">
                  <xsl:value-of select="'MISC_EXP'"/>
                </xsl:when>

                <xsl:when test="COL19='MISC INCOME'">
                  <xsl:value-of select="'MISC_INC'"/>
                </xsl:when>
                <xsl:when test="COL19='CASH WTHDRWL'">
                  <xsl:value-of select="'CASH_WDL'"/>
                </xsl:when>

                <xsl:when test="COL19='CASH DEPOSIT'">
                  <xsl:value-of select="'CASH_DEP'"/>
                </xsl:when>

                <xsl:when test="COL19='SHORT RBT INCOME' or COL19='INT INCOME'">
                  <xsl:value-of select="'Interest_Income'"/>
                </xsl:when>              

                <xsl:when test="COL19='INT EXPENSE'">

			...
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:if test="number($varAmount)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_SYMBOL_NAME" select="COL5"/>
						...
						<xsl:variable name="varMonth">
							<xsl:value-of select="substring($varExDate,5,2)"/>
						</xsl:variable>
						<xsl:variable name="varDAY">
							<xsl:value-of select="substring($varExDate,7,2)"/>
						</xsl:variable>
						<xsl:variable name="varYEAR">
							<xsl:value-of select="substring($varExDate,1,4)"/>
						</xsl:variable>

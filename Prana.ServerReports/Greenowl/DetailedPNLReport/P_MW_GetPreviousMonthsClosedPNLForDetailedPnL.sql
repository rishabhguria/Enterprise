...
Execution Statement:                       
 P_MW_GetPreviousMonthsClosedPNLForDetailedPnL '4/16/2015','1245,1213,1214,1238,1239,1240,1241,1242,1244,1243,1246','6,1,2',0,'',Symbol'        
*************************************************/        
...
Where Datediff (Day , @YTDFromdate , Rundate) >= 0 and Datediff(Day , Rundate , @PreviousMonthEndDate) >= 0                       
and Open_CloseTag <> 'Accruals' and Open_CloseTag='C'          
...
If(@SearchString <> '')                                           
 Begin                                         
  ...
  begin                            
  SELECT * FROM #TempPreviousMonthsPNL                                
  Inner Join #Symbol on #Symbol.items = #TempPreviousMonthsPNL.underlyingSymbol                        Order by symbol                                
  end                                  
...
Else                                           
 Begin                                            
  Select * from #TempPreviousMonthsPNL Order By symbol                                  
 End                 

    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:variable name="varNewSecFee">
            <xsl:choose>
              <xsl:when test="$varFees=''">
                <xsl:value-of select="0"/>
              </xsl:when>
              <xsl:otherwise>
          ...
          <NetAmount>
            <xsl:choose>
              <xsl:when test ="Side='Buy'">
                <xsl:value-of select ="format-number(((AllocatedQty * $varPrice) + $varNewCommission + $varNewSecFee),'#.##')"/>
              </xsl:when>
          ...
          <Fees>
            <xsl:value-of select="$varNewSecFee"/>
          </Fees>
          <InstructionToFollow>
            <xsl:value-of select="''"/>
          </InstructionToFollow>

				...
				<xsl:if test="number($Quantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="contains(substring(substring-after(substring-after(substring-after(COL2,' '),' '),' '),1,1),P) or contains(substring(substring-after(substring-after(substring-after(COL2,' '),' '),' '),1,1),C)">
						...
						<xsl:variable name="PB_BROKER_NAME" select="COL3"/>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="translate(COL8,'$','')"/>
							</xsl:call-template>
						</xsl:variable>
						<Commission>
							<xsl:choose>
						...
						<xsl:variable name="OtherBrokerFees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="translate(COL9,'$','')"/>
							</xsl:call-template>
						</xsl:variable>
						<Fees>
							<xsl:choose>
						...
						<xsl:variable name="OrfFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="translate(COL10,'$','')"/>
							</xsl:call-template>
						</xsl:variable>
						<OrfFee>
							<xsl:choose>
						...
						<SideTagValue>
							...
							<xsl:choose>
								<xsl:when test="$Asset='EquityOption'">
									<xsl:choose>
										<xsl:when test ="$Side='Bought'">
											<xsl:value-of select ="'Buy to Open'"/>
										</xsl:when>
										
										<xsl:when test ="$Side='Sold'">
											<xsl:value-of select ="'Cell to Open'"/>
										</xsl:when>

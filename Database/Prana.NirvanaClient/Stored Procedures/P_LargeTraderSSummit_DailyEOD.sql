...
/*
EXEC P_LargeTraderSSummit_DailyEOD 1,'1,2','02-18-2021',1,'1,2',1,0,12,0

DESC: https://jira.nirvanasolutions.com:8443/browse/ONB-2168
*/

CREATE Procedure [dbo].[P_LargeTraderSSummit_DailyEOD]
(
	@thirdPartyID INT
...
SET @FirstDateofMonth = @inputDate --(SELECT DATEADD(m, DATEDIFF(m, 0, @inputDate), 0)) 

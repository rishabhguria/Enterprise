      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varCash)" >
          ...
          <PositionMaster>
            ...
            <Description>
              <xsl:choose>
                <xsl:when test="$varDescription='TRANSFER TO FUTURES ACCOUNT'">
                  <xsl:value-of select="'Sweep To future'"/>
                </xsl:when>
				   <xsl:when test="$varDescription='TRANSFER FROM FUTURES ACCOUNT'">
                  <xsl:value-of select="'Sweep to Brokerage'"/>
                </xsl:when>
			   <xsl:when test="$varDescription='HARD TO BORROW FEE'">
                  <xsl:value-of select="'Hard To Borrow Fee'"/>
                </xsl:when>
			   <xsl:when test="$varDescription='MARGIN INTEREST ADJUSTMENT'">
                  <xsl:value-of select="'Margin Interest Adjustment'"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="''"/>
                </xsl:otherwise>

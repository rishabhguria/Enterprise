...
/*
exec [P_GetOpenPos_Const_Neovest] @thirdPartyID=86,@companyFundIDs=N'1257',
...
CREATE Procedure [dbo].[P_GetOpenPos_LeapDistrict_Neovest]                        
(                                 
@ThirdPartyID int,                                            
...
Group By Temp.AccountName,Temp.Symbol,Temp.PositionIndicator,Temp.AssetClass,temp.ExpirationDate,Temp.StrategyID

  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($varCash) and (COL7='Charges' or COL7='Interest' or COL7='Deposit' or COL7='Withdraw')">
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME">
              <xsl:choose>
                <xsl:when test="COL10 ='INTEREST ON DEBIT BALANCE' or COL7='Interest'">
                  <xsl:value-of select="'Interest_Expense'"/>
                </xsl:when>

                <xsl:when test="COL10 ='TICKET CHARGE'">
            ...
            <JournalEntries>
              <xsl:choose>
                <xsl:when test="normalize-space(COL10) ='SHORT INTEREST REBATE'">

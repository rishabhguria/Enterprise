...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL3),' '),' '),' '),' '),' ') ='P' or substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL3),' '),' '),' '),' '),' ') ='C'">
      ...
      <xsl:variable name="ExpiryMonth">
        <xsl:value-of select="substring-before(substring-after(substring-after(substring-after(COL3,' '),' '),' '),' ')"/>
      </xsl:variable>
      ...
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring-before(substring-after(substring-after(substring-after(substring-after(normalize-space(COL3),' '),' '),' '),' '),' '),'##.##')"/>
      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($Quantity)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PB_FUND_NAME" select="concat(COL3,COL5)"/>
         ...
         <xsl:variable name="Side">
              <xsl:value-of select="COL11"/>
                ...
                <xsl:choose>
                  <xsl:when test="COL11='1'">
                    <xsl:value-of select="COL38"/>
                  </xsl:when>
                  <xsl:when test="COL11='2'">
                    <xsl:value-of select="COL39 * -1"/>
                  </xsl:when>
                </xsl:choose>              

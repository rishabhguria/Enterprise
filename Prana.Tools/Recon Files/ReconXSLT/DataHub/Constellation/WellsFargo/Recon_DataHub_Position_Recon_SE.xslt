					...
					<xsl:when test="number($varQuantity)">
						...
						<GrossNotionalValueBase>
							...
							<xsl:variable name="NetNotionalValueBase">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="format-number(COL33,'##.####')"/>
								</xsl:call-template>
							</xsl:variable>
							...
							<xsl:variable name="UnitCost">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="format-number(COL35,'##.####')"/>
								</xsl:call-template>
							</xsl:variable>
							<UnitCost>
								<xsl:choose>
							...
							<xsl:variable name="MarketValue">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="format-number(COL6,'##.####')"/>
								</xsl:call-template>
							</xsl:variable>
							<MarketValue>
								<xsl:choose>
							...
							<xsl:variable name="MarkPrice">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="format-number(COL4,'##.###') "/>
								</xsl:call-template>
							</xsl:variable>
							<MarkPrice>
								<xsl:choose>
							...
							<xsl:variable name="MarkPriceBase">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="format-number(COL5,'##.###') "/>
								</xsl:call-template>
							</xsl:variable>
							<MarkPriceBase>
								<xsl:choose>

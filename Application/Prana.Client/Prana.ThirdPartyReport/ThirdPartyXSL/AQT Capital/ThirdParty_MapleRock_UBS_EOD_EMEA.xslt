...
xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>		
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[ CurrencySymbol = 'AED'   or CurrencySymbol = 'AMD'   or CurrencySymbol = 'AOA'   or CurrencySymbol = 'AZN'   or CurrencySymbol = 'BAM'   or CurrencySymbol = 'BGN'   or CurrencySymbol = 'BHD'   or CurrencySymbol = 'BIF'   or CurrencySymbol = 'BWP'   or CurrencySymbol = 'BYN'   or CurrencySymbol = 'CDF'   or CurrencySymbol = 'CHF'   or CurrencySymbol = 'CVE'   or CurrencySymbol = 'CZK'   or CurrencySymbol = 'DJF'   or CurrencySymbol = 'DKK'   or CurrencySymbol = 'DZD'   or CurrencySymbol = 'EGP'   or CurrencySymbol = 'ERN'   or CurrencySymbol = 'ETB'   or CurrencySymbol = 'EUR'   or CurrencySymbol = 'GBP'   or CurrencySymbol = 'GEL'   or CurrencySymbol = 'GHS'   or CurrencySymbol = 'GMD' 
				...
				<ThirdPartyFlatFileDetail>
					...
					<ProductCode>
						<xsl:choose>
							...
							<xsl:when test="Asset = 'Equity' or Asset = 'EquityOption' or Asset = 'FixedIncome'" >

...
{
    class VerifyThirdPartySend:ThirdPartyUIMap,ITestStep
    {
        /// <summary>
       ...
       /// <summary>
       /// Verify data third party data after send
       /// </summary>
       ...
       /// <returns></returns>
        private List<string> VerifyData(DataTable dTable)
        {
            ...
            try
            {
                ...
                string fileName = GetLastModifiedFileFromArchives();

                string filePath = (ApplicationArguments.ClientReleasePath + "\\EOD\\ISOX\\Archives\\" + fileName);

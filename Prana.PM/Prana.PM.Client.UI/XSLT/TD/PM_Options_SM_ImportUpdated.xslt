...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="Option">
		...
		<!--MANU US 03/15/2024 C33.000 Equity-->
		...
		<xsl:variable name="ExpiryYear">
			<xsl:value-of select="substring(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),'/'),'/'),3,2)"/>
		</xsl:variable>
		...
		<xsl:variable name="StrikePrice">
			<xsl:value-of select="format-number(substring-before(substring(substring-after(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),'/'),'/'),' '),2),' '),'##.00')"/>
		</xsl:variable>
				...
				<xsl:if test="$varAssetType='EquityOption'">
					...
					<PositionMaster>
						...
						<xsl:variable name="varExpiryYear">
							<xsl:value-of select="concat('20',substring(substring-after(substring-after(substring-after(substring-after(normalize-space(COL4),' '),' '),'/'),'/'),3,2))"/>
						</xsl:variable>

                  ...
                  <xsl:value-of select="$Date"/>
						...
						<xsl:variable name="varCOL108">
							...
							<xsl:choose>
								...
								<xsl:when test="$varCOL107 &gt; 0">
									<xsl:value-of select="$varCOL107"/>
								</xsl:when>

								<xsl:when test="$varCOL107 &lt; 0">
									<xsl:value-of select="$varCOL107 * (-1)"/>
								</xsl:when>
						...
						<xsl:variable name="StampDuty">
							<xsl:choose>
								...
								<xsl:when test="COL3='USD' and (normalize-space(COL58)='B' or normalize-space(COL58)='SHS' or normalize-space(COL58)='SC')">
									<xsl:value-of select="(COL107 * COL44) + COL73  +  COL108"/>
								</xsl:when>

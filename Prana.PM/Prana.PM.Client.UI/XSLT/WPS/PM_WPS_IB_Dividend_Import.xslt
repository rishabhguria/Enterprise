        ...
        <xsl:if test="number($varDividend)">
          <PositionMaster>
            ...
            <xsl:variable name="varPMonth">
              <xsl:value-of select="substring($varPDate,5,2)"/>
            </xsl:variable>
            <xsl:variable name="varPDay">
              <xsl:value-of select="substring($varPDate,7,2)"/>
            </xsl:variable>
            <xsl:variable name="varPYear">
              <xsl:value-of select="substring($varPDate,1,4)"/>
            </xsl:variable>
            <PayoutDate>
            ...
            <xsl:variable name="varRMonth">
              <xsl:value-of select="substring($varRDate,5,2)"/>
            </xsl:variable>
            <xsl:variable name="varRDay">
              <xsl:value-of select="substring($varRDate,7,2)"/>
            </xsl:variable>
            <xsl:variable name="varRYear">
              <xsl:value-of select="substring($varRDate,1,4)"/>
            </xsl:variable>
            <RecordDate>
              <xsl:value-of select="concat($varRMonth,'/',$varRDay,'/',$varRYear)"/>
            </RecordDate>

...
{
    class MANUAL : AlgoBase
    {
        private List<TaxLot> SortBuyList(List<TaxLot> taxlots, PostTradeEnums.SecondarySortCriteria sortCriteria)
        {
            //primary sorting is done based on the core logic of the Algo for eg for NONE taxlots will first be sorted(ASC) on closing date basis..

...
exec P_MiscIncomeExpenseBreakdown     
...
@SubCategory=N'Misc Expense,Misc Income',    
@SubAccount=N'46,338,327,401,427,63,353,399,393,333,396,65,42,351,394,428,205,426,54,386,100,332,409,60'    
*************************************************/      
                
CREATE Procedure [dbo].[P_MiscIncomeExpenseBreakdown]                
(      
@StartDate datetime,                
@EndDate datetime,      
@fund varchar(max),    

        ...
        <xsl:if test="number($qty)">
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="normalize-space(COL1)='Option'">
            ...
            <xsl:variable name="PB_FUND_NAME" select="normalize-space(COL33)"/>
            ...
            <TradeDate>
              <xsl:call-template name="FormatDate">
                <xsl:with-param name="DateTime" select="normalize-space(COL11)"/>
              </xsl:call-template>
            </TradeDate>

    ...
    <DocumentElement>
      <xsl:for-each select="Comparision">
        ...
        <xsl:if test="$varFormatPrice > 0 ">
			<xsl:if test="substring(COL1,80,1)='T' and substring(COL1,4,5)='87017'">
				<PositionMaster>
            ...
            <xsl:variable name="PRANA_FUND_NAME">
              <xsl:value-of select="document('../ReconMappingXml/AccountMapping.xml')/FundMapping/PB[@Name='JPMorgan']/FundData[@PBFundCode=$PB_FUND_NAME]/@PranaFund"/>
            </xsl:variable>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
  ...
  <xsl:template match="/ThirdPartyFlatFileDetailCollection">
	...
	<xsl:attribute name="xsi:noNamespaceSchemaLocation">C:/UpdatedTP/Prana_Final.xsd</xsl:attribute>
      ...
      <!-- <xsl:for-each select="ThirdPartyFlatFileDetail[(AccountName='Boothbay SWAP-JPM 317-60644' or AccountName='Boothbay EQPB-JPM 312-28367' or AccountName='Boothbay - Wells Fargo') and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOX Collapse' and CounterParty!='SwapReset' and CounterParty!='Swap Reset' and (CompanyAccountID=1299 or CompanyAccountID=1302)]"> -->
 <xsl:for-each select="ThirdPartyFlatFileDetail[(AccountName='Boothbay SWAP-JPM 317-60644' or AccountName='Boothbay EQPB-JPM 312-28367' or AccountName='Boothbay - Wells Fargo') and CounterParty!='CorpAction' and CounterParty!='Transfer' and CounterParty!='Washsale' and CounterParty!='BOX Collapse' and CounterParty!='SwapReset' and CounterParty!='Swap Reset']">
        <ThirdPartyFlatFileDetail>
          ...
          <ArcesiumTradeSecurityLoader>
            <xsl:choose>
              <xsl:when test="AccountName='Boothbay SWAP-JPM 317-60644'">

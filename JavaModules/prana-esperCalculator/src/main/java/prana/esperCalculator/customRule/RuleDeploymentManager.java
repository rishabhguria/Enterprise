...
public class RuleDeploymentManager {
	...
	public static void generateAndDeployCustomRuleEom(ArrayList<String> preTradeEomEvent) {
		try {
			...
			sbEom.append("\tselect distinct \n\t\tD.basketId as basketId,'EomPreTrade' as compressionLevel \n\tfrom\n");
			...
			PranaLogManager.logOnly("Custom rule EOM genereted. Generated EOM is:\n" + eom);

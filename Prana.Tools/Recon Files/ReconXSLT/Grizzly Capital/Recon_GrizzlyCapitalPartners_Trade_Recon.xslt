...
>
  ...
  <xsl:template name="Option">
    ...
    <xsl:variable name="var">
      <xsl:value-of select="substring-after(substring-after(substring-after($varSymbol,'_'),'_'),'_')" />
    </xsl:variable>
    <xsl:variable name="UnderlyingSymbol">
      <xsl:value-of select="substring-before(normalize-space($varSymbol),'_')" />
    </xsl:variable>
			...
			<xsl:for-each select="//Comparision">
				...
				<xsl:if test="number($varNetPosition)">
					...
					<PositionMaster>
                      ...
                      <xsl:variable name="varSCurrentDate">
                              <xsl:value-of select="concat($varSMonth,'/',$varSDay, '/', $varSYear)"/>
                      </xsl:variable>
											
						<SettlementDate>
							<xsl:value-of select="$varSCurrentDate"/>
						</SettlementDate>

    ...
    public class GlobalEventProvider : Component
    {
        ...
        public event KeyPressEventHandler KeyPress
        {
            add
            {
                if (m_KeyPress == null)
                {
                    NativeMethods.KeyPress += NativeMethods_KeyPress;
                }
                m_KeyPress += value;
            }
            remove
        ...
        void NativeMethods_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (m_KeyPress != null)
            {
        ...
        public event KeyEventHandler KeyUp
        {
            add
            {
                if (m_KeyUp == null)
                {
                    NativeMethods.KeyUp += NativeMethods_KeyUp;
                }
                m_KeyUp += value;
            }
            remove
        ...
        private void NativeMethods_KeyUp(object sender, KeyEventArgs e)
        {
            if (m_KeyUp != null)
            {
        ...
        public event KeyEventHandler KeyDown
        {
            add
            {
                if (m_KeyDown == null)
                {
                    NativeMethods.KeyDown += NativeMethods_KeyDown;
                }
                m_KeyDown += value;
            }
            remove

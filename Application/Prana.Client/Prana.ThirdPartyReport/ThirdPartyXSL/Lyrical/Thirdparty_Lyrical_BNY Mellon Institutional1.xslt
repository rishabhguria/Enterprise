...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='Alaska Permanent Fund: 833305' or FundName='The Citigroup Plan: 576064' or FundName='Marion Hospital District: 668721' or FundName='Memorial Hermann Health System: 733704' or FundName='Memorial Hermann Benefit Fund: 732231' or FundName='Diocese of Rockville Centre: 287461' or FundName='Tufts University: 836065' or FundName='Putnam Foundation: P19F90020002' or FundName='National Elevator: 824332' or FundName='NFL Players Association: 942718']">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='Alaska Permanent Fund: 833305'">
								<xsl:value-of select="'833305'"/>
							</xsl:when>
							
							<xsl:when test="FundName='The Citigroup Plan: 576064'">
								<xsl:value-of select="'576064'"/>
							</xsl:when>

							<xsl:when test="FundName='Marion Hospital District: 668721'">
								<xsl:value-of select="'MH2F66872102'"/>
							</xsl:when>

							<xsl:when test="FundName='Memorial Hermann Health System: 733704'">
								<xsl:value-of select="'733704'"/>
							</xsl:when>

							<xsl:when test="FundName='Memorial Hermann Benefit Fund: 732231'">
								<xsl:value-of select="'732231'"/>
							</xsl:when>

							<xsl:when test="FundName='Diocese of Rockville Centre: 287461'">
								<xsl:value-of select="'287461'"/>
							</xsl:when>

							<xsl:when test="FundName='Tufts University: 836065'">
								<xsl:value-of select="'836065'"/>
							</xsl:when>

							<xsl:when test="FundName='Putnam Foundation: P19F90020002'">
								<xsl:value-of select="'P19F90020002'"/>
							</xsl:when>

							<xsl:when test="FundName='National Elevator: 824332'">
								<xsl:value-of select="'824332'"/>
							</xsl:when>

							<xsl:when test="FundName='NFL Players Association: 942718'">
								<xsl:value-of select="'942718'"/>
							</xsl:when>

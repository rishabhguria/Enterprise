		...
		<xsl:variable name="varCommission">
			<xsl:choose>
				<xsl:when test="SettlCurrFxRate=0">
					<xsl:value-of select="format-number($varTotalCommission,'##.00')"/>
				</xsl:when>
				<xsl:when test="SettlCurrFxRate!=0 and SettlCurrFxRateCalc='M'">
					<xsl:value-of select="format-number($varTotalCommission * SettlCurrFxRate,'##.00')"/>
				</xsl:when>
				<xsl:when test="SettlCurrFxRate!=0 and SettlCurrFxRateCalc='D'">
					<xsl:value-of select="format-number($varTotalCommission div SettlCurrFxRate,'##.00')"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="''"/>
				</xsl:otherwise>

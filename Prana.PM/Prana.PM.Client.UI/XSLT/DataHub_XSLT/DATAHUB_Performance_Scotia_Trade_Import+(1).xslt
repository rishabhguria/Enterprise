			...
			<xsl:for-each select ="//PositionMaster">
              ...
              <xsl:value-of select="document('../ReconMappingXml/SymbolMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCompanyName=$PB_SYMBOL_NAME]/@PranaSymbol"/>
						...
						<!--<xsl:variable name="Currency">
							<xsl:choose>
								<xsl:when test="(COL8='CAD') and (contains(COL18,'/') or contains(COL18,'-'))">
							...
							<xsl:choose>
								...
								<xsl:when test="$AssetType='Equity'">
									<xsl:choose>
										...
										<!--<xsl:when test="COL8!='CAD' and contains($varSymbol,'/') or contains($varSymbol,'-')">
											<xsl:choose>
												<xsl:when test="contains($varSymbol,'/')">
						...
						<Strategy>
							<xsl:value-of select="concat(normalize-space(COL11),' , ',normalize-space(COL23))"/>
						</Strategy>

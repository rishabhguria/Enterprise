...
{
   public class UpdateDailyDelta : DailyDeltaUIMap, ITestStep
    {
       /// <summary>
       /// Run the test.
       /// </summary>
       ...
       /// <returns></returns>
        public TestResult RunTest(System.Data.DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                OpenDailyDeltaTab();
                UpdateDailyDeltaTabData(testData, sheetIndexToName);
       ...
       /// <param name="testData">The test data.</param>
       /// <param name="sheetIndexToName">The sheet no.</param>
        private void UpdateDailyDeltaTabData(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            try
            {

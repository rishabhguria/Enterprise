...
namespace Prana.BusinessObjects
{
    ...
    public class VWAPImport : BusinessBase<VWAPImport>
    {
        /// <summary>
        ...
        public class CustomRules : RuleArgs
        {
            ...
            public static void CheckValidationOnAllFileds(VWAPImport finalTarget)
            {
            ...
            {
                VWAPImport finalTarget = target as VWAPImport;
                if (finalTarget != null)
                {

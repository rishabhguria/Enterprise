...
<xsl:template name="Translate">
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  ...
                  <xsl:call-template name="Option">
                    <xsl:with-param name="varSymbol" select="normalize-space(COL5)" />
                  </xsl:call-template>
                </xsl:when>
 ...
 <xsl:variable name="varDay">
                                                        <xsl:value-of select="substring(COL22,7,2)"/>
                                                </xsl:variable>
                                                <xsl:variable name="varYear">
                                                        <xsl:value-of select="substring(COL22,1,4)"/>
                                                </xsl:variable>

                                                <xsl:variable name="varMonth">
                                                        <xsl:value-of select="substring(COL22,5,2)"/>
                                                </xsl:variable>

        ...
        <xsl:if test="number($Cash)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_PRE">
              <xsl:choose>
				  <xsl:when test="$varSubAccountDesc ='DR / CR INTEREST' and $Cash &gt; 0 ">
					  <xsl:value-of select="'Cash'"/>
				  </xsl:when>
				  <xsl:when test="$varSubAccountDesc ='SL FEES' and $Cash &lt; 0 ">
					  <xsl:value-of select="'SL FEE'"/>
				  </xsl:when>
				  <xsl:when test="$varSubAccountDesc ='SMV REBATE' and $Cash &gt; 0 ">
					  <xsl:value-of select="'Cash'"/>
				  </xsl:when>
				    <xsl:when test="$varSubAccountDesc ='DR / CR INTEREST' and $Cash &lt; 0 ">
				  ...
				  <xsl:when test="$varSubAccountDesc ='CASH IN LIEU' and $Cash &lt; 0 ">

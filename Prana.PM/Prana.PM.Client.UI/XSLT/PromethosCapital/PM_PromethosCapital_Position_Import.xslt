	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:variable name="varAsset" select="normalize-space(COL22)"/>

				<xsl:if test ="number($varQuantity) and $varAsset='Equities'">
					...
					<PositionMaster>
						...
						<xsl:variable name="varSide" select="normalize-space(COL45)"/>
						...
						<xsl:variable name="varCostBasis">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL7 div $varQuantity"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="varFXRate">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="COL8 div COL7"/>
							</xsl:call-template>
						</xsl:variable>

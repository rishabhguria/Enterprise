	...
	<xsl:template match="/">
		<DocumentElement>
			<xsl:for-each select="//PositionMaster">
				...
				<xsl:variable name="varQuantity" select="number(translate(COL7,',',''))"/>
				...
				<xsl:if test="number($varQuantity)">
					...
					<PositionMaster>					
						...
						<SideTagValue>
							<xsl:choose>
								<xsl:when test="translate($varSide, $vLowercaseChars_CONST, $vUppercaseChars_CONST)='B'">
									<xsl:value-of select="'1'"/>
								</xsl:when>
								<xsl:when test="translate($varSide, $vLowercaseChars_CONST, $vUppercaseChars_CONST)='BC'">
									<xsl:value-of select="'B'"/>
								</xsl:when>
								<xsl:when test="translate($varSide, $vLowercaseChars_CONST, $vUppercaseChars_CONST)='S'">
									<xsl:value-of select="'2'"/>
								</xsl:when>
								<xsl:when test="translate($varSide, $vLowercaseChars_CONST, $vUppercaseChars_CONST)='SS'">

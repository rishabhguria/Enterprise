				...
				<xsl:if test="number($varQuantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="SecFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL52)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="NetNotionalValueBase">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL70)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<Side>
							<xsl:choose>
								<xsl:when test="normalize-space(COL9)='BUY LONG'">
									<xsl:value-of select="'Buy'"/>
								</xsl:when>
								<xsl:when test="normalize-space(COL9)='SELL LONG'">

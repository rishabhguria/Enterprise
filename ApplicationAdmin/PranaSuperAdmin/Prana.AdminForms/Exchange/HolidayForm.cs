...
namespace Prana.Admin
{
    ...
    /// </summary>
    public class HolidayForm : System.Windows.Forms.Form
    {
        ...
        private void BindHolidayGrid()
        {
            ...
            else
            {
                ...
                Prana.BusinessObjects.CommonObjects.Holiday holiday = new Prana.BusinessObjects.CommonObjects.Holiday(int.MinValue, "", Prana.BusinessObjects.DateTimeConstants.MinValue, int.MinValue);
        ...
        private int SaveHoliday()
        {
            ...
            Prana.BusinessObjects.CommonObjects.Holiday holiday = new Prana.BusinessObjects.CommonObjects.Holiday();
            ...
            else
            {
                ...
                if (holidays.Count > 0)
                {
                    foreach (Holiday checkHoliday in holidays)
                    {

				...
				<ThirdPartyFlatFileDetail>
					...
					<!--<xsl:choose>
						<xsl:when test="Side='Buy' or Side='Buy to Open' or Side='Sell' or Side='Sell to Close'">
							<CASHACCOUNT>
								<xsl:value-of select="concat(AccountNo , '2')"/>
							</CASHACCOUNT>
						</xsl:when>
					...
					<CASHACCOUNT>
						<xsl:value-of select="concat (AccountMappedName, '0')"/>
					</CASHACCOUNT>
					...
					<!--<xsl:choose>
						...
						<xsl:when test="AccountNo = 'JMP001813' and (Side='Buy to Close' or Side='Buy to Cover' or Side='Sell short' or Side='Sell to Open')">
							<SECACCOUNT>
								<xsl:value-of select="concat(AccountNo,'3')"/>
							</SECACCOUNT>
						</xsl:when>

      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:variable name="NetPosition">
          <xsl:call-template name="Translate">
            <xsl:with-param name="Number" select="substring(COL1,54,20)"/>
          </xsl:call-template>
        </xsl:variable>
        ...
        <xsl:if test="number($NetPosition)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PB_SYMBOL_NAME">
              <xsl:value-of select="substring(COL1,196,31)"/>
            </xsl:variable>
            ...
            <xsl:variable name="Symbol">
              <<xsl:value-of select="substring(COL1,46,5)"/>
            </xsl:variable>
            ...
            <xsl:variable name="PB_FUND_NAME" select="substring(COL1,28,8)"/>
            ...
            <xsl:variable name="CostBasis" select="substring(COL1,81,9)"/>
            ...
            <xsl:variable name="Commission">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="substring(COL1,123,8)"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="Fees">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="substring(COL1,104,11)"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="Side" select="COL33"/>
            ...
            <xsl:variable name="Year1" select="substring(COL1,24,4)"/>
            <xsl:variable name="Month" select="substring(COL1,21,1)"/>
            <xsl:variable name="Day" select="substring(COL1,22,2)"/>
            ...
            <xsl:variable name="Year" select="substring(COL1,189,4)"/>
            <xsl:variable name="Month1" select="substring(COL1,186,1)"/>
            <xsl:variable name="Day1" select="substring(COL1,187,2)"/>

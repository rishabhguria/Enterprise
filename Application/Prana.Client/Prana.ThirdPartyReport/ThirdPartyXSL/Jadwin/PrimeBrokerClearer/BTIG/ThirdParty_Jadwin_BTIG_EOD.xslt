	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
				...
				<ClosingMethod>
					<xsl:value-of select="'ClosingMethod'"/>
				</ClosingMethod>
				...
				<OptionsMultiplier>
					<xsl:value-of select="'OptionsMultiplier'"/>
				</OptionsMultiplier>
				...
				<ThirdPartyFlatFileDetail>
					...
					<Side>
						<xsl:choose>
							...
							<xsl:when test="Side='Sell short' or 'Sell to Open'">
					...
					<Investment>
						<xsl:choose>
							...
							<!--<xsl:when test="Asset='Equity' and CUSIP != ''">
								<xsl:value-of select="CUSIP"/>
							</xsl:when>-->

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
		  ...
		  <Groups>
			  ...
			  <xsl:for-each select="/ThirdPartyFlatFileDetailCollection/ThirdPartyFlatFileDetail[AccountName !='AIRT-AGEN 0082' and AccountName !='AIRT-AGEN 0217' and AccountName !='AIRT-IB 6160' and AccountName !='AIRT-PIPR 7165' and AccountName !='SPAG-IB 0034' and AccountName !='SPAG-IB 9812' and AccountName !='SPAG-PIPR 6076'
  and AccountName!='MSTR-Rebal Risk Analysis']">
 	...
 	<xsl:variable name ="varAllocationState">
	  ...
	  <xsl:variable name="varCustodian">
		  <xsl:choose>
			  ...
			  <xsl:when test="AccountName ='Pan Africa–AGEN AXT000097'">

...
namespace Nirvana.Admin
{
	...
	public class AddCounterPartyVenue : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AddCounterPartyVenue));
			...
			this.label1.Text = "Counter Party";
			// 
			// cmbCounterParty
			// 
			...
			this.cmbCounterParty.Size = new System.Drawing.Size(100, 20);
			...
			this.btnSave.Location = new System.Drawing.Point(126, 62);
			...
			// 
			this.stbAddCounterPartyVenue.Location = new System.Drawing.Point(0, 87);
			...
			this.stbAddCounterPartyVenue.Size = new System.Drawing.Size(402, 22);
			...
			this.Text = "AddCounterPartyVenue";
		...
		private void AddCounterPartyVenue_Load(object sender, System.EventArgs e)
		{
			...
			finally
			{
				...
				LogEntry logEntry = new LogEntry("AddCounterPartyVenue_Load", 
					Common.LOG_CATEGORY_UI, 1, 1, Severity.Information, 
					FORM_NAME + "AddCounterPartyVenue_Load"); 
		...
		private int SaveCounterParty_Venue()
		{
			...
			if(int.Parse(cmbCounterParty.Value.ToString()) == int.MinValue 
				|| int.Parse(cmbVenue.Value.ToString()) == int.MinValue)
			{

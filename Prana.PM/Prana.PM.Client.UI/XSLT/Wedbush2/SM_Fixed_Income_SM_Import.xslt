	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test ="COL2!='Description' and COL3!='#N/A Invalid Security' and number(COL8)">
					...
					<PositionMaster>
						...
						<FirstCouponDate>
							<xsl:choose>
								<xsl:when test="COL11='Y'">
									<xsl:value-of select ="'1/1/2014'"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<SedolSymbol>
							<xsl:choose>
								<xsl:when test=" COL15='#N/A Field Not Applicable'">
									<xsl:value-of select ="''"/>
								</xsl:when>
						...
						<IsZero>
							...
							<AccrualBasisID>
								<xsl:choose>
									...
									<xsl:when test="COL10='30/360' or COL10='ISMA-30/360'">
										<xsl:value-of select ="'2'"/>
									</xsl:when>
									<xsl:when test="COL10='ACT/360'">
										<xsl:value-of select ="'1'"/>
						...
						<SecurityTypeID>
							<xsl:choose>
								<xsl:when test="COL13='MUNICIPAL BONDS'">
									<xsl:value-of select="1"/>
								</xsl:when>
								<xsl:when test="COL13='DISCOUNT'">
									<xsl:value-of select="0"/>
								</xsl:when>
								<xsl:when test="COL13='STREET CONVENTION'">
									<xsl:value-of select="4"/>
								</xsl:when>
								<xsl:when test="COL13='FLOAT RATE NOTE'">
									<xsl:value-of select="0"/>
								</xsl:when>
								<xsl:when test="COL13='%TYPE PRFD'">
									<xsl:value-of select="0"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="0"/>

PRINT 'Started Executing: ClientDB_1997_PMGetRealizeAndUnrealizePnL.sql'
GO
IF EXISTS (
		SELECT *
		FROM sysobjects
...
END
GO
PRINT 'Creating Stored Procedure: PMGetRealizeAndUnrealizePnL'
GO  
...
DROP table #FXConversionRates, #AUECYesterDates, #AUECBusinessDatesForEndDate,#MTMDataTable,#FundsInMP,#FundsInFXMP           
END     
    
 
go
PRINT 'Done executing ClientDB_1997_PMGetRealizeAndUnrealizePnL.sql'
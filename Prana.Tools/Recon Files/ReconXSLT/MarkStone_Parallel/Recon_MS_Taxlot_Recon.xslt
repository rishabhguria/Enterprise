      ...
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:if test="number($Quantity) ">
          ...
          <PositionMaster>
			  ...
			  <xsl:variable name="Symbol" >
				  <xsl:choose>
					  <xsl:when test="contains(COL2,'_')">
						  ...
						  <xsl:value-of select="translate(normalize-space(substring-before(COL2,'_')),$lower_CONST,$upper_CONST)"/>
					  </xsl:when>

					  <xsl:otherwise>
						  <xsl:value-of select="translate(normalize-space(COL2),$lower_CONST,$upper_CONST)"/>
					  </xsl:otherwise>
				  </xsl:choose>
			  </xsl:variable>
            ...
            <!--<xsl:variable name="CUSIP" select="COL3"/>
            ...
            <xsl:variable name="PRANA_FUND_NAME">
              <xsl:value-of select ="document('../ReconMappingXML/FundMapping.xml')/AccountMapping/PB[@Name=$PB_NAME]/FundData[@PBAccountName=$PB_FUND_NAME]/@PranaFund"/>
            </xsl:variable>
            ...
            <MarkPrice>
			  ...
			  <xsl:variable name="MarkPrice1">
				  <xsl:call-template name="Translate">
					  <xsl:with-param name="Number" select="COL6 div $Quantity" />
				  </xsl:call-template>
			  </xsl:variable>

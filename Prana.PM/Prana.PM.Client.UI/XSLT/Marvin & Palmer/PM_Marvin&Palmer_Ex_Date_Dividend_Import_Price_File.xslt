      ...
      <xsl:for-each select="//PositionMaster">
        ...
        <xsl:if test="number($varDividend)">
          <PositionMaster>
            ...
            <Amount>
              <xsl:choose>
                <xsl:when test="number($varDividend) and $varActivityType = 'Dividend Expense'">
                  <xsl:value-of select="$varDividend * (-1)"/>
                </xsl:when>
				<xsl:when test="number($varDividend) and $varActivityType = 'Dividend Income'">
			...
			<!-- 2024-11-08 -->
				 ...
				 <xsl:variable name="varPayoutDate" select="normalize-space(substring-before(COL5,''))"/>
            <PayoutDate>
            ...
            <Description>
			 <xsl:choose>
                <xsl:when test="$varActivityType = 'Dividend Expense'">
                  <xsl:value-of select="'Dividend Paid'"/>
                </xsl:when>

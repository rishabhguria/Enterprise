	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:choose>
					<xsl:when test="number($Quantity) and COL4='EQUITY' or 'COMMON STOCK' and COL2!='GTPB' and COL2!='DTPM' and COL2!='PPR' and COL2!='BDC' and COL2!='GMMB'">
						<PositionMaster>
							...
							<xsl:variable name ="MarkPrice">
								<xsl:call-template name="Translate">
									<xsl:with-param name="Number" select="$Quantity * $MarketValue"/>
								</xsl:call-template>
							</xsl:variable>
							<MarkPrice>
								<xsl:choose>

      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Cash)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varDescription" select="normalize-space(COL5)"/>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_PRE">
              <xsl:choose>
                ...
                <xsl:when test="$varDescription ='CUSTOMER AUTHORIZED TRANSFER'">
                  <xsl:value-of select="'CashTransferIn'"/>
                </xsl:when>
            ...
            <JournalEntries>
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of select="concat($PRANA_ACRONYM_NAME_POST, ':' , $AbsCash , '|' , $PRANA_ACRONYM_NAME_PRE, ':' , $AbsCash)"/>
                </xsl:otherwise>
              </xsl:choose>
            </JournalEntries>

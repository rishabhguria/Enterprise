...
/*       
EXEC [P_GetThirdPartyDetails_Automailer_RPDOpportunity]  '03-08-2022'
DESC: Customized SP for RPDOpportunities Automailer
JIRA: https://jira.nirvanasolutions.com:8443/browse/ONB-5763
*/
              
CREATE PROCEDURE [dbo].[P_GetThirdPartyDetails_Automailer_RPDOpportunity]                                                                                       
(                                                                                                      
 @inputDate datetime                                                                                                  
)                                                                                                         
AS          
...
Select                 
	...
	Case
		When T_CounterParty.ShortName = 'DASH'
		Then
			Case
				 When T_CompanyFunds.FundName = 'MS - RPD Fund'
				Then '038CAOUB0'
				When T_CompanyFunds.FundName = 'MS - Prelude'
				Then '038CAOYH3'
				When T_CompanyFunds.FundName = 'Jones Trading - RPD'
				Then 'AVC01209'
				When T_CompanyFunds.FundName = 'TD Prime'
				Then '35000270'
				When T_CompanyFunds.FundName = 'Jones Trading - Fortress'
				Then 'AV761209'
				
				
			Else T_CompanyFunds.FundName
			End
		When T_CounterParty.ShortName = 'ISIG'
		Then
			Case
				 When T_CompanyFunds.FundName = 'MS - RPD Fund'
				Then '038224309'
		...
		When T_CounterParty.ShortName = 'MSCO'
		Then
			Case
			    When T_CompanyFunds.FundName = 'MS - RPD Fund'
				Then '038224309'

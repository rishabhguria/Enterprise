        ...
        <xsl:if test="number($varCash)" >
         ...
         <xsl:variable name="PB_CURRENCY_NAME">
            ...
            <xsl:variable name = "PRANA_PRE_ACRONYM_NAME" >
              <xsl:choose>
                <xsl:when test="($varDescription = 'Locate Fee') and $varCash &gt; 0">
                  <xsl:value-of select="'MISC_EXP'"/>
                </xsl:when>
				  <xsl:when test="($varDescription = 'Short Credit Interest Rebate' or  $varDescription = 'Credit/Margin Interest') and $varCash &gt; 0">
                  <xsl:value-of select="'Interest_Expense'"/>
                </xsl:when>
              
			     <xsl:when test="($varDescription = 'Locate Fee' or $varDescription = 'Short Credit Interest Rebate' or  $varDescription = 'Credit/Margin Interest') and $varCash &lt; 0">

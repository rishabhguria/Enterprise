		...
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($Quantity)">
					<!--<normalize-space(COL2)!='Cusip' and $PRANA_FUND_NAME!=''>-->
                ...
                <xsl:otherwise>
                  <xsl:value-of select="1"/>
						...
						<xsl:variable name="PRANA_CUSIP_SYMBOL">
							<xsl:value-of select="document('../ReconMappingXml/CusipMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME1]/SymbolData[@CusipSymbol=$PB_CUSIP_SYMBOL]/@PranaCusip"/>
						</xsl:variable>

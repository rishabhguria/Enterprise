  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Cash) and COL27 = 'INTEREST ACCRUAL POSTING'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_ACRONYM_NAME_PRE">
              <xsl:choose>
                ...
                <xsl:when test="$varSubAccountDesc = 'INTEREST ACCRUAL POSTING' and $Cash &lt; 0">

    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:choose>
            <xsl:when test="FundName ='HSBC Offshore' or FundName = 'IB Offshore' or FundName = 'PERS Offshore' or FundName = 'JEFF Offshore'">
              <Fund>
                <xsl:value-of select ="'SONOMALTD'"/>
              </Fund>
            </xsl:when>
            <xsl:when test="FundName ='HSBC SCLP' or FundName = 'IB SCLP' or FundName = 'PERS SCLP' or FundName = 'JEFF SCLP' or FundName = 'Schwab SCLP' or FundName = 'AMTD SCLP'">
              <Fund>
          ...
          <!--<CustodianAccountTest1>
						<xsl:value-of select ="FundName"/>
					</CustodianAccountTest1>
					<CustodianAccountTest2>
						<xsl:value-of select ="FundID"/>
					</CustodianAccountTest2>
					<CustodianAccountTest3>
          ...
          <xsl:choose>
            <xsl:when test ="(TaxOnCommissions + OtherBrokerFee + StampDuty + TransactionLevy + ClearingFee) != 0">
              <MiscCharges>
                <xsl:value-of select ='format-number(TaxOnCommissions + OtherBrokerFee + StampDuty + TransactionLevy + ClearingFee, "###.0000000")'/>
              </MiscCharges>
            </xsl:when>
            <xsl:otherwise>
              <MiscCharges>
          ...
          <!--<ExchangeTax>
						<xsl:value-of select ="TaxOnCommissions + OtherBrokerFee + StampDuty + TransactionLevy + ClearingFee"/>
					</ExchangeTax>-->

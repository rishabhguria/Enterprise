  ...
  <xsl:template match="/ThirdPartyFlatFileDetailCollection">
    <ThirdPartyFlatFileDetailCollection>
      ...
      <ThirdPartyFlatFileDetail>
		...
		<SoftCommissions>
			<xsl:value-of select="'SoftCommissions'"/>
		</SoftCommissions>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail[(contains(AccountName, 'Booth Bay'))]">
        ...
        <ThirdPartyFlatFileDetail>
		  ...
		  <SoftCommissions>
            <xsl:choose>
              <xsl:when test="number(SoftCommissionCharged)">
          ...
          <TicketCharges>
            <xsl:value-of select="(TaxOnCommissions + MiscFees + OrfFee + TransactionLevy + StampDuty)"/>
          </TicketCharges>

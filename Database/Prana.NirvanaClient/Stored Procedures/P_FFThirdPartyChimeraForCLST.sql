 CREATE PROCEDURE [dbo].[P_FFThirdParty_ChimeraForCLST] 
 (
	@thirdPartyID INT
...
SET AccountName = 
CASE 
		WHEN CharIndex('Chimera Capital', AccountName) <> 0
			THEN '102863'
		...
		WHEN CharIndex('Stevens Capital', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Walleye WMO', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Walleye WOF', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Chimera Systematic', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Walleye WOF Systematic', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Walleye Concentrated', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('WOF Consumer TMT Discretionary', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('WOF Consumer TMT Systematic', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('WMO Consumer TMT Discretionary', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('WMO Consumer TMT Systematic', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Walleye WMO Systematic', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Swap - Walleye WOF TMT Discretionary', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Swap - Walleye WMO TMT Discretionary', AccountName) <> 0
			THEN '102863'
		WHEN CharIndex('Booth Bay DA', AccountName) <> 0
			THEN '102866'
		WHEN CharIndex('Booth Bay SMA', AccountName) <> 0
			THEN '102866'
		WHEN CharIndex('Atom', AccountName) <> 0
			THEN '102864'
		ELSE AccountName
		END

    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <OtherFees>
			  <xsl:choose>
				  <xsl:when test="AccountName='ECOR1 CAPITAL FUND' or AccountName='ECOR1 CAPITAL FUND QUALIFIED'">
					  <xsl:value-of select="OtherBrokerFee"/>
				  </xsl:when>
				  <xsl:when test="AccountName='Ecor Capital- GS' or AccountName='Ecor Qualified- GS'">

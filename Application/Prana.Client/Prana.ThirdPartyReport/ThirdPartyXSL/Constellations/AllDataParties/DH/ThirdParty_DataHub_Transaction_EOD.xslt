					...
					<AvragePrice>
						<xsl:choose>
							<xsl:when test="number(AvgPX)">
								<xsl:value-of select="format-number(AvgPX,'0.###########')"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="0"/>
							</xsl:otherwise>
					...
					<OtherBrokerFee>
						<xsl:choose>
							<xsl:when test="number(OtherBrokerFees)">
								<xsl:value-of select="format-number(OtherBrokerFees,'0.###########')"/>
							</xsl:when>
					...
					<ClearingFees>
						<xsl:choose>
							<xsl:when test="number(ClearingFees)">
								<xsl:value-of select="format-number(ClearingFees,'0.###########')"/>
							</xsl:when>
					...
					<MiscFee>
						<xsl:choose>
							<xsl:when test="number(MiscFee)">
								<xsl:value-of select="format-number(MiscFee,'0.###########')"/>
							</xsl:when>
					...
					<AUECFee1>
						<xsl:choose>
							<xsl:when test="number(AUECFee1)">
								<xsl:value-of select="format-number(AUECFee1,'0.###########')"/>
							</xsl:when>
					...
					<AUECFee2>
						<xsl:choose>
							<xsl:when test="number(AUECFee2)">
								<xsl:value-of select="format-number(AUECFee2,'0.###########')"/>
							</xsl:when>
					...
					<GrossNotionalValue>
						<xsl:choose>
							<xsl:when test="number(GrossNotionalValue)">
								<xsl:value-of select="format-number(GrossNotionalValue,'0.###########')"/>
							</xsl:when>
					...
					<GrossNotionalValueBase>
						<xsl:choose>
							<xsl:when test="number(GrossNotionalValueBase)">
								<xsl:value-of select="format-number(GrossNotionalValueBase,'0.###########')"/>
							</xsl:when>
					...
					<NetNotionalValue>
						<xsl:choose>
							<xsl:when test="number(NetNotionalValue)">
								<xsl:value-of select="format-number(NetNotionalValue,'0.###########')"/>
							</xsl:when>
					...
					<NetNotionalValueBase>
						<xsl:choose>
							<xsl:when test="number(NetNotionalValueBase)">
								<xsl:value-of select="format-number(NetNotionalValueBase,'0.###########')"/>
							</xsl:when>
					...
					<TotalCommissionandFees>
						<xsl:choose>
							<xsl:when test="number(TotalCommissionandFees)">
								<xsl:value-of select="format-number(TotalCommissionandFees,'0.###########')"/>
							</xsl:when>
					...
					<TotalCommissionandFeesBase>
						<xsl:choose>
							<xsl:when test="number(TotalCommissionandFeesBase)">
								<xsl:value-of select="format-number(TotalCommissionandFeesBase,'0.###########')"/>
							</xsl:when>
					...
					<OccFee>
						<xsl:choose>
							<xsl:when test="number(OccFee)">
								<xsl:value-of select="format-number(OccFee,'0.###########')"/>
							</xsl:when>
					...
					<OrfFee>
						<xsl:choose>
							<xsl:when test="number(OrfFee)">
								<xsl:value-of select="format-number(OrfFee,'0.###########')"/>
							</xsl:when>
					...
					<SecFeeBase>
						<xsl:choose>
							<xsl:when test="number(SecFeeBase)">
								<xsl:value-of select="format-number(SecFeeBase,'0.###########')"/>
							</xsl:when>
					...
					<OccFeeBase>
						<xsl:choose>
							<xsl:when test="number(OccFeeBase)">
								<xsl:value-of select="format-number(OccFeeBase,'0.###########')"/>
							</xsl:when>
					...
					<OrfFeeBase>
						<xsl:choose>
							<xsl:when test="number(OrfFeeBase)">
								<xsl:value-of select="format-number(OrfFeeBase,'0.###########')"/>
							</xsl:when>
					...
					<ClearingBrokerFeeBase>
						<xsl:choose>
							<xsl:when test="number(ClearingBrokerFeeBase)">
								<xsl:value-of select="format-number(ClearingBrokerFeeBase,'0.###########')"/>
							</xsl:when>
					...
					<SoftCommission>
						<xsl:choose>
							<xsl:when test="number(SoftCommission)">
								<xsl:value-of select="format-number(SoftCommission,'0.###########')"/>
							</xsl:when>
					...
					<SoftCommissionBase>
						<xsl:choose>
							<xsl:when test="number(SoftCommissionBase)">
								<xsl:value-of select="format-number(SoftCommissionBase,'0.###########')"/>
							</xsl:when>
					...
					<SettlPrice>
						<xsl:choose>
							<xsl:when test="number(SettlPrice)">
								<xsl:value-of select="format-number(SettlPrice,'0.###########')"/>
							</xsl:when>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
        ...
        <xsl:variable name="AssetType">
          <xsl:choose>
            <xsl:when test="contains(normalize-space(COL18),'P ') or contains(normalize-space(COL18),'C ')">
            ...
            <xsl:otherwise>
              <xsl:value-of select="'Equity'"/>
				...
				<xsl:if test="number($Position) and COL3 !='C' and COL3 !='T' and $AssetType = 'Option'">

          ...
          <PositionMaster>
            ...
            <AccountName>
              <xsl:choose>			                 
                ...
                <xsl:when test="$PB_FUND_NAME ='102539102'">
                  <xsl:value-of select="'NEO IVY CAPITAL MASTER FUND LP'" />
                </xsl:when>
                <xsl:when test="$PB_FUND_NAME ='102055292'">
                  <xsl:value-of select="'Sea Hawk Multi-Strategy Master'" />
                </xsl:when>
                <xsl:otherwise>
           ...
           <xsl:variable name="Side" select="COL8"/>
            ...
            <xsl:variable name="varPositionStartDate" select="COL2"/>

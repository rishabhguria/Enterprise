CREATE PROCEDURE [dbo].[PMGetAllSymbolsDividendYield]       
(                                          
  @FromDate DateTime,                                    
  @ToDate DateTime,                                    
...
LEFT JOIN #T_AUEC AUEC ON SecMasterWithUnderlying.AUECID = AUEC.AUECID   
 ...
 CREATE TABLE [dbo].#TempDividendYieldDataFinal                                                                                      
   (                                                                                      
    Symbol varchar(200),                                                                                                                 
    FinalDividendYield numeric(18,4),                                                                                  
   DayDividendYieldID int,                                                     
    Date1 DateTime,                                                                      
    AUECID int,                                                                      
    AUECIdentifier varchar(200),            
 ...
 INSERT INTO [dbo].#TempDividendYieldDataFinal                                                                                      
   (                                                                                      
    Symbol,                                                                                
    Date1,                                                      
    AUECID,                                                                      
 ...
 exec ('select *                                        
  from (Select TPATAF.Symbol, Date, IsNull(PMDB.DividendYield,0) AS FBV, TPATAF.AUECID, TPATAF.AUECIdentifier,TPATAF.BloombergSymbol FROM #TempDividendYieldDataFinal TPATAF     
  LEFT OUTER JOIN PM_DailyDividendYield PMDB                                      

	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:choose>
					<xsl:when test="number($Cash) and ((contains(COL6,'1013001.004.00.CAD')='true') or (contains(COL6,'1013001.004.00.USD')='true') or (contains(COL6,'Fiduciary Call USD,07.09.16, SOCGEN PARIS   (111514)')='true') or (contains(COL6,'Fiduciary Call USD,19.05.17, NATIXIS PARIS (7756)')='true')) ">
						<PositionMaster>

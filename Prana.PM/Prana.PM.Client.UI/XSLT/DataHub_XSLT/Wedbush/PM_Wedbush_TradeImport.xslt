  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
			...
			<xsl:if test="number(COL4) and COL23='0' and (COL2='64860812' or COL2='41954500' or COL2='11520755')">				
          <PositionMaster>
          ...
          <xsl:value-of select ="document('../../../MappingFiles/ReconMappingXml/FundMapping.xml')/FundMapping/PB[@Name='WedbushS']/FundData[@PBFundName=$PB_FUND_NAME]/@PranaFund"/>
			  </xsl:variable>

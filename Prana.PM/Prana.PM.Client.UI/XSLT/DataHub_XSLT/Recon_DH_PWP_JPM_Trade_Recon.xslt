		...
		<DocumentElement>
			<xsl:for-each select ="//Comparision">
						...
						<PositionMaster>
							...
							<Symbol>
								<xsl:choose>
									...
									<xsl:when test="COL6='UNITED STATES DOLLAR (USD)'">
										<xsl:value-of select="concat($varSymbol,' US')"/>
									</xsl:when>
              ...
              <TaxOnCommissions>
							...
							<!--<xsl:variable name="Year1" select="substring($Date1,7,4)"/>
							<xsl:variable name="Month1" select="substring($Date1,1,2)"/>
							<xsl:variable name="Day1" select="substring($Date1,4,2)"/>-->
                ...
                <xsl:choose>
                  ...
                  <xsl:otherwise>
                    <xsl:value-of select="''"/>
							...
							<Side>
								<xsl:choose>
									<xsl:when test="contains(COL16,'CALL') or contains(COL16,'PUT') ">
										<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:choose>
											<xsl:when test="$varSide ='BUY' or $varSide ='BUY RVP' or $varSide ='DELIVER LONG' or $varSide ='RECEIVE LONG'">
											...
											<xsl:when test="$varSide ='BUY TO COVER' or $varSide='COVER SHORT'">
												<xsl:value-of select="'Buy to Close'"/>
											</xsl:when>
											<xsl:when test="$varSide ='SELL SHORT'">
							...
							<Side>
								<xsl:choose>
									...
									<xsl:when test="$varSide='SELL' or $varSide='DELIVER LONG'">
										<xsl:value-of select="'Sell'"/>
									</xsl:when>
									<xsl:when test="$varSide='BUY' or  $varSide='RECEIVE LONG'">
										<xsl:value-of select="'Buy'"/>
									</xsl:when>

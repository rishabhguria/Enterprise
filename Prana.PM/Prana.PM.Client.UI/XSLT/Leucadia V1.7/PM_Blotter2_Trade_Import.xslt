				...
				<xsl:if test="number($NetPosition)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_BROKER_NAME">
							<xsl:value-of select="normalize-space(COL50)"/>
						</xsl:variable>
						...
						<SideTagValue>
							<xsl:choose>
										<xsl:when test ="$Side='B' and COL4='2'">
											<xsl:value-of select ="'1'"/>
										</xsl:when>
								
								<xsl:when test ="$Side='B' and COL4='6'">
									<xsl:value-of select ="'B'"/>
								</xsl:when>
								<xsl:when test ="$Side='S' and COL4='2'">
									<xsl:value-of select ="'2'"/>
								</xsl:when>
								
										<xsl:when test ="$Side='S' and COL4='6'">

...
Exec:   P_GetTradeCurrencyDynamically        
*/        
        
        
CREATE Procedure P_GetTradeCurrencyDynamically                
As            
Begin        
...
------------------------------------------------------------------------        
-- FILL TRADECURRENCY WHICH ARE PRESENT IN MIDDLEWARE TABLE         
------------------------------------------------------------------------        
 Insert Into #TempTradeCurrency          
  Select Distinct        
  CurrencySymbol        
  from T_Currency        
  Inner Join T_MW_GenericPNL PNL On CurrencySymbol = TradeCurrency           
  Order by CurrencySymbol        
---------------------------------------------------------------        
-- IF NO DATA IN MIDDLEWARE FILL ALL TRADECURRENCY        
---------------------------------------------------------------        

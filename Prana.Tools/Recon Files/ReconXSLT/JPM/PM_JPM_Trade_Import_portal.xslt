        ...
        <xsl:if test="number($Position) and contains(COL33,'CASH')!='true'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="PRANA_SYMBOL_NAME">
			  ...
			  <xsl:variable name="PB_SYMBOLSUFFIX_NAME">
				  <xsl:value-of select="substring-after(normalize-space(COL43),' ')"/>
			  </xsl:variable>
			  <xsl:variable name="PRANA_Symbol_NAME">
				  <xsl:value-of    select="document('../ReconMappingXML/SymbolSuffixMapping.xml')/SymbolMapping/PB[@Name=$PB_NAME]/SymbolData[@PBCompanyName=$PB_SYMBOLSUFFIX_NAME]/@PranaSuffixCode"/>
			  </xsl:variable>
            ...
            <Symbol>
              ...
              <xsl:choose>
                ...
                <xsl:when test="$Symbol!='*'">
				  ...
				  <xsl:when test="contains(COL106 ,'Foreign Currency (F/X)')">
					  <xsl:value-of select="concat($PB_SYMBOLSUFFIX_NAME,'-',$PRANA_Symbol_NAME)"/>
				  </xsl:when>
            ...
            <xsl:variable name="TradePrice">
              <xsl:call-template name="Translate">
                <xsl:with-param name="Number" select="COL107 div COL108"/>
              </xsl:call-template>
            </xsl:variable>
            ...
            <xsl:variable name="StampDuty">
              <xsl:choose>
				  ...
				  <xsl:when test="COL3='USD' and (normalize-space(COL58)='B' or normalize-space(COL58)='SHS' or normalize-space(COL58)='SC'  or normalize-space(COL58)='B')">

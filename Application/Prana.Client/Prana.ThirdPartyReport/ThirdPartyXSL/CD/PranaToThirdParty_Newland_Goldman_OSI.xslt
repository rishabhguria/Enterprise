	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<xsl:if test ="AccountNo!='013101969' and AccountNo!='013425764' and AccountNo!='013216619'">
				<ThirdPartyFlatFileDetail>
					...
					<!--<order_price>
						--><!--<xsl:value-of select='format-number(AveragePrice, "###.0000")*$NormalizedFxRate'/>--><!--
						<xsl:value-of select='format-number(AveragePrice*$NormalizedFxRate, "0.0000")'/>
					</order_price>-->
					...
					<!--<principal>
						<xsl:value-of select="GrossAmount*$NormalizedFxRate"/>
					</principal>-->

					<principal>
						<!--format-number($QtySum * AveragePrice, "###") '$QtySum * AveragePrice'-->
						<!--<xsl:value-of select='format-number($QtySum * AveragePrice, "###.00")'/>-->
						<xsl:value-of select='format-number(ExecutedQty * format-number(AveragePrice, "###.0000"), "###.00")'/>
					</principal>

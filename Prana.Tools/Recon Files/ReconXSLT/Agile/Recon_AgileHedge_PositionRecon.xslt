	...
	<xsl:template name="Option">
		...
		<xsl:if test="contains(substring-before(COL1,' '),'CALL') or contains(substring-before(COL1,' '),'PUT') ">
			<xsl:variable name="UnderlyingSymbol">
				<xsl:value-of select="substring(COL3,1,3)"/>
			</xsl:variable>
			<xsl:variable name="ExpiryDay">
				<xsl:value-of select="substring(COL3,6,2)"/>
			</xsl:variable>
			<xsl:variable name="ExpiryMonth">
				<xsl:value-of select="substring(COL3,8,1)"/>
			</xsl:variable>
			<xsl:variable name="ExpiryYear">
				<xsl:value-of select="substring(COL3,4,2)"/>
			</xsl:variable>
			...
			<xsl:variable name="StrikePrice">
				...
				<xsl:value-of select="format-number(substring(COL3,9),'#.00')"/>
			</xsl:variable>
				...
				<xsl:if test="number($Quantity)">
					...
					<PositionMaster>
						...
						<FundName>
							...
							<xsl:value-of select="'PS_AgilHadge'"/>
						</FundName>

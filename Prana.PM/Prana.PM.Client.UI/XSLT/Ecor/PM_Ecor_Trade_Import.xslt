  ...
  <xsl:template match="/">
    ...
    <DocumentElement>
      ...
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and contains(COL3,'Cash')!='true'">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="Asset">
              <xsl:choose>
                <xsl:when test="contains(COL3,'Option')">
				  ...
				  <xsl:when test="contains(COL3,'Bond')">
            ...
            <!--<xsl:variable name="Underlying" select="substring-before(COL2,'1')"/>
            ...
            <xsl:variable name="IdcoLast" select="substring(COL2,string-length($Underlying)+1)"/>
            ...
            <SideTagValue>
			  ...
			  <xsl:variable name="TradePrice">
				...
				<xsl:choose>
					<xsl:when test="$Asset='Fixed Income'">
						<xsl:value-of select="($COL9 div $Position * 100)"/>
					</xsl:when>

					<xsl:when test="$Asset='Option'">
						<xsl:value-of select="($COL9 div $Position) div 100"/>
					</xsl:when>

					<xsl:when test="$Asset='Equity'">
						<xsl:value-of select="$COL9 div $Position "/>
					</xsl:when>
            ...
            <CostBasis>
			  ...
			  <xsl:variable name="AccruedInterest" select="COL17"/>

          ...
          <xsl:when test="number($Quantity)">
            <PositionMaster>
              ...
              <TradeDate>
                <xsl:choose>
                  <xsl:when test="COL15!='' and COL15!='*'">
                    <xsl:value-of select="concat(substring(normalize-space(COL15),5,2),'/',substring(normalize-space(COL15),7,2),'/',substring(normalize-space(COL15),1,4))"/>
                  </xsl:when>
              ...
              <OriginalPurchaseDate>
                <xsl:choose>
                  <xsl:when test="COL28!='' and COL28!='*'">
                    <xsl:value-of select="concat(substring(normalize-space(COL28),5,2),'/',substring(normalize-space(COL28),7,2),'/',substring(normalize-space(COL28),1,4))"/>
                  </xsl:when>

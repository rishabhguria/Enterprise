		...
		<ThirdPartyFlatFileDetailCollection>		
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[Asset!='FX' and Asset!='FXForward']">
				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="PRANA_FUND_NAME" select="FundAccountNo"/>

					<xsl:variable name="PB_FUND_NAME">
						<xsl:value-of select="document('../ReconMappingXml/FundMapping.xml')/FundMapping/PB[@Name=$PB_NAME]/FundData[@PranaFund = $PRANA_FUND_NAME]/@PBFundName"/>
					</xsl:variable>

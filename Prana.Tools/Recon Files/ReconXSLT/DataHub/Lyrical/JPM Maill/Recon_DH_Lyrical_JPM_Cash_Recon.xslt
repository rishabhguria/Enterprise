	...
	<xsl:template match="/">
		<DocumentElement>
			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:choose>
					<xsl:when test="number($Cash) and (normalize-space(COL4)='JPMORGAN PRIME MMKT FUND CAPITAL SHARES - FUND 3605' or COL4='US DOLLAR'or COL4='JPMORGAN US GOVT MMKT FUND INST SHARES - FUND 3915')">
						<PositionMaster>

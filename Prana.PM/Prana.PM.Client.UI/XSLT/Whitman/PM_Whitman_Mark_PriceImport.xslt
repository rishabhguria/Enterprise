					...
					<PositionMaster>
						...
						<xsl:variable name="MonthsCode">
							<xsl:call-template name="MonthCode">
								<xsl:with-param name="varMonth" select="substring(COL17,5,2)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="Yeer">
							<xsl:value-of select="substring(COL17,4,1)"/>
						</xsl:variable>
						...
						<xsl:variable name="Year" select="substring(COL19,1,4)"/>
						<xsl:variable name="Month" select="substring(COL19,5,2)"/>
						<xsl:variable name="Day" select="substring(COL19,8,2)"/>

...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:template match="/">
    <Groups>
      ...
      <xsl:for-each select="/NewDataSet/ThirdPartyFlatFileDetail[(contains(AccountName, 'Swap') = false and TaxLotState = 'Allocated') and (UDASecurityTypeName!='cfeu' and UDASecurityTypeName!='cfus')]">
  ...
  <xsl:template name="TaxLotIDBuilder">
    ...
    <xsl:variable name="varFeeValue2">
	  ...
	  <Group 
			  OrderNumber ="" Cancelcorrectindicator ="" AccountNumber="{AccountNo}" SecurityIdentifier="{$varSymbol}"

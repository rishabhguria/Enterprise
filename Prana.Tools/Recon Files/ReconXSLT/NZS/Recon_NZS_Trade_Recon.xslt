					...
					<PositionMaster>
				       ...
				       <TradeDate>
						...
						<xsl:variable name="varYEAR">
							<xsl:value-of select="substring-before(substring-before(COL12,'-'),'-')"/>
						</xsl:variable>
						<xsl:variable name="varMonth">
							<xsl:value-of select="substring-after(substring-before(COL12,'-'),'-')"/>
						</xsl:variable>
						<xsl:variable name="varDATE">
							<xsl:value-of select="substring-after(substring-after(COL12,'-'),'-')"/>
						</xsl:variable>

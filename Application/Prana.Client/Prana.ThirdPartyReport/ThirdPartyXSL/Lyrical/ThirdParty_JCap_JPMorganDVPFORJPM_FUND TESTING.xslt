				...
				<xsl:if test="$PRANA_FUND_NAME!=''">
					...
					<xsl:variable name ="FundAccountNol">
						<xsl:choose>
							...
							<!--<xsl:when test="AccountName='Mitch Albom and Janine Sabino: JH04064'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<!--<xsl:when test="AccountName='Alettar LLC: NE27662'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							...
							<!--<xsl:when test="AccountName='Couch Distributing Co: Y621310'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<xsl:when test="AccountName='Alaska Permanent Fund: AKPFCD269002'">
							...
							<!--<xsl:when test="AccountName='Terry L. Atkinson: NE31252'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
...
<xsl:value-of select ="'N/A'"/>
							...
							<!--<xsl:when test="AccountName='David Blitzer: Y125347'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							...
							<!--<xsl:when test="AccountName='Arthur W. Brown and Susan: G241834394'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<!--<xsl:when test="AccountName='Quinn Family DyN/Asty: NE29554'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
...
<xsl:value-of select ="'N/A'"/>
							...
							<!--<xsl:when test="AccountName='Jason and Maria Chandler: NE 91247'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
...
<xsl:value-of select ="'N/A'"/>
							...
							<!--<xsl:when test="AccountName='Community Memorial Health System: 5TL-02745'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<!--<xsl:when test="AccountName='American Trucking Associations: 5TL-02335'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<xsl:when test="AccountName='ATA Pension Plan: 5TL-05245'">
								<xsl:value-of select ="'N/A'"/>
							</xsl:when>
							<!--<xsl:when test="AccountName='National Assocation of Theatre Owners: 5TL-02748'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
...
<xsl:value-of select ="'N/A'"/>
							...
							<!--<xsl:when test="AccountName='Stephen Fleishman: 5R910276'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							...
							<!--<xsl:when test="AccountName='William Weisser Traditional IRA: NE38502'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							...
							<!--<xsl:when test="AccountName='A Francis Trust: 7EQ28231'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
							<!--<xsl:when test="AccountName='D Francis Trust: 7EQ28230'">
<xsl:value-of select ="'N/A'"/>
</xsl:when>-->
...
<xsl:value-of select ="'N/A'"/>
		...
		<xsl:value-of select ="'N/A'"/>
					...
					<ThirdPartyFlatFileDetail
					  ...
					  SERVICE_FEES = "" POSTAGE ="" STAMP_TAX = "" LEVY_TAX = "" ACCOUNT ="{$FundAccountNol}" ACCOUNT_TYPE = "{AccountName}" IS_ALLOCATION = "Y" 

...
Date: 06 AUGUST 2015    
Desc: Added following     
135: Cash UnRealized Profit And Loss    
17: Cash    
TransactionSource: 9 Entries generated by revaluation    
 (    
...
CREATE Procedure [dbo].[P_MW_ChangeInEquity_PSR]                
(                
@EndDate datetime,                
@fund varchar(max),                
@ITD datetime                
...
DELETE FROM @EquityItems WHERE items in ('Interest Income','Interest Expense','Misc Income','Misc Expense')                

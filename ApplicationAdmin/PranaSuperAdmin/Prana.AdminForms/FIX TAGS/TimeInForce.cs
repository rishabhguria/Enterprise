    ...
    public class TimeInForce : System.Windows.Forms.Form
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (txtTimeInForce != null)
                {
                    txtTimeInForce.Dispose();
                }
                if (lblTimeInForce != null)
                {
                    lblTimeInForce.Dispose();
                }
                if (lblTimeInForceTagValue != null)
                {
                    lblTimeInForceTagValue.Dispose();
                }
                if (grdTimeInForce != null)
                {
                    grdTimeInForce.Dispose();
                }
                if (grpTimeInForce != null)
                {
                    grpTimeInForce.Dispose();
                }
                if (txtTimeInForceTagValue != null)
                {
                    txtTimeInForceTagValue.Dispose();
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimeInForce));
            ...
            this.grpTimeInForce.Controls.Add(this.label1);
            ...
            this.grdTimeInForce.UseFlatMode = DefaultableBoolean.True;
            ...
            this.grpTimeInForce.PerformLayout();
        ...
        private void BindTimeInForceGrid()
        {
            ...
            {
                TimeInForces nullTimeInForces = new TimeInForces();
                nullTimeInForces.Add(new Prana.Admin.BLL.TimeInForce(int.MinValue, "", ""));
                grdTimeInForce.DataSource = nullTimeInForces;
            }
        }
        ...
        private int SaveTimeInForce()
        {
            ...
            errorProvider1.SetError(txtTimeInForceTagValue, "");
            errorProvider1.SetError(btnSave, "");

            int result = int.MinValue;

            Prana.Admin.BLL.TimeInForce timeInForce = new Prana.Admin.BLL.TimeInForce();
            ...
            if (txtTimeInForceTagValue.Text.Trim().Length == 0)
            {
                errorProvider1.SetError(txtTimeInForceTagValue, "Provide Value!");
                return result;
            }
            else
            {
            ...
            {
                MessageBox.Show("Time In Force with the same name or tag already exists.", "Prana Alert", MessageBoxButtons.OK);
            }
        ...
        private void btnDelete_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (grdTimeInForce.Rows.Count > 0)
                {
                    string tifName = grdTimeInForce.ActiveRow.Cells["Name"].Text.ToString();
                    if (tifName != "")
                    {
                        //Asking the user to be sure about deleting the timeInForce.
                        if (MessageBox.Show(this, "Do you want to delete this Time in Force?", "Prana Alert", MessageBoxButtons.YesNo) == DialogResult.Yes)
                        {
                            ...
                            bool chkVarraible = OrderManager.DeleteTimeInForce(timeInForceID);
                            if (!(chkVarraible))
                            {

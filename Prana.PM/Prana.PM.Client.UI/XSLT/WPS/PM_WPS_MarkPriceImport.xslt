  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(COL4,'Option')">
      ...
      <xsl:variable name="ExpiryYear">
        <xsl:value-of select="substring(substring-before(substring-after(substring-after(normalize-space(COL2),'/'),'/'),' '),3,2)"/>
      </xsl:variable>
      ...
      <xsl:variable name="StrikePrice">
        <xsl:value-of select="format-number(substring(substring-before(substring-after(substring-after(substring-after(substring-before(normalize-space(COL3),'Equity'),'/'),'/'),' '),' '),2),'#.00')"/>
      </xsl:variable>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs"
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<!--<xsl:for-each select="ThirdPartyFlatFileDetail[FundName='JD Investment Trust: 80785699' or FundName='McLain Capital Partners LLC: 71802226' or FundName='Andrew H. Sieja Living Trust: 77624659' or FundName='Eskenazi Health Foundation Inc: 24550516' or FundName='Robert J Troxel Revocable Trust: 10931054' or FundName='Syndicate Sales Inc: 86226082' or FundName='Michael D Elwood: 74879771' or FundName='John A Elwood: 88781780' ]">-->
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				<ThirdPartyFlatFileDetail>
					...
					<AccountNumber>
						<!--<xsl:choose>
							<xsl:when test="FundName='JD Investment Trust: 80785699'">
								<xsl:value-of select="'80785699'"/>
							</xsl:when>

							<xsl:when test="FundName='McLain Capital Partners LLC: 71802226'">
								<xsl:value-of select="'71802226'"/>
							</xsl:when>

							<xsl:when test="FundName='Andrew H. Sieja Living Trust: 77624659'">
								<xsl:value-of select="'77624659'"/>
							</xsl:when>

							<xsl:when test="FundName='Eskenazi Health Foundation Inc: 24550516'">
								<xsl:value-of select="'24550516'"/>
							</xsl:when>

							<xsl:when test="FundName='Robert J Troxel Revocable Trust: 10931054'">
								<xsl:value-of select="'10931054'"/>
							</xsl:when>

							<xsl:when test="FundName='Syndicate Sales Inc: 86226082'">
								<xsl:value-of select="'86226082'"/>
							</xsl:when>

							<xsl:when test="FundName='Michael D Elwood: 74879771'">
								<xsl:value-of select="'74879771'"/>
							</xsl:when>

							<xsl:when test="FundName='John A Elwood: 88781780'">
								<xsl:value-of select="'88781780'"/>
							</xsl:when>

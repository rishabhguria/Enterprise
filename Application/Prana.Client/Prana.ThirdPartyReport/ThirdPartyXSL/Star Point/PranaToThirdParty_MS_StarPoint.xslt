				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:choose>
						<xsl:when test ="Asset = 'Equity'">
							<xsl:choose>
								<xsl:when test="Symbol='TRAD-OMX'">
									<SecID>
										<xsl:value-of select="'TRDBLR'"/>
									</SecID>
								</xsl:when>
								<xsl:when test="Symbol='TDS.S'">
									<SecID>
										<xsl:value-of select="'TDSS'"/>
									</SecID>
								</xsl:when>
								<xsl:when test="Symbol='JPR-LON'">
									<SecID>
										<xsl:value-of select="'JOHNP'"/>
									</SecID>
								</xsl:when>
								<xsl:otherwise>
									<SecID>

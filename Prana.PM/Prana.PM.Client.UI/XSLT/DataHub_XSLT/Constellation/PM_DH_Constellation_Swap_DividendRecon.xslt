        ...
        <xsl:choose>
          <xsl:when test="number($varDividend) and contains($varDividendIdentify,'Dividend')">
            <PositionMaster>
              ...
              <xsl:variable name="PB_Symbol" select="normalize-space(COL8)"/>
              <xsl:variable name="varSymbol" select="normalize-space(COL9)"/>
              ...
              <xsl:variable name="varEXDateDay" select="substring-before(COL5,'-')"/>
              <xsl:variable name="varEXDateYear" select="substring-after(substring-after(COL5,'-'),'-')"/>
              ...
              <xsl:variable name="varPDateDay" select="substring-before(COL6,'-')"/>
              <xsl:variable name="varPDateYear" select="substring-after(substring-after(COL6,'-'),'-')"/>

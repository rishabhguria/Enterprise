...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="Option">
    ...
    <xsl:if test="contains(COL5,'CALL') or contains(COL5,'PUT')">
  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//PositionMaster">
        ...
        <xsl:if test="number($Position) and contains(COL5,'PUT') or contains(COL5,'CALL') ">
          ...
          <PositionMaster>
            ...
            <xsl:variable name ="Asset">
              <xsl:choose>
                <xsl:when test="contains(COL3,'PUT') or contains(COL3,'CALL')">

        ...
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:variable name="varfee2">
            <xsl:choose>
              ...
              <xsl:when test="SettlCurrFxRate!=0 and SettlCurrFxRateCalc='M'">
                <xsl:value-of select="$varFEE1 * SettlCurrFxRate"/>
              </xsl:when>

              <xsl:when test="SettlCurrFxRate!=0 and SettlCurrFxRateCalc='D'">
                <xsl:value-of select="$varFEE1 div SettlCurrFxRate"/>
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="''"/>
              </xsl:otherwise>
          ...
          <EXECUTINGBROKER>
            <xsl:choose>
              <xsl:when test="contains(CounterParty,'MISL')">
                <xsl:value-of select="'MISL'"/>
              </xsl:when>
              <xsl:otherwise>
                <xsl:choose>

        ...
        <xsl:if test="number($varNetPosition)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varAsset">
              <xsl:choose>
                <xsl:when test="normalize-space(COL3)='Call' or normalize-space(COL3)='Put' or normalize-space(COL3)='call' or normalize-space(COL3)='put'
				or normalize-space(COL3)='PUT' or normalize-space(COL3)='CALL'">

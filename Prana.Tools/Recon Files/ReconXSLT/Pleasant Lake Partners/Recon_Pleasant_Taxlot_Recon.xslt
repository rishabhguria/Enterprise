			...
			<xsl:for-each select ="//Comparision">
				...
				<xsl:if test="number($varQuantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_FUND_NAME" select ="normalize-space(COL12)"/>
						...
						<xsl:variable name="varAvgPX">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL102)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="NetNotionalValue">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="normalize-space(COL104)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="varDate">
							<xsl:call-template name="FormatDate">
								<xsl:with-param name="DateTime" select="normalize-space(COL134)"/>
							</xsl:call-template>
						</xsl:variable>

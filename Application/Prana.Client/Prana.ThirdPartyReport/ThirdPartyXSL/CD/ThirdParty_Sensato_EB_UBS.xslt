...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail[(CounterParty = 'UBS Electronic') and (AccountName = 'SAPGS_CASH' or AccountName = 'SP29GS_CASH' or AccountName = 'S1GS_CASH' or AccountName = 'SP29DB_CASH' or AccountName = 'SP29CS_CASH' or AccountName = 'S1CS_CASH' or AccountName = 'SAPCS_CASH' or AccountName = 'SAPDB_CASH' or AccountName = 'S1DB_CASH' or AccountName = 'SP29MS_ALL')]">
				<ThirdPartyFlatFileDetail>
					<!--for system internal use-->
					<RowHeader>
						<xsl:value-of select ="'true'"/>

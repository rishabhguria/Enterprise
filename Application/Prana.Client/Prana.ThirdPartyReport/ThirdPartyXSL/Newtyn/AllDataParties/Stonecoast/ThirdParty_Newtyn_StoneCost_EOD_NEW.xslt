  ...
  <xsl:template name="TaxLotIDBuilder">
    ...
    <xsl:variable name="varClosingMethod">
	  ...
	  <Group 
        ...
        OtherFees="{OtherBrokerFee}" AccruedInterest="{AccruedInterest}" NetTradeCash="{NetAmount}" Counterparty="{$varBroker}"
		...
		UDASecurityType="{UDASecurityTypeName}" UDAAsset="{UDAAssetName}" EntityID="{EntityID}" TaxLotState="{TaxLotState}" TaxLotState1="" FileHeader="FALSE" FileFooter="FALSE">

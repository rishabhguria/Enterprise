			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				...
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="PB_CounterParty">
						<xsl:value-of select="document('../ReconMappingXml/ThirdParty_Exec_BrokerMapping.xml')/BrokerMapping/PB[@Name=$PB_NAME]/BrokerData[@PranaBrokerName=$Prana_CounterParty]/@PBBrokerName"/>
					</xsl:variable>

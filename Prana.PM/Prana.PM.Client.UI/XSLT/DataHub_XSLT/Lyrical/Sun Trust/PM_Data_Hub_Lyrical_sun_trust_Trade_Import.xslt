	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Position) and $PRANA_FUND_NAME!=''">
      				...
      				<PositionMaster>
						...
						<NetPosition>
							<!--<xsl:choose>
								<xsl:when test="contains(COL5,'CASH')!='true' and contains(COL7,'TBIXXFFS')!='true' and contains(COL7,'TOIXXFFS')!='true'  and contains(COL7,'FEDSINSFFS')!='true'  and contains(COL7,'GOIXXFFS')!='true' and COL16!='*'">

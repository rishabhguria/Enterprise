...
namespace Prana.Utilities.XMLUtilities
{
    ...
    public class CustomXmlSerializer
    {
        ...
        public System.Text.StringBuilder WriteText(object source)
        {
            ...
            using (StringWriter textStreamWriter = new StringWriter(xmlText))
            {
                XmlTextWriter xmlWriter = new XmlTextWriter(textStreamWriter);
        ...
        private object ReadChildren(System.Xml.XmlReader reader, object target, object propertyMember)
        {
            ...
            while (reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                ...
                if (_MetaInstructions != null && _MetaInstructions.IndexOfKey("key") >= 0)
        ...
        {
            return System.Int32.TryParse(s, out int a);
        }

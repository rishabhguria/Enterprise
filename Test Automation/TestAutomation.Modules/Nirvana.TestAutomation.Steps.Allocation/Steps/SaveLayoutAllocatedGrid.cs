...
{
    class SaveLayoutAllocatedGrid : AllocationUIMap, ITestStep
    {
        ...
        public TestResult RunTest(DataSet testData, Dictionary<int, string> sheetIndexToName)
        {
            ...
            {
                SamsaraHelperClass.CaptureMyScreen("", ApplicationArguments.TestCaseToBeRun, "SaveLayoutAllocatedGrid");
                _res.IsPassed = false;
        ...
        private void FieldChooser(DataSet testData)
        {
            try
            {
                ...
                foreach (DataRow dr in testData.Tables[0].Rows)
                {
                    ...
                    {
                        InfragisticsWindowsDataPresenterFieldChooserEntry1.DoubleClick(MouseButtons.Left);
                    }
                    FieldChooserAllocatedTextBox.Click();
                }

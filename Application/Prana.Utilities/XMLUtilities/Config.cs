/* This Class is for the reading and writing into the XML config Files
 * created by Dileep 
 * 
 */
...
namespace Prana.Utilities.XMLUtilities
{
    public class Config : System.Configuration.AppSettingsReader
    {
        ...
        public string cfgFile
        {
            get { return _cfgFile; }
            set { _cfgFile = value; }
            //set	{ _cfgFile= Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + "\\" + value; }
        }
        ...
        public bool removeElement(string key)
        {
            ...
            {
                LogAndDisplayOnInformationReporter.GetInstance.WriteAndDisplayOnInformationReporter(ex.Message);
                return false;
            }
        }

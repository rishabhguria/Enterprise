              ...
              <xsl:value-of select="document('../ReconMappingXml/ExecBrokerMapping.xml')/BrokerMapping/PB[@Name=$PB_NAME]/BrokerData[@PranaBroker=$PB_BROKER_NAME]/@PranaBrokerCode"/>
						...
						<xsl:variable name="Secfee">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="COL25 div $FXRate"/>
								</xsl:otherwise>
						...
						<xsl:variable name ="Side" select="COL51"/>
						<SideTagValue>
							<xsl:choose>
						...
						<xsl:variable name ="CalculatedData1">
							<xsl:value-of select ="COL20 * COL17"/>
						</xsl:variable>

						<xsl:variable name ="CalculatedData2">
							<xsl:value-of select ="$CalculatedData1 + COL25 + COL24 + COL15"/>
						</xsl:variable>

						<xsl:variable name="OtherBrokerFee">
							<xsl:choose>
								<xsl:when test="COL19 = 'USD'">
									<xsl:value-of select="$CalculatedData2"/>
								</xsl:when>

    ...
    <ThirdPartyFlatFileDetailCollection>
      ...
      <xsl:for-each select="ThirdPartyFlatFileDetail">
        ...
        <ThirdPartyFlatFileDetail>
          ...
          <xsl:variable name="PB_NAME" select="'PMEOD_MapleRock'"/>

          <xsl:variable name="varPRANA_FUND_NAME">
            <xsl:value-of select="AccountName"/>
          </xsl:variable>
          <xsl:variable name="varTHIRDPARTY_FUND_CODE">
            <xsl:value-of select="document('../ReconMappingXml/ThirdParty_AccountMapping.xml')/FundMapping/PB[@Name=$PB_NAME]/FundData[@PranaFund=$varPRANA_FUND_NAME]/@PBFundCode"/>
          </xsl:variable>

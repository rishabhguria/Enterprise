USE [ConstellationV1.7.1]
GO
/****** Object:  StoredProcedure [dbo].[P_GetAccruedDividendReport_DH]    Script Date: 7/10/2019 7:11:58 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER Procedure [dbo].[P_GetAccruedDividendReport_DH]        
(      
 @EndDate datetime,        
 @FundIds varchar(max)        
)        

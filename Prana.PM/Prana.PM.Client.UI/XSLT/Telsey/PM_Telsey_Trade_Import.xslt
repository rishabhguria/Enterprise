			...
			<xsl:for-each select ="//PositionMaster">
				<xsl:variable name="Quantity">
					...
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="substring(COL1,105,13)"/>
					</xsl:call-template>
				</xsl:variable>
				...
				<xsl:if test="number($Quantity)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_SYMBOL_NAME">
							<xsl:value-of select="substring(COL1,28,35)"/>
						</xsl:variable>
						...
						<xsl:variable name="Asset">
							<xsl:choose>
								<xsl:when test="substring(COL1,561,2)='OP'">
									<xsl:value-of select="'EquityOption'"/>
								</xsl:when>
								<xsl:when test="substring(COL1,561,2)='EQ'">
						...
						<xsl:variable name="Symbol">
							<xsl:value-of select="substring(COL1,382,20)"/>
						</xsl:variable>
						<Symbol>
							<xsl:choose>
						...
						<xsl:variable name="NetPosition">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,104,18)"/>
							</xsl:call-template>
						</xsl:variable>
						...
						<xsl:variable name="AvgPrice">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,122,16)"/>
							</xsl:call-template>
						</xsl:variable>
						<CostBasis>
							<xsl:choose>
						...
						<xsl:variable name="Side" select="substring(COL1,381,1)"/>
						<SideTagValue>
							<xsl:choose>
						...
						<xsl:variable name="Commission">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,180,14)"/>
							</xsl:call-template>
						</xsl:variable>
						<Commission>
							<xsl:choose>
						...
						<xsl:variable name="Fees">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,152,14)"/>
							</xsl:call-template>
						</xsl:variable>
						<Fees>
							<xsl:choose>
						...
						<xsl:variable name="SecFee">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,255,14)"/>
							</xsl:call-template>
						</xsl:variable>
						<SecFee>
							<xsl:choose>
						...
						<xsl:variable name="Year">
							<xsl:value-of select="substring(COL1,74,4)"/>
						</xsl:variable>
						<xsl:variable name="Month">
							<xsl:value-of select="substring(COL1,79,2)"/>
						</xsl:variable>
						<xsl:variable name="Day">
							<xsl:value-of select="substring(COL1,82,2)"/>
						</xsl:variable>
						<PositionStartDate>
						...
						<!--<xsl:variable name="varPYear">
							<xsl:value-of select="substring(COL1,84,4)"/>
						</xsl:variable>
						<xsl:variable name="varPMonth">
							<xsl:value-of select="substring(COL1,89,2)"/>
						</xsl:variable>
						<xsl:variable name="varPDay">
							<xsl:value-of select="substring(COL1,92,2)"/>
						</xsl:variable>
						<ProcessDate>
						...
						<xsl:variable name="Year1">
							<xsl:value-of select="substring(COL1,94,4)"/>
						</xsl:variable>
						<xsl:variable name="Month1">
							<xsl:value-of select="substring(COL1,99,2)"/>
						</xsl:variable>
						<xsl:variable name="Day1">
							<xsl:value-of select="substring(COL1,102,2)"/>
						</xsl:variable>

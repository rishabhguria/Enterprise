			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:variable name="Position">
					<xsl:call-template name="Translate">
						<xsl:with-param name="Number" select="normalize-space(substring(COL1,73,15))"/>
					</xsl:call-template>
				</xsl:variable>
				...
				<xsl:if test="number($Position)">
					...
					<PositionMaster>
						...
						<xsl:variable name="PB_NAME">
							<xsl:value-of select="'Wells Fargo Advisor'"/>
						</xsl:variable>
						...
						<xsl:variable name ="MArkPrice">
							<xsl:call-template name="Translate">
								<xsl:with-param name="Number" select="substring(COL1,175,19)"/>
							</xsl:call-template>
						</xsl:variable>

  ...
  <xsl:output method="xml" encoding="UTF-8" indent="yes" omit-xml-declaration="yes"/>
    ...
    <DocumentElement>
      <xsl:for-each select="//Comparision">
		  ...
		  <xsl:if test="(normalize-space(substring(COL1,57,11)) != 0) and ($varTransaction_type='by' or $varTransaction_type='cs' or $varTransaction_type='sl' or $varTransaction_type='ss') and ($varSecurity_Type='cl' or $varSecurity_Type='cs' or $varSecurity_Type='pt')">

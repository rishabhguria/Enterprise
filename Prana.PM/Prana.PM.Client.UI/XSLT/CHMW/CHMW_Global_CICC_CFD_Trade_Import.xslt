				...
				<xsl:if test="number($NetPosition) ">
					...
					<PositionMaster>
						<xsl:variable name="PB_NAME">
							<xsl:value-of select="'CICC Financial Trading Limited'"/>
						</xsl:variable>
						...
						<xsl:variable name="Year1">
							<xsl:value-of select="substring(substring-after(substring-after(COL1,'/'),'/'),1,4)"/>
						</xsl:variable>
						...
						<xsl:variable name="Year2">
							<xsl:value-of select="substring(substring-after(substring-after(COL2,'/'),'/'),1,4)"/>
						</xsl:variable>
						...
						<!--<xsl:variable name ="varCommision">
							<xsl:value-of select ="($NetPosition * COL9 * COL17) div 10000"/>
						</xsl:variable>

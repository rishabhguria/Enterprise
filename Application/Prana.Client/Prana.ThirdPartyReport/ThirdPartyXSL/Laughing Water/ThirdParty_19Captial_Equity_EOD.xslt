	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		<ThirdPartyFlatFileDetailCollection>
			...
			<ThirdPartyFlatFileDetail>
				...
				<xsl:for-each select="ThirdPartyFlatFileDetail[(Asset='Equity') and Symbol !='FGTXX']">
				<ThirdPartyFlatFileDetail>
					...
					<xsl:variable name="THIRDPARTY_COUNTERPARTY_NAME">
						<xsl:value-of select="document('../ReconMappingXml/ExecBrokerMapping.xml')/BrokerMapping/PB[@Name=$PB_NAME]/BrokerData[@MLPBroker=$PRANA_COUNTERPARTY_NAME]/@PranaBroker"/>
					</xsl:variable>

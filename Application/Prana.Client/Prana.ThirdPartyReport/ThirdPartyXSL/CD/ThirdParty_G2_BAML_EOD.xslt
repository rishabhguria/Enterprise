	...
	<xsl:template match="/ThirdPartyFlatFileDetailCollection">
		...
		<ThirdPartyFlatFileDetailCollection>
			...
			<xsl:for-each select="ThirdPartyFlatFileDetail">
				...
				<xsl:if test ="AccountName='naveen1'">
					...
					<ThirdPartyFlatFileDetail>
						...
						<PBAcctNo>
							<xsl:choose>
								<xsl:when test ="AccountName='naveen1'">
									<xsl:value-of select ="'10435'"/>
								</xsl:when>
								<!--<xsl:when test ="AccountName='G2 Investment Partners QP LP'">
									<xsl:value-of select ="'10436'"/>
								</xsl:when>-->
							</xsl:choose>
							<!--<xsl:value-of select="''"/>-->
						</PBAcctNo>

...
******************************************************************/                              
ALTER PROCEDURE  [dbo].[PMGetRealizeAndUnrealizePnL]                                                                               
(                                                                                                                                                                                                                                                    
...
'' as ClosedTradeAttribute2 ,          '' as ClosedTradeAttribute3 ,          
...
Insert into #MTMDataTable                                                                                                                                    
 Select                                                                                                                                                                        
   ...
   MIN(CLocal.CurrencySymbol) as CompanyName,                                                                                                                                                                                                                  
...
0 As NetTotalCost_Base,                                        
'Currency' as BloombergSymbol,                                      
'Currency' as SedolSymbol,                                      
'' as ISINSymbol,                                      
'' as CusipSymbol,                                      
'' as OSISymbol,                                      
'' as IDCOSymbol,                  
...
AND FXDayRatesForStartDate.ToCurrencyID = CF.LocalCurrency                                                                                                          
 And DateDiff(d,dbo.AdjustBusinessDays(@StartDate,-1,@DefaultAUECID),FXDayRatesForStartDate.Date)=0 And (FXDayRatesForStartDate.FundID=0 Or FXDayRatesForStartDate.FundID is NUll And DailyCash.FundID Not in (Select FundID from #FundsInFXMP Where FundID is 

  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select="//PositionMaster">
               <xsl:if test="number(COL4) and COL23='0' and (COL2='30889134' or COL2='10111644' or COL2='59792710'or COL2='71240526' or COL2='71240527' or COL2='71240528'or COL2='71240529' or COL2='71240540' or COL2='78726923' or COL2='80025901' or COL2='82394500' or COL2='1PT00052')">
          ...
          <PositionMaster>
            ...
            <SideTagValue>
              <xsl:choose>
				  ...
				  <xsl:when test="COL3 = 'P' and (COL34 = '6' or COL34 = '3')  and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'B'"/>
				  </xsl:when>
				  <xsl:when test="COL3 = 'S' and COL34 = '2'  and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'2'"/>
				  </xsl:when>
				  <xsl:when test="COL3 = 'S'and (COL34 = '6' or COL34 = '3')  and not(contains(COL18,'CALL ') or contains(COL18,'PUT '))">
					  <xsl:value-of select="'5'"/>
				  </xsl:when>
			  ...
			  <Fees>
				  <xsl:choose>
					  <xsl:when test="normalize-space(COL2 = '1PT00052')">
						  <xsl:choose>

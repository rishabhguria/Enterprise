	...
	<xsl:template match="/">
		...
		<DocumentElement>
			...
			<xsl:for-each select ="//PositionMaster">
				...
				<xsl:if test="number($Cash) and COL13 !='PURCHASE' and COL13 !='DIVIDEND' and COL13 !='INC-EXP' and COL13 !='SALE'">
					<PositionMaster>
						...
						<xsl:variable name="PB_SubAccountData" select="COL13"/>
						...
						<xsl:variable name="Description" select="COL13"/>
						<Description>

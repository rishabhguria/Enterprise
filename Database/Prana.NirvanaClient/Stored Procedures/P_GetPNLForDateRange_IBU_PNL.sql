...
Usage :                         
EXEC P_GetPNLForDateRange_shankey @StartDate='2016-06-06',@EndDate='2016-06-06',@AssetIds=N'',@FundIds=N''          
******************************************************************/          
CREATE PROCEDURE [dbo].[P_GetPNLForDateRange_IBU_PNL] (          
 @StartDate DATETIME          
 ,@EndDate DATETIME          
...
select *,(LongTermTotalRealizedPNLWithCommission + ShortTermTotalRealizedPNLWithCommission) as TotalRealizedPnl from #temp        

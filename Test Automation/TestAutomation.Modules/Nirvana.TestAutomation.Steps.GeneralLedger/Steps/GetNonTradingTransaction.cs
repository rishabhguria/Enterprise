...
using Nirvana.TestAutomation.Steps.GeneralLedger;
...
{
    class GetNonTradingTransaction: CashJournalUIMap, ITestStep
    {
        ...
        /// <summary>
        /// Opens non trading transactions tab in the cash journal 
        /// </summary>

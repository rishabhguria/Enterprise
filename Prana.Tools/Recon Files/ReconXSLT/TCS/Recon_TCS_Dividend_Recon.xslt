      ...
      <xsl:for-each select="//Comparision">
        ...
        <xsl:if test="number($varDividend)">
          ...
          <PositionMaster>
            ...
            <xsl:variable name="varSymbol" select="substring-before(normalize-space(COL19),' ')"/>
           ...
           <xsl:variable name="varPayoutDate" select="COL10"/>

		    <PayoutDate>
              <xsl:value-of select="$varPayoutDate"/>
            </PayoutDate>

			  <xsl:variable name="varExDate" select="COL8"/>

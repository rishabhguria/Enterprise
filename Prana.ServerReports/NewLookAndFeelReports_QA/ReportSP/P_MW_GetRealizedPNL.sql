 GO 
  print 'Started Executing: ClientDB_P_MW_GetRealizedPNL.sql'
GO 
                      
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[P_MW_GetRealizedPNL]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
DROP PROCEDURE [dbo].[P_MW_GetRealizedPNL]
END
GO                  
/*****************************************************************                              
...
CREATE Procedure [dbo].[P_MW_GetRealizedPNL]                             
(                              
@StartDate datetime  ,                            
@EndDate datetime,                    
@ReportID Varchar(20),                  
...
GO 
  print 'Done Executing: ClientDB_P_MW_GetRealizedPNL.sql'
 GO 
        ...
        <xsl:if test="number($NetPosition)" >
          <PositionMaster>
           ...
           <xsl:variable name="varCostBasis">
             <xsl:call-template name="Translate">
               <xsl:with-param name="Number" select="($varTotalCost div $NetPosition)"/>
             </xsl:call-template>
           </xsl:variable>
            <CostBasis>
              <xsl:choose>
            ...
            <xsl:variable name="PB_STRATEGY_NAME">
              <xsl:choose>
            ...
            <xsl:variable name="PRANA_STRATEGY_NAME">
              <xsl:value-of select="document('../ReconMappingXml/StrategyMapping.xml')/StrategyMapping/PB[@Name=$PB_NAME]/StrategyData[@PranaBrokerStrategy=$PB_STRATEGY_NAME]/@PranaStrategy"/>
            </xsl:variable>
            <Strategy>
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of select="$PB_STRATEGY_NAME"/>
                </xsl:otherwise>
              </xsl:choose>
            </Strategy>

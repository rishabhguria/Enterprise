...
-- =============================================  
CREATE FUNCTION [dbo].[F_BS_dTwo_Black76]  
(  
...
BEGIN  
 ...
 SELECT @Result = dbo.F_BS_dOne_Black76(@UnderlyingPrice ,@ExercisePrice ,@time ,@Interest ,@Volatility ,@Dividend ) - (@Volatility * sqrt(@time))  

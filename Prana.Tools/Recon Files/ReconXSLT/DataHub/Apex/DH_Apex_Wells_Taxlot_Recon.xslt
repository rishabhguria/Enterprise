  ...
  <xsl:template match="/">
    <DocumentElement>
      <xsl:for-each select ="//Comparision">
        ...
        <xsl:choose>
          <xsl:when test="number($Position) and not(contains(COL18,'Currencies'))">
            <PositionMaster>
              ...
              <xsl:variable name="Asset">
                <xsl:choose>
                  <xsl:when test="contains(COL11,'Options')">
              ...
              <xsl:variable name="PB_SUFFIX" select="normalize-space(COL27)"/>
